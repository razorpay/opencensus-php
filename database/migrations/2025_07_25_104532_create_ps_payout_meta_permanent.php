...
class CreatePsPayoutMetaPermanent extends Migration
{
    /**
    ...
    public function up()
    {
        Schema::create('ps_payout_meta_permanent', function (Blueprint $table) {
            $table->engine = 'InnoDB';
    ...
    {
        Schema::dropIfExists('ps_payout_meta_permanent');
    }
}
