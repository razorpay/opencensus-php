...
class CreateBankingAccountStatementPoolRbl extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create(Table::BANKING_ACCOUNT_STATEMENT_POOL_RBL, function(Blueprint $table)
        {
            $table->engine = 'InnoDB';
            ...
            'bas_pool_rbl_merchant_id_created_at_index');

            $table->index([Entity::BANK_TRANSACTION_ID, Entity::TRANSACTION_DATE],
            'banking_account_statement_pool_rbl_bank_txn_id_txn_date');
    ...
    {
        Schema::dropIfExists(Table::BANKING_ACCOUNT_STATEMENT_POOL_RBL);
    }
}
