...
class CreateCardsNewTable extends Migration
{
    /**
    ...
    public function up()
    {
        Schema::create(Table::CARDS_NEW, function(Blueprint $table)
        {
            $table->engine = 'InnoDB';
    ...
    {
        Schema::table(Table::CARDS_NEW, function($table)
        {
            $table->dropForeign(
                Table::CARDS_NEW . '_' . Card::MERCHANT_ID . '_foreign');
        });

        Schema::drop(Table::CARDS_NEW);
    }
}
