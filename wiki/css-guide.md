...
npm run lint:css —- web/css/merchant/**/*.styl web/css/merchant/*.styl
```
...
4. Run npm fix CSS – changed file list (this fixes auto-fixable errors)

   ```bash
   npm run fix:css —- web/css/merchant/80gdetails.styl web/css/merchant/activation.styl
   ```
