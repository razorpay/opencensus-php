...
func (s *PaymentPageAPITestSuite) TestSubscriptionButtonCreatePositive() {
	...
	for _, scenario := range []positiveTestCases{
		...
		s.Run(scenario.description, func() {
			ppRes := CreateSubsctiptionButton(s.T(), scenario.input)
...
func validateSubscriptionButtonRequest(request PaymentPageRequest) error {
...
func (s *PaymentPageAPITestSuite) TestSubscriptionButtonNegative(){
	...
	for _, scenario := range []errorTestCases{
		...
		s.Run(scenario.description, func () {
			err := validateSubscriptionButtonRequest(scenario.input)
