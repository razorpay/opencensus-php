...
configure_dark(){
    ...
    echo "NBPLUS_PAYMENT_SERVICE_LIVE_URL=\"https://payments-nbplus-live-dark.razorpay.com/v1/\"" >> ./environment/.env.production
    echo "NBPLUS_PAYMENT_SERVICE_TEST_URL=\"https://payments-nbplus-test-dark.razorpay.com/v1/\"" >> ./environment/.env.production
}
