...
import ProgressBarContinuous, { ProgressBarContinuousPropsT } from './ProgressBarContinuous';
...
export const ProgressBar: React.FC<ProgressBarContinuousPropsT> = () => {
...
const Template: Story<ProgressBarContinuousPropsT> = (args) => <ProgressBarContinuous {...args} />;
