    ...
    <Modal bottomsheet isOpen={isOpen} onClose={() => setIsOpen(false)}>
      <ModalBody>
        <StatelessAccordian accordian expanded={expanded} onChange={(_, exp) => setExpanded(exp)}>
          ...
          >
            Activation of an account is subject to approval from our banking partners (Working days
            do not include Saturdays, Sundays and bank holidays)
            <br />
          ...
          <Panel key="Q5" title="What is KYC review process">
            ...
            activated, it is required that you submit your KYC form which needs to be reviewed and
          ...
          <Panel key="Q7" title="Special anniversary pricing offer">
            ...
            between 4th March 00:00 AM till 30th April 11:59 PM. After the expiry of the promotional
            pricing offer, all transactions will be charged at our standard pricing plan of 2%.
            <br />
            <br />
            <Text weight="bold" color="shade.970" size="medium">
            ...
            <small>
              *Some payment methods might take time to get enabled and are subjected to the approval
              of our wallet/banking partners.
            </small>
            <br />
            <br />
            <Text weight="bold" color="shade.970" size="medium">
            ...
            done under Subscriptions via Credit Card will reflect the promotional pricing during the
            course of the promotional offer. Standard pricing will be applied afterwards.
            <br />
            <br />
            <Text weight="bold" color="shade.970" size="medium">
            ...
            <Link href="https://razorpay.typeform.com/to/giXuFa">quick survey</Link> and we will get
            the pricing changed for you in 1-2 working days. The other terms and conditions for the
            promotional pricing will apply to you as well.
            <br />
            <br />
            <Text weight="bold" color="shade.970" size="medium">
              6) Where can I see the updated pricing for my account?
            </Text>
            The promotional pricing can be seen in the Razorpay Dashboard under the Reports section.
            Any payments reports downloaded with fees breakup will show the effective pricing in
          ...
          <Panel key="Q8" title="Unlock Growth with Razorpay">
            ...
            disburse vendor payouts worth ₹33+ lakh, working capital loans from 1.25% per month and
            more!
            <br />
            <br />
            <Text weight="bold" color="shade.970" size="medium">
            ...
            Every business, whether you are a registered business (private limited, public limited,
            proprietorship, etc.) or an unregistered business(freelancer, consultant, homepreneur,
            etc.), you can sign up and avail these offers.
            <br />
            <br />
            <Text weight="bold" color="shade.970" size="medium">
            ...
            months free trial on Opfin. 1 month free trial and an additional 10% off on the first 3
            paid months. Working capital loans starting at 1.25% per month.
            <br />
            <br />
            <Text weight="bold" color="shade.970" size="medium">
            ...
            This offer is applicable to all signups till 31st July 2020. The benefits, free credits,
            and free trials can be availed for up to 1 year.
            <br />
            <br />
            <Text weight="bold" color="shade.970" size="medium">
          ...
          >
            ...
            <Link href="https://i.imgur.com/prVyTF9.gif">short animation</Link> to find and complete
            the activation form in your dashboard.
          </Panel>
          <Panel
            key="Q10"
            title="My account is not yet activated, it's been too long since I got any update, what do I do?"
          >
            We try our best to have everyone's account activated on time, however since you haven’t
            received an update on this, please file a grievance over here:{' '}
          ...
          >
            ...
            activation form and revert on the mail thread. If you don’t see any mail, please raise a
            request over:
          ...
          <Panel key="Q13" title="Do you support unregistered businesses?">
            Yes, we do support freelancers/individuals/unregistered business entities. You can sign
            up <Link href="https://dashboard.razorpay.com/#/access/signup">here</Link> and submit
            your activation form. Get started on accepting payments from your customers now!
            <br />
            <br />
          ...
          <Panel key="Q14" title="What are the payment methods supported?">
            We support payments through Cards, Netbanking, UPI and Wallets. You may find more about
            this <Link href="https://razorpay.com/payment-gateway/#methods">here</Link>
          </Panel>
        </StatelessAccordian>
      </ModalBody>
    </Modal>
