...
test.describe.parallel(
  'Test Partner Manage Team Flows for POS Reseller @flow=partner-homepage @project=partner-dashboard',
  () => {
    test.use({
    ...
    test('should load the Partner Manage Team page for Reseller with correct messages and CTAs @priority=critical', async ({
      page,
    }) => {
      try {
