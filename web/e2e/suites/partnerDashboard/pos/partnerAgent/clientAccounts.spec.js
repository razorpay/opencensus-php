...
test.describe
  .parallel('Test Reseller Partner POS Agent pos @flow=partnerships-pos @project=partner-dashboard', () => {
  test.use({
  ...
  test.skip('should load the Accepted Invite list and Details Panel with correct CTAs @priority=critical', async ({
    page,
  }) => {
