...
test.describe.parallel(
  ...
  () => {
    ...
    test('should show entity search results for email search @priority=normal', async ({
      page,
    }) => {
      const searchBox = await page.locator("input[name='search']");
      await expect(searchBox).toBeVisible();
    ...
    test('should list all entities for no search query match @priority=normal', async ({
      page,
    }) => {
      const searchBox = await page.locator("input[name='search']");
      await expect(searchBox).toBeVisible();
