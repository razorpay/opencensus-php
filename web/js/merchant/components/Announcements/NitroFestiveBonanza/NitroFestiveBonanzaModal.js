...
const NitroFestiveBonanzaModal = ({ closeModal, save }) => {
      ...
      <div className="nss-details" id="nss-details">
        <div id="main-section">
          ...
          <div className="mainDivider">
            <img src="https://cdn.razorpay.com/static/assets/modal-asset/vertical-divider-diwali-bonanza.svg" />
          </div>
...
export default compose(connect(null, { closeModal: closeModalProp }))(NitroFestiveBonanzaModal);
