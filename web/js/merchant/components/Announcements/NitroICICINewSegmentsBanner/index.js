...
const bannerText =
  'Get an ICICI powered RazorpayX current account & an assured corporate card! All while accepting your payments at 1.65% fee 🎉';
const cardId = 'JAN-NITRO-ICICIPLUSCARD';
...
const NitroICICINewSegmentsBanner = React.memo(({ productName, openModal, closeModal }) => {
  const user = getUser();
  ...
  return (
    <AnnouncementBanner
      ...
      canBeClosed={true}
      theme="primary"
      bannerKey={`jan-nitro-icici-new-segment-${user.current}`}
      card_id={cardId}
    >
