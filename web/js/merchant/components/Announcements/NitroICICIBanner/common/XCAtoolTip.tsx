  ...
  return (
    <div className="xcaToolTip">
      ...
      <img
        ...
        src="https://cdn.razorpay.com/static/assets/modal-asset/icici-dashboard-logo.png"
      />
      <img
        className="xcaToolTip__image"
        src={XCAToolTipAlert?.image}
        alt={XCAToolTipAlert?.imageAlt}
