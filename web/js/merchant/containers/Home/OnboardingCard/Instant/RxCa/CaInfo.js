...
const CaInfo = (props) => {
    ...
    const GoToCaDocs = () => {
        ...
        props.tracking.trackEvent(window.rzpQ.merchantActions().clicked('dashboard.neopricing_tracker',{
            ...
            status: caAccount && caAccount.status ? analyticsStatusMap[caAccount.status] : analyticsStatusMap['created']
        }));
    }
    ...
    return (
        <>
            <Primary settings={props.user.user.settings} hasAppliedCa={hasAppliedCa} caAccount={caAccount} headState={headState}/>
            <hr className='separator' />
            <Secondary hasAppliedCa={hasAppliedCa} caAccount={caAccount} pillType={pillType} pillText={pillText} content={content}/>
        </>
    )
}
...
const getCaState = (caAccountStatus, GoToCaDocs) => {
    let pillType, pillText, content, headState = '';
    if (
        (!caAccountStatus) ||
        caAccountStatus === currentAccountStatuses.created
    ) {
        pillType = 'default';
        ...
        content = (
            <>
                <span>
                    Our executive will contact you soon. You can get the application
                    documents ready as per your business category.
          </span>{' '}
        ...
        content = (
            <>
                <span>
                    RazorpayX has started the application process. You can get the
                    application documents ready as per your business category.
          </span>{' '}
                <Button.Transparent className='view-doc' onClick={GoToCaDocs}>
                    View Documents
          </Button.Transparent>
        ...
        content = (
            <>RazorpayX is working with bank to get your Current Account activated.</>
        );
    } else if (
        ...
        content = (
            <>
                RBL bank has received your form & is working to complete your process.
            </>
        );
        ...
        content = (
            <>
                Your current account application has been cancelled.
            </>
        );
        ...
        content = (
            <>
         Unfortunately, our banking partner can't service at your location currently.   </>
        );
        ...
        content = (
            <>
                Your current account application has been rejected by our banking
                partner. We will not be able to provide a Current Account at the moment.
            </>
        );
        ...
        content = (
            <>
      Your current account is now active, and you’re ready to take off! You can start exploring your account or learn more by reading the guide.       </>
        )
    }
