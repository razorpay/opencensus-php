...
export const FEATURES_DATA = [
  ...
  {
    icon: '/dist/css/assets/product_onboarding/10.svg',
    title: 'Transfers',
    desc:
  ...
  },
  {
    ...
    title: 'Settlements',
    desc: 'Control the entire fund movements with flexible settlement plans.',
  },
];
...
export const FEATURES_LINKS = [
  ...
  {
    label: 'View API Docs',
    url: 'https://razorpay.com/docs/api/route/',
  },
];
