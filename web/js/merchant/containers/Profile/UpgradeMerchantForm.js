      ...
      .confirm({
        ...
        message: () => (
          <div class="text-semi-muted">
            <p>
              This will create a merchant account in your business name. Are you
              sure?
            </p>
          </div>
        ),
  ...
  render() {
    ...
    return (
      <div class="panel panel-default">
        <div class="panel-heading">Upgrade Merchant</div>
        <div class="panel-body text-center">
          <div>
            You can upgrade your account to a Merchant Account by giving us your
            business name
          </div>
