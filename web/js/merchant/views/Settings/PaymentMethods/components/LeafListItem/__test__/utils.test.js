...
describe('displayName', () => {
  ...
  test('should return html having data-testid equal to direct-ins-name when there is intermediate instrument and intermediate instrument slug is not equal to cards or netbanking', () => {
    const html = displayName({
      name: 'Bank of India',
      intermediateInstrument: { slug: 'retail' },
    });
