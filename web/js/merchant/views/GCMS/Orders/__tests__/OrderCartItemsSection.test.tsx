...
import OrderCartItemsSection from 'merchant/views/GCMS/Orders/OrderCartItemsSection';
...
describe('GCMS: Orders:Create:Cart:Items', () => {
  it('should render cart items section', async () => {
    rootRender(
