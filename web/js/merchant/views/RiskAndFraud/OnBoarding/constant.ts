export const getFeaturesData = (businessName: string) => [
  {
    icon: require('assets/risk-analytics/risk-guide-1.svg'),
  ...
  {
    icon: require('assets/risk-analytics/risk-guide-2.svg'),
  ...
  {
    icon: require('assets/risk-analytics/risk-guide-3.svg'),
