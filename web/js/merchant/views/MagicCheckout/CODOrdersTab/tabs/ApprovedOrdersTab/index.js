...
const ApprovedOrdersTab = (props) => {
  ...
  useEffect(() => {
    if (fetchCODOrders)
      fetchCODOrders({
        count: 25,
        skip: 0,
        review_status: REVIEWED_ORDERS_CATEGORY.approved,
      });
  }, [fetchCODOrders]);
  ...
  return (
    <div className="orders-container approved-orders-container">
      <OrderFilters
      ...
      <DataTable
        ...
        items={itemsArray}
        customClass="magic-cod-orders-table approved-orders-table"
        loading={loading}
        skip={skip}
        count={count}
        paginate={paginate}
...
export default connect(mapStateToProps, mapDispatchToProps)(ApprovedOrdersTab);
