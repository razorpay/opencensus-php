...
// API Imports
import { RESPONSE_WITH_PARTIALLY_ORDER } from 'merchant/views/MagicCheckout/ShopifyOrderEditing/__test__/mocks/fixtures';
...
fetchShopifyOrders.mockReturnValue(RESPONSE_WITH_PARTIALLY_ORDER);
...
describe('Magic - Shopify Order editing with a partially fullfilled order', () => {
  ...
  test('should render shopify order editing', async () => {
    ...
    const editCtaWrapper = await waitFor(() => screen.findByTestId(`edit-${platform_order_id}`));
