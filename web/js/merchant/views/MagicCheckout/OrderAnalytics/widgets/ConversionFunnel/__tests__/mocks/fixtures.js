export const LOADING_ORDER_ANALYTICS = {
  isFetching: true,
  analyticsData: null,
};

const CONVERSION_FUNNEL_OBJ = {
...
const CONVERSION_FUNNEL_LOGGED_IN_OBJ = {
  title: 'Conversion Funnel',
  checkout_initiated: {
    title: 'Checkout Initiated',
    value: 140,
...
const CONVERSION_FUNNEL_LOGGED_OUT_OBJ = {
  title: 'Conversion Funnel',
  checkout_initiated: {
    title: 'Checkout Initiated',
    value: 140,
...
const ORDER_ANALYTICS_METRICS_OBJ = {
  total_sales: {
    title: 'Total Sales',
    timestamps: [
    ...
    values: [
      955980, 323480, 41140, 0, 166500, 251345, 199490, 402700, 462330, 2234120, 1464850, 1124185,
      1161055, 1942335, 1161285, 1731365, 1711580, 1192800, 798480, 739230, 736130, 5626935,
      1888135, 1073585, 1242820, 1042405, 399540, 314235, 51570, 75420, 0, 1103310, 633375, 877930,
      2293150, 862775, 684060, 2020590, 1042990, 1445480, 734345, 741690, 1232120, 665780, 923730,
      1304995, 1549830, 1098400,
    ],
    unit: 'paise',
  ...
  total_orders_placed: {
    ...
    values: [
      8, 5, 1, 0, 2, 2, 3, 6, 7, 13, 15, 13, 12, 15, 12, 19, 20, 10, 12, 9, 9, 10, 16, 12, 14, 9, 3,
      3, 1, 1, 0, 7, 7, 8, 21, 12, 9, 16, 9, 8, 7, 7, 13, 9, 11, 14, 15, 13,
    ],
    unit: 'count',
    updated_at: 1709487000,
  },
  average_order_value: {
    ...
    values: [
      ...
      115822, 133180, 104745, 51570, 75420, 0, 157615, 90482, 109741, 109197, 71897, 76006, 126286,
      115887, 180685, 104906, 105955, 94778, 73975, 83975, 93213, 103322, 84492,
    ],
    unit: 'paise',
    updated_at: 1709487000,
  },
    ...
    total_sales: {
      values: [
        ...
        },
        {
          label: 'Prepaid',
          values: [
            138380, 51570, 0, 0, 0, 251345, 74880, 55710, 68040, 1561385, 712455, 446795, 780650,
            1381600, 403155, 654230, 647320, 387200, 253980, 387170, 177510, 84510, 562590, 280965,
            527810, 393140, 0, 162265, 0, 0, 0, 731860, 107270, 513060, 973245, 267840, 160710,
            1308340, 449400, 0, 324540, 299125, 203615, 46300, 242210, 379610, 423740, 341110,
          ],
        },
      ],
      unit: 'paise',
      ...
      values: [
        {
          label: 'COD',
          values: [
            7, 4, 1, 0, 2, 0, 2, 5, 6, 7, 9, 7, 5, 7, 9, 11, 13, 9, 8, 5, 6, 9, 13, 9, 9, 7, 3, 2,
            1, 1, 0, 5, 6, 4, 15, 8, 6, 10, 5, 8, 5, 5, 11, 8, 7, 11, 12, 9,
          ],
        },
        {
          label: 'Prepaid',
          values: [
            1, 1, 0, 0, 0, 2, 1, 1, 1, 6, 6, 6, 7, 8, 3, 8, 7, 1, 4, 4, 3, 1, 3, 3, 5, 2, 0, 1, 0,
            0, 0, 2, 1, 4, 6, 4, 3, 6, 4, 0, 2, 2, 2, 1, 4, 3, 3, 4,
          ],
        },
      ],
      unit: 'count',
        ...
        utm_medium: [
          {
            ...
            utm_campaign: [
              ...
              {
                label: 'Berr_13853_adyogi_catalogsales_prospect_selected_value-120201291182040707',
                sales: 1506300,
                order_count: 21,
              },
              {
              ...
              {
                label: 'Berr_13853_adyogi_catalogsales_dynamic_MagicMagic Curve-120204916513390707',
                sales: 1051880,
                order_count: 14,
              },
            ],
...
export const ORDER_ANALYTICS_WITH_ONLY_CONVERSION_FUNNEL = {
  isFetching: false,
  analyticsData: {
    metrics: {
      ...ORDER_ANALYTICS_METRICS_OBJ,
      conversion_funnel: CONVERSION_FUNNEL_OBJ,
    },
  },
};

export const ORDER_ANALYTICS_WITH_ALL_3_CONVERSION_FUNNELS = {
  isFetching: false,
  analyticsData: {
    metrics: {
      ...ORDER_ANALYTICS_METRICS_OBJ,
      conversion_funnel: CONVERSION_FUNNEL_OBJ,
      conversion_funnel_logged_in: CONVERSION_FUNNEL_LOGGED_IN_OBJ,
      conversion_funnel_logged_out: CONVERSION_FUNNEL_LOGGED_OUT_OBJ,
    },
  },
};
