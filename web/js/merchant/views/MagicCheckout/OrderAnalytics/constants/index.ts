...
export const LINE_CHARTS = [
  ...
  CHART_LABEL_MAPPING.LOGIN_TREND,
  CHART_LABEL_MAPPING.TOTAL_LOGIN,
  CHART_LABEL_MAPPING.NEW_LOGIN,
];
...
export const CHART_COLORS = {
  ...
  [CHART_LABEL_MAPPING.LOGIN_TREND]: COLORS.DARK_BLUE,
  [CHART_LABEL_MAPPING.TOTAL_LOGIN]: COLORS.BLUE,
  [CHART_LABEL_MAPPING.NEW_LOGIN]: COLORS.GREEN,
};
...
export const LINE_CHART_GRAPH_COLOR = {
  ...
  [CHART_LABEL_MAPPING.TOTAL_LOGIN]: GRADIENT_COLORS.BLUE,
  [CHART_LABEL_MAPPING.NEW_LOGIN]: GRADIENT_COLORS.GREEN,
};
