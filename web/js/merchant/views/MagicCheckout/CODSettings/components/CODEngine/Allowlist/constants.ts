...
export const SAMPLE_FILE_URL =
  'https://cdn.razorpay.com/static/assets/magic-checkout/sample_codengine_allowlist.csv';

export const FILE_UPDATE_NOTIFICATION_MSG =
  'Uploading a new file, will delete the older one and new records are being saved.';
