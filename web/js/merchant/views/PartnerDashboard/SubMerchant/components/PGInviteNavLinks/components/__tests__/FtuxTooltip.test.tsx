...
import FtuxTooltip from 'merchant/views/PartnerDashboard/SubMerchant/components/PGInviteNavLinks/components/FtuxTooltip';
import * as ftuxVisibilityAction from 'merchant/views/PartnerDashboard/SubMerchant/components/PGInviteNavLinks/components/FtuxTooltip/ftuxVisibility';
