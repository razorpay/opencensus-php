...
export const FEATURES_DATA = {
  noCodingRequired: {
    icon: require('assets/product_onboarding/without_coding.svg'),
    title: 'No Coding Required',
    desc: `Your business can go online with zero integration and tech efforts. We build and operate for you.`,
  },
  customBrandedBtn: {
    icon: require('assets/product_onboarding/custom_brand.svg'),
  ...
  paymentModesRzp: {
    icon: require('assets/product_onboarding/alter_native_payment_option.svg'),
