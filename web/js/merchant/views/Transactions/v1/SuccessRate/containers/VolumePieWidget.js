...
import StyledHeader from 'merchant/views/Transactions/v1/SuccessRate/components/StyledHeader';
import GenericPanel, { PanelBody } from 'merchant/components/Home/GenericPanel';
import {
  pieChartOptions as options,
  piePlugins as plugins,
} from 'merchant/views/Transactions/v1/SuccessRate/chartConfig';
import {
  getPieChartData,
  getTagLabel,
  getFormattedNumber,
...
import { TAG_OVERALL_MAP } from 'merchant/views/Transactions/v1/SuccessRate/constants';
