...
import GraphPanel from 'merchant/views/Transactions/v1/SuccessRate/components/GraphPanel';
import MethodFilter from 'merchant/views/Transactions/v1/SuccessRate/components/MethodFilter';
import MetricsCard from 'merchant/views/Transactions/v1/SuccessRate/components/MetricsCard';
...
import { StyledContainer } from 'merchant/views/Transactions/v1/SuccessRate/styles';
import {
  methodTabClick,
...
const GraphWidget = (props) => {
  ...
  const handleTabChange = (tabIndex) => {
    ...
    trackSuccessRateEvents(methodTabClick({ tabName: tab.name }), splitz);
  };
