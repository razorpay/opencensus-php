...
import MethodFilter from 'merchant/views/Transactions/v1/SuccessRate/components/MethodFilter';
import { DEFAULT_PROPS } from 'merchant/views/Transactions/v1/SuccessRate/__tests__/mocks/fixtures';
jest.mock('merchant/views/Transactions/v1/SuccessRate/components/MethodType', () => () => (
