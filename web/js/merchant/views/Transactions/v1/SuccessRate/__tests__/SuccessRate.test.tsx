...
import SuccessRate from 'merchant/views/Transactions/v1/SuccessRate/containers/SuccessRate';
...
jest.mock('merchant/views/Transactions/v1/SuccessRate/helper', () => ({
  ...(jest.requireActual('merchant/views/Transactions/v1/SuccessRate/helper') as typeof Object),
