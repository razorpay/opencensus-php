...
describe('Transactions component', () => {
  test('should render TransactionsV2 when isTransactionsV2Enabled is true', () => {
    renderApp();
    expect(screen.getByText('TransactionsV2')).toBeInTheDocument();
  });

  test('should render TransactionsV1 when isTransactionsV2Enabled is false', () => {
    isTransactionsV2Enabled.mockReturnValue(false);
    renderApp();
    expect(screen.getByText('TransactionsV1')).toBeInTheDocument();
  });
});
