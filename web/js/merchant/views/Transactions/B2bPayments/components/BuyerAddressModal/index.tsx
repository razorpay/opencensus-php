...
import BuyerAddressForm from 'merchant/views/Transactions/B2bPayments/components/BuyerAddressModal/BuyerAddressForm';
///- components
...
import {
  FormHeader,
  SupportWarning,
} from 'merchant/views/Transactions/B2bPayments/components/BuyerAddressModal/styled';
///- styled

// constants
import { BUYER_ADDRESS_VALIDATION_SCHEMA } from 'merchant/views/Transactions/B2bPayments/components/BuyerAddressModal/constants';
///- constants

// hooks
import { useBuyerAddressState } from 'merchant/views/Transactions/B2bPayments/components/BuyerAddressModal/hooks';
///- hooks

// types
import { BuyerAddressModalProps } from 'merchant/views/Transactions/B2bPayments/components/BuyerAddressModal/types';
///- types
