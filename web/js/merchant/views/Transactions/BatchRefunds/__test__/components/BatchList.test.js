import BatchList, {
  STATUS_VALUES,
} from 'merchant/views/Transactions/BatchRefunds/components/BatchList';
...
import {
  mock_refund_items,
  batchListInitProps,
} from 'merchant/views/Transactions/BatchRefunds/__test__/mock';
...
jest.mock('merchant/views/Transactions/BatchRefunds/components/BatchListFilter', () => () => (
