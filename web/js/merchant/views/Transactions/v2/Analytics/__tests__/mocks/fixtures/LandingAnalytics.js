...
import LandingAnalytics from 'merchant/views/Transactions/v2/Analytics/LandingAnalytics';

jest.mock('common/hooks/useMobile', () => ({
  useMobile: jest.fn(() => false),
}));

jest.mock('merchant/views/Transactions/v2/Analytics/LandingAnalytics/TopOverview/index.ts', () => ({
  __esModule: true,
  default: (props) => {
    ...
    return (
      <div>
        <h1>Top overview</h1>
        {isPaymentsDataLoading && <p data-testid="payments-data-failed">Payments Refresh</p>}
      </div>
    );
  },
}));
...
jest.mock(
  'merchant/views/Transactions/v2/Analytics/LandingAnalytics/BottomOverview/index.ts',
  () => ({
    __esModule: true,
    default: (props) => {
      const {
      ...
      return (
        <div>
          ...
          {isRefundsDataFailed && <p data-testid="refunds-data-failed">Refunds Refresh</p>}
          {isDisputesDataFailed && <p data-testid="disputes-data-failed">Disputes Refresh</p>}
