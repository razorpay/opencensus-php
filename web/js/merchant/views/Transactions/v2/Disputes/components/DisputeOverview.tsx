...
import { LandingAnalyticsProps } from 'merchant/views/Transactions/v2/Analytics/types';
import { getOptions } from 'merchant/views/Transactions/v2/Analytics/utils';
import DisputeDistributionGraph from 'merchant/views/Transactions/v2/Disputes/components/DisputeDistributionGraph';
import { DisputeIndicators } from 'merchant/views/Transactions/v2/Disputes/styled';
import { getDisputesOverviewValues } from 'merchant/views/Transactions/v2/Disputes/utils';
...
const DisputeOverview = ({ mode, user }: LandingAnalyticsProps): JSX.Element => {
...
export default compose(connect(mapStateToProps, null)(DisputeOverview));
