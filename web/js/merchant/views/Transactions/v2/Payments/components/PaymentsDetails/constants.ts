export const getTooltipContent = (organizationName = 'Razorpay') => ({
  ...
  authenticated: `This is amount that was deducted from the customer(s) account after successful authentication. It’ll be added to your ${organizationName} balance after being captured`,
  captured: `This is the amount collected in your ${organizationName} balance and will be deposited in your bank account after deductions and adjustments as per your settlement cycle`,
  refunded: 'This is the amount reversed to a customer(s) bank account',
  failed:
  ...
  paymentId: `A unique identifier generated by ${organizationName} when a payment enters the ‘Created’ state`,
  settlementId: `A unique identifier generated by ${organizationName} when a settlement enters the ‘Created’ state`,
  ...
  refundId: `A unique identifier generated by ${organizationName} when refund is issued for a payment`,
  rrnARN: 'A unique identifier (Reference Number) which serves as a proof of the refund',
  platformFees: `Platform fees charged by ${organizationName}`,
  gst: 'Goods and Services Tax (GST), as levied by the government',
  tax: 'A government-imposed charge on your product / service',
...
export const cardNetworkLogoMap = {
  Visa: { name: 'visa-logo.png' },
  MasterCard: { name: 'mastercard-logo.png' },
  RuPay: { name: 'rupay-logo.png' },
