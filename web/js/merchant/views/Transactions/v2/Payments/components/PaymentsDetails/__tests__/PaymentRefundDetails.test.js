...
import PaymentRefundDetails from 'merchant/views/Transactions/v2/Payments/components/PaymentsDetails/PaymentRefundDetails';
import {
  initialState,
  appProps,
} from 'merchant/views/Transactions/v2/Payments/components/PaymentsDetails/__tests__/mocks/fixtures/PaymentRefundDetails';
import {
...
jest.mock('merchant/views/Transactions/v2/Payments/components/PaymentsDetails/utils', () => ({
  ...jest.requireActual('merchant/views/Transactions/v2/Payments/components/PaymentsDetails/utils'),
  __esModule: true,
...
jest.mock('merchant/views/Transactions/v2/Refunds/components/RefundMiniTimeline', () => ({
  __esModule: true,
  default: () => {
