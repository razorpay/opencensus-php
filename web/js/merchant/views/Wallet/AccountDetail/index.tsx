        ...
        <div className="panel panel-default SliderPanel">
          ...
          <div className="AccountDetailSlider SliderPanel__Body">
            <div className="panel-body">
              <EntityDetailRow label="User ID">
                <Definition>{data?.user_id || '-'}</Definition>
              </EntityDetailRow>
              <EntityDetailRow label="Partner Customer ID">
                <Definition>{data?.partner_customer_id || '-'}</Definition>
              </EntityDetailRow>
