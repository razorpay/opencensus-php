...
export const APPLICATION_STATE_DESCRIPTIONS = {
  BUSINESS_INFO_PENDING: {
    ...
    description:
      'Complete your loan within a few minutes to check the loan' + ' offer',
  ...
  [APPLICATION_STATES.PREVERIFICATION_UPLOAD_PENDING]: {
    ...
    description:
      'Upload your documents for us to begin evaluation of your' +
      ' loan offer',
  ...
  [APPLICATION_STATES.PREVERIFICATION_IN_PROGRESS]: {
    ...
    description:
      'We are evaluating your loan eligibility to calculate the' +
      ' loan offer',
    ctaText: 'view application',
  ...
  [APPLICATION_STATES.CREDIT_OFFER_GENERATED]: {
    ...
    description:
      'We have the loan offer ready for you. Accept the terms to move ahead',
  ...
  [APPLICATION_STATES.DOCUMENT_COLLECTION_INITIATED]: {
    title: 'Document collection pending',
    description:
      'Our representative will reach out to you for the document' +
      ' collection',
    ctaText: 'view application',
  ...
  [APPLICATION_STATES.DOCUMENTS_UNDER_REVIEW]: {
    ...
    description:
      'Your documents will be shared with the lender for the' +
      ' final approval',
    ctaText: 'view',
    short_description: 'Documents Review',
  },
  [APPLICATION_STATES.RZP_APPROVED]: {
    ...
    description:
      'Your documents have been shared with the lender for the' +
      ' final approval',
    ctaText: 'View Loan offer',
...
export const STATE_GROUP_COMPLETION_DESCRIPTION = {
  [CONSOLIDATED_STATES.CHECK_LOAN_ELIGIBILITY]: {
    ...
    description:
      'Loan eligibility check is' +
      ' successful and loan offer has been calculated',
  },
  ...
  [CONSOLIDATED_STATES.DOCUMENT_COLLECTION]: {
    ...
    description:
      'Our executive has successfully picked up your Documents and proofs',
  },
  [CONSOLIDATED_STATES.FINAL_REVIEW]: {
    title: 'Loan offer is Approved!',
    description:
      'We’ve successfully reviewed documents and approved your loan offer',
  },
  [CONSOLIDATED_STATES.FUND_DISBURSED]: {
    title: 'Fund Disbursed!',
    description:
      'The loan amount has been successfully disbursed to your bank account.',
  },
};
...
export const TOOLTIP_DESCRIPTIONS = {
  ...
  edi:
    'Amount to be repaid on a daily basis. This will be deducted from your transaction volume.',
  tenure:
    'Time period within which you will repay the loan amount with the interest.',
  loan_agreement_faq:
  ...
  credit_score:
    "Indicative score representating an individual's ability to" +
