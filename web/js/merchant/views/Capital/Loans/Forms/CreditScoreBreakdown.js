    ...
    if(!!ntc_score && !score)
    {
      ...
      <div>
        <div className="credit-score-ntc">
          <span class="m-b">You either don't have a bureau presence or your bureau records are not recent enough to evaluate a score.</span>

          <span>The good news is that we will still process your application and evaluate you for loan.</span>
        </div>
