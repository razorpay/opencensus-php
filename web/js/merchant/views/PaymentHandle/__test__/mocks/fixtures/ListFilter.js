import ListFilter from 'merchant/views/PaymentHandle/views/List/components/ListFilter';
import { handleInfo } from 'merchant/views/PaymentHandle/__test__/mocks/fixtures/common';

jest.mock('merchant/views/PaymentHandle/views/List/PaymentsList', () => () => (
  <div>Payment List</div>
));

const paymentPageEntityData = {
...
export const App = (props = {}) => {
  return (
    <ListFilter
      ...
      paymentPageEntity={paymentPageEntityData}
    />
  );
};
