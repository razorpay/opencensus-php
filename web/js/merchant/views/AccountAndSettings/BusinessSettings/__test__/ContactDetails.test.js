import ContactDetails from 'merchant/views/AccountAndSettings/BusinessSettings/Tabs/ContactDetails/ContactDetails';
...
const renderApp = ({ user, isFlowRevamped } = {}) => {
  ...
  return render(<ContactDetails isFlowRevamped={isFlowRevamped} />, {
    reduxStore,
    showModal: true,
  });
};
