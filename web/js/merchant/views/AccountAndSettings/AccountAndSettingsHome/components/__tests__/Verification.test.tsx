...
import { getState, state } from './mocks/fixtures/verification';
...
describe('Verification', () => {
  ...
  test('should render 2fa tooltip with description', () => {
    ...
    const tooltipIcon = screen.getByText((_, element) => element?.tagName.toLowerCase() === 'i');
    expect(tooltipIcon).toBeInTheDocument();
    expect(tooltipIcon).toHaveAttribute('class', 'i i-info-tooltip');
  });
