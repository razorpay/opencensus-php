...
import MerchantAgreement from 'merchant/views/POS/MerchantAgreement/MerchantAgreement';
import { COMPLETED, IN_PROGRESS, POS_AGREEMENT_SIGN_FAILED } from 'merchant/views/POS/constants';
