...
import PosProductCard from 'merchant/views/POS/Catalog/ProductCards/PosProductCard';
import { getMockPropsForPosProductCardComponent } from 'merchant/views/POS/__tests__/mocks/fixtures';
