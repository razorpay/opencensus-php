...
import ProductFeatureRows from 'merchant/views/POS/Catalog/ProductFeatureTable/ProductFeatureRows';
import ProductFeatureTableItem from 'merchant/views/POS/Catalog/ProductFeatureTable/ProductFeatureTableItem';
import {
  MOCK_FEATURE_SCHEMA,
...
jest.mock('merchant/views/POS/constants', () => {
  ...
  const mocks = jest.requireActual('merchant/views/POS/__tests__/mocks/fixtures');
