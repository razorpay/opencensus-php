                        ...
                        <div class="row">
                          ...
                          <div className="col-xs-12">
                            <div className="row" style={{ marginTop: '10px' }}>
                              ...
                              <div className="col-xs-6">
                                {!this.state.steps[1].edit ? (
                                  <div class="stepper-readonly">{this.state.rule.description}</div>
                                ) : (
                                  <textarea
                                    id="description"
                                ...
                                onClick={() => {
                                  ...
                                  this.context
                                    ...
                                    .then((rule) => {
                                      ...
                                      // this.setState({ redirect: '/navigator/rules/' + rule.id });
                                      // });
                                      // setTimeout(() => this.setState({ redirect: '/navigator/rules/' + rule.id }), 400)
                                    })
                                    .catch((e) => {
                                      this.props.showNotification({
                                        type: 'error',
