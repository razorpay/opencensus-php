...
class ImageCropperModalComponent extends React.Component {
  componentDidMount() {
  ...
  render() {
    return (
      <ModalMask maskClosable={false} className="merchant-80g-details">
        <Modal onClose={this.props.closeModal} className="animate-appear ImageCropper" showCloseBtn>
          ...
          <div className="Input-ImageCropper">
            <div className="Cropper-area Cropper-area--enabled" ref={this.setRef} />
...
const ImageCropperModal = compose(connect(null, { showNotification }))(ImageCropperModalComponent);

class Merchant80gDetails extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
        ...
        <div className="modal-body">
          <Form onSubmit={this.onSubmit} onChange={this.onChange}>
            <Input.Textarea
              ...
              className="Input-description Input--vTop"
            ...
            <div className="Input--FileUpload">
              <Label
                text={() => (
                  <div>
                    <b className="m-r">Signature of Authorised Person</b>(Optional)
                  </div>
                )}
              />
              <FileUpload
