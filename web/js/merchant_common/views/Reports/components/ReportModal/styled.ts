...
export const ReportModalWrapper = styled.div<{ scrollable?: boolean; initialWidth?: number }>`
  max-width: ${({ initialWidth = 750 }) => initialWidth}px;
  background: white;
  padding: ${({ initialWidth = 750 }) => (initialWidth > 750 ? 30 : 60)}px;
