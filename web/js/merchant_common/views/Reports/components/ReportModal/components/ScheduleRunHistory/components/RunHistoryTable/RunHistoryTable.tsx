...
import { useRunHistoryReducer } from 'merchant_common/views/Reports/components/ReportModal/components/ScheduleRunHistory/hooks/useRunHistoryReducer';
...
const RunHistoryTableComponent = connect(
  null,
  mapDispatchToProps,
)(({ dashboardType, showNotification, scheduleId }: RunHistoryTablePropsType): JSX.Element => {
  ...
  const {
    ...
    setIsPollActive,
  } = useRunHistoryReducer(dashboardType);
