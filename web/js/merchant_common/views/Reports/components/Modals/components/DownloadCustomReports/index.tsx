...
import { DownloadReportModalPropsType } from 'merchant_common/views/Reports/components/Modals/components/DownloadReport/types';
        ...
        <MarginDivider theme={theme}>
          <FieldWrapper>
            <Dropdown
              ...
              validate={() => (shouldShowError ? Boolean(selectedConfig) : true)}
            />
            {selectedConfig?.helpInfo && (
              <Text variant="caption" type="subdued" weight="regular">
