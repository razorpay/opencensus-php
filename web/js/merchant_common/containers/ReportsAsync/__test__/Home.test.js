...
describe('Reports Home Container', () => {
  ...
  test('should render dashboard banner, test mode banner and loader', async () => {
    renderApp();
  ...
  test('should call generateReport function and analyticsTrack with Success on clicking generate report button', async () => {
  ...
  test('should show same report type notification and call analyticsTrack with same report type on clicking generate report button with already shown log', async () => {
    await clickGenerateReportButton({
      success: true,
  ...
  test('should show call pollLog using accountId when report generated by and consumer are different on clicking generate report button', async () => {
