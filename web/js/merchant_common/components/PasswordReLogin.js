          ...
          window.rzpQ &&
            window.rzpQ.push(
              window.rzpQ
                .now()
                .onbr()
                .failed('dash.unlock', {...this.eventObj, method: 'email', service: this.service})
            );
        ...
        window.rzpQ &&
          window.rzpQ.push(
            window.rzpQ
              .now()
              .onbr()
              .failed('dash.unlock', {...this.eventObj, method: 'email', service: this.service, error: errors[0]})
          );

        this.props.showNotification({
          type: 'error',
          message: [
            'Some network issue. Please reload the page.',
          ],
        });
          ...
          (errors) => {
            ...
            window.rzpQ.push(
              window.rzpQ
                ...
                .onbr()
                .failed('dash.unlock',
                  {...this.eventObj, method: 'google_oauth', error: errors.error})
            );
          }
        );
      });
          ...
          window.rzpQ &&
            window.rzpQ.push(
              window.rzpQ
                .now()
                .onbr()
                .success('dash.unlock', {...this.eventObj, method: 'google_oauth', service: this.service, email: email})
            );
        } else {
          window.rzpQ &&
            window.rzpQ.push(
              window.rzpQ
                .now()
                .onbr()
                .failed('dash.unlock', {...this.eventObj, method: 'google_oauth', service: this.service})
            );
          this.props.showNotification({
            type: 'error',
    ...
    window.rzpQ &&
      window.rzpQ.push(
        window.rzpQ
          .now()
          .onbr()
          .initiated('dash.unlock', {...this.eventObj, method: 'google_oauth', service: this.service})
      );
