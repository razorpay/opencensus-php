...
const options = {
  ...
  putRequests: ['assign_methods'],

  postRequests: ['assign_schedule', 'assign_pricing', 'assign_tag'],
      ...
      case 'assign_tag': {
        ...
        formBody = (
          <div>
            ...
            <SelectField name="action" label="Action" defaultValue="insert">
        ...
        <Form class="full-span full-elements" id="full-form">
          ...
          <AsyncButton
            ...
            onSubmit={body => {
              ...
              if (
                options.putRequests.indexOf(this.state.selectedRequest) >= 0
              ) {
