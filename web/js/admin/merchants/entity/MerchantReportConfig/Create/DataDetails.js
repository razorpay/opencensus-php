...
export default function DataDetails(props) {
  const { isPartner, isMarketplaceMerchant, configOptions, values } = props;
  ...
  return (
    <div class="row-item">
      ...
      <Field
        ...
        defaultValue={(template.file_meta || {}).filename}
      />
      ...
      {!configOptions.loading ? (
        <>
          <SelectField
            ...
            label="File Format"
            defaultValue={(template.file_meta || {}).extension || 'csv'}
          >
            ...
            (function() {
              ...
              return (
                <SelectField
                  ...
                  defaultValue={(template.file_meta || {}).delimiter}
                >
      ...
      <SwitchField
        ...
        disabledLabel="No"
        defaultValue={
          isNone((template.file_meta || {}).header)
            ? true
            : template.file_meta.header
        }
      ...
      {(isPartner || isMarketplaceMerchant) && (
        <SwitchField
          ...
          disabledLabel="No"
          enabledValue="all"
          defaultValue={template.referred_accounts}
          disabledValue={0}
          onChange={props.onChange}
        />
      )}
      ...
      <SelectField
        ...
        defaultValue={(template.formats || {}).date || 'd-m-Y'}
      >
