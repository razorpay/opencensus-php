  ...
  return (
    <div className="opfin-announcement-wrapper">
      ...
      <div className="opfin-announcement-offer">
        ...
        <div>
          <h4 className="opfin-announcement-offer-title">Get 5,00,000 rupees of free credits </h4>
          <p className="opfin-announcement-offer-description">
            Once the offer is applied Razorpay will not charge any fees for upto 5L rupees on your
            account.
          </p>
        </div>
      </div>
