...
const styles = {
  ...
  padding({ size, theme, children, variant }) {
    switch (size) {
      case 'xsmall':
        if (children) {
          return [0, relativePadding(variant, theme.bladeOld.spacings.small)];
        }
        return [0, relativePadding(variant, theme.bladeOld.spacings.xxsmall)];
      case 'small':
        if (children) {
          return [0, relativePadding(variant, theme.bladeOld.spacings.large)];
        }
        return [0, relativePadding(variant, theme.bladeOld.spacings.xsmall)];
      case 'medium':
        if (children) {
          return [0, relativePadding(variant, theme.bladeOld.spacings.xxlarge)];
        }
