...
class RblBankingAccountStatement extends Job
{
     ...
     * @var string
     */
    protected $queueConfigKey = 'rbl_banking_account_statement_fetch';
    ...
    public function checkRateLimit(string $channel)
    {
        ...
        $rateLimit = (int) (new AdminService)->getConfigKey(['key' => ConfigKey::RBL_STATEMENT_FETCH_RATE_LIMIT]);

        $windowLength = (int) (new AdminService)->getConfigKey(['key' => ConfigKey::RBL_STATEMENT_FETCH_WINDOW_LENGTH]);
