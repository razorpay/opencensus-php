...
class RouteTeamMap
{
    ...
    protected static $routeTeamMap = [
        ...
        'update_brand_dealer_details'              => [self::TEAM_OMNI_ACQUISITION],
        ...
        'user_change_password_with_otp_verification'  => [self::TEAM_PAYMENTS_DASHBOARD],
        ...
        'user_merchant_mapping_action_with_otp_verification' => [self::TEAM_PAYMENTS_DASHBOARD],
