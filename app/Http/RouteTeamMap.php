...
class RouteTeamMap
{
    ...
    protected static $routeTeamMap = [
        ...
        'oauth_user_pre_signup'     => [self::TEAM_PAYMENTS_GROWTH],
        ...
        'oauth_merchant_details'    => [self::TEAM_PAYMENTS_GROWTH],
