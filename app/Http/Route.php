...
final class Route
{
    ...
    protected static $apiRoutes = array(
        ...
        'gateway_add_priority'                    => ['post',     'gateway/priority/{method}',                      'GatewayController@addGatewayPriority'                            ],
        'gateway_fetch_priority'                  => ['get',      'gateway/priority',                               'GatewayController@getGatewayPriority'                            ],
        'gateway_delete_priority'                 => ['delete',   'gateway/priority/{method}',                      'GatewayController@deleteGatewayPriority'                         ],
    ...
    public static $internal = array(
        ...
        'invoice_expire',
        'batch_process_file',
        'gateway_add_priority',
        'gateway_fetch_priority',
        'gateway_delete_priority',
