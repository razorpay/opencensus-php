...
final class Route
{
    ...
    protected static $apiRoutes = [
        ...
        'merchant_create_key'                     => ['post',     'merchant/keys',                                  'MerchantController@postCreateKeys'                                 ],
        'merchant_fetch_keys'                     => ['get',      'merchant/keys',                                  'MerchantController@getKeys'                                        ],
        'merchant_replace_key'                    => ['put',      'merchant/keys/{keyId}',                          'MerchantController@putKeys'                                        ],
