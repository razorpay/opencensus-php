...
// Routes for the admin roles project
        ...
        'admin_get_multiple'                    => ['get',      'orgs/{id}/admins',                               'AdminController@getMultipleAdmins'                                 ],
        'admin_get'                             => ['get',      'orgs/{id}/admins/{admin_id}',                    'AdminController@getAdmin'                                          ],
        'admin_edit'                            => ['put',      'orgs/{id}/admins/{admin_id}',                    'AdminController@editAdmin'                                         ],
        'admin_delete'                          => ['delete',   'orgs/{id}/admins/{admin_id}',                    'AdminController@deleteAdmin'                                       ],
        'admin_roles_create'                    => ['post',     'orgs/{id}/admins/{admin_id}/roles/{role_id}',    'AdminController@addRoleToAdmin'                                    ],
        'admin_roles_revoke'                    => ['delete',   'orgs/{id}/admins/{admin_id}/roles/{role_id}',    'AdminController@revokeRoleFromAdmin'                                    ],
        'admin_merchants_create'                => ['post',     'orgs/{id}/admins/{admin_id}/merchants/{mid}',    'AdminController@addMerchantToAdmin'                                ],
        'admin_merchants_delete'                => ['delete',   'orgs/{id}/admins/{admin_id}/merchants/{mid}',    'AdminController@deleteMerchantFromAdmin'                           ],
