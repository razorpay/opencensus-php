...
final class Route
{
    ...
    protected static $apiRoutes = array(
        ...
        'invoice_update'                          => ['put',      'invoices/{id}',                                  'InvoiceController@updateInvoice'                                   ],
        ...
        'invoice_add_line_item'                   => ['post',     'invoices/{id}/line_items',                       'InvoiceController@addLineItem'                                     ],
        'invoice_add_many_line_items'             => ['post',     'invoices/{id}/line_items/many',                  'InvoiceController@addManyLineItems'                                ],
        'invoice_update_line_item'                => ['put',      'invoices/{id}/line_items/{lineItemId}',          'InvoiceController@updateLineItem'                                  ],
        'invoice_remove_many_line_items'          => ['delete',   'invoices/{id}/line_items/many',                  'InvoiceController@removeManyLineItems'                             ],
        ...
        'item_update_active'                      => ['put',      'items/{id}/active/{active}',                     'ItemController@updateItemActive'                                   ],
        ...
        'role_edit'                               => ['put',      'orgs/{id}/roles/{roleId}',                       'AdminController@putRole'                                           ],
        ...
        'admin_authentication'                    => ['post',     'orgs/{id}/admin/authenticate',                   'AdminController@postAuthenticate'                                  ],
        ...
        'admin_oauth_authenticate'                => ['post',     'orgs/{id}/admin/oauth_login',                    'AdminController@oAuthLogin'                                        ],
        'admin_password_reset'                    => ['post',     'orgs/{id}/admin/password/reset',                 'AdminController@postPasswordReset'                                 ],
        'admin_logout'                            => ['post',     'orgs/{id}/admin/logout',                         'AdminController@logoutAdmin'                                       ],
    ...
    public static $proxy = array(
        ...
        'invoice_add_many_line_items',
        'invoice_update_line_item',
        'invoice_remove_many_line_items',
