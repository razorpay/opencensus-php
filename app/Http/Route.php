...
final class Route
{
    ...
    protected static $apiRoutes = array(
        ...
        'terminal_add_merchant'                   => ['put',      'terminals/{id}/merchant/{mid}',                  'TerminalController@addMerchant'                                    ],
        'terminal_remove_merchant'                => ['put',      'terminals/{id}/merchant/{mid}',                  'TerminalController@removeMerchant'                                 ],
