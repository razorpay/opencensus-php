...
class Route
{
    ...
    public static $routePermission = [
        ...
        'fts_dashboard_channel_health_create'       => Permission::FTS_TRANSFER_ATTEMPT_BULK_UPDATE,
        'fts_dashboard_channel_health_delete'       => Permission::FTS_TRANSFER_ATTEMPT_BULK_UPDATE,
