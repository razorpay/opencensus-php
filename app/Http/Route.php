...
//        'nodal_get_account_balance'                => ['get',      'nodal/balance/{channel}',                        'SettlementController@getAccountBalance'                            ],
        ...
        'capital_marketplace_oauth'                => ['any',      'marketplace/oauth/{path?}',                      'MarketplaceController@handleDirectRequests'                        ],
        'capital_marketplace_service'              => ['any',      'marketplace/service/{path?}',                    'MarketplaceController@handleProxyRequests'                         ],
        'capital_marketplace_admin'                => ['any',      'marketplace/admin/{path?}',                      'MarketplaceController@handleAdminRequests'                         ],
