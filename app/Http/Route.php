...
final class Route
{
    protected static $apiRoutes = [
        ...
        'subscription_fetch_changes'               => ['get',      'subscriptions/{subscriptionId}/retrieve_scheduled_changes', 'SubscriptionController@getFetchScheduledChanges'        ],
        'subscription_cancel_changes'              => ['post',      'subscriptions/{subscriptionId}/cancel_scheduled_changes',   'SubscriptionController@getCancelScheduledChanges'       ],
