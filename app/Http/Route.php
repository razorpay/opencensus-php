...
// Routes for the admin roles project
        ...
        'admin_get_multiple'                      => ['get',      'orgs/{id}/admins',                               'AdminController@fetchMultiple'                                     ],
        ...
        'group_get_multiple'                      => ['get',      'orgs/{id}/groups',                               'AdminController@fetchMultiple'                                     ],
        ...
        'group_admins_create'                     => ['post',     'orgs/{id}/groups/{groupId}/admins',              'AdminController@addAdminToGroup'                                   ],
