...
final class Route
{
    protected static $apiRoutes = [
        ...
        // @todo Remove the next 2 routes once the dashboard switches to the new routes
        ...
        'payment_link_create'                      => ['post',     'payment_links',                                  'PaymentLinkController@createPaymentLink'                           ],
        'payment_link_fetch_multiple'              => ['get',      'payment_links',                                  'PaymentLinkController@fetchPaymentLinks'                           ],
        'payment_link_update'                      => ['patch',    'payment_links/{id}',                             'PaymentLinkController@updatePaymentLink'                           ],
        'payment_link_payments_fetch'              => ['get',      'payment_links/{id}/payments',                    'PaymentLinkController@fetchPaymentLinkPayments'                    ],
    ...
    public static $proxy = [
        ...
        'payment_link_create',
        'payment_link_fetch_multiple',
        'payment_link_update',
        'payment_link_payments_fetch',
        'offer_create',
        'offer_update',
