...
final class Route
{
    ...
    protected static $apiRoutes = array(
        ...
        'invoice_refund_late_auth_pay_of_expired' => ['post',     'invoices/payments/refund_late_auth',             'PaymentController@refundLateAuthPaymentsOfExpiredInvoice'          ],
    ...
    public static $internal = array(
        ...
        'invoice_expire_bulk',
        'invoice_refund_late_auth_pay_of_expired',
        'batch_process_file',
