...
final class Route
{
    ...
    protected static $apiRoutes = [
        ...
        'invoice_issue_by_batch'                  => ['post',     'invoices/batches/{batchId}/issue',               'InvoiceController@issueInvoicesOfBatch'                            ],
        'invoice_get_stats_by_batch_ids'          => ['get',      'invoices/batches/stats',                         'InvoiceController@getNonDraftInvoiceCountByBatchIds'               ],
