...
final class Route
{
    ...
    protected static $apiRoutes = array(
        ...
        'subscriptions_invoices'                  => ['post',     'subscriptions/invoices',                         'PlanController@postCreateSubscriptionInvoices'                     ],
        'subscriptions_charge'                    => ['post',     'subscriptions/invoices/charge',                  'PlanController@postChargeSubscriptions'                            ],
