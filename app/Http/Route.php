...
final class Route
{
    ...
    protected static $apiRoutes = array(
        ...
        'invoice_add_lineitem'                    => ['post',     'invoices/{id}/lineitem',                         'InvoiceController@addLineItem'                                     ],
        'invoice_update_lineitem'                 => ['put',      'invoices/{id}/lineitem/{lineItemId}',            'InvoiceController@updateLineItem'                                  ],
        'invoice_remove_lineitem'                 => ['delete',   'invoices/{id}/lineitem/{lineItemId}',            'InvoiceController@removeLineItem'                                  ],
    ...
    public static $private = array(
        ...
        'invoice_issue',
        'invoice_delete',
        'invoice_add_lineitem',
        'invoice_update_lineitem',
        'invoice_remove_lineitem',
        'item_create',
        'item_fetch',
        'item_fetch_multiple',
        'item_update',
    ...
    public static $routeNameToFeatureMap = array(
        ...
        'invoice_add_lineitem'          => 'invoice',
        'invoice_update_lineitem'       => 'invoice',
        'invoice_remove_lineitem'       => 'invoice',
