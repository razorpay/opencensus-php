...
final class Route
{
    ...
    protected static $apiRoutes = [
        ...
        // TODO: What should the new route be? Plan is dashboard will use this and will remove old one.
        'admin_fetch_merchant_ids_v2'             => ['get',      'orgs/{orgId}/admins/{id}/merchant_ids/v2',       'OrganizationController@getMerchantIdsFromEs'                       ],
        'admin_fetch_merchants_v2'                => ['get',      'orgs/{orgId}/admins/{id}/merchants/v2',          'OrganizationController@getMerchantsFromEs'                         ],
    ...
    public static $admin = [
        ...
        'admin_fetch_merchant_ids_v2',
        'admin_fetch_merchants_v2',
        'admin_create',
        'group_get',
        'group_get_multiple',
    ...
    public static $routePermission = [
        ...
        'admin_fetch_merchant_ids_v2'      => Permission::VIEW_ALL_MERCHANTS,
        'admin_fetch_merchants_v2'         => Permission::VIEW_ALL_MERCHANTS,
