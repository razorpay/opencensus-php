...
final class Route
{
    ...
    protected static $apiRoutes = [
        ...
        'role_get_multiple'                       => ['get',      'orgs/roles',                                     'OrganizationController@getMultipleRoles'                           ],
        'role_get'                                => ['get',      'orgs/roles/{id}',                                'OrganizationController@getRole'                                    ],
        'role_edit'                               => ['put',      'orgs/roles/{id}',                                'OrganizationController@putRole'                                    ],
        'role_delete'                             => ['delete',   'orgs/roles/{id}',                                'OrganizationController@deleteRole'                                 ],
