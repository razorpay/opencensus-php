...
final class Route
{
    ...
    protected static $apiRoutes = array(
        ...
        'gateway_fetch_rules'                     => ['get',      'gateway/rules',                                  'GatewayController@fetchGatewayRules'                               ],
        'gateway_find_rule_by_id'                 => ['get',      'gateway/rules/{id}',                             'GatewayController@findGatewayRule'                                 ],
