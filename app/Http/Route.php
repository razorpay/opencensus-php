...
final class Route
{
    ...
    protected static $apiRoutes = array(
        ...
        'terminal_reassign_merchant'              => ['put',      'terminals/{id}/merchants/{mid}/reassign',        'TerminalController@reassignMerchant'                               ],
        ...
        'merchant_activation_update'              => ['post',     'merchant/activation/{id}/update',                'MerchantController@postEditMerchantDetailsAfterLock'               ],
        ...
        'org_get'                                 => ['get',      'orgs/{orgId}',                                   'OrganisationController@getOrganisation'                            ],
        ...
        'org_edit'                                => ['put',      'orgs/{orgId}',                                   'OrganisationController@putOrganisation'                            ],
        'org_delete'                              => ['delete',   'orgs/{orgId}',                                   'OrganisationController@deleteOrganisation'                         ],
        'role_create'                             => ['post',     'orgs/{orgId}/roles',                             'AdminController@createRole'                                        ],
        'role_get_multiple'                       => ['get',      'orgs/{orgId}/roles',                             'AdminController@getMultipleRoles'                                  ],
        'role_get'                                => ['get',      'orgs/{orgId}/roles/{id}',                        'AdminController@getRole'                                           ],
        'role_edit'                               => ['put',      'orgs/{orgId}/roles/{id}',                        'AdminController@putRole'                                           ],
        'role_delete'                             => ['delete',   'orgs/{orgId}/roles/{id}',                        'AdminController@deleteRole'                                        ],
        'admin_create'                            => ['post',     'orgs/{orgId}/admins',                            'AdminController@createAdmin'                                       ],
        'admin_get_multiple'                      => ['get',      'orgs/{orgId}/admins',                            'AdminController@fetchAdminMultiple'                                ],
        'admin_get_app_auth'                      => ['post',     'orgs/{orgId}/current_admin',                     'AdminController@getAdminByAppAuth'                                 ],
        'admin_get'                               => ['get',      'orgs/{orgId}/admins/{id}',                       'AdminController@getAdmin'                                          ],
        'admin_edit'                              => ['put',      'orgs/{orgId}/admins/{id}',                       'AdminController@editAdmin'                                         ],
        'admin_fetch_merchant_ids'                => ['get',      'orgs/{orgId}/admins/{id}/merchant_ids',          'AdminController@getMerchantIds'                                    ],
        'admin_delete'                            => ['delete',   'orgs/{orgId}/admins/{id}',                       'AdminController@deleteAdmin'                                       ],
        'group_create'                            => ['post',     'orgs/{orgId}/groups',                            'AdminController@createGroup'                                       ],
        'group_get_multiple'                      => ['get',      'orgs/{orgId}/groups',                            'AdminController@getGroupsMultiple'                                 ],
        'group_get_allowed_groups'                => ['get',      'orgs/{orgId}/groups/{id}/allowed_groups',        'AdminController@getAllowedGroups'                                  ],
        'group_get'                               => ['get',      'orgs/{orgId}/groups/{id}',                       'AdminController@getGroup'                                          ],
        'group_edit'                              => ['put',      'orgs/{orgId}/groups/{id}',                       'AdminController@putGroup'                                          ],
        'group_delete'                            => ['delete',   'orgs/{orgId}/groups/{id}',                       'AdminController@deleteGroup'                                       ],
        ...
        'permission_get'                          => ['get',      'permissions/{id}',                               'AdminController@getPermission'                                     ],
        'permission_get_multiple'                 => ['get',      'permissions',                                    'AdminController@getMultiplePermissions'                            ],
        'permission_delete'                       => ['delete',   'permissions/{id}',                               'AdminController@deletePermission'                                  ],
        'permission_edit'                         => ['put',      'permissions/{id}',                               'AdminController@putPermission',                                    ],
        ...
        'auditlog_search'                         => ['get',      'orgs/{orgId}/auditlog/search',                   'AdminController@auditLogSearch'                                    ],
