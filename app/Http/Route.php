...
class Route
{
    protected static $apiRoutes = [
        ...
        'qr_code_payment_fetch_by_id'              => ['get',      'checkout/qr_code/{id}/payment',                  'QrPaymentController@fetchCapturedPaymentByQrCodeId'                ],
...
//        'nodal_get_account_balance'                => ['get',      'nodal/balance/{channel}',                        'SettlementController@getAccountBalance'                            ],
        ...
        'commissions_invoice_fix_status'           => ['post',     'commissions/invoice/fix_status',                 'CommissionInvoiceController@postFixInvoicesStatus'                 ],
...
//        'governor_delete_namespace_v1'            => ['delete',   'namespaces/{namespace_id}',                                                                                'GovernorController@proxy'              ],
    ...
    public static $private = [
        ...
        'payment_refund',
        'payment_capture',
        'commissions_invoice_fix_status',
...
//        'governor_delete_namespace_v1'             => Permission::DELETE_GATEWAY_RULE,
        ...
        'fetch_journal_by_transactor'                     => Permission::LEDGER_SERVICE_ACTIONS,
