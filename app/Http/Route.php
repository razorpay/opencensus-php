...
final class Route
{
    ...
    protected static $apiRoutes = array(
        ...
        'ecollect_create_customer_bank_account'   => ['post',     'ecollect/customers/{id}/bank_account',           'BankTransferController@createCustomerBankAccount'                  ],
        'ecollect_create_standing_bank_account'   => ['post',     'ecollect/bank_account',                          'BankTransferController@createStandingBankAccount'                  ],
