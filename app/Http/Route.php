...
final class Route
{
    protected static $apiRoutes = [
        ...
        'payments_downtime_trigger_cron'           => ['post',     'payments/downtimes/trigger',                     'DowntimeController@triggerDowntimes'                               ],
        ...
        'virtual_account_close_cron'               => ['post',     'virtual_accounts/close',                         'VirtualAccountController@closeAccountsByCloseBy'                   ],
