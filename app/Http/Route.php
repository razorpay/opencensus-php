...
final class Route
{
    ...
    protected static $apiRoutes = [
        ...
        'batch_upload_form_get'                    => ['get',      'batches/direct_debit/upload',                    'BatchController@renderBatchUploadForm'                       ],
        'batch_upload_form_validate_file'          => ['post',     'batches/direct_debit/validate',                  'BatchController@validateBatchFile'                           ],
        'batch_upload_form_submit'                 => ['post',     'batches/direct_debit/upload',                    'BatchController@submitBatchUploadForm'                       ],
