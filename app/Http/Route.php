...
final class Route
{
    ...
    protected static $apiRoutes = array(
        ...
        'vpa_register'                            => ['post',     'customers/{customerId}/bank_accounts/{baId}/mpin', 'CustomerController@setMpin'                                        ],
        'reset_mpin'                              => ['put',      'customers/{customerId}/bank_accounts/{id}/mpin',   'CustomerController@resetMpin'                                      ],
