...
final class Route
{
    protected static $apiRoutes = [
        ...
        'merchant_activation_category_details'     => ['get',      'merchant/activation/business_category_details',  'MerchantController@getBusinessCategoriesDetails'                   ],
    ...
    public static $proxy = [
        ...
        'merchant_activation_category_details',
        'offer_create',
        'offer_update',
