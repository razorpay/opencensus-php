...
final class Route
{
    protected static $apiRoutes = [
        ...
        'merchant_activation_categories_details'   => ['get',      'merchant/activation/business_categories_details','MerchantController@getBusinessCategoriesDetails'                   ],
    ...
    public static $proxy = [
        ...
        'merchant_activation_categories_details',
        'offer_create',
        'offer_update',
