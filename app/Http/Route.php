...
final class Route
{
    ...
    protected static $apiRoutes = [
        ...
        'reports_transaction_rpp'                 => ['get',      'reports/transaction/rpp',                        'MerchantController@getRPPTransactionReport'                        ],
    ...
    public static $routeNameToFeaturesMap = [
        ...
        'reports_transaction_rpp'           => [Feature::RPP_REPORT],
