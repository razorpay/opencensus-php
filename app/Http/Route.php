...
final class Route
{
    ...
    protected static $apiRoutes = [
        ...
        'role_create'                             => ['post',     'org/roles',                                     'OrganizationController@createRole'                                 ],
        'role_get_multiple'                       => ['get',      'org/roles',                                      'OrganizationController@getMultipleRoles'                           ],
        'role_get'                                => ['get',      'org/roles/{id}',                                'OrganizationController@getRole'                                    ],
        'role_edit'                               => ['put',      'org/roles/{id}',                                'OrganizationController@putRole'                                    ],
        'role_delete'                             => ['delete',   'org/roles/{id}',                                'OrganizationController@deleteRole'                                 ],
