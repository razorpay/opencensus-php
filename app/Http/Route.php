...
final class Route
{
    protected static $apiRoutes = [
        ...
        'payout_approve_with_otp'                  => ['post',     'payouts/approve/{id}',                           'PayoutController@postApproveFundAccountPayout'                     ],
        'payout_approve_bulk_with_otp'             => ['post',     'payouts/approve',                                'PayoutController@bulkApproveFundAccountPayouts'                    ],
        'payout_reject_with_otp'                   => ['post',     'payouts/reject/{id}',                            'PayoutController@postRejectFundAccountPayout'                      ],
        'payout_reject_bulk_with_otp'              => ['post',     'payouts/reject',                                 'PayoutController@bulkRejectFundAccountPayouts'                     ],
    ...
    public static $userWhitelist = [
        ...
        'payout_approve_with_otp',
        'payout_approve_bulk_with_otp',
        'payout_reject_with_otp',
        'payout_reject_bulk_with_otp',
        'invoice_create',
        'invoice_fetch',
        'invoice_fetch_multiple',
        'invoice_update',
    ...
    public static $routeNameToFeaturesMap = [
        ...
        'payout_approve_with_otp'              => [Feature::PAYOUT],
        'payout_approve_bulk_with_otp'         => [Feature::PAYOUT],
        'payout_reject_with_otp'               => [Feature::PAYOUT],
        'payout_reject_bulk_with_otp'          => [Feature::PAYOUT],
