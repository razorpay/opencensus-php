...
final class Route
{
    ...
    protected static $apiRoutes = array(
        ...
        'merchant_archive'                        => ['post',     'merchants/{id}/archive',                         'MerchantController@postArchive'                                    ],
        'merchant_unarchive'                      => ['post',     'merchants/{id}/unarchive',                       'MerchantController@postUnarchive'                                  ],
        'merchant_suspend'                        => ['post',     'merchants/{id}/suspend',                         'MerchantController@postSuspend'                                    ],
        'merchant_unsuspend'                      => ['post',     'merchants/{id}/unsuspend',                       'MerchantController@postUnsuspend'                                  ],
