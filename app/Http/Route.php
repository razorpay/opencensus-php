...
final class Route
{
    ...
    protected static $apiRoutes = [
        ...
        'subscription_create_addon'               => ['post',     'subscriptions/{subscription_id}/addon',          'SubscriptionController@postAddon'                                  ],
        'addon_fetch'                             => ['get',      'addons/{addon_id}',                              'SubscriptionController@getAddon'                                   ],
        'addon_fetch_multiple'                    => ['get',      'addons',                                         'SubscriptionController@getAddons'                                  ],
        'addons_fetch_due'                        => ['get',      'subscriptions/{subscription_id}/addons/due',     'SubscriptionController@fetchDueAddons'                             ],
        'addon_delete'                            => ['delete',   'addons/{addon_id}',                              'SubscriptionController@deleteAddon'                                ],
