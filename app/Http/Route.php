...
final class Route
{
    ...
    protected static $apiRoutes = array(
        ...
        'invoice_add_line_item'                   => ['post',     'invoices/{id}/line_item',                        'InvoiceController@addLineItem'                                     ],
        'invoice_update_line_item'                => ['put',      'invoices/{id}/line_item/{lineItemId}',           'InvoiceController@updateLineItem'                                  ],
        'invoice_remove_line_item'                => ['delete',   'invoices/{id}/line_item/{lineItemId}',           'InvoiceController@removeLineItem'                                  ],
