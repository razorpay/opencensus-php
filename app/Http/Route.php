...
final class Route
{
    ...
    protected static $apiRoutes = array(
        ...
        'gateway_add_priorities'                  => ['post',     'gateway/priorities/{method}',                    'GatewayController@addGatewayPriorities'                            ],
        'gateway_fetch_priorities'                => ['get',      'gateway/priorities',                             'GatewayController@getGatewayPriorities'                            ],
        'gateway_delete_priorities'               => ['delete',   'gateway/priorities/{method}',                    'GatewayController@deleteGatewayPriorities'                         ],
