 ...
 * even though the name has Authenticate in it, it is not related to authentication and hence not owned by spine-edge
...
class NotAuthenticate
{
     ...
     * @var array
     */
    protected array $whitelistRoutesForReferrerPartnerAccess = [
    ...
    public function handle($request, Closure $next)
    {
        try {
            ...
            $this->trace->error(TraceCode::NOT_AUTHENTICATE_MIDDLEWARE_FAILED, [
                'trace' => $e->getTrace(),
