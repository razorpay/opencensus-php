...
class RouteLatencyGroup
{
    ...
    */
    ...
    protected static $latencyGroupMap = [
        ...
        'merchant_onboarding_crons'             => self::LATENCY_GROUP_HIGH,
        'merchant_onboarding_escalations'       => self::LATENCY_GROUP_HIGH,
        'merchant_onboarding_cron_jobs'         => self::LATENCY_GROUP_HIGH,
