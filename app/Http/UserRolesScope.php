...
class UserRolesScope
{
    ...
    public function setRouteUserRoleMap()
    {
        $this->routeUserRoleMap = [
            ...
            'reversal_fetch_multiple'                       => [Role::ADMIN, Role::OWNER, Role::MANAGER,],
            ...
            'transfer_fetch'                                => [Role::ADMIN, Role::OWNER, Role::OPERATIONS, Role::MANAGER, Role::SUPPORT,],
            'transfer_fetch_reversals'                      => [Role::ADMIN, Role::OWNER, Role::OPERATIONS, Role::SUPPORT, Role::MANAGER,],
            ...
            'la_transfer_create_reversal'                          => [Role::OWNER, Role::ADMIN, Role::LINKED_ACCOUNT_OWNER],
            'link_account_documents_v2'                            => [Role::OWNER, Role::ADMIN],
            'link_stakeholder_documents_v2'                        => [Role::OWNER, Role::ADMIN],
            'linked_account_create_batch'                          => [Role::OWNER, Role::ADMIN],
            ...
            'payment_transfer_batch'                               => [Role::OWNER, Role::ADMIN, Role::MANAGER, Role::OPERATIONS, Role::FINANCE, Role::SUPPORT],
            ...
            'reversal_fetch'                                       => [Role::OWNER, Role::ADMIN],
            ...
            'store_create'                                         => [Role::OWNER, Role::ADMIN],
            'store_get_by_merchant'                                => [Role::OWNER, Role::ADMIN],
            'store_update'                                         => [Role::OWNER, Role::ADMIN],
            'store_delete'                                         => [Role::OWNER, Role::ADMIN],
            'store_validate_slug'                                  => [Role::OWNER, Role::ADMIN],
            'store_add_product'                                    => [Role::OWNER, Role::ADMIN],
            'store_fetch_products'                                 => [Role::OWNER, Role::ADMIN],
            'store_get_product'                                    => [Role::OWNER, Role::ADMIN],
            'store_update_product'                                 => [Role::OWNER, Role::ADMIN],
            'store_patch_product'                                  => [Role::OWNER, Role::ADMIN],
            'store_upload_image'                                   => [Role::OWNER, Role::ADMIN],
