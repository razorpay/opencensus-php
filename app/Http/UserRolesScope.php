...
class UserRolesScope
{
    ...
    public function setRouteUserRoleMap()
    {
        $this->routeUserRoleMap = [
            ...
            'merchant_policy_section_publish_v2'                   => [Role::OWNER, Role::MANAGER, Role::ADMIN, Role::FINANCE, Role::PARTNER, Role::PARTNER_AGENT],
            'merchant_website_policy_verify'                               => [Role::OWNER, Role::MANAGER, Role::ADMIN, Role::FINANCE, Role::PARTNER, Role::PARTNER_AGENT],
            ...
            'merchant_process_verification_details' => [Role::OWNER, Role::ADMIN, Role::PARTNER_AGENT, Role::PARTNER],
            ...
            'fetch_merchant_escalation'                     => [Role::ADMIN, Role::OWNER, Role::MANAGER, Role::OPERATIONS, Role::SELLERAPP, Role::FINANCE, Role::SUPPORT, Role::SELLERAPP_PLUS, Role::RBL_SUPERVISOR, Role::AGENT, Role::PARTNER, Role::PARTNER_AGENT],
            ...
            'merchant_activation_business_categories'       => [Role::ADMIN, Role::OWNER, Role::MANAGER, Role::SELLERAPP,Role::FINANCE, Role::PARTNER],
            'merchant_activation_business_categories_v2'    => [Role::ADMIN, Role::OWNER, Role::MANAGER, Role::SELLERAPP,Role::FINANCE, Role::PARTNER, Role::PARTNER_AGENT],
            'merchant_activation_gst_details'               => [Role::OWNER, Role::MANAGER, Role::ADMIN, Role::FINANCE, Role::PARTNER, Role::PARTNER_AGENT],
            'merchant_activation_save'                      => [Role::OWNER, Role::MANAGER, Role::ADMIN, Role::FINANCE, Role::PARTNER, Role::PARTNER_AGENT],
            ...
            'merchant_store_fetch'                          => [Role::ADMIN, Role::OWNER, Role::SELLERAPP, Role::FINANCE, Role::MANAGER,Role::OPERATIONS, Role::PARTNER, Role::PARTNER_AGENT],
            ...
            'merchant_business_types'                              => array_merge(Role::ALL_ROLES, BankingRole::getAllRoles(), Role::LINKED_ACCOUNT_ROLES,Role::RBL_ROLES,[Role::PARTNER]),
            ...
            'merchant_pre_signup_details'                          => [Role::OWNER, Role::MANAGER, Role::ADMIN, Role::FINANCE, Role::PARTNER_AGENT],
            ...
            'merchant_store_add'                                   => [Role::OWNER, Role::MANAGER, Role::ADMIN, Role::FINANCE, Role::OPERATIONS, Role::PARTNER],
            ...
            'merchant_website_section_action'                      => [Role::OWNER, Role::MANAGER, Role::ADMIN, Role::FINANCE, Role::PARTNER, Role::PARTNER_AGENT],
            'merchant_website_section_save'                        => [Role::OWNER, Role::MANAGER, Role::ADMIN, Role::FINANCE],
            'merchant_website_section_fetch'                       => [Role::OWNER, Role::MANAGER, Role::ADMIN, Role::FINANCE, Role::PARTNER_AGENT, Role::PARTNER],
            'merchant_website_section_page_load'                   => [Role::OWNER, Role::MANAGER, Role::ADMIN, Role::FINANCE, Role::PARTNER, Role::PARTNER_AGENT],
            ...
            'merchant_consents_save'                               => [Role::OWNER, Role::ADMIN, Role::PARTNER, Role::PARTNER_AGENT],
