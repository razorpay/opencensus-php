...
class UserRolesScope
{
    ...
    public function setRouteUserRoleMap()
    {
        $this->routeUserRoleMap = [
            ...
            'pos_fetch_device_order'                               => [Role::OWNER, Role::MANAGER, Role::ADMIN, Role::FINANCE, Role::PARTNER],
            'pos_fetch_all_device_orders'                          => [Role::OWNER, Role::MANAGER, Role::ADMIN, Role::FINANCE, Role::PARTNER],
            'pos_fetch_latest_order'                               => [Role::OWNER, Role::MANAGER, Role::ADMIN, Role::FINANCE, Role::PARTNER],
            ...
            'batch_fetch_by_id'    => array_merge(Role::READER_ROLES, [Role::RBL_SUPERVISOR, Role::LINKED_ACCOUNT_OWNER,Role::SELLERAPP, Role::AUTH_LINK_SUPERVISOR, Role::PARTNER], BankingRole::getAllRoles()),
            'batch_fetch_multiple' => array_merge(Role::READER_ROLES, [Role::RBL_SUPERVISOR, Role::LINKED_ACCOUNT_OWNER,Role::SELLERAPP, Role::AUTH_LINK_SUPERVISOR, Role::PARTNER], BankingRole::getAllRoles()),
        ...
        [Role::RBL_SUPERVISOR, Role::AGENT]),
            ...
            'batch_validate_file'                           => [Role::ADMIN, Role::OWNER, Role::MANAGER, Role::OPERATIONS, Role::FINANCE, Role::LINKED_ACCOUNT_OWNER, Role::PARTNER,],
