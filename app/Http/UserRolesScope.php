...
class UserRolesScope
{
    ...
    public function setRouteUserRoleMap()
    {
        $this->routeUserRoleMap = [
            ...
            'merchant_bmc_response_fetch'                          => [Role::OWNER, Role::MANAGER, Role::ADMIN, Role::FINANCE, Role::PARTNER, Role::PARTNER_AGENT,Role::RAZORPAY_SALES],
            ...
            'fetch_onboarding_payment_details'                     => [Role::OWNER, Role::MANAGER, Role::ADMIN, Role::FINANCE,Role::RAZORPAY_SALES],
            ...
            'merchant_website_section_page_load_v2'                => [Role::OWNER, Role::MANAGER, Role::ADMIN, Role::FINANCE, Role::PARTNER, Role::PARTNER_AGENT,Role::RAZORPAY_SALES],
            'merchant_activation_business_categories_v3'           => [Role::OWNER, Role::MANAGER, Role::ADMIN, Role::FINANCE, Role::PARTNER_AGENT, Role::PARTNER,Role::RAZORPAY_SALES],
            ...
            'merchant_fetch_keys'                   => [Role::OWNER, Role::ADMIN, Role::SELLERAPP, Role::PARTNER],
            ...
            'merchant_bank_account_change_status'   => [Role::OWNER, Role::ADMIN, Role::PARTNER],
            'merchant_bank_account_file_upload'     => [Role::OWNER, Role::ADMIN],
            'create_submerchant_user'               => [Role::OWNER, Role::MANAGER, Role::ADMIN],
            'merchant_fetch_users'                  => [Role::OWNER, Role::LINKED_ACCOUNT_OWNER, Role::RBL_SUPERVISOR, Role::PARTNER_AGENT],
            ...
            'plan_fetch_multiple'         => [Role::OWNER, Role::MANAGER, Role::ADMIN, Role::PARTNER],
            ...
            'payment_page_get_details'                 => array_merge(Role::WRITER_ROLES, [Role::PARTNER]),
            'payment_page_list'                        => array_merge(Role::WRITER_ROLES, [Role::PARTNER]),
            ...
            'fetch_merchant_balance_configs'                => [Role::ADMIN, Role::OWNER, Role::MANAGER, Role::OPERATIONS, Role::FINANCE, Role::SELLERAPP, Role::SUPPORT, Role::SELLERAPP_PLUS, Role::RBL_SUPERVISOR, Role::AGENT, Role::PARTNER, ],
            'fetch_merchant_escalation'                     => [Role::ADMIN, Role::OWNER, Role::MANAGER, Role::OPERATIONS, Role::SELLERAPP, Role::FINANCE, Role::SUPPORT, Role::SELLERAPP_PLUS, Role::RBL_SUPERVISOR, Role::AGENT, Role::PARTNER, Role::PARTNER_AGENT,Role::RAZORPAY_SALES],
            ...
            'fetch_payment_merchant_actions'                => [Role::ADMIN, Role::OWNER, Role::OPERATIONS, Role::MANAGER, Role::SUPPORT, Role::FINANCE, Role::PARTNER],
            ...
            'fetch_trusted_badge_status'                    => [Role::ADMIN, Role::OWNER, Role::MANAGER, Role::OPERATIONS, Role::SELLERAPP, Role::SUPPORT, Role::FINANCE, Role::SELLERAPP_PLUS, Role::AGENT, Role::RBL_SUPERVISOR, Role::PARTNER,],
            ...
            'merchant_activation_business_categories'       => [Role::ADMIN, Role::OWNER, Role::MANAGER, Role::SELLERAPP,Role::FINANCE, Role::PARTNER,Role::RAZORPAY_SALES],
            'merchant_activation_business_categories_v2'    => [Role::ADMIN, Role::OWNER, Role::MANAGER, Role::SELLERAPP,Role::FINANCE, Role::PARTNER, Role::PARTNER_AGENT,Role::RAZORPAY_SALES],
            'merchant_activation_gst_details'               => [Role::OWNER, Role::MANAGER, Role::ADMIN, Role::FINANCE, Role::PARTNER, Role::PARTNER_AGENT,Role::RAZORPAY_SALES],
            ...
            'merchant_activation_update_website_status'     => [Role::ADMIN, Role::OWNER, Role::MANAGER, Role::OPERATIONS, Role::SELLERAPP, Role::SUPPORT, Role::FINANCE, Role::RBL_SUPERVISOR, Role::SELLERAPP_PLUS,Role::RAZORPAY_SALES],
            'merchant_analytics'                            => [Role::ADMIN, Role::OWNER, Role::MANAGER, Role::OPERATIONS, Role::SELLERAPP, Role::FINANCE, Role::SUPPORT, Role::SELLERAPP_PLUS, Role::RBL_SUPERVISOR, Role::AGENT, Role::PARTNER,],
            'merchant_aov_config'                           => [Role::ADMIN, Role::OWNER, Role::MANAGER, Role::SELLERAPP,Role::FINANCE,Role::RAZORPAY_SALES],
            ...
            'merchant_fetch_payment_failure_analysis'       => [Role::ADMIN, Role::OWNER, Role::OPERATIONS, Role::MANAGER, Role::FINANCE, Role::SUPPORT, Role::PARTNER,],
            'merchant_fetch_schedule_tasks'                 => [Role::ADMIN, Role::OWNER, Role::MANAGER, Role::FINANCE, Role::OPERATIONS, Role::SUPPORT, Role::SELLERAPP, Role::PARTNER,],
            'merchant_get_tags'                             => [Role::ADMIN, Role::OWNER, Role::MANAGER, Role::OPERATIONS, Role::SELLERAPP, Role::SUPPORT, Role::FINANCE, Role::SELLERAPP_PLUS, Role::AGENT, Role::RBL_SUPERVISOR, Role::LINKED_ACCOUNT_ADMIN, Role::LINKED_ACCOUNT_OWNER, Role::PARTNER, Role::PARTNER_AGENT],
            ...
            'merchant_store_fetch'                          => [Role::ADMIN, Role::OWNER, Role::SELLERAPP, Role::FINANCE, Role::MANAGER,Role::OPERATIONS, Role::PARTNER, Role::PARTNER_AGENT,Role::RAZORPAY_SALES],
            'm2m_referral_link_get'                         => [Role::ADMIN, Role::OWNER, Role::SELLERAPP, Role::FINANCE, Role::MANAGER,Role::OPERATIONS,Role::RAZORPAY_SALES],
            ...
            'offer_fetch_multiple'                          => [Role::ADMIN, Role::OWNER, Role::MANAGER, Role::FINANCE, Role::SUPPORT, Role::SELLERAPP, Role::OPERATIONS, Role::PARTNER,],
            ...
            'payment_links_fetch_multiple'                  => [Role::ADMIN, Role::OWNER, Role::OPERATIONS, Role::SELLERAPP_PLUS, Role::SELLERAPP, Role::MANAGER, Role::FINANCE, Role::PARTNER,],
            'payment_links_get'                             => [Role::ADMIN, Role::OWNER, Role::OPERATIONS, Role::SELLERAPP, Role::MANAGER, Role::SELLERAPP_PLUS, Role::FINANCE, Role::PARTNER,],
            ...
            'payment_links_custom_field_config_get'         => [Role::OWNER],
            ...
            'proxy_merchant_get_support_details'            => [Role::ADMIN, Role::OWNER, Role::MANAGER, Role::OPERATIONS, Role::SELLERAPP, Role::FINANCE, Role::SUPPORT, Role::SELLERAPP_PLUS, Role::RBL_SUPERVISOR, Role::AGENT, Role::PARTNER,],
            ...
            'setl_amount'                                   => [Role::ADMIN, Role::OWNER, Role::MANAGER, Role::OPERATIONS, Role::SUPPORT, Role::FINANCE, Role::SELLERAPP, Role::SELLERAPP_PLUS, Role::AGENT, Role::RBL_SUPERVISOR, Role::PARTNER],
            ...
            'setl_holidays'                                 => [Role::ADMIN, Role::OWNER, Role::MANAGER, Role::FINANCE, Role::OPERATIONS, Role::SUPPORT, Role::SELLERAPP, Role::PARTNER],
            ...
            'settlement_ondemand_blocked'                   => [Role::ADMIN, Role::OWNER, Role::MANAGER, Role::OPERATIONS, Role::FINANCE, Role::SUPPORT, Role::SELLERAPP, Role::PARTNER],
            ...
            'subscription_fetch_due_addons'                 => [Role::ADMIN, Role::OWNER, Role::MANAGER, Role::PARTNER,],
            ...
            'subscription_registration_fetch_link_internal' => [Role::ADMIN, Role::OWNER, Role::OPERATIONS, Role::MANAGER, Role::FINANCE, Role::SUPPORT, Role::PARTNER,],
            'subscription_registration_fetch_token'         => [Role::ADMIN, Role::OWNER, Role::MANAGER, Role::FINANCE, Role::OPERATIONS, Role::SUPPORT,],
            'subscription_registration_list_links'          => [Role::ADMIN, Role::OWNER, Role::OPERATIONS, Role::FINANCE, Role::MANAGER, Role::SUPPORT, Role::PARTNER,],
            'subscription_registration_list_tokens'         => [Role::ADMIN, Role::OWNER, Role::FINANCE, Role::SUPPORT, Role::OPERATIONS, Role::MANAGER, Role::PARTNER,],
            'subscription_registration_resend_link'         => [Role::ADMIN, Role::OWNER, Role::OPERATIONS,],
            'subscription_settings_get'                     => [Role::ADMIN, Role::OWNER, Role::MANAGER, Role::FINANCE, Role::PARTNER,],
            'subscriptions_overview'                        => [Role::ADMIN, Role::OWNER, Role::MANAGER, Role::FINANCE, Role::SUPPORT, Role::OPERATIONS, Role::SELLERAPP, Role::PARTNER],
            'tax_get_meta_gst_taxes'                        => [Role::ADMIN, Role::OWNER, Role::MANAGER, Role::OPERATIONS, Role::FINANCE, Role::SUPPORT, Role::SELLERAPP, Role::PARTNER],
            ...
            'commissions_invoice_fetch'                            => [Role::OWNER, Role::ADMIN, Role::PARTNER],
            'get_partner_kyc_access_status'                        => [Role::OWNER, Role::ADMIN],
            ...
            'merchant_supported_plugins'                           => [Role::OWNER, Role::MANAGER, Role::ADMIN, Role::FINANCE,Role::RAZORPAY_SALES],
            ...
            'merchant_activation_business_details'                 => [Role::OWNER, Role::MANAGER, Role::ADMIN, Role::FINANCE,Role::RAZORPAY_SALES],
            'merchant_activation_company_search'                   => [Role::OWNER, Role::MANAGER, Role::ADMIN, Role::FINANCE,Role::RAZORPAY_SALES],
            'merchant_activation_needs_clarification'              => [Role::OWNER, Role::MANAGER, Role::ADMIN, Role::FINANCE, Role::PARTNER, Role::PARTNER_AGENT,Role::RAZORPAY_SALES],
            ...
            'merchant_document_fetch'                              => [Role::OWNER, Role::MANAGER, Role::ADMIN, Role::FINANCE,Role::RAZORPAY_SALES],
            ...
            'merchant_document_url_fetch'                          => [Role::OWNER, Role::MANAGER, Role::ADMIN, Role::FINANCE, Role::PARTNER, Role::PARTNER_AGENT,Role::RAZORPAY_SALES],
            ...
            'merchant_fetch_config_internal'                       => [Role::OWNER, Role::ADMIN, Role::PARTNER, Role::PARTNER_AGENT],
            ...
            'merchant_pre_signup_details'                          => [Role::OWNER, Role::MANAGER, Role::ADMIN, Role::FINANCE, Role::PARTNER_AGENT,Role::RAZORPAY_SALES],
            ...
            'merchant_website_section_fetch'                       => [Role::OWNER, Role::MANAGER, Role::ADMIN, Role::FINANCE, Role::PARTNER_AGENT, Role::PARTNER,Role::RAZORPAY_SALES],
            'merchant_website_section_page_load'                   => [Role::OWNER, Role::MANAGER, Role::ADMIN, Role::FINANCE, Role::PARTNER, Role::PARTNER_AGENT,Role::RAZORPAY_SALES],
            ...
            'offer_fetch_by_id'                                    => [Role::OWNER, Role::ADMIN, Role::MANAGER, Role::SELLERAPP, Role::PARTNER],
            ...
            'partner_referral_fetch'                               => [Role::OWNER, Role::ADMIN, Role::PARTNER_AGENT],
            ...
            'pincode_get'                                          => [Role::OWNER, Role::ADMIN, Role::PARTNER, Role::PARTNER_AGENT],
            ...
            'proxy_merchant_get_pricing'                           => [Role::OWNER, Role::MANAGER, Role::ADMIN, Role::FINANCE,Role::RAZORPAY_SALES],
            ...
            'subscription_offer_fetch_usage'                       => [Role::OWNER, Role::ADMIN, Role::PARTNER],
            ...
            'subscription_registration_fetch_link'                 => [Role::OWNER, Role::ADMIN, Role::PARTNER],
            ...
            'vendor_payment_items_list'                            => [Role::OWNER, Role::ADMIN],
            'vendor_payment_items_get'                             => [Role::OWNER, Role::ADMIN],
            'vendor_payment_items_edit'                            => [Role::OWNER, Role::ADMIN],
            'vendor_payment_po_number_suggestion'                  => [Role::OWNER, Role::ADMIN],
            ...
            '1cc_shipping_item_category_search_product'           => [Role::OWNER, Role::ADMIN],
            '1cc_shipping_create_method'                          => [Role::OWNER, Role::ADMIN],
            '1cc_shipping_update_method'                          => [Role::OWNER, Role::ADMIN],
            '1cc_shipping_get_method'                             => [Role::OWNER, Role::ADMIN],
            '1cc_shipping_delete_method'                          => [Role::OWNER, Role::ADMIN],
            '1cc_shipping_get_shipping_profiles'                  => [Role::OWNER, Role::ADMIN],
            ...
            '1cc_order_edit_search_products'                      => [Role::OWNER, Role::ADMIN, Role::OPERATIONS, Role::MANAGER, Role::FINANCE],
            '1cc_order_edit_get_orders'                           => [Role::OWNER, Role::ADMIN, Role::OPERATIONS, Role::MANAGER, Role::FINANCE],
            '1cc_order_edit_get_order'                            => [Role::OWNER, Role::ADMIN, Role::OPERATIONS, Role::MANAGER, Role::FINANCE],
            ...
            '1cc_coupon_engine_get_segments'                      => [Role::OWNER, Role::ADMIN, Role::MANAGER, Role::OPERATIONS],
            ...
            'b2b_invoice_show_address'                            => [Role::OWNER, Role::ADMIN, Role::MANAGER, Role::FINANCE, Role::OPERATIONS],
            'state_fetch_internal'                                => [Role::OWNER, Role::ADMIN, Role::MANAGER, Role::FINANCE, Role::OPERATIONS],
