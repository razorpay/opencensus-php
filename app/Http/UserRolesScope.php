...
class UserRolesScope
{
    ...
    public function setRouteUserRoleMap()
    {
        $this->routeUserRoleMap = [
            ...
            'merchant_features_fetch'                       => [Role::ADMIN, Role::OWNER, Role::MANAGER, Role::OPERATIONS, Role::SELLERAPP, Role::SUPPORT, Role::FINANCE, Role::SELLERAPP_PLUS, Role::AGENT, Role::RBL_SUPERVISOR,],
            ...
            'merchant_razorx_bulk_evaluate'                 => [Role::ADMIN, Role::OWNER, Role::MANAGER, Role::OPERATIONS, Role::SELLERAPP, Role::SUPPORT, Role::FINANCE, Role::SELLERAPP_PLUS, Role::AGENT, Role::RBL_SUPERVISOR, Role::AUTH_LINK_AGENT,Role::AUTH_LINK_SUPERVISOR],
            'merchant_razorx_evaluate'                      => Role::ALL_ROLES,
            ...
            'ufh_get_file_signed_url'                       => [Role::ADMIN, Role::OWNER, Role::FINANCE, Role::OPERATIONS, Role::MANAGER, Role::SUPPORT, Role::SELLERAPP_PLUS, Role::RBL_SUPERVISOR,],
            ...
            'governor_get_merchant_rule_group'                     => [Role::OWNER, Role::ADMIN],
            'governor_list_merchant_providers'                     => [Role::OWNER, Role::ADMIN],
            'governor_list_merchant_rule_groups'                   => [Role::OWNER, Role::ADMIN],
            ...
            'terminals_proxy_get_merchant_optimizer_provider'      => [Role::OWNER, Role::ADMIN],
            'terminals_proxy_get_optimizer_gateways'               => [Role::OWNER, Role::ADMIN],
            'terminals_proxy_get_optimizer_merchant_methods'       => [Role::OWNER, Role::ADMIN],
