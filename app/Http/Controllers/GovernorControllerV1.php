...
class GovernorControllerV1 extends Controller
{
    ...
    public function updateNamespace($namespace_id)
    {
        $input = Request::all();

        $response = $this->app['governor']->sendRequestV1(GovernorService::UPDATE_NAMESPACE_V1, $input, null, $namespace_id);

        return response()->json($response['response_body'])->setStatusCode($response['response_code']);
    }

    public function deleteNamespace($namespace_id)
    {
        $input = Request::all();

        $response = $this->app['governor']->sendRequestV1(GovernorService::DELETE_NAMESPACE_V1, $input, null, $namespace_id);
    ...
    public function listRuleGroups($namespace_id, $rule_chain_id)
    {
        ...
        $response = $this->app['governor']->sendRequestV1(GovernorService::LIST_RULE_GROUPS_V1, $input, null, $namespace_id, $rule_chain_id);
    ...
    public function getRuleGroup($namespace_id, $rule_chain_id, $rule_group_id)
    {
        ...
        $response = $this->app['governor']->sendRequestV1(GovernorService::GET_RULE_GROUP_V1, $input, null, $namespace_id, $rule_chain_id, $rule_group_id);
    ...
    public function deleteRuleGroup($namespace_id, $rule_chain_id, $rule_group_id)
    {
        ...
        $response = $this->app['governor']->sendRequestV1(GovernorService::DELETE_RULE_GROUP_V1, $input, null, $namespace_id, $rule_chain_id, $rule_group_id);
    ...
    public function updateRuleGroup($namespace_id, $rule_chain_id, $rule_group_id)
    {
        ...
        $response = $this->app['governor']->sendRequestV1(GovernorService::UPDATE_RULE_GROUP_V1, $input, null, $namespace_id, $rule_chain_id, $rule_group_id);
    ...
    public function createRule($namespace_id, $rule_chain_id, $rule_group_id)
    {
        ...
        $response = $this->app['governor']->sendRequestV1(GovernorService::CREATE_RULE_V1, $input, null, $namespace_id, $rule_chain_id, $rule_group_id);
    ...
    public function listRule($namespace_id, $rule_chain_id, $rule_group_id)
    {
        ...
        $response = $this->app['governor']->sendRequestV1(GovernorService::LIST_RULE_V1, $input, null, $namespace_id, $rule_chain_id, $rule_group_id);
    ...
    public function getRule($namespace_id, $rule_chain_id, $rule_group_id, $rule_id)
    {
        ...
        $response = $this->app['governor']->sendRequestV1(GovernorService::GET_RULE_V1, $input, null, $namespace_id, $rule_chain_id, $rule_group_id, $rule_id);
