    ...
    public function getIndex()
    {
        ...
        else
        {
            ...
            if(is_null($currentMerchantId) === false)
            {
                ...
                $data['pl_customer_name_enabled'] = json_encode((new Merchant\PaymentLinkCustomization\Service)->getIsCustomerNameFieldEnabledForPaymentLinksForMerchant($currentMerchantId));
            }
            else {
                $data['custom_notes'] = null;
                $data['pl_expiry_in_hrs'] = null;
                $data['pl_customer_name_enabled'] = null;
            }
