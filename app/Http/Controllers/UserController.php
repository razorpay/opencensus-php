    ...
    public function getIndex()
    {
        ...
        else
        {
            ...
            if(is_null($currentMerchantId) === false)
            {
                ...
                $data['is_pl_customer_name_field_enabled'] = json_encode((new Merchant\PaymentLinkCustomization\Service)->getIsCustomerNameFieldEnabledForPaymentLinksForMerchant($currentMerchantId));
            }
            else {
