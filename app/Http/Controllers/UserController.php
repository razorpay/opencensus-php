    ...
    public function getIndex()
    {
        ...
        else
        {
            ...
            if(is_null($currentMerchantId) === false)
            {
                ...
                $data['pl_custom_labels'] = json_encode((new Merchant\PaymentLinkCustomization\Service)->getCustomFormLabelsForPaymentLinksForMerchant($currentMerchantId));
            }
            else {
                $data['custom_notes'] = null;
                $data['pl_expiry_in_hrs'] = null;
                $data['pl_custom_labels'] = null;
            }
