...
class MerchantController extends Controller
{
    ...
    public function postValidateCreateTerminalV3(string $id)
    {
        $input = Request::all();

        $data = $this->service(E::TERMINAL)->validateCreateTerminalV3($id,$input);

        return ApiResponse::json($data);
    }

    public function postCreateTerminalV3(string $id)
    {
        $input = Request::all();

        $data = $this->service(E::TERMINAL)->createTerminalV3($id,$input);
    ...
    public function editAllMerchantMethods($mid)
    {
        $input = Request::all();

        $data = $this->service()->editAllMerchantMethods($mid, $input);
    ...
    public function getBankingAccountBalances()
    {
        $input = Request::all();

        $data = $this->service()->fetchBankingAccountBalances($input);
    ...
    public function getAllPaymentMethodsById($merchantId)
    {
        $data = (new Methods\Service)->getAllPaymentMethodsById($merchantId);
...
// --------------------- End Credits API Handlers -----------------------------------------
    ...
    public function saveOrgDefinedMerchantFieldsBatch()
    {
        $input = Request::all();

        $response = $this->service(E::MERCHANT_DETAIL)->saveOrgDefinedMerchantFieldsBatch($input);
    ...
    public function getTagsInternal($id)
    {
        $response = $this->service()->getTags($id);
    ...
    public function getShippingInfo()
    {
        ...
        try
        {
            if (isset($input['reference_id']) && isset($input['reference_type']) && $input['reference_type'] === 'shopify') // serviceability using checkout id flow
            {
