...
class CapitalESController extends Controller
{
    ...
    protected function handleAdminRequests($path = null)
    {
        ...
        $this->trace->info(TraceCode::CAPITAL_ES_ADMIN_REQUEST, [
            'request' => $url,
        ]);
    ...
    protected function handleDevAdminRequests($path = null)
    {
        ...
        $this->trace->info(TraceCode::CAPITAL_ES_DEV_ADMIN_REQUEST, [
            'request' => $url,
        ]);
    ...
    protected function handleProxyRequests($path = null)
    {
        ...
        $this->trace->debug(TraceCode::CAPITAL_ES_PROXY_REQUEST, [
            'request' => $url,
        ]);
    ...
    protected function sendRequest($headers, $url, $method, $body)
    {
        ...
        $this->trace->info(TraceCode::CAPITAL_ES_RESPONSE, $traceData);
