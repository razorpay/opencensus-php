...
class CapitalScorecardController extends Controller
{
    const GET      = 'GET';
    const POST     = 'POST';
    const PUT      = 'PUT';
    ...
    protected function handleAdminRequests($path = null)
    {
        ...
        $this->trace->info(TraceCode::CAPITAL_SCORECARD_ADMIN_REQUEST, [
            'request' => $url,
        ]);
    ...
    protected function handleDevAdminRequests($path = null)
    {
        ...
        $this->trace->info(TraceCode::CAPITAL_SCORECARD_DEV_ADMIN_REQUEST, [
            'request' => $url,
        ]);
    ...
    protected function sendRequestAndParseResponse(
        ...
        array  $headers = [])
    {
        $config = config('applications.capital_scorecard');
        $baseUrl = $config['url'];
    ...
    {
        $this->trace->debug(TraceCode::CAPITAL_SCORECARD_REQUEST, [
            'url' => $url,
            'method' => $method,
        ]);
        ...
        $this->trace->info(TraceCode::CAPITAL_SCORECARD_RESPONSE, $traceData);
