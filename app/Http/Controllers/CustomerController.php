...
class CustomerController extends Controller
{
    ...
    public function fetchTokenEmandate($customerId, $tokenId)
    {
        $data = $this->service(E::TOKEN)->fetchEmandate($customerId, $tokenId);
    ...
    public function editLocalAddress($customerId)
    {
        $input = Request::all();

        $address = $this->service()->editLocalAddress($customerId, $input);
    ...
    public function createGlobalCustomerAndAddress()
    {
        $input = Request::all();
