...
class LOSController extends Controller
{
    ...
    const MERCHANT_ROUTES_REGEX = [
        ...
        self::SEND_OTP_REGEX                              => '/rzp\.capital\.los\.origination\.d2c\.v1\.D2CBureauAPI\/SendOtp/',
        self::SUBMIT_OTP_REGEX                            => '/rzp\.capital\.los\.origination\.d2c\.v1\.D2CBureauAPI\/SubmitOtp/',
        self::GET_BUREAU_REPORT_REGEX                     => '/rzp\.capital\.los\.origination\.d2c\.v1\.D2CBureauAPI\/GetBureauReport/',
