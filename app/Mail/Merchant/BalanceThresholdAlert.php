...
class BalanceThresholdAlert extends Mailable
{
    protected $data;
    ...
    {
        $subject = '[Alert] Razorpay | Low Live Balance for '.$this->data['merchant_dba'];
    ...
    protected function addHeaders()
    {
        $this->withSymfonyMessage(function (Email $message)
        {
            ...
            $headers->addTextHeader(MailTags::HEADER, MailTags::BALANCE_THRESHOLD_ALERT);
        });
    ...
    {
        $this->view('emails.merchant.balance_threshold_alert');
