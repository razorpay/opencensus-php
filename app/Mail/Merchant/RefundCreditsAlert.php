...
class RefundCreditsAlert extends Mailable
{
    protected $data;
    ...
    {
        $subject = '[Alert] Razorpay | Low Refund Credits Balance for '.$this->data['merchant_dba'];
    ...
    protected function addHeaders()
    {
        $this->withSymfonyMessage(function (Email $message)
        {
            ...
            $headers->addTextHeader(MailTags::HEADER, MailTags::REFUND_CREDITS_ALERT);
        });
    ...
    {
        $this->view('emails.merchant.refund_credits_alert');
