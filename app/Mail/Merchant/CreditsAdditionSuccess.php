...
class CreditsAdditionSuccess extends Mailable
{
    protected $data;
    ...
    protected function addHeaders()
    {
        $this->withSymfonyMessage(function (Email $message)
        {
            ...
            $headers->addTextHeader(MailTags::HEADER, MailTags::CREDITS_ADDITION_MAIL);
        });
    ...
    {
        $this->view('emails.merchant.credits_addition_success');
