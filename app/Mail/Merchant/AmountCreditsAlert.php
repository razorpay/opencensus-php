...
class AmountCreditsAlert extends Mailable
{
    protected $data;
    ...
    {
        $subject = '[Alert] Razorpay | Low Amount Credits Balance for '.$this->data['merchant_dba'];
    ...
    protected function addHeaders()
    {
        $this->withSymfonyMessage(function (Email $message)
        {
            ...
            $headers->addTextHeader(MailTags::HEADER, MailTags::AMOUNT_CREDITS_ALERT);
        });
    ...
    {
        $this->view('emails.merchant.amount_credits_alert');
