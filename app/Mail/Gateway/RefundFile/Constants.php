...
class Constants extends Base\Constants
{
    ...
    const HEADER_MAP = [
        ...
        Gateway::NETBANKING_CSB         => 'Csb Netbanking refunds',
    ...
    const MAILTAG_MAP = [
        ...
        Gateway::NETBANKING_CSB         => MailTags::CSB_NETBANKING_REFUNDS_MAIL,
    ...
    const BODY_MAP = [
        ...
        Gateway::NETBANKING_CSB         => 'Please forward the CSB Netbanking refunds file to UBPS operations team',
    ...
    const MAIL_TEMPLATE_MAP = [
        ...
        Gateway::NETBANKING_CSB         => 'emails.message',
