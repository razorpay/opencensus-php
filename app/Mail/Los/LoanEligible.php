...
class LoanEligible extends Base\Mailable
{
    protected $data;
    ...
    {
        $subject = '=?utf-8?Q?Congratulations=21_=F0=9F=8E=89_You_are_eligible_for_Working_Capital_loans=21?=';
    ...
    {
        $this->view('emails.los.razorpay_loan_eligible');
        return $this;
    }
}
