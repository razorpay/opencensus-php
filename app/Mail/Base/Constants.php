...
class Constants
{
    ...
    const PG_NOTIFICATION_CARD          = 'pg_notification_card';
    const PG_NOTIFICATION_UPI           = 'pg_notification_upi';
    ...
    const MAIL_ADDRESSES = [
        ...
        self::PG_NOTIFICATION_CARD      => 'pg-notifications-card@razorpay.com',
