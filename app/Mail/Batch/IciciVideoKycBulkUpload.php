...
{
    protected static $mailTag     = MailTags::BATCH_ICICI_VIDEO_KYC_BULK_UPLOAD_FILE;

    protected static $sender      = Constants::BANKING_ACCOUNT;

    protected static $subjectLine = 'RazorpayX | ICICI Video KYC Bulk Upload file dated %s';

    protected static $body        = 'Please find attached the ICICI Video KYC Bulk Upload file created.';
