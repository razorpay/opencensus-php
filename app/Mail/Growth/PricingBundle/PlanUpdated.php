...
class PlanUpdated extends Mailable
{
    ...
    const SUBJECT = ' Congratulations! Your new plan has been successfully updated 🚀';
    ...
    protected function getParamsForStork(): array
    {
        return [
            ...
            'template_name'      => 'growth.pricing_bundle.plan_updated',
            'params'  => $this->data,
        ];
    }
    ...
    {
        $this->view('growth.pricing_bundle.plan_updated');
