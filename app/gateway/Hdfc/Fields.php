...
class Fields
{
     ...
     *
     * Field Description
     * The currency code of the transaction. For Indian
     ...
     * Gateway, this transaction ID is required for any future
     * support/subsequent transaction
