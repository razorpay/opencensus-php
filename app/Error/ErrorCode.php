...
// Payment bad requests
    ...
    /* Free Credits Bad Request Exception */
    const BAD_REQUEST_MERCHANT_TOTAL_CREDITS_LESSER_THAN_CREDITS_TO_SUBTRACT        = 'BAD_REQUEST_MERCHANT_TOTAL_CREDITS_LESSER_THAN_CREDITS_TO_SUBTRACT';
    const BAD_REQUEST_MERCHANT_FREE_CREDITS_LOG_FOR_CAMPAING_EXISTS                 = 'BAD_REQUEST_MERCHANT_FREE_CREDITS_LOG_FOR_CAMPAIGN_EXISTS';
    const BAD_REQUEST_MERCHANT_CAMPAIGN_CREDITS_LESSER_THAN_CREDITS_TO_SUBTRACT     = 'BAD_REQUEST_MERCHANT_FREE_CREDITS_CAMPAIGN_CREDITS_LESSER_THAN_CREDITS_TO_SUBTRACT';
