...
class ErrorCode
{
    ...
    const GATEWAY_ERROR_PAYMENT_NETBANKING_CANCELLED_BY_BANK                        = 'GATEWAY_ERROR_PAYMENT_NETBANKING_CANCELLED_BY_BANK';
...
// Unauthorized bad requests
    ...
    const BAD_REQUEST_UNAUTHORIZED_UNABLE_TO_ATHORIZE                               = 'BAD_REQUEST_UNAUTHORIZED_UNABLE_TO_ATHORIZE';
