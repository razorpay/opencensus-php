...
class ErrorCode
{
    ...
    */
    ...
    const BAD_REQUEST_SUBMERCHANT_MANUAL_SETTLEMENT_EXP_NOT_ENABLED                 = 'BAD_REQUEST_SUBMERCHANT_MANUAL_SETTLEMENT_EXP_NOT_ENABLED';
    ...
    const MISSING_STATEMENT_DETECTION_IN_PROGRESS                                   = 'MISSING_STATEMENT_DETECTION_IN_PROGRESS';
    const MISSING_STATEMENT_DETECTION_UPDATE_IN_PROGRESS                            = 'MISSING_STATEMENT_DETECTION_UPDATE_IN_PROGRESS';
