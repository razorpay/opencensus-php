...
class ErrorCode
{
    ...
    const BAD_REQUEST_ORDER_RECEIPT_ID_REQUIRED                                     = 'BAD_REQUEST_ORDER_RECEIPT_ID_REQUIRED';
    const BAD_REQUEST_ORDER_RECEIPT_ID_NOT_UNIQUE                                   = 'BAD_REQUEST_ORDER_RECEIPT_ID_NOT_UNIQUE';
