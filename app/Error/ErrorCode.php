...
class ErrorCode
{
    ...
    const BAD_REQUEST_CANNOT_APPROVE_MERCHANT_FEATURE_NOT_ASSIGNED                  = 'BAD_REQUEST_CANNOT_APPROVE_MERCHANT_FEATURE_NOT_ASSIGNED';
    const BAD_REQUEST_MERCHANT_FEATURE_ONBOARDING_STATUS_NOT_RECOGNIZED             = 'BAD_REQUEST_MERCHANT_FEATURE_ONBOARDING_STATUS_NOT_RECOGNIZED';
    const BAD_REQUEST_CANNOT_RESEND_FEATURE_ONBOARDING_RESPONSES                    = 'BAD_REQUEST_CANNOT_RESEND_FEATURE_ONBOARDING_RESPONSES';
