...
class ErrorCode
{
    ...
    */
    ...
    const BAD_REQUEST_MODE_NOT_ALLOWED_FOR_LINKED_NUMBER                            = 'BAD_REQUEST_MODE_NOT_ALLOWED_FOR_LINKED_NUMBER';

    const BAD_REQUEST_LINKED_NUMBER_NOT_PRESENT                                    = 'BAD_REQUEST_LINKED_NUMBER_NOT_PRESENT';
    const BAD_REQUEST_ACCOUNT_HOLDER_NAME_NOT_PRESENT                              = 'BAD_REQUEST_ACCOUNT_HOLDER_NAME_NOT_PRESENT';
    const BAD_REQUEST_LINKED_NUMBER_INVALID                                        = 'BAD_REQUEST_LINKED_NUMBER_INVALID';

    const BAD_REQUEST_LINKED_NUMBER_PAYOUT_NOT_ALLOWED                             = 'BAD_REQUEST_LINKED_NUMBER_PAYOUT_NOT_ALLOWED';
