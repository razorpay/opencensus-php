...
class ErrorCode
{
    ...
    const BAD_REQUEST_UPI_INVALID_PAYER_BANK_ACCOUNT                                = 'BAD_REQUEST_UPI_INVALID_PAYER_BANK_ACCOUNT';
    ...
    const BAD_REQUEST_CARD_ISSUER_AUTHENTICATION_ERROR                              = 'BAD_REQUEST_CARD_ISSUER_AUTHENTICATION_ERROR';
