...
class ErrorCode
{
    ...
    const BAD_REQUEST_GATEWAY_TERMINAL_MAX_AMOUNT_LIMIT_REACHED                     = 'BAD_REQUEST_GATEWAY_TERMINAL_MAX_AMOUNT_LIMIT_REACHED';
    const BAD_REQUEST_GATEWAY_TERMINAL_MAX_TRANSACTION_LIMIT_REACHED                = 'BAD_REQUEST_GATEWAY_TERMINAL_MAX_TRANSACTION_LIMIT_REACHED';
    ...
    const GATEWAY_ERROR_CANNOT_AUTHENTICATE_TECH_BUSINESS_REASON                    = 'GATEWAY_ERROR_CANNOT_AUTHENTICATE_TECH_BUSINESS_REASON';
}
