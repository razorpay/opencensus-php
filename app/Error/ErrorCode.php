...
class ErrorCode
{
    ...
    */
    ...
    const SERVER_ERROR_FTA_MODE_SENT_NON_YESBANK                                    = 'SERVER_ERROR_FTA_MODE_SENT_NON_YESBANK';
    ...
    const BAD_REQUEST_ERROR_ACTIVATION_AMOUNT_NON_ZERO                              = 'BAD_REQUEST_ERROR_ACTIVATION_AMOUNT_NON_ZERO';
    const BAD_REQUEST_ACCOUNT_ACTIVATION_NOT_PERMITTED                              = 'BAD_REQUEST_ACCOUNT_ACTIVATION_NOT_PERMITTED';
