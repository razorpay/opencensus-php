...
class ErrorCode
{
    ...
    */
    ...
    const BAD_REQUEST_VPA_VALIDATE_API_CREDENTIAL_NOT_FOUND                         = 'BAD_REQUEST_VPA_VALIDATE_API_CREDENTIAL_NOT_FOUND';

    const FAILED_TO_DISPATCH_JOB                                                    = 'FAILED_TO_DISPATCH_JOB';
    ...
    const BAD_REQUEST_INVALID_REQUEST                                                = 'BAD_REQUEST_INVALID_REQUEST';
    ...
    const BAD_REQUEST_MANDATE_PAYMENT_ATTEMPTED_BEFORE_MIN_GAP_OF_NOTIFICATION       = 'BAD_REQUEST_MANDATE_PAYMENT_ATTEMPTED_BEFORE_MIN_GAP_OF_NOTIFICATION';
    const BAD_REQUEST_PAYMENT_MANDATE_NOTIFICATION_NOT_SENT                          = 'BAD_REQUEST_PAYMENT_MANDATE_NOTIFICATION_NOT_SENT';
    const BAD_REQUEST_PRIOR_PAYMENT_IN_PROGRESS                                      = 'BAD_REQUEST_PRIOR_PAYMENT_IN_PROGRESS';

    // Generic bad requests
    const BAD_REQUEST_INVALID_ID                                                    = 'BAD_REQUEST_INVALID_ID';
    const BAD_REQUEST_INVALID_MIN_AMOUNT                                            = 'BAD_REQUEST_INVALID_MIN_AMOUNT';
    ...
    const COLLECTX_UNSUPPORTED_UPI_TRANSFER_REQUEST                                 = 'COLLECTX_UNSUPPORTED_UPI_TRANSFER_REQUEST';
    const COLLECTX_UNSUPPORTED_BANK_TRANSFER_REQUEST                                = 'COLLECTX_UNSUPPORTED_BANK_TRANSFER_REQUEST';

    const COLLECTX_PROCESS_TRANSFER_SQS_PUSH_FAILED                                 = 'COLLECTX_PROCESS_TRANSFER_SQS_PUSH_FAILED';
    const COLLECTX_UNEXPECTED_PAYMENT_ON_CLOSED_VA                                  = 'COLLECTX_UNEXPECTED_PAYMENT_ON_CLOSED_VA';

    const COLLECTX_PROCESS_TRANSFER_SQS_PUSH_ERROR                                  = 'COLLECTX_PROCESS_TRANSFER_SQS_PUSH_ERROR';
    const COLLECTX_UNEXPECTED_PAYMENT_ON_NON_DIRECT_OR_NON_BANKING__VA              = 'COLLECTX_UNEXPECTED_PAYMENT_ON_NON_DIRECT_OR_NON_BANKING__VA';
    const COLLECTX_UNEXPECTED_PAYMENT_BY_NON_ALLOWED_PAYER                          = 'COLLECTX_UNEXPECTED_PAYMENT_BY_NON_ALLOWED_PAYER';
    const COLLECTX_PRIMARY_BALANCE_UNAVAILABLE_FOR_FEE_CREDITS                      = 'COLLECTX_PRIMARY_BALANCE_UNAVAILABLE_FOR_FEE_CREDITS';
    const COLLECTX_FEE_CREDITS_UNAVAILABLE_FOR_API_MERCHANT                         = 'COLLECTX_FEE_CREDITS_UNAVAILABLE_FOR_API_MERCHANT';
    const INVALID_MODE_COLLECTX_TRANSFER                                            = 'INVALID_MODE_COLLECTX_TRANSFER';
    const COLLECTX_FEE_CREDITS_BELOW_THRESHOLD                                      = 'COLLECTX_FEE_CREDITS_BELOW_THRESHOLD';
    const COLLECTX_VIRTUAL_ACCOUNT_NOT_FOUND                                        = 'COLLECTX_VIRTUAL_ACCOUNT_NOT_FOUND';
    const COLLECTX_UNEXPECTED_PAYMENT_CREDIT_ACCOUNT_MISMATCH                       = 'COLLECTX_UNEXPECTED_PAYMENT_CREDIT_ACCOUNT_MISMATCH';
    ...
    const DUPLICATE_PAYOUT_CREATION_ATTEMPT                                         = 'DUPLICATE_PAYOUT_CREATION_ATTEMPT';
    const BAD_REQUEST_DUPLICATE_PAYOUT_CREATION_ATTEMPT                             = 'BAD_REQUEST_DUPLICATE_PAYOUT_CREATION_ATTEMPT';
    const BAD_REQUEST_DUPLICATE_PAYOUT_CREATION_ATTEMPT_NO_PAYOUT_ID_FOUND_IN_RESPONSE = 'BAD_REQUEST_DUPLICATE_PAYOUT_CREATION_ATTEMPT_NO_PAYOUT_ID_FOUND_IN_RESPONSE';
    ...
    const SERVER_ERROR_WORKFLOW_WILDCARD_ADMIN_REQUEST_FAILED                       = 'SERVER_ERROR_WORKFLOW_WILDCARD_ADMIN_REQUEST_FAILED';
    const SERVER_ERROR_WORKFLOW_CONFIG_GET_FAILED                                   = 'SERVER_ERROR_WORKFLOW_CONFIG_GET_FAILED';
    const SERVER_ERROR_WORKFLOW_CONFIG_LIST_FAILED                                  = 'SERVER_ERROR_WORKFLOW_CONFIG_LIST_FAILED';
    ...
    const SERVER_ERROR_WORKFLOW_LIST_PENDING_FAILED                                 = 'SERVER_ERROR_WORKFLOW_LIST_PENDING_FAILED';
    ...
    const BAD_REQUEST_WORKFLOW_WILDCARD_ADMIN_REQUEST_FAILED                        = 'BAD_REQUEST_WORKFLOW_WILDCARD_ADMIN_REQUEST_FAILED';
    ...
    const BAD_REQUEST_BLACKLISTED_BALANCE_ID_DUE_TO_NEGATIVE_FEE_RECOVERY_AMOUNT    = 'BAD_REQUEST_BLACKLISTED_BALANCE_ID_DUE_TO_NEGATIVE_FEE_RECOVERY_AMOUNT';
    const BAD_REQUEST_FEE_CREDITS_INSUFFICIENT                                      = 'BAD_REQUEST_FEE_CREDITS_INSUFFICIENT';
    const BAD_REQUEST_AMOUNT_CREDITS_INSUFFICIENT                                   = 'BAD_REQUEST_AMOUNT_CREDITS_INSUFFICIENT';
    ...
    const BAD_REQUEST_BALANCE_NOT_FOUND                                             = 'BAD_REQUEST_BALANCE_NOT_FOUND';
    ...
    const BAD_REQUEST_FEE_RECOVERY_SCHEDULE_NOT_ELIGIBLE                            = 'BAD_REQUEST_FEE_RECOVERY_SCHEDULE_NOT_ELIGIBLE';
    const BAD_REQUEST_WRONG_FEE_RECOVERY_SCHEDULE_ACTION_SPECIFIED                  = 'BAD_REQUEST_WRONG_FEE_RECOVERY_SCHEDULE_ACTION_SPECIFIED';
    const BAD_REQUEST_LOGIC_ERROR_FEE_RECOVERY_ENTITY_MISSING                       = 'BAD_REQUEST_LOGIC_ERROR_FEE_RECOVERY_ENTITY_MISSING';
    ...
    const BAD_REQUEST_WALLET_PAYMENT_PENDING                                        = 'BAD_REQUEST_WALLET_PAYMENT_PENDING';
    ...
    const BAD_REQUEST_PAYMENT_UPI_AMOUNT_LIMIT_EXCEEDED                             = 'BAD_REQUEST_PAYMENT_UPI_AMOUNT_LIMIT_EXCEEDED';
    ...
    const BAD_REQUEST_CARD_MANDATE_CUSTOMER_APPROVED_AFTER_TAT                      = 'BAD_REQUEST_CARD_MANDATE_CUSTOMER_APPROVED_AFTER_TAT';
    const BAD_REQUEST_DUMMY_PAYMENT                                                 = 'BAD_REQUEST_DUMMY_PAYMENT';
    ...
    const BAD_REQUEST_ADMIN_ANOTHER_USER_CREATION_IN_PROGRESS                       = 'BAD_REQUEST_ADMIN_ANOTHER_USER_CREATION_IN_PROGRESS';
    ...
    const BAD_REQUEST_CONTACT_NAME_MISMATCH_WITH_MAPPED_VPA                         = 'BAD_REQUEST_CONTACT_NAME_MISMATCH_WITH_MAPPED_VPA';
    ...
    const BAD_REQUEST_PAYMENT_UPI_INVALID_LINKED_NUMBER                             = 'BAD_REQUEST_PAYMENT_UPI_INVALID_LINKED_NUMBER';
    ...
    const BAD_REQUEST_PAYMENT_GIFT_CARD_NOT_SUPPORTED                               = 'BAD_REQUEST_PAYMENT_GIFT_CARD_NOT_SUPPORTED';
    ...
    const BAD_REQUEST_OFFERS_ENGINE_DISCOUNT_MISMATCH                               = 'BAD_REQUEST_OFFERS_ENGINE_DISCOUNT_MISMATCH';
    ...
    const BAD_REQUEST_PAYMENT_PRICING_ISSUE                                         = 'BAD_REQUEST_PAYMENT_PRICING_ISSUE';
    ...
    const BAD_REQUEST_PAYMENT_UNDER_DISPUTE                                         = 'BAD_REQUEST_PAYMENT_UNDER_DISPUTE';
    ...
    const BAD_REQUEST_REFUND_BLOCKED_FOR_SMART_COLLECT_PAYMENTS                     = 'BAD_REQUEST_REFUND_BLOCKED_FOR_SMART_COLLECT_PAYMENTS';
    ...
    const BAD_REQUEST_INTERNATIONAL_NOT_ALLOWED_FOR_PRODUCTS_PA_CB                  = 'BAD_REQUEST_INTERNATIONAL_NOT_ALLOWED_FOR_PRODUCTS_PA_CB';
    ...
    const SERVER_ERROR_PGOS_PROCESSNG_FAILED                                        = 'SERVER_ERROR_PGOS_PROCESSNG_FAILED';
    ...
    const BAD_REQUEST_PAYOUT_NOT_ON_HOLD                                            = 'BAD_REQUEST_PAYOUT_NOT_ON_HOLD';
    ...
    const BAD_REQUEST_RISK_FEATURE_ALREADY_ENABLED                                  = 'BAD_REQUEST_RISK_FEATURE_ALREADY_ENABLED';
    const BAD_REQUEST_RISK_FEATURE_NOT_ENABLED                                      = 'BAD_REQUEST_RISK_FEATURE_NOT_ENABLED';
    ...
    const BAD_REQUEST_QR_CODE_INVALID_ORDER_ID                                      = 'BAD_REQUEST_QR_CODE_INVALID_ORDER_ID';
    ...
    const BAD_REQUEST_VIRTUAL_ACCOUNT_ADD_ALLOWED_PAYER_NOT_ALLOWED_RBL             = 'BAD_REQUEST_VIRTUAL_ACCOUNT_ADD_ALLOWED_PAYER_NOT_ALLOWED_RBL';
    ...
    const BAD_REQUEST_CLOSE_DYNAMIC_QR_CODE_FAILURE                                 = 'BAD_REQUEST_CLOSE_DYNAMIC_QR_CODE_FAILURE';
    ...
    const BAD_REQUEST_QR_REFACTOR_EXPERIMENT_NOT_ENABLED_FOR_GATEWAY                = 'BAD_REQUEST_QR_REFACTOR_EXPERIMENT_NOT_ENABLED_FOR_GATEWAY';
    const BAD_REQUEST_QR_STRING_TR_EMPTY_ERROR                                      = 'BAD_REQUEST_QR_STRING_TR_EMPTY_ERROR';
    ...
    const BAD_REQUEST_INVALID_FEE_BEARER                                            = 'BAD_REQUEST_INVALID_FEE_BEARER';
    ...
    const BAD_REQUEST_VA_CREATION_BLOCKED_FOR_RBL_MERCHANTS                         = 'BAD_REQUEST_VA_CREATION_BLOCKED_FOR_RBL_MERCHANTS';
    const BAD_REQUEST_VA_CLOSE_BLOCKED_FOR_RBL_MERCHANTS                            = 'BAD_REQUEST_VA_CLOSE_BLOCKED_FOR_RBL_MERCHANTS';
    ...
    const BAD_REQUEST_MERCHANT_LOGO_NOT_RECTANGLE                                   = 'BAD_REQUEST_MERCHANT_LOGO_NOT_RECTANGLE';
    ...
    const BAD_REQUEST_VENDOR_ID_REQUIRED                                            = 'BAD_REQUEST_VENDOR_ID_REQUIRED';
    const BAD_REQUEST_INVALID_FUND_ACCOUNT                                          = 'BAD_REQUEST_INVALID_FUND_ACCOUNT';
    const BAD_REQUEST_VENDOR_CONTACT_CREATION_NOT_PERMITTED                         = 'BAD_REQUEST_VENDOR_CONTACT_CREATION_NOT_PERMITTED';
    const BAD_REQUEST_VENDOR_CONTACT_UPDATION_NOT_PERMITTED                        = 'BAD_REQUEST_VENDOR_CONTACT_UPDATION_NOT_PERMITTED';
    ...
    const BAD_REQUEST_EMAIL_OTP_VERIFICATION_THRESHOLD_EXHAUSTED                    = 'BAD_REQUEST_EMAIL_OTP_VERIFICATION_THRESHOLD_EXHAUSTED';
    ...
    const SERVER_ERROR_TXN_DB_SAVE_DENIED                                            = 'SERVER_ERROR_TXN_DB_SAVE_DENIED';
    ...
    const BAD_REQUEST_FTA_ALREADY_BEING_PROCESSED                                   = 'BAD_REQUEST_FTA_ALREADY_BEING_PROCESSED';

    const BAD_REQUEST_VIRTUAL_ACCOUNT_PROCESSING_ANOTHER_OPERATION_IN_PROGRESS      = 'BAD_REQUEST_VIRTUAL_ACCOUNT_PROCESSING_ANOTHER_OPERATION_IN_PROGRESS';
    ...
    const BAD_REQUEST_PAYMENT_TRANSFER_FAILED                                       = 'BAD_REQUEST_PAYMENT_TRANSFER_FAILED';
    ...
    const BAD_REQUEST_TRANSFER_ASYNC_BALANCE_UPDATE_IN_PROGRESS                     = 'BAD_REQUEST_TRANSFER_ASYNC_BALANCE_UPDATE_IN_PROGRESS';
    const BAD_REQUEST_TRANSFER_TXN_CREATION_PROCESS_IN_PROGRESS                     = 'BAD_REQUEST_TRANSFER_TXN_CREATION_PROCESS_IN_PROGRESS';
    const BAD_REQUEST_TRANSFER_CREATION_IN_PROGRESS                                 = 'BAD_REQUEST_TRANSFER_CREATION_IN_PROGRESS';
    ...
    const BAD_REQUEST_TRANSFER_NOT_ALLOWED_FOR_OPTIMIZER_EXTERNAL_GATEWAYS         = 'BAD_REQUEST_TRANSFER_NOT_ALLOWED_FOR_OPTIMIZER_EXTERNAL_GATEWAYS';
    ...
    const BAD_REQUEST_EMAIL_ASSOCIATED_WITH_NON_ORPHAN_USERS                        = 'BAD_REQUEST_EMAIL_ASSOCIATED_WITH_NON_ORPHAN_USERS';
    const BAD_REQUEST_MOBILE_ASSOCIATED_WITH_NON_ORPHAN_USERS                       = 'BAD_REQUEST_MOBILE_ASSOCIATED_WITH_NON_ORPHAN_USERS';
    ...
    const BAD_REQUEST_INVALID_FIELD_TYPE                                            = 'BAD_REQUEST_INVALID_FIELD_TYPE';
    ...
    const BAD_REQUEST_INVITATION_USER_ALREADY_INVITED_FOR_PHONE                     = 'BAD_REQUEST_INVITATION_USER_ALREADY_INVITED_FOR_PHONE';
    const BAD_REQUEST_INVITATION_USER_ALREADY_MEMBER_FOR_PHONE                      = 'BAD_REQUEST_INVITATION_USER_ALREADY_MEMBER_FOR_PHONE';
    ...
    const BAD_REQUEST_INVITATION_DETAILS_FIRST_NAME_MISSING                         = 'BAD_REQUEST_INVITATION_DETAILS_FIRST_NAME_MISSING';
    const BAD_REQUEST_INVITATION_DETAILS_LAST_NAME_MISSING                          = 'BAD_REQUEST_INVITATION_DETAILS_LAST_NAME_MISSING';
    ...
    const BAD_REQUEST_MODE_NOT_ALLOWED_FOR_MOBILE_NUMBER                            = 'BAD_REQUEST_MODE_NOT_ALLOWED_FOR_MOBILE_NUMBER';

    const BAD_REQUEST_MOBILE_NUMBER_NOT_PRESENT                                    = 'BAD_REQUEST_MOBILE_NUMBER_NOT_PRESENT';
    const BAD_REQUEST_ACCOUNT_HOLDER_NAME_NOT_PRESENT                              = 'BAD_REQUEST_ACCOUNT_HOLDER_NAME_NOT_PRESENT';
    const BAD_REQUEST_MOBILE_NUMBER_INVALID                                        = 'BAD_REQUEST_MOBILE_NUMBER_INVALID';

    const BAD_REQUEST_MOBILE_NUMBER_PAYOUT_NOT_ALLOWED                             = 'BAD_REQUEST_MOBILE_NUMBER_PAYOUT_NOT_ALLOWED';
    ...
    const BAD_REQUEST_EXTERNAL_OFFER_NOT_FOUND                                      = 'BAD_REQUEST_EXTERNAL_OFFER_NOT_FOUND';
    const BAD_REQUEST_BULK_OFFER_MERCHANT_LIMIT_EXCEEDED                            = 'BAD_REQUEST_BULK_OFFER_MERCHANT_LIMIT_EXCEEDED';
    ...
    const BAD_REQUEST_PAYMENT_CAPTURE_MORE_THAN_2_DAYS                              = 'BAD_REQUEST_PAYMENT_CAPTURE_MORE_THAN_2_DAYS';
    ...
    const BAD_REQUEST_LINKED_ACCOUNT_CREATION_BLOCKED_FOR_VAS_MERCHANT              = 'BAD_REQUEST_LINKED_ACCOUNT_CREATION_BLOCKED_FOR_VAS_MERCHANT';
    ...
    const BAD_REQUEST_INVALID_PARTNER_CONFIG_ENTITY_TYPE                            = 'BAD_REQUEST_INVALID_PARTNER_CONFIG_ENTITY_TYPE';
    ...
    const BAD_REQUEST_PURE_PLATFORM_TO_RESELLER_MIGRATION_IN_PROGRESS               = 'BAD_REQUEST_PURE_PLATFORM_TO_RESELLER_MIGRATION_IN_PROGRESS';

    const BAD_REQUEST_SET_DEFAULT_METHODS_ALREADY_IN_PROGRESS                       = 'BAD_REQUEST_SET_DEFAULT_METHODS_ALREADY_IN_PROGRESS';

    const BAD_REQUEST_PRODUCT_CONFIG_ALREADY_IN_PROGRESS                            = 'BAD_REQUEST_PRODUCT_CONFIG_ALREADY_IN_PROGRESS';
    ...
    const BAD_REQUEST_EXPECTED_FUND_ACCOUNT_TYPE_NOT_PRESENT                       = 'BAD_REQUEST_EXPECTED_FUND_ACCOUNT_TYPE_NOT_PRESENT';
    ...
    const SERVER_ERROR_CHECKOUT_AFFORDABILITY_SERVICE_FAILURE                                 = 'SERVER_ERROR_CHECKOUT_AFFORDABILITY_SERVICE_FAILURE';
    const SERVER_ERROR_CORE_PAYMENT_SERVICE_TIMEOUT                                 = 'SERVER_ERROR_CORE_PAYMENT_SERVICE_TIMEOUT';

    const SERVER_ERROR_CHECKOUT_AFFORDABILITY_SERVICE_TIMEOUT                                 = 'SERVER_ERROR_CHECKOUT_AFFORDABILITY_SERVICE_TIMEOUT';
    ...
    const BAD_REQUEST_FUND_ACCOUNT_OPERATION_IN_PROGRESS                            = 'BAD_REQUEST_FUND_ACCOUNT_OPERATION_IN_PROGRESS';
    const BAD_REQUEST_CONTACT_OPERATION_IN_PROGRESS                                 = 'BAD_REQUEST_CONTACT_OPERATION_IN_PROGRESS';
    ...
    const BAD_REQUEST_ONDEMAND_SETTLEMENT_LIMIT_EXHAUSTED                       = 'BAD_REQUEST_ONDEMAND_SETTLEMENT_LIMIT_EXHAUSTED';
    ...
    const BAD_REQUEST_FUND_ACCOUNT_VALIDATION_NOT_FOUND                             = 'BAD_REQUEST_FUND_ACCOUNT_VALIDATION_NOT_FOUND';

    const BAD_REQUEST_SMART_SETTLEMENTS_NOT_ENABLED                                 = 'BAD_REQUEST_SMART_SETTLEMENTS_NOT_ENABLED';
    const BAD_REQUEST_AMOUNT_LESS_THAN_MIN_SMART_SETTLEMENT_AMOUNT                  = 'BAD_REQUEST_AMOUNT_LESS_THAN_MIN_SMART_SETTLEMENT_AMOUNT';

    const BAD_REQUEST_AMOUNT_LESS_THAN_MAX_SMART_SETTLEMENT_AMOUNT                  = 'BAD_REQUEST_AMOUNT_LESS_THAN_MAX_SMART_SETTLEMENT_AMOUNT';

    const BAD_REQUEST_SMART_SETTLEMENT_WINDOW_NOT_OPEN                              =  'BAD_REQUEST_SMART_SETTLEMENT_WINDOW_NOT_OPEN';
    ...
    const SERVER_ERROR_CARD_METADATA_CACHE_FETCH_FAILED                             = 'SERVER_ERROR_CARD_METADATA_CACHE_FETCH_FAILED';
    const SERVER_ERROR_CARD_METADATA_CACHE_FAILED                                   = 'SERVER_ERROR_CARD_METADATA_CACHE_FAILED';
    ...
    const BAD_REQUEST_MERCHANT_IS_ALREADY_ASSIGNED_TO_SOME_OTHER_PARTNER_AGENT      = 'BAD_REQUEST_MERCHANT_IS_ALREADY_ASSIGNED_TO_SOME_OTHER_PARTNER_AGENT';
    const BAD_REQUEST_OWNER_MERCHANT_USER_NOT_FOUND                                 = 'BAD_REQUEST_OWNER_MERCHANT_USER_NOT_FOUND';
    ...
    const BAD_REQUEST_SOURCE_ACCOUNT_ADDITION_FAILURE                               = 'BAD_REQUEST_SOURCE_ACCOUNT_ADDITION_FAILURE';
    const BAD_REQUEST_SOURCE_ACCOUNT_ADDITION_IN_PROGRESS                           = 'BAD_REQUEST_SOURCE_ACCOUNT_ADDITION_IN_PROGRESS';

    const BAD_REQUEST_MERCHANT_NOT_ON_LEDGER_REVERSE_SHADOW  = 'BAD_REQUEST_MERCHANT_NOT_ON_LEDGER_REVERSE_SHADOW';
    const BAD_REQUEST_MERCHANT_HAS_CREDIT_SELF_SERVICE_ENABLED = 'BAD_REQUEST_MERCHANT_HAS_CREDIT_SELF_SERVICE_ENABLED';
    const BAD_REQUEST_MERCHANT_HAS_CREDIT_SELF_SERVICE_DISABLED = 'BAD_REQUEST_MERCHANT_HAS_CREDIT_SELF_SERVICE_DISABLED';
    ...
    const BAD_REQUEST_RESERVE_BALANCE_NOT_FOUND_FOR_FUND_WITHDRAWAL                 = 'BAD_REQUEST_RESERVE_BALANCE_NOT_FOUND_FOR_FUND_WITHDRAWAL';
    const BAD_REQUEST_INSUFFICIENT_BALANCE_FOR_FUND_WITHDRAWAL                      = 'BAD_REQUEST_INSUFFICIENT_BALANCE_FOR_FUND_WITHDRAWAL';
    ...
    const BAD_REQUEST_EMPTY_FILE_UPLOADED                                           = 'BAD_REQUEST_EMPTY_FILE_UPLOADED';
    ...
    const SERVER_ERROR_MERCHANT_VERIFICATION_UPSERT_FAILED                           = 'SERVER_ERROR_MERCHANT_VERIFICATION_UPSERT_FAILED';
    ...
    const BAD_REQUEST_RESTRICT_ONE_PAYMENT_TO_AN_ORDER                             = 'BAD_REQUEST_RESTRICT_ONE_PAYMENT_TO_AN_ORDER';
    ...
    const BAD_REQUEST_ENABLE_COMMISSION_NOT_ALLOWED                                = 'BAD_REQUEST_ENABLE_COMMISSION_NOT_ALLOWED';
    ...
    const BAD_REQUEST_LINKED_ACCOUNT_UPDATE_BLOCKED_WITHOUT_2FA                    = 'BAD_REQUEST_LINKED_ACCOUNT_UPDATE_BLOCKED_WITHOUT_2FA';
    ...
    const BAD_REQUEST_CRYPTOGRAM_NO_LONGER_SUPPORTED                               = 'BAD_REQUEST_CRYPTORAM_NO_LONGER_SUPPORTED';
    ...
    const BAD_REQUEST_DEVICE_ID_REQUIRED                                           = 'BAD_REQUEST_DEVICE_ID_REQUIRED';
    const BAD_REQUEST_QR_CODE_NOT_FOUND                                            = 'BAD_REQUEST_QR_CODE_NOT_FOUND';
    ...
    const BAD_REQUEST_SPLIT_PAYMENT_ORDER_AMOUNT_MISMATCH                          = 'BAD_REQUEST_SPLIT_PAYMENT_ORDER_AMOUNT_MISMATCH';
    const GATEWAY_ERROR_SPLIT_PAYMENT_NOT_AUTHORIZED                                 = 'GATEWAY_ERROR_SPLIT_PAYMENT_NOT_AUTHORIZED';
    const BAD_REQUEST_SPLIT_PAYMENT_NOT_ALLOWED                                    = 'BAD_REQUEST_SPLIT_PAYMENT_NOT_ALLOWED';
    const BAD_REQUEST_QR_CODE_CREATE_KOTAK                                         = 'BAD_REQUEST_QR_CODE_CREATE_KOTAK';
    const BAD_REQUEST_QR_CODE_CREATE_HDFC                                          = 'BAD_REQUEST_QR_CODE_CREATE_HDFC';

    const SERVER_ERROR_DCS_SERVICE_PAYOUT_MODE_CONFIG_FETCH_FAILURE                = 'SERVER_ERROR_DCS_SERVICE_PAYOUT_MODE_CONFIG_FETCH_FAILURE';

    const SERVER_ERROR_KMS_WORKFLOW_FAILURE                                         = 'SERVER_ERROR_KMS_WORKFLOW_FAILURE';
    ...
    // VAS Pricing Error Codes
    const SERVER_ERROR_MERCHANT_ENTITY_FETCH_FAILED                                = 'SERVER_ERROR_MERCHANT_ENTITY_FETCH_FAILED';
    const SERVER_ERROR_FAILED_TO_CREATE_CALCULATOR                                 = 'SERVER_ERROR_FAILED_TO_CREATE_CALCULATOR';
    ...
    const BAD_REQUEST_PARTNER_COBRANDED_ONBOARDING_NOT_ENABLED                      = 'BAD_REQUEST_PARTNER_COBRANDED_ONBOARDING_NOT_ENABLED';
    ...
    // intl bank transfer
    const BAD_REQUEST_INVALID_PURPOSE_CODE_FOR_INTL_PAYMENTS                        = 'BAD_REQUEST_INVALID_PURPOSE_CODE_FOR_INTL_PAYMENTS';
    const BAD_REQUEST_INTERNATIONAL_NOT_ENABLED_FOR_INTL_BANK_TRANSFER              = 'BAD_REQUEST_INTERNATIONAL_NOT_ENABLED_FOR_INTL_BANK_TRANSFER';
    const BAD_REQUEST_TERMS_AND_CONDITIONS_NOT_CHECKED                              = 'BAD_REQUEST_TERMS_AND_CONDITIONS_NOT_CHECKED';
    const GATEWAY_ERROR_VIRTUAL_ACCOUNT_CREATION_FAILED                             = 'GATEWAY_ERROR_VIRTUAL_ACCOUNT_CREATION_FAILED';
    const BAD_REQUEST_UNABLE_TO_ASSIGN_PRICING_PLAN_FOR_B2B_EXPORT                  = 'BAD_REQUEST_UNABLE_TO_ASSIGN_PRICING_PLAN_FOR_B2B_EXPORT';
    const GATEWAY_ERROR_MERCHANT_ACCOUNT_THROTTLED                                  = 'GATEWAY_ERROR_MERCHANT_ACCOUNT_THROTTLED';
    const GATEWAY_ERROR_INTL_BANK_TRANSFER_ACCOUNT_DOES_NOT_EXIST                   = 'GATEWAY_ERROR_INTL_BANK_TRANSFER_ACCOUNT_DOES_NOT_EXIST';
    ...
    const BAD_REQUEST_EDD_STATUS_NOT_VERIFIED                                       = 'BAD_REQUEST_EDD_STATUS_NOT_VERIFIED';
    ...
    const BAD_REQUEST_GIFT_CARDS_INSUFFICIENT_BALANCE                  = 'BAD_REQUEST_GIFT_CARDS_INSUFFICIENT_BALANCE';
    const BAD_REQUEST_QR_CODE_REFERENCE_REQUIRED = 'BAD_REQUEST_QR_CODE_REFERENCE_REQUIRED' ;
    const BAD_REQUEST_PAYMENT_OTM_MANDATE_ALREADY_CONFIRMED                         = 'BAD_REQUEST_PAYMENT_OTM_MANDATE_ALREADY_CONFIRMED';

    // IRCTC RDS Balance update errors
    const BAD_REQUEST_RDS_BALANCE_UPDATE_IN_PROGRESS                   = 'BAD_REQUEST_RDS_BALANCE_UPDATE_IN_PROGRESS';
    ...
    const BANK_TRANSFER_REQUEST_NOT_FOUND = 'BANK_TRANSFER_REQUEST_NOT_FOUND';

    const MANUAL_SMART_COLLECT_ENTITY_CREATION_FAILED = 'MANUAL_SMART_COLLECT_ENTITY_CREATION_FAILED';

    // NPCI-RZP_internal_error_code
    const BAD_REQUEST_MINOR_ACCOUNT_NOT_ALLOWED = 'BAD_REQUEST_MINOR_ACCOUNT_NOT_ALLOWED';
    const BAD_REQUEST_NRE_ACCOUNT_NOT_ALLOWED = 'BAD_REQUEST_NRE_ACCOUNT_NOT_ALLOWED';
    const BAD_REQUEST_INVALID_MOBILE_NUMBER = 'BAD_REQUEST_INVALID_MOBILE_NUMBER';
    const BAD_REQUEST_CUST_VIEW_ONLY_RIGHTS_NB = 'BAD_REQUEST_CUST_VIEW_ONLY_RIGHTS_NB';
    const BAD_REQUEST_PAYMENT_INVALID_AADHAR_OTP = 'BAD_REQUEST_PAYMENT_INVALID_AADHAR_OTP';
    const BAD_REQUEST_PAYMENT_INVALID_DB_CARD = 'BAD_REQUEST_PAYMENT_INVALID_DB_CARD';
    const BAD_REQUEST_PAYMENT_OTP_MAX_LIMIT_EXCEEDED = 'BAD_REQUEST_PAYMENT_OTP_MAX_LIMIT_EXCEEDED';
    const BAD_REQUEST_REGISTRATION_CANCELLED_BY_CUSTOMER = 'BAD_REQUEST_REGISTRATION_CANCELLED_BY_CUSTOMER';
    const BAD_REQUEST_INVALID_PAYMENT_MODE = 'BAD_REQUEST_INVALID_PAYMENT_MODE';
    const BAD_REQUEST_PAYMENT_OTP_FAILED = 'BAD_REQUEST_PAYMENT_OTP_FAILED';
    const BAD_REQUEST_EMANDATE_REGISTRATION_DEBITCARD_ACTION_NEEDED = 'BAD_REQUEST_EMANDATE_REGISTRATION_DEBITCARD_ACTION_NEEDED';
    const GATEWAY_ERROR_ISSUER_DOWN_TRY_LATER = 'GATEWAY_ERROR_ISSUER_DOWN_TRY_LATER';
    const BAD_REQUEST_PAYMENT_KYC_PENDING_AADHAR = 'BAD_REQUEST_PAYMENT_KYC_PENDING_AADHAR';
    const BAD_REQUEST_PAYMENT_KYC_PENDING_CUST_ID = 'BAD_REQUEST_PAYMENT_KYC_PENDING_CUST_ID';
    const BAD_REQUEST_EMANDATE_REGISTRATION_AADHAROTP_ACTION_NEEDED = 'BAD_REQUEST_EMANDATE_REGISTRATION_AADHAROTP_ACTION_NEEDED';
    const BAD_REQUEST_PAYMENT_KYC_PENDING_PANNUM = 'BAD_REQUEST_PAYMENT_KYC_PENDING_PANNUM';
    const BAD_REQUEST_PAYMENT_KYC_PENDING_PAN_UPDATE_REQ = 'BAD_REQUEST_PAYMENT_KYC_PENDING_PAN_UPDATE_REQ';
    const BAD_REQUEST_PAYMENT_INVALID_NETB_ACCOUNT = 'BAD_REQUEST_PAYMENT_INVALID_NETB_ACCOUNT';
    const BAD_REQUEST_PAYMENT_KYC_PENDING_AADHAR_LINK = 'BAD_REQUEST_PAYMENT_KYC_PENDING_AADHAR_LINK';
    const BAD_REQUEST_PAYMENT_KYC_PENDING_AADHAR_NUM = 'BAD_REQUEST_PAYMENT_KYC_PENDING_AADHAR_NUM';
    const BAD_REQUEST_PAYMENT_INVALID_ACCOUNT_BANK_REACTIV_REQ = 'BAD_REQUEST_PAYMENT_INVALID_ACCOUNT_BANK_REACTIV_REQ' ;
    const GATEWAY_ERROR_ISSUER_DOWN_OTP_RETRY = 'GATEWAY_ERROR_ISSUER_DOWN_OTP_RETRY';
    const GATEWAY_ERROR_ISSUER_DOWN_OTP_INVALID = 'GATEWAY_ERROR_ISSUER_DOWN_OTP_INVALID';
    const BAD_REQUEST_PAYMENT_ACCOUNT_WITHDRAWAL_FROZEN_A = 'BAD_REQUEST_PAYMENT_ACCOUNT_WITHDRAWAL_FROZEN_A';
    const BAD_REQUEST_PAYMENT_INVALID_ACCOUNT_CLOSED = 'BAD_REQUEST_PAYMENT_INVALID_ACCOUNT_CLOSED';
    const BAD_REQUEST_PAYMENT_ACCOUNT_WITHDRAWAL_FROZEN_B = 'BAD_REQUEST_PAYMENT_ACCOUNT_WITHDRAWAL_FROZEN_B';
    const BAD_REQUEST_PAYMENT_INVALID_ACCOUNT_INACTIVE = 'BAD_REQUEST_PAYMENT_INVALID_ACCOUNT_INACTIVE';
    const BAD_REQUEST_PAYMENT_KYC_PENDING_VISIT_BANK = 'BAD_REQUEST_PAYMENT_KYC_PENDING';
    const BAD_REQUEST_PAYMENT_INVALID_ACCOUNT_HOLDER_NAME_MISMATCH = 'BAD_REQUEST_PAYMENT_INVALID_ACCOUNT_HOLDER_NAME_MISMATCH';
    const BAD_REQUEST_PAYMENT_INVALID_ACCOUNT_AADHAR_MISMATCH = 'BAD_REQUEST_PAYMENT_INVALID_ACCOUNT_AADHAR_MISMATCH';
    const BAD_REQUEST_PAYMENT_ACCOUNT_MAX_LIMIT_EXCEEDED_A = 'BAD_REQUEST_PAYMENT_ACCOUNT_MAX_LIMIT_EXCEEDED_A';
    const BAD_REQUEST_PAYMENT_INVALID_ACCOUNT_EMAIL_MOBNUM = 'BAD_REQUEST_PAYMENT_INVALID_ACCOUNT_EMAIL_MOBNUM';
    const BAD_REQUEST_PAYMENT_INVALID_ACCOUNT_MOB_NUM = 'BAD_REQUEST_PAYMENT_INVALID_ACCOUNT_MOB_NUM';
    const BAD_REQUEST_PAYMENT_INVALID_ACCOUNT_EMAIL_MOBNUM_B = 'BAD_REQUEST_PAYMENT_INVALID_ACCOUNT_EMAIL_MOBNUM_B';
    const BAD_REQUEST_PAYMENT_LOCKED_ACCOUNT_A = 'BAD_REQUEST_PAYMENT_LOCKED_ACCOUNT_A';
    const BAD_REQUEST_PAYMENT_LOCKED_ACCOUNT_B = 'BAD_REQUEST_PAYMENT_LOCKED_ACCOUNT_B';
    const BAD_REQUEST_PAYMENT_ACCOUNT_MAX_LIMIT_EXCEEDED_B = 'BAD_REQUEST_PAYMENT_ACCOUNT_MAX_LIMIT_EXCEEDED_B';
    const BAD_REQUEST_PAYMENT_INVALID_CURRENCY_OR_AMOUNT = 'BAD_REQUEST_PAYMENT_INVALID_CURRENCY_OR_AMOUNT';
    const BAD_REQUEST_MERCHANT_NOT_COLLECTX = 'BAD_REQUEST_MERCHANT_NOT_COLLECTX';

    const BAD_REQUEST_PAYMENT_ID_REQUIRED_FOR_COLLECTX_REFUND_PAYOUT = 'BAD_REQUEST_PAYMENT_ID_REQUIRED_FOR_COLLECTX_REFUND_PAYOUT';

    const BAD_REQUEST_NO_DIRECT_ACCOUNT_FOUND = 'BAD_REQUEST_NO_DIRECT_ACCOUNT_FOUND';

    const BAD_REQUEST_CHANNEL_NOT_FOUND_FOR_PAYMENT_ID = 'BAD_REQUEST_CHANNEL_NOT_FOUND_FOR_PAYMENT_ID';

    const BAD_REQUEST_PAYMENT_NOT_COLLECTX = 'BAD_REQUEST_PAYMENT_NOT_COLLECTX';

    const BAD_REQUEST_ES_ON_DEMAND_DISABLED_FOR_B2B_EXPORT = 'BAD_REQUEST_ES_ON_DEMAND_DISABLED_FOR_B2B_EXPORT';
