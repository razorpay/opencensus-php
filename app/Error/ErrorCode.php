...
class ErrorCode
{
    ...
    const BAD_REQUEST_VIRTUAL_ACCOUNT_ALPHA_SANS_HANDLE                             = 'BAD_REQUEST_VIRTUAL_ACCOUNT_ALPHA_SANS_HANDLE';
    const BAD_REQUEST_VIRTUAL_ACCOUNT_DESCRIPTOR_WITH_NUMERIC                       = 'BAD_REQUEST_VIRTUAL_ACCOUNT_DESCRIPTOR_WITH_NUMERIC';
