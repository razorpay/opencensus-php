...
class ErrorCode
{
    ...
    const BAD_REQUEST_PARTNER_SUBMERCHANT_NOT_FOUND                                 = 'BAD_REQUEST_PARTNER_SUBMERCHANT_NOT_FOUND';
    const BAD_REQUEST_LINKED_ACCOUNT_CANNOT_BE_PARTNER                              = 'BAD_REQUEST_LINKED_ACCOUNT_CANNOT_BE_PARTNER';
    const BAD_REQUEST_PARTNER_SUBMERCHANT_ALREADY_EXISTS                            = 'BAD_REQUEST_PARTNER_SUBMERCHANT_ALREADY_EXISTS';
}
