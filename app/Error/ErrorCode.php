...
class ErrorCode
{
    ...
    const GATEWAY_ERROR_INVALID_ACCOUNT_SECRET_ID                                   = 'GATEWAY_ERROR_INVALID_ACCOUNT_SECRET_ID';
...
// Payment bad requests
    ...
    const BAD_REQUEST_PAYMENT_ALREADY_CANCELLED                                     = 'BAD_REQUEST_PAYMENT_ALREADY_CANCELLED';
    ...
    const BAD_REQUEST_PAYMENT_REFUND_LESS_THAN_TWENTYONE                            = 'BAD_REQUEST_PAYMENT_REFUND_AMOUNT_GREATER_THAN_CAPTURED';
    const BAD_REQUEST_PAYMENT_REFUND_AFTER_EIGHTY_DAYS                              = 'BAD_REQUEST_PAYMENT_REFUND_AFTER_EIGHTY_DAYS';
    ...
    const BAD_REQUEST_PAYMENT_AMOUNT_CANNOT_BE_CANCELLED                            = 'BAD_REQUEST_PAYMENT_AMOUNT_CANNOT_BE_CANCELLED';
