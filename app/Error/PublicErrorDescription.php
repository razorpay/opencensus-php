...
class PublicErrorDescription
{
    ...
    const BAD_REQUEST_ORDER_RECEIPT_REQUIRED                                    = 'Please provide a receipt id for the order.';
    const BAD_REQUEST_ORDER_RECEIPT_NOT_UNIQUE                                  = 'Please provide a unique receipt id for the order.';
