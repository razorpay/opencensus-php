...
class PublicErrorDescription
{
    ...
    const BAD_REQUEST_PAYMENT_CARD_AUTHENTICATION_NOT_AVAILABLE                 = 'Your payment could not be completed due to incorrect OTP or verification details. Try another payment method or contact your bank for details.';
    ...
    const BAD_REQUEST_DEVICE_ID_REQUIRED                                        = 'Device id is required for device dependent merchant when creating QR';
    ...
    const BAD_REQUEST_RISK_FEATURE_NOT_ENABLED                                  = 'Feature not enabled';
    ...
    const BAD_REQUEST_NO_KEYS_TO_EXPIRE                                         = 'No API Keys provided to be expired';
    ...
    const BAD_REQUEST_INVITATION_DETAILS_LAST_NAME_MISSING                      = 'Last name not present in invitation details';
    ...
    const GATEWAY_ERROR_SPLIT_PAYMENT_NOT_AUTHORIZED                                  = "Your payment didn\'t go through due to a temporary issue. Any debited amount will be refunded in 4-5 business days.";
    ...
    const GATEWAY_ERROR_INTL_BANK_TRANSFER_ACCOUNT_DOES_NOT_EXIST                     = 'Something went wrong. Please try again after some time. If the issue repeats, please reach out to our support.';
