...
class PublicErrorDescription
{
    ...
    const BAD_REQUEST_PAYMENT_VERIFICATION_BLOCKED                              = 'Payment verification with gateway failed';
    const BAD_REQUEST_PAYMENT_VERIFICATION_RETRY                                = 'Payment verification with gateway failed';
    const BAD_REQUEST_PAYMENT_VERIFICATION_SKIP                                 = 'Payment verification with gateway failed';
