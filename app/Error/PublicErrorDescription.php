...
class PublicErrorDescription
{
    ...
    const BAD_REQUEST_OFFER_INVALID_FOR_ORDER                                   = 'Offer applied not valid for order';
    const BAD_REQUEST_OFFER_INVALID_FOR_PAYMENT                                 = 'Offer not applicable on payment';
