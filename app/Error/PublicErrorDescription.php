...
class PublicErrorDescription
{
    ...
    const BAD_REQUEST_GATEWAY_TOKEN_EMPTY                                       = 'The gateway token is empty during the second recurring (debit) request';
    ...
    const BAD_REQUEST_PAYMENT_AMOUNT_GREATER_THAN_TOKEN_MAX_AMOUNT              = 'Request amount is greater than the max amount allowed by the token';
    ...
    const BAD_REQUEST_TOKEN_INVALID_RECURRING_STATUS                            = 'Invalid recurring status passed for token.';
    ...
    const BAD_REQUEST_SUBSCRIPTION_INVALID_STATUS                               = 'Invalid status passed for the subscription';
