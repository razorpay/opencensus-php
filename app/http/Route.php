...
final class Route
{
    ...
    protected static $apiRoutes = array(
        ...
        'payment_verify_previously_failed'      => ['get',      'payments/verify/failed',                   'PaymentController@getVerifyPaymentsWithPreviousVerifyResultFailed' ],
    ...
    public static $internal = array(
        ...
        'payment_verify_all',
        'payment_verify_previously_failed',
