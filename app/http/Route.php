...
final class Route
{
    ...
    protected static $apiRoutes = array(
        ...
        'merchant_create_webhook'           => ['post',     'merchants/{id}/webhooks',                  'MerchantController@postMerchantWebhook'                        ],
        'merchant_fetch_webhooks'           => ['get',      'merchants/{id}/webhooks',                  'MerchantController@getMerchantWebhooks'                        ],
        'merchant_edit_webhook'             => ['put',      'merchants/{merchantId}/webhooks/{whId}',   'MerchantController@putMerchantWebhoook'                        ],
