...
final class Route
{
    ...
    protected static $apiRoutes = array(
        ...
        'payment_otp_resend'                    => ['post',     'payments/{id}/otp_resend',                 'PaymentController@postOtpResend'                                   ],
        'payment_topup_ajax'                    => ['post',     'payments/{id}/topup/ajax',                 'PaymentController@postTopupAjax'                                   ],
        ...
        'cusotmer_saved_status'                 => ['get',      'customer/status/{contact}',                'CustomerController@fetchCustomerStatus'                            ],
        'app_delete_token'                      => ['delete',   'apps/{appId}/tokens/{token}',              'CustomerController@deleteAppToken'                                 ],
