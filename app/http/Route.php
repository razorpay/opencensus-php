...
final class Route
{
    ...
    protected static $apiRoutes = array(
        ...
        'create_customer_token'                 => ['post',     'customers/{uid}/tokens',                   'CustomerController@addToken'                                       ],
        'update_customer_token'                 => ['put',      'customers/{uid}/tokens/{mid}',             'CustomerController@updateToken'                                    ],
        'fetch_customer_token'                  => ['get',      'customers/{uid}/tokens/{mid}',             'CustomerController@fetchToken'                                     ],
        'fetch_multiple_customer_tokens'        => ['get',      'customers/{uid}/tokens',                   'CustomerController@fetchTokens'                                    ],
        'delete_customer_token'                 => ['delete',   'customers/{uid}/tokens/{mid}',             'CustomerController@deleteToken'                                    ],
        'delete_token_for_app'                  => ['delete',   'apps/{appId}/tokens/{mId}',                'CustomerController@deleteAppToken'                                 ],
