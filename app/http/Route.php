...
final class Route
{
    ...
    protected static $apiRoutes = array(
        ...
        'create_customer_method'                => ['post',     'customers/{uid}/methods',                  'CustomerController@addMethod'                                      ],
        'update_customer_method'                => ['put',      'customers/{uid}/methods/{mid}',            'CustomerController@updateMethod'                                   ],
