...
// Transaction bad requests
    const BAD_REQUEST_TRANSACTION_ALREADY_PROCCESSED                        = 'BAD_REQUEST_TRANSACTION_ALREADY_PROCCESSED';
    const BAD_REQUEST_TRANSACTION_ALREADY_CAPTURED                          = 'BAD_REQUEST_TRANSACTION_ALREADY_CAPTURED';
    const BAD_REQUEST_TRANSACTION_FULLY_REFUNDED                            = 'BAD_REQUEST_TRANSACTION_FULLY_REFUNDED';
    const BAD_REQUEST_TRANSACTION_CARD_IS_NOT_ARRAY                         = 'BAD_REQUEST_TRANSACTION_CARD_IS_NOT_ARRAY';
    const BAD_REQUEST_TRANSACTION_CAPTURE_ONLY_AUTHORIZED                   = 'BAD_REQUEST_TRANSACTION_CAPTURE_ONLY_AUTHORIZED';
    const BAD_REQUEST_TRANSACTION_CARD_NOT_PROVIDED                         = 'BAD_REQUEST_TRANSACTION_CARD_NOT_PROVIDED';
    const BAD_REQUEST_TRANSACTION_STATUS_NOT_CAPTURED                       = 'BAD_REQUEST_TRANSACTION_STATUS_NOT_CAPTURED';
    const BAD_REQUEST_TRANSACTION_FULLY_REFUNDED                            = 'BAD_REQUEST_TRANSACTION_FULLY_REFUNDED';
    ...
    const BAD_REQUEST_GATEWAY_TERMINAL_ID_EXISTS_FOR_MERCHANT               = 'BAD_REQUEST_GATEWAY_TERMINAL_ID_EXISTS_FOR_MERCHANT';
    const BAD_REQUEST_GATEWAY_MERCHANT_ID_EXISTS                            = 'BAD_REQUEST_GATEWAY_MERCHANT_ID_EXISTS';

    const BAD_REQUEST_CURRENCY_NOT_SUPPORTED                                = 'BAD_REQUEST_CURRENCY_NOT_SUPPORTED';
