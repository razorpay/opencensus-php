...
class ErrorCode
{
    ...
    const GATEWAY_CARD_MISSING_CVC                          = 'GATEWAY_CARD_MISSING_CVC';
    const GATEWAY_CARD_DECLINED                             = 'GATEWAY_CARD_DECLINED';

    /**
     * Card errors catchable in the app
     */
    const CARD_INVALID_NAME             = 'CARD_INVALID_NAME';
    const CARD_INVALID_EXPIRY_MONTH     = 'CARD_INVALID_EXPIRY_MONTH';
    const CARD_INVALID_EXPIRY_YEAR      = 'CARD_INVALID_EXPIRY_YEAR';
    const CARD_INVALID_CVC              = 'CARD_INVALID_CVC';
    const CARD_INVALID_BRAND            = 'CARD_INVALID_BRAND';
    const CARD_INVALID_AMOUNT           = 'CARD_INVALID_AMOUNT';
    const CARD_INVALID_UDF              = 'CARD_INVALID_UDF';
    const CARD_INVALID_NUMBER           = 'CARD_INVALID_NUMBER';
