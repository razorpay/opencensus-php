...
// Unauthorized bad requests
    ...
    const BAD_REQUEST_UNAUTHORIZED_SECRET_NOT_PROVIDED              = 'BAD_REQUEST_UNAUTHORIZED_INVALID_API_SECRET';
    ...
    const BAD_REQUEST_PRICING_NO_PLAN_ASSIGNED                      = 'BAD_REQUEST_PRICING_NO_PLAN_ASSIGNED';
    ...
    const BAD_REQUEST_NO_TERMINAL_ASSIGNED_TO_MERCHANT              = 'BAD_REQUEST_NO_TERMINAL_ASSIGNED_TO_MERCHANT';
