...
{   
    ...
    public function testActivationPanel()
    {
        ...
        $this->browser
            ...
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('#activation-form > fieldset:eq(4) > div > div > .alert-success').length == 1", 2000)
            ->attachFile(l::IdOrName('bussiness_pan_proof'), URL::to('/img/logo.png'))
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('#activation-form > fieldset:eq(4) > div > div > .alert-success').length == 2", 2000)
            ->attachFile(l::IdOrName('promoter_pan_proof'), URL::to('/img/logo.png'))
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('#activation-form > fieldset:eq(4) > div > div > .alert-success').length == 3", 2000)
