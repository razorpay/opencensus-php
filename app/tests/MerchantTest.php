...
{   
    ...
    public function testRegister()
    {
        $this->browser
            ...
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('form[name=\"signup\"]').length > 0", 2000)
            ...
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('.alert-success').length > 0", 2000);  
    ...
    public function testLogin()
    {
        $this->browser
            ...
            ->click(l::IdOrName('submit'))                 // Click in the button
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('.navbar').length > 0", 2000);                     // Wait for page to load
    ...
    {
        $this->browser
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('#transactionsNav').length > 0", 2000)
            ->click(l::IdOrName('transactionsNav')) 
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('.transactions-table').length > 0", 2000)
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('.alert').length == 0", 2000);    
    ...
    {
        $this->browser
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('#refundsNav').length > 0", 2000)
            ->click(l::IdOrName('refundsNav')) 
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('.refunds-table').length > 0", 2000)
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('.alert').length == 0", 2000);    
    ...
    {   
        //Testing keys display
         $this->browser
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('#keysNav').length > 0", 2000)
            ->click(l::IdOrName('keysNav')) 
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('.keys-table').length > 0", 2000)
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('.alert').length == 0", 2000);    
        ...
        $this->browser
            ...
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('.new-key-modal').length > 0", 2000);
        ...
        $this->browser
            ...
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('.confirm-modal').length > 0", 2000)
        ...
        $this->browser
            ...
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('.roll-key-modal').length > 0", 2000)    
            ->click(l::css('.modal-ok'))
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('.new-key-modal').length > 0", 2000)
            ->click(l::css('.modal-ok'))
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('.confirm-modal').length > 0", 2000)
    ...
    public function testActivationPanel()
    {
        ///Testing keys display
         $this->browser
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('#activationNav').length > 0", 2000)
            ->click(l::IdOrName('activationNav')) 
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('.activation-wrapper').length > 0", 2000)
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('.alert').length == 0", 2000);   
        ...
        $this->browser
            ...
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('form[name=\"step1\"] > fieldset > .alerts > .alert-danger').length > 0", 2000)
            ...
            ->click(l::css('form[name="step1"] > fieldset > .prev-next > .btn-save'))
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('form[name=\"step1\"] > fieldset > .alerts > .alert-success').length > 0", 2000);
        ...
        $this->browser
            ...
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('form[name=\"step2\"]').is(':visible')", 2000)
            ...
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('form[name=\"step2\"] > fieldset > .alerts > .alert-success').length > 0", 2000);
        ...
        $this->browser
            ...
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('form[name=\"step3\"]').is(':visible')", 2000)
            ...
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('form[name=\"step3\"] > fieldset > .alerts > .alert-success').length > 0", 2000);
        ...
        $this->browser
            ...
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('form[name=\"step4\"]').is(':visible')", 2000)
            ...
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('form[name=\"step4\"] > fieldset > .alerts > .alert-success').length > 0", 2000);
        ...
        $this->browser
            ...
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('form[name=\"step5\"]').is(':visible')", 2000)
            ->attachFile(l::IdOrName('bussiness_proof'), URL::to('/img/logo.png'))
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('form[name=\"step5\"] > fieldset > div > div > .alerts > .alert-success').length == 1", 2000)
            ->attachFile(l::IdOrName('bussiness_pan_proof'), URL::to('/img/logo.png'))
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('form[name=\"step5\"] > fieldset > div > div > .alerts > .alert-success').length == 2", 2000)
            ->attachFile(l::IdOrName('promoter_pan_proof'), URL::to('/img/logo.png'))
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('form[name=\"step5\"] > fieldset > div > div > .alerts > .alert-success').length == 3", 2000)
            ->attachFile(l::IdOrName('address_proof'), URL::to('/img/logo.png'))
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('form[name=\"step5\"] > fieldset > div > div > .alerts > .alert-success').length == 4", 2000)
            ->click(l::css('form[name="step5"] > fieldset > .prev-next > .btn-save'))
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('form[name=\"step5\"] > fieldset > .alerts > .alert-success').length > 0", 2000);
        ...
        $this->browser
            ...
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('form[name=\"step6\"]').is(':visible')", 2000)
            ->click(l::IdOrName('agree_terms'))
            ->click(l::css('.btn-submit'))
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('form[name=\"step6\"] > fieldset > .alerts > .alert-success').length > 0", 2000)
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('.activation-wrapper > .alerts > .alert-info').length > 0", 2000);
    ...
    public function testProfilePanel()
    {
        ...
        $this->browser
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('#profileNav').length > 0", 2000)
            ->click(l::IdOrName('profileNav')) 
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('.profile-wrapper').length > 0", 2000)
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('.alert').length == 0", 2000);    
        ...
        $this->browser
            ...
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('.change-pwd-modal').length > 0", 2000)
    ...
    {
        $this->browser
            ->waitForCondition("selenium.browserbot.getCurrentWindow().$('.user-dropdown').length > 0", 2000)
