...
class TraceCode extends \Razorpay\Trace\TraceCode
{
    ...
    const ORDER_NOTIFY_REQUEST_FOR_PAYMENT_V2                   = 'ORDER_NOTIFY_REQUEST_FOR_PAYMENT_LINK_V2';
    const MERCHANT_CACHE_EVICTION_REQUEST_FOR_PAYMENT_LINK_V2   = 'MERCHANT_CACHE_EVICTION_REQUEST_FOR_PAYMENT_LINK_V2';
    const ORDER_NOTIFY_REQUEST_PARAMS_FOR_PAYMENT_V2            = 'ORDER_NOTIFY_REQUEST_PARAMS_FOR_PAYMENT_LINK_V2';
    const ORDER_NOTIFY_RESPONSE_FOR_PAYMENT_V2                  = 'ORDER_NOTIFY_RESPONSE_FOR_PAYMENT_LINK_V2';
