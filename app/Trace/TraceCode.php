...
class TraceCode extends \Razorpay\Trace\TraceCode
{
    ...
    const MUTEX_LOCK_ON_LINKED_ACCOUNT_ID_ACQUIRED              = 'MUTEX_LOCK_ON_LINKED_ACCOUNT_ID_ACQUIRED';
    const TRANSFER_PROCESS_JOB_RELEASE_SINCE_MUTEX_ACQUIRE_FAILED = 'TRANSFER_PROCESS_JOB_RELEASE_SINCE_MUTEX_ACQUIRE_FAILED';
