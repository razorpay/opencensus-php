...
// Trace code for Invitation
    ...
    const HEARTBEAT_CHECK_NO_LAG                        = 'HEARTBEAT_CHECK_NO_LAG';
    const HEARTBEAT_CHECK_COMPLETED                     = 'HEARTBEAT_CHECK_COMPLETED';
    const HEARTBEAT_CHECK_RAMP_RESULT                   = 'HEARTBEAT_CHECK_RAMP_RESULT';
    const HEARTBEAT_CHECK_TIME_CONVERSION               = 'HEARTBEAT_CHECK_TIME_CONVERSION';
    const HEARTBEAT_LAG_CHECK_DEBUG_TRACE               = 'HEARTBEAT_LAG_CHECK_DEBUG_TRACE';
    const HEARTBEAT_CHECK_EMPTY_ROUTE_LIST              = 'HEARTBEAT_CHECK_EMPTY_ROUTE_LIST';
    const HEARTBEAT_CHECK_ROUTE_NOT_LISTED              = 'HEARTBEAT_CHECK_ROUTE_NOT_LISTED';
