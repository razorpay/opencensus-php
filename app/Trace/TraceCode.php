...
class TraceCode extends \Razorpay\Trace\TraceCode
{
    ...
    const LEDGER_STATUS_QUEUE_JOB_PAYOUT_CRON_INIT              = 'LEDGER_STATUS_QUEUE_JOB_PAYOUT_CRON_INIT';
    const LEDGER_STATUS_QUEUE_JOB_FAV_CRON_INIT                 = 'LEDGER_STATUS_QUEUE_JOB_FAV_CRON_INIT';
    const LEDGER_STATUS_QUEUE_JOB_REVERSAL_CRON_INIT            = 'LEDGER_STATUS_QUEUE_JOB_REVERSAL_CRON_INIT';
    const LEDGER_STATUS_QUEUE_JOB_BANK_TRANSFER_CRON_INIT       = 'LEDGER_STATUS_QUEUE_JOB_BANK_TRANSFER_CRON_INIT';
    const LEDGER_STATUS_QUEUE_JOB_ADJUSTMENT_CRON_INIT          = 'LEDGER_STATUS_QUEUE_JOB_ADJUSTMENT_CRON_INIT';

    const LEDGER_STATUS_QUEUE_JOB_SKIP_BLACKLIST_PAYOUT         = 'LEDGER_STATUS_QUEUE_JOB_SKIP_BLACKLIST_PAYOUT';
    const LEDGER_STATUS_QUEUE_JOB_SKIP_BLACKLIST_FAV            = 'LEDGER_STATUS_QUEUE_JOB_SKIP_BLACKLIST_FAV';
    const LEDGER_STATUS_QUEUE_JOB_SKIP_BLACKLIST_REVERSAL       = 'LEDGER_STATUS_QUEUE_JOB_SKIP_BLACKLIST_REVERSAL';
    const LEDGER_STATUS_QUEUE_JOB_SKIP_BLACKLIST_BANK_TRANSFER  = 'LEDGER_STATUS_QUEUE_JOB_SKIP_BLACKLIST_BANK_TRANSFER';
    const LEDGER_STATUS_QUEUE_JOB_SKIP_BLACKLIST_ADJUSTMENT     = 'LEDGER_STATUS_QUEUE_JOB_SKIP_BLACKLIST_ADJUSTMENT';

    const LEDGER_STATUS_QUEUE_JOB_PAYOUT_CRON_FAILED            = 'LEDGER_STATUS_QUEUE_JOB_PAYOUT_CRON_FAILED';
    const LEDGER_STATUS_QUEUE_JOB_FAV_CRON_FAILED               = 'LEDGER_STATUS_QUEUE_JOB_FAV_CRON_FAILED';
    const LEDGER_STATUS_QUEUE_JOB_REVERSAL_CRON_FAILED          = 'LEDGER_STATUS_QUEUE_JOB_REVERSAL_CRON_FAILED';
    const LEDGER_STATUS_QUEUE_JOB_BANK_TRANSFER_CRON_FAILED     = 'LEDGER_STATUS_QUEUE_JOB_BANK_TRANSFER_CRON_FAILED';
    const LEDGER_STATUS_QUEUE_JOB_ADJUSTMENT_CRON_FAILED        = 'LEDGER_STATUS_QUEUE_JOB_ADJUSTMENT_CRON_FAILED';
