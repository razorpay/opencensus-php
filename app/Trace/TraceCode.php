...
class TraceCode extends \Razorpay\Trace\TraceCode
{
    ...
    const PAYMENT_RECON_QUEUE_NB_PLUS_REQUEST                   = 'PAYMENT_RECON_QUEUE_NB_PLUS_REQUEST';
    const PAYMENT_RECON_QUEUE_NB_PLUS_SUCCESS                   = 'PAYMENT_RECON_QUEUE_NB_PLUS_SUCCESS';
    const PAYMENT_RECON_NB_PLUS_QUEUE_DELETE                    = 'PAYMENT_RECON_NB_PLUS_QUEUE_DELETE';
