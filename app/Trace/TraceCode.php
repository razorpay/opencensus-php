...
class TraceCode
{
    ...
    const PAYMENT_AUTHORIZED_EVENT                  = 'PAYMENT_AUTHORIZED_EVENT';
    const ORDER_PAID_EVENT                          = 'ORDER_PAID_EVENT';
    const INVOICE_PAID_EVENT                        = 'INVOICE_PAID_EVENT';
    const PAYMENT_FAILED_EVENT                      = 'PAYMENT_FAILED_EVENT';
    ...
    const GATEWAY_ABSENCE_DUPLICATE                 = 'GATEWAY_ABSENCE_DUPLICATE';
    ...
    const GATEWAY_ABSENCE_STATUSCAKE_INVALID_STATUS = 'GATEWAY_ABSENCE_STATUSCAKE_INVALID_STATUS';
    const GATEWAY_ABSENCE_STATUSCAKE_INVALID_DATA   = 'GATEWAY_ABSENCE_STATUSCAKE_INVALID_DATA';
    const GATEWAY_ABSENCE_STATUSCAKE_PARSE_ERROR    = 'GATEWAY_ABSENCE_STATUSCAKE_PARSE_ERROR';
    const GATEWAY_ABSENCE_STATUSCAKE_CREATE         = 'GATEWAY_ABSENCE_STATUSCAKE_CREATE';
    const GATEWAY_ABSENCE_STATUSCAKE_EDIT           = 'GATEWAY_ABSENCE_STATUSCAKE_EDIT';
