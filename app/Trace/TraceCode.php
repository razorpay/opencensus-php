...
class TraceCode extends \Razorpay\Trace\TraceCode
{
    ...
    const VALIDATE_ENTITY_ID_API_DCS_FEATURE_JOB_FAILED         = 'VALIDATE_ENTITY_ID_API_DCS_FEATURE_JOB_FAILED';
    ...
    const PRTS_COMMISSION_DUAL_WRITE_DISPATCHING                = 'PRTS_COMMISSION_DUAL_WRITE_DISPATCHING';
    const PRTS_COMMISSION_CAPTURE_DISPATCHING                   = 'PRTS_COMMISSION_CAPTURE_DISPATCHING';
    const PRTS_COMMISSION_CAPTURE_DISPATCHED                    = 'PRTS_COMMISSION_CAPTURE_DISPATCHED';
    const PRTS_COMMISSION_DUAL_WRITE_DISPATCHED                 = 'PRTS_COMMISSION_DUAL_WRITE_DISPATCHED';
    const PRTS_COMMISSION_DUAL_WRITE_SPLITZ_ERROR               = 'PRTS_COMMISSION_DUAL_WRITE_SPLITZ_ERROR';
    const PRTS_COMMISSION_CALCULATION_SHADOW_PHASE_SPLITZ_ERROR = 'PRTS_COMMISSION_CALCULATION_SHADOW_PHASE_SPLITZ_ERROR';
    const PRTS_COMMISSION_DUAL_WRITE_FAILED                     = 'PRTS_COMMISSION_DUAL_WRITE_FAILED';
    const PRTS_COMMISSION_CAPTURE_DISPATCH_FAILED               = 'PRTS_COMMISSION_CAPTURE_DISPATCH_FAILED';
    ...
    const UPI_PAYMENT_SERVICE_ROUTING_CRITERIA_FAILED_REASON           = 'UPI_PAYMENT_SERVICE_ROUTING_CRITERIA_FAILED_REASON';
