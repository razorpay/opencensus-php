...
class TraceCode extends \Razorpay\Trace\TraceCode
{
    ...
    const SETTLEMENT_PROCESSED_MAIL_NOTIFICATION_ENQUEUE_FAILED    = 'SETTLEMENT_PROCESSED_MAIL_NOTIFICATION_ENQUEUE_FAILED';
    const SETTLEMENT_PROCESSED_MAIL_NOTIFICATION_ENQUEUE_SKIPPED   = 'SETTLEMENT_PROCESSED_MAIL_NOTIFICATION_ENQUEUE_SKIPPED';
