...
class TraceCode extends \Razorpay\Trace\TraceCode
{
    ...
    const FREE_PAYOUT_LEDGER_VIA_PS_FEATURE_ASSIGN_FAILED          = 'FREE_PAYOUT_LEDGER_VIA_PS_FEATURE_ASSIGN_FAILED';
    const FREE_PAYOUT_LEDGER_VIA_PS_FEATURE_ASSIGNED_ALREADY       = 'FREE_PAYOUT_LEDGER_VIA_PS_FEATURE_ASSIGNED_ALREADY';
    const FREE_PAYOUT_LEDGER_VIA_PS_FEATURE_NOT_ASSIGNED           = 'FREE_PAYOUT_LEDGER_VIA_PS_FEATURE_NOT_ASSIGNED';
