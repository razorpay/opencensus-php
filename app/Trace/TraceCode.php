...
class TraceCode extends \Razorpay\Trace\TraceCode
{
    ...
    const GENERIC_ACCOUNTING_PAYOUT_UPDATER_CHECK_EXPERIMENT    = 'GENERIC_ACCOUNTING_PAYOUT_UPDATER_CHECK_EXPERIMENT';
    const GENERIC_ACCOUNTING_PAYOUT_CHECK_EXPERIMENT_RESP       = 'GENERIC_ACCOUNTING_PAYOUT_CHECK_EXPERIMENT_RESP';
