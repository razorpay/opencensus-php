...
class TraceCode extends \Razorpay\Trace\TraceCode
{
    ...
    const WEBSITE_CHECKER_PERIODIC_CRON_STARTED             = 'WEBSITE_CHECKER_PERIODIC_CRON_STARTED';
    const WEBSITE_CHECKER_PERIODIC_CRON_ENDED               = 'WEBSITE_CHECKER_PERIODIC_CRON_ENDED';
    const WEBSITE_CHECKER_CRON_MERCHANT_SKIPPED             = 'WEBSITE_CHECKER_CRON_MERCHANT_SKIPPED';
    const WEBSITE_CHECKER_RETRY_CRON_STARTED                = 'WEBSITE_CHECKER_RETRY_CRON_STARTED';
    const WEBSITE_CHECKER_RETRY_CRON_ENDED                  = 'WEBSITE_CHECKER_RETRY_CRON_ENDED';
    const WEBSITE_CHECKER_REMINDER_CRON_STARTED             = 'WEBSITE_CHECKER_REMINDER_CRON_STARTED';
    const WEBSITE_CHECKER_REMIND                            = 'WEBSITE_CHECKER_REMIND';
    const WEBSITE_CHECKER_REMIND_SKIPPED_BECAUSE_NO_FD_ID   = 'WEBSITE_CHECKER_REMIND_SKIPPED_BECAUSE_NO_FD_ID';
    const WEBSITE_CHECKER_REMINDER_CRON_ENDED               = 'WEBSITE_CHECKER_REMINDER_CRON_ENDED';
    const WEBSITE_CHECKER_INVALID_WORKFLOW_ACTION_COUNT     = 'WEBSITE_CHECKER_INVALID_WORKFLOW_ACTION_COUNT';
    const WEBSITE_CHECKER_REMINDER_INFERRED_WORKFLOW_ACTION = 'WEBSITE_CHECKER_REMINDER_INFERRED_WORKFLOW_ACTION';
    const WEBSITE_CHECKER_DEBUG                             = 'WEBSITE_CHECKER_DEBUG';
    const WEBSITE_CHECKER_URL_NOT_REACHABLE                 = 'WEBSITE_CHECKER_URL_NOT_REACHABLE';
    const WEBSITE_CHECKER_MERCHANT_NOT_REACHABLE            = 'WEBSITE_CHECKER_MERCHANT_NOT_REACHABLE';
    const WEBSITE_CHECKER_MERCHANT_REACHABLE                = 'WEBSITE_CHECKER_MERCHANT_REACHABLE';
    const WEBSITE_CHECKER_NOTIFY_RAS_INITIATED              = 'WEBSITE_CHECKER_NOTIFY_RAS_INITIATED';
    const WEBSITE_CHECKER_NOTIFY_RAS_FAILED                 = 'WEBSITE_CHECKER_NOTIFY_RAS_FAILED';
    const WESBITE_CHECKER_JOB_PROCESSING_START              = 'WESBITE_CHECKER_JOB_PROCESSING_START';
    const WESBITE_CHECKER_JOB_PROCESSING_END                = 'WESBITE_CHECKER_JOB_PROCESSING_END';
    const WESBITE_CHECKER_JOB_PROCESSING_INVALID_JOB_TYPE   = 'WESBITE_CHECKER_JOB_PROCESSING_INVALID_JOB_TYPE';
    const WESBITE_CHECKER_JOB_PROCESSING_FAILED             = 'WESBITE_CHECKER_JOB_PROCESSING_FAILED';
    const WEBSITE_CHECKER_JOB_ENQUEUE_INITIATED             = 'WEBSITE_CHECKER_JOB_ENQUEUE_INITIATED';
    const WEBSITE_CHECKER_JOB_ENQUEUE_FAILED                = 'WEBSITE_CHECKER_JOB_ENQUEUE_FAILED';
    const WEBSITE_CHECKER_REMINDER_ABORT                    = 'WEBSITE_CHECKER_REMINDER_ABORT';
    const WEBSITE_CHECKER_MILESTONE_CRON_STARTED            = 'WEBSITE_CHECKER_MILESTONE_CRON_STARTED';
    const WEBSITE_CHECKER_MILESTONE_CRON_ENDED              = 'WEBSITE_CHECKER_MILESTONE_CRON_ENDED';
    const WEBSITE_CHECKER_RISK_SCORE_CRON_STARTED           = 'WEBSITE_CHECKER_RISK_SCORE_CRON_STARTED';
    const WEBSITE_CHECKER_RISK_SCORE_CRON_ENDED             = 'WEBSITE_CHECKER_RISK_SCORE_CRON_ENDED';
    const WEBSITE_CHECKER_DRUID_ERROR                       = 'WEBSITE_CHECKER_DRUID_ERROR';
