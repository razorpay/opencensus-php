...
class TraceCode extends \Razorpay\Trace\TraceCode
{
    ...
    const TXN_FOUND_FOR_PAYOUT_PROCESSED_IN_LEDGER_WEBHOOK      = 'TXN_FOUND_FOR_PAYOUT_PROCESSED_IN_LEDGER_WEBHOOK';
    const TXN_FOUND_FOR_PAYOUT_REVERSED_IN_LEDGER_WEBHOOK       = 'TXN_FOUND_FOR_PAYOUT_REVERSED_IN_LEDGER_WEBHOOK';
    ...
    const LEDGER_TRANSACTIONS_WEBHOOK_REQUEST                   = 'LEDGER_TRANSACTIONS_WEBHOOK_REQUEST';
    const LEDGER_TRANSACTIONS_WEBHOOK_RESPONSE                  = 'LEDGER_TRANSACTIONS_WEBHOOK_RESPONSE';
    const LEDGER_TRANSACTIONS_WEBHOOK_EXCEPTION                 = 'LEDGER_TRANSACTIONS_WEBHOOK_EXCEPTION';
    const LEDGER_TRANSACTIONS_WEBHOOK_RELINK_EXT_TO_PAYOUT      = 'LEDGER_TRANSACTIONS_WEBHOOK_RELINK_EXT_TO_PAYOUT';
    const LEDGER_TRANSACTIONS_WEBHOOK_RELINK_EXT_TO_REVERSAL    = 'LEDGER_TRANSACTIONS_WEBHOOK_RELINK_EXT_TO_REVERSAL';
    const LEDGER_TRANSACTIONS_WEBHOOK_INVALID_REQUEST           = 'LEDGER_TRANSACTIONS_WEBHOOK_INVALID_REQUEST';
    const EXT_TRANSACTION_ALREADY_LINKED_WITH_PAYOUT            = 'EXT_TRANSACTION_ALREADY_LINKED_WITH_PAYOUT';
    const EXT_TRANSACTION_ALREADY_LINKED_WITH_REVERSAL          = 'EXT_TRANSACTION_ALREADY_LINKED_WITH_REVERSAL';
    const EXT_ALREADY_LINKED                                    = 'EXT_ALREADY_LINKED';
    const PAYOUT_ALREADY_LINKED                                 = 'PAYOUT_ALREADY_LINKED';
    const REVERSAL_ALREADY_LINKED                               = 'REVERSAL_ALREADY_LINKED';
    const BAS_ALREADY_LINKED                                    = 'BAS_ALREADY_LINKED';
    const RELINKING_EXT_TO_SOURCE_ENTITY                        = 'RELINKING_EXT_TO_SOURCE_ENTITY';
    const SEND_RELINKING_EVENTS_TO_LEDGER_FROM_WEBHOOK_FLOW     = 'SEND_RELINKING_EVENTS_TO_LEDGER_FROM_WEBHOOK_FLOW';
    const LEDGER_WEBHOOK_FOR_MERCHANT_NOT_ON_REVERSE_SHADOW     = 'LEDGER_WEBHOOK_FOR_MERCHANT_NOT_ON_REVERSE_SHADOW';
