...
class TraceCode extends \Razorpay\Trace\TraceCode
{
    ...
    const TRANSFER_PROCESS_JOB_STARTED                          = 'TRANSFER_PROCESS_JOB_STARTED';
    const TRANSFER_PROCESS_JOB_COMPLETED                        = 'TRANSFER_PROCESS_JOB_COMPLETED';
    const TRANSFER_PROCESS_INVALID_PAYMENT_ID                   = 'TRANSFER_PROCESS_INVALID_PAYMENT_ID';
    const TRANSFER_PROCESS_JOB_FAILED                           = 'TRANSFER_PROCESS_JOB_FAILED';
    ...
    // Deprecated traces codes, kept for future reference.
