...
class TraceCode extends \Razorpay\Trace\TraceCode
{
    ...
    const FAILED_PAYMENT_PL_CREATION_KAFKA_MESSAGE              = 'FAILED_PAYMENT_PL_CREATION_KAFKA_MESSAGE';
    const FAILED_PAYMENT_PL_CREATION_DELAY_CONFIG               = 'FAILED_PAYMENT_PL_CREATION_DELAY_CONFIG';
    const FAILED_PAYMENT_PL_CREATION_REQUEST                    = 'FAILED_PAYMENT_PL_CREATION_REQUEST';
    const FAILED_PAYMENT_PL_CREATION_RESPONSE                   = 'FAILED_PAYMENT_PL_CREATION_RESPONSE';
    const FAILED_PAYMENT_PL_CREATION_CONDITION                  = 'FAILED_PAYMENT_PL_CREATION_CONDITION';
