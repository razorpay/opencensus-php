...
class TraceCode extends \Razorpay\Trace\TraceCode
{
    ...
    const EMANDATE_INSTRUMENTATION_RESPONSE_RAZORX_FAIL         = 'EMANDATE_INSTRUMENTATION_RESPONSE_RAZORX_FAIL';
    ...
    const FREE_PAYOUT_LEDGER_VIA_PS_ASSIGNED                       = 'FREE_PAYOUT_LEDGER_VIA_PS_ASSIGNED';
