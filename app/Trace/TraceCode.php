...
class TraceCode extends \Razorpay\Trace\TraceCode
{
    ...
    const FETCH_PARTNER_AND_MERCHANT_FROM_PUBLIC_KEY            = 'FETCH_PARTNER_AND_MERCHANT_FROM_PUBLIC_KEY';
    const ALLOW_MARKETPLACE_FEATURE_FOR_SUBMERCHANT             = 'ALLOW_MARKETPLACE_FEATURE_FOR_SUBMERCHANT';
