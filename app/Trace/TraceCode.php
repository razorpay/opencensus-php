...
class TraceCode extends \Razorpay\Trace\TraceCode
{
    ...
    const SEND_SMS_ON_ADD_SUB_MERCHANT_PARTNER                  = 'SEND_SMS_ON_ADD_SUB_MERCHANT_PARTNER';
    const SEND_SMS_ON_ADD_SUB_MERCHANT_PARTNER_FAILED           = 'SEND_SMS_ON_ADD_SUB_MERCHANT_PARTNER_FAILED';
    ...
    const CHECKOUT_ORDERS_PARTITION_CREATE_QUERY                  = 'CHECKOUT_ORDERS_PARTITION_CREATE_QUERY';
    const CHECKOUT_ORDERS_PARTITION_DROP_QUERY                    = 'CHECKOUT_ORDERS_PARTITION_DROP_QUERY';
    const CHECKOUT_ORDERS_PARTITION_TO_DROP                       = 'CHECKOUT_ORDERS_PARTITION_TO_DROP';
    const CHECKOUT_ORDERS_PARTITION_SUCCESS                       = 'CHECKOUT_ORDERS_PARTITION_SUCCESS';
    const CHECKOUT_ORDERS_LOW_PARTITION_COUNT_ERROR               = 'CHECKOUT_ORDERS_LOW_PARTITION_COUNT_ERROR';
    const CHECKOUT_ORDERS_PARTITION_ERROR                         = 'CHECKOUT_ORDERS_PARTITION_ERROR';
    const CHECKOUT_ORDERS_PARTITION_EXISTS_ALREADY                = 'CHECKOUT_ORDERS_PARTITION_EXISTS_ALREADY';

    const PAYOUT_OUTBOX_PARTITION_CREATE_QUERY                      = 'PAYOUT_OUTBOX_PARTITION_CREATE_QUERY';
    const PAYOUT_OUTBOX_PARTITION_DROP_QUERY                        = 'PAYOUT_OUTBOX_PARTITION_DROP_QUERY';
    const PAYOUT_OUTBOX_PARTITION_TO_DROP                           = 'PAYOUT_OUTBOX_PARTITION_TO_DROP';
    const PAYOUT_OUTBOX_PARTITION_SUCCESS                           = 'PAYOUT_OUTBOX_PARTITION_SUCCESS';
