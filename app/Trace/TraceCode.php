...
class TraceCode extends \Razorpay\Trace\TraceCode
{
    ...
    const PRTS_COMMISSION_INVOICE_DISPATCHING                   = 'PRTS_COMMISSION_CAPTURE_DISPATCHING';
    const PRTS_COMMISSION_INVOICE_DISPATCHING_ERROR             = 'PRTS_COMMISSION_INVOICE_DISPATCHING_ERROR';
    const PRTS_COMMISSION_INVOICE_DISPATCHED                    = 'PRTS_COMMISSION_CAPTURE_DISPATCHED';
