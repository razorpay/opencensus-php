...
class TraceCode
{
    ...
    const ES_SEARCH_PARAMS                          = 'ES_SEARCH_PARAMS';
    const ES_EXPLAIN_PARAMS                         = 'ES_EXPLAIN_PARAMS';
    const ES_GET_MAPPING_PARAMS                     = 'ES_GET_MAPPING_PARAMS';
    const ES_GET_SETTINGS_PARAMS                    = 'ES_GET_SETTINGS_PARAMS';
