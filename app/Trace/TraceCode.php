...
class TraceCode extends \Razorpay\Trace\TraceCode
{
    ...
    const LOCAL_TOKENISATION_JOB_REQUEST        = 'LOCAL_TOKENISATION_JOB_REQUEST';
    const LOCAL_TOKENISATION_JOB_SUCCESS        = 'LOCAL_TOKENISATION_JOB_SUCCESS';
    const LOCAL_TOKENISATION_JOB_TOKEN_NOT_APPLICABLE = 'LOCAL_TOKENISATION_JOB_TOKEN_NOT_APPLICABLE';
    const LOCAL_TOKENISATION_JOB_ERROR          = 'LOCAL_TOKENISATION_JOB_ERROR';
    const LOCAL_TOKENISATION_JOB_FAILED         = 'LOCAL_TOKENISATION_JOB_FAILED';
