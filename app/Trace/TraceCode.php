...
// Trace code for Invitation
    ...
    const FUND_ACCOUNT_VALIDATION_SYNC_REQUEST          = 'FUND_ACCOUNT_VALIDATION_SYNC_REQUEST';
    const FUND_ACCOUNT_VALIDATION_ASYNC_REQUEST         = 'FUND_ACCOUNT_VALIDATION_ASYNC_REQUEST';
