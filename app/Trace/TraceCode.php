...
class TraceCode extends \Razorpay\Trace\TraceCode
{
    ...
    const PAYMENT_CARD_RECURRING_VIA_MUTEX_LOCK                 = 'PAYMENT_CARD_RECURRING_VIA_MUTEX_LOCK';
    ...
    const RECURRING_SUBSEQUENT_MUTEX_LOCK_RAZORX_FAILURE        = 'RECURRING_SUBSEQUENT_MUTEX_LOCK_RAZORX_FAILURE';
