...
class TraceCode extends \Razorpay\Trace\TraceCode
{
    ...
    const FUND_LOADING_DOWNTIME_SMS_INIT                = 'FUND_LOADING_DOWNTIME_SMS_INIT';
    const FUND_LOADING_DOWNTIME_SMS_COMPLETE            = 'FUND_LOADING_DOWNTIME_SMS_COMPLETE';
    const FUND_LOADING_DOWNTIME_EMAIL_INIT              = 'FUND_LOADING_DOWNTIME_EMAIL_INIT';
    const FUND_LOADING_DOWNTIME_EMAIL_COMPLETE          = 'FUND_LOADING_DOWNTIME_EMAIL_COMPLETE';
    const FAILED_TO_SEND_FUND_LOADING_DOWNTIME_SMS      = 'FAILED_TO_SEND_FUND_LOADING_DOWNTIME_SMS';
    const FAILED_TO_SEND_FUND_LOADING_DOWNTIME_EMAIL    = 'FAILED_TO_SEND_FUND_LOADING_DOWNTIME_EMAIL';
    const DUPLICATE_FUND_LOADING_DOWNTIME_FOUND         = 'DUPLICATE_FUND_LOADING_DOWNTIME_FOUND';
