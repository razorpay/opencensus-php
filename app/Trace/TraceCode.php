...
// Trace Code for Gateway Absence StatusCake
    ...
    const GATEWAY_ABSENCE_STATUSCAKE_INVALID_TAGS       = 'GATEWAY_ABSENCE_STATUSCAKE_INVALID_TAGS';
    const GATEWAY_ABSENCE_STATUSCAKE_INVALID_DATA       = 'GATEWAY_ABSENCE_STATUSCAKE_INVALID_DATA';
    const GATEWAY_ABSENCE_STATUSCAKE_INVALID_NBDATA     = 'GATEWAY_ABSENCE_STATUSCAKE_INVALID_NBDATA';
    const GATEWAY_ABSENCE_STATUSCAKE_INVALID_CDATA      = 'GATEWAY_ABSENCE_STATUSCAKE_INVALID_CDATA';
    const GATEWAY_ABSENCE_STATUSCAKE_INVALID_WDATA      = 'GATEWAY_ABSENCE_STATUSCAKE_INVALID_WDATA';
