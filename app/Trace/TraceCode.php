...
class TraceCode extends \Razorpay\Trace\TraceCode
{
    ...
    const PAYMENT_LINK_PAYMENT_REFUNDED                 = 'PAYMENT_LINK_PAYMENT_REFUNDED';
    const PAYMENT_LINK_PAYMENT_REFUND_EXCEPTION         = 'PAYMENT_LINK_PAYMENT_REFUND_EXCEPTION';
    ...
    const PAYMENT_LINK_PAYMENT_REFUND_REQUESTED         = 'PAYMENT_LINK_PAYMENT_REFUND_REQUESTED';
