...
class TraceCode
{
    ...
    const PAYMENT_REVERSE_AUTH_FAILURE              = 'PAYMENT_REVERSE_AUTH_FAILURE';
    ...
    const GATEWAY_REVERSE_AUTH_RESPONSE             = 'GATEWAY_REVERSE_AUTH_RESPONSE';
    const GATEWAY_REVERSE_AUTH_REQUEST              = 'GATEWAY_REVERSE_AUTH_REQUEST';
    const GATEWAY_REVERSE_AUTH_ERROR                = 'GATEWAY_REVERSE_AUTH_ERROR';
