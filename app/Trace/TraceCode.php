...
class TraceCode extends \Razorpay\Trace\TraceCode
{
    ...
    const BENEFICIARY_NAME_AND_ACCOUNT_NUMBER_TRIMMED_FOR_MERCHANT = 'BENEFICIARY_NAME_AND_ACCOUNT_NUMBER_TRIMMED_FOR_MERCHANT';
    const CONTACT_NAME_AND_TYPE_TRIMMED_FOR_MERCHANT          = 'CONTACT_NAME_AND_TYPE_TRIMMED_FOR_MERCHANT';
    const PAYOUT_PURPOSE_TRIMMED_FOR_MERCHANT                 = 'PAYOUT_PURPOSE_TRIMMED_FOR_MERCHANT';
    const CONTACT_NAME_AND_TYPE_TRIMMED                       = 'CONTACT_NAME_AND_TYPE_TRIMMED';
    const BENEFICIARY_NAME_AND_ACCOUNT_NUMBER_TRIMMED         = 'BENEFICIARY_NAME_AND_ACCOUNT_NUMBER_TRIMMED';
