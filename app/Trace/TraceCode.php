...
class TraceCode
{
    ...
    const BANK_TRANSFER_VALIDATION_REQUEST          = 'BANK_TRANSFER_VALIDATION_REQUEST';
    const BANK_TRANSFER_VALIDATION_SUCCESSFUL       = 'BANK_TRANSFER_VALIDATION_SUCCESSFUL';
    const BANK_TRANSFER_VALIDATION_FAILED           = 'BANK_TRANSFER_VALIDATION_FAILED';
    const BANK_TRANSFER_VALIDATION_DUPLICATE_UTR    = 'BANK_TRANSFER_VALIDATION_DUPLICATE_UTR';
