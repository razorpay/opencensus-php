...
class TraceCode extends \Razorpay\Trace\TraceCode
{
    ...
    const PAYOUT_VA_TO_VA_QUEUE_DISPATCH_INITIATE               = 'PAYOUT_VA_TO_VA_QUEUE_DISPATCH_INITIATE';
    const PAYOUT_VA_TO_VA_QUEUE_DISPATCH_COMPLETE               = 'PAYOUT_VA_TO_VA_QUEUE_DISPATCH_COMPLETE';
    const PAYOUT_VA_TO_VA_QUEUE_REQUEST                         = 'PAYOUT_VA_TO_VA_QUEUE_REQUEST';
    const PAYOUT_VA_TO_VA_QUEUE_SUCCESS                         = 'PAYOUT_VA_TO_VA_QUEUE_SUCCESS';
    const PAYOUT_VA_TO_VA_QUEUE_ATTEMPT_FAILED                  = 'PAYOUT_VA_TO_VA_QUEUE_ATTEMPT_FAILED';
    const PAYOUT_VA_TO_VA_QUEUE_FAILURE_EXCEPTION               = 'PAYOUT_VA_TO_VA_QUEUE_FAILURE_EXCEPTION';
    const PAYOUT_VA_TO_VA_REVERSED                              = 'PAYOUT_VA_TO_VA_REVERSED';
    const PAYOUT_VA_TO_VA_REVERSAL_FAILED                       = 'PAYOUT_VA_TO_VA_REVERSAL_FAILED';
    const PAYOUT_VA_TO_VA_HANDLE_PROCESSED_EXCEPTION            = 'PAYOUT_VA_TO_VA_HANDLE_PROCESSED_EXCEPTION';
