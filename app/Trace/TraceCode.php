...
class TraceCode
{
    ...
    const PAYMENT_REV_AUTH_FAILURE                  = 'PAYMENT_REV_AUTH_FAILURE';
    ...
    const GATEWAY_REV_AUTH_RESPONSE                 = 'GATEWAY_REV_AUTH_RESPONSE';
    const GATEWAY_REV_AUTH_REQUEST                  = 'GATEWAY_REV_AUTH_REQUEST';
    const GATEWAY_REV_AUTH_ERROR                    = 'GATEWAY_REV_AUTH_ERROR';
