...
class TraceCode
{
    const CROSS_REGION_SESSION_STORAGE_USAGE        = 'CROSS_REGION_SESSION_STORAGE_USAGE';

    const SETTING_REGION_COOKIES = 'SETTING_REGION_COOKIES';

    const CROSS_REGION_SESSION_STORAGE_TRANSFER      = 'CROSS_REGION_SESSION_STORAGE_TRANSFER';
    const CROSS_REGION_REGISTRATION_SUCCESS         = 'CROSS_REGION_REGISTRATION_SUCCESS';
    const CROSS_REGION_REGISTRATION_ATTEMPT         = 'CROSS_REGION_REGISTRATION_ATTEMPT';
    const INVALID_CELL_REGION_CONFIGURATION         = 'INVALID_CELL_REGION_CONFIGURATION';
    ...
    // Memory DB operation observability trace codes
    const MEMORY_DB_OPERATION_FAILED                = 'MEMORY_DB_OPERATION_FAILED';
    const MEMORY_DB_CONNECTION_FAILED               = 'MEMORY_DB_CONNECTION_FAILED';

    const REDIS_SESSION_READ = 'REDIS_SESSION_READ';

    const REDIS_SESSION_WRITE = 'REDIS_SESSION_WRITE';

    const MEMORY_DB_METRICS_PUSH_FAILED             = 'MEMORY_DB_METRICS_PUSH_FAILED';
    ...
    // Session Memory DB write trace codes
    const SESSION_MEMORY_DB_CONNECTION_FAILED       = 'SESSION_MEMORY_DB_CONNECTION_FAILED';
    const SESSION_MEMORY_DB_CONNECTION_NULL         = 'SESSION_MEMORY_DB_CONNECTION_NULL';
    const SESSION_MEMORY_DB_WRITE_SUCCESS           = 'SESSION_MEMORY_DB_WRITE_SUCCESS';
    const SESSION_MEMORY_DB_WRITE_FAILED            = 'SESSION_MEMORY_DB_WRITE_FAILED';
    const SESSION_MEMORY_DB_DESTROY_SUCCESS         = 'SESSION_MEMORY_DB_DESTROY_SUCCESS';
    const SESSION_MEMORY_DB_DESTROY_FAILED          = 'SESSION_MEMORY_DB_DESTROY_FAILED';

    const SESSION_TIMEOUT_PARSE_FAILED              = 'SESSION_TIMEOUT_PARSE_FAILED';
    ...
    const SESSION_MEMORY_DB_READ_FAILED         = 'SESSION_MEMORY_DB_READ_FAILED';
    ...
    const INSIGHTX_METHOD_AGGREGATE_FAIL = 'INSIGHTX_METHOD_AGGREGATE_FAIL';
    ...
    const MES_ADMIN_GENERIC_REQUEST_RECEIVED = 'MES_ADMIN_GENERIC_REQUEST_RECEIVED';
    const MES_SERVICE_REQUEST_FAILED = 'MES_SERVICE_REQUEST_FAILED';
    ...
    const INTERNAL_GENERATE_SESSION                 = 'INTERNAL_GENERATE_SESSION';
    const INTERNAL_GENERATE_SESSION_FAILED          = 'INTERNAL_GENERATE_SESSION_FAILED';
    ...
    const MERCHANT_USER_ENABLED_PRODUCT_DETECTION = 'MERCHANT_USER_ENABLED_PRODUCT_DETECTION';
    const INVALID_REGION_COUNTRY_CODE_ENV = 'INVALID_REGION_COUNTRY_CODE_ENV';

    // New logs for shell migration
    const NOTIFICATION_SERVICE_CODE_EXECUTION = 'NOTIFICATION_SERVICE_CODE_EXECUTION';
    const DOMAIN_BASED_REDIRECTION = 'DOMAIN_BASED_REDIRECTION';
    const PAYMENT_LINK_CUSTOM_NOTES = 'PAYMENT_LINK_CUSTOM_NOTES';
    const PAYMENT_LINK_CUSTOM_NOTES_NULL = 'PAYMENT_LINK_CUSTOM_NOTES_NULL';
    const PATTERN_MATCHING_REDIRECTION = 'PATTERN_MATCHING_REDIRECTION';
