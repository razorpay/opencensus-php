...
class TraceCode extends \Razorpay\Trace\TraceCode
{
    ...
    const SEND_RESELLER_TO_PURE_PLATFORM_EMAIL                  = 'SEND_RESELLER_TO_PURE_PLATFORM_EMAIL';
    const SEND_RESELLER_TO_PURE_PLATFORM_SMS                    = 'SEND_RESELLER_TO_PURE_PLATFORM_SMS';
    const RESELLER_TO_PURE_PLATFORM_SMS_FAILED                  = 'RESELLER_TO_PURE_PLATFORM_SMS_FAILED';
