    ...
    public static function entities()
    {
        $entities = [
            ...
            Entity::PAYMENTS_UPI_FISCAL => [
                ...
                'gateway_reference' => [
                    Fetch::LABEL  => 'Gateway Reference',
                    Fetch::TYPE   => Fetch::TYPE_STRING,
                ],
                'gateway_amount' => [
                    Fetch::LABEL  => 'Gateway Amount',
                    Fetch::TYPE   => Fetch::TYPE_STRING,
                ],
                'gateway_merchant_id' => [
                    Fetch::LABEL  => 'Gateway Merchant Id',
                ...
                'gateway_status_code' => [
                    Fetch::LABEL  => 'Gateway Status Code',
                    Fetch::TYPE   => Fetch::TYPE_STRING,
                ],
                'gateway_data' => [
                    Fetch::LABEL  => 'Gateway Data',
                    Fetch::TYPE   => Fetch::TYPE_STRING,
                ],
                'gateway_timestamp' => [
                    Fetch::LABEL  => 'Gateway Data',
                ...
                'npci_txn_id' => [
                    Fetch::LABEL  => 'NPCI TXN ID',
                    Fetch::TYPE   => Fetch::TYPE_STRING,
                ],
                'npci_response_code' => [
                    Fetch::LABEL  => 'NPCI Response Code',
                    Fetch::TYPE   => Fetch::TYPE_STRING,
                ],
                'source' => [
                    Fetch::LABEL  => 'Source',
                ...
                'callback_at' => [
                    Fetch::LABEL  => 'Callback At',
                    Fetch::TYPE   => Fetch::TYPE_STRING,
                ],
                'reconciled_at' => [
                    Fetch::LABEL  => 'Reconciled At',
                    Fetch::TYPE   => Fetch::TYPE_STRING,
                ],
            ]
        ];
