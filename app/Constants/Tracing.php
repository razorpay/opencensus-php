...
class Tracing
{
    ...
    public static function getRoutesToInclude(): array
    {
        ...
        return array_merge($routesToInclude, [
            ...
            'vendor_payment_create_draft',
            'vendor_payment_create_vendor_advance',
            'vendor_payment_get_signed_url',
            ...
            'vendor_payment_get_purchase_order',
            ...
            'vendor_payment_items_create',
            'vendor_payment_items_list',
            'vendor_payment_items_get',
            'vendor_payment_items_edit',
