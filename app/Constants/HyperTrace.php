...
class HyperTrace
{
    ...
    const QR_CODE_CREATE_FOR_PAYMENT_LINKS                      = 'qrv2_qr_code.create_for_payment_links';
    ...
    const QR_CODE_CREATE_FOR_PAYMENT_LINKS_SERVICE              = 'qrv2_qr_code.create_for_payment_links.createForPaymentlinks';
