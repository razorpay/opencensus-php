...
class Country
{
    ...
    protected static $countryNumericCodeMap = [
        self::AF => "004",
        self::AX => "248",
        self::AL => "008",
        self::DZ => "012",
    ...
    public static function getCountryCode($value)
    {
        ...
        $countryCode = array_search($value, self::$countryCodeNameMap);
  ...
  */
    ...
    public static function getCountryNumericCode(string $code)
    {
        return self::$countryNumericCodeMap[$code] ?? null;
    }
}
