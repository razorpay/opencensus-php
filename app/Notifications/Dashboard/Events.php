...
class Events
{
    ...
    const SMS_TEMPLATES = [
        ...
        self::MERCHANT_BUSINESS_WEBSITE_UPDATE                          => 'website.update.success.vx',
        self::BANK_ACCOUNT_CHANGE_REQUEST                               => 'bank.account.update.request.vx',
        self::BANK_ACCOUNT_CHANGE_PENNY_TESTING_FAILURE                 => 'sms.dashboard.bank_account_change_penny_testing_failure',
        self::BANK_ACCOUNT_CHANGE_SUCCESSFUL                            => 'bank.account.update.success.vx',
        self::INCREASE_TRANSACTION_LIMIT_REQUEST_APPROVE                => 'Increase.transaction.limit.vx',
        ...
        self::GSTIN_UPDATED_ON_BVS_VALIDATION_SUCCESS                   => 'Gst.success.vx',
        ...
        self::GSTIN_ADDED_ON_BVS_VALIDATION_SUCCESS                     => 'Gst.success.vx',
        ...
        self::IE_SUCCESSFUL                                             => 'sms.dashboard.ie_successful_v4',
        self::IE_UNDER_REVIEW                                           => 'sms.dashboard.ie_under_review_v4',
        self::IE_SUCCESSFUL_PPLI                                        => 'sms.dashboard.ie_successful_ppli_v4',
        self::IE_SUCCESSFUL_PG                                          => 'sms.dashboard.ie_successful_pg_v4',
        self::IE_REJECTED_CLARIFICATION_NOT_PROVIDED                    => 'sms.dashboard.ie_rejected_clarification_not_provided_v4',
        self::IE_REJECTED_WEBSITE_DETAILS_INCOMPLETE                    => 'sms.dashboard.ie_rejected_website_details_incomplete_v4',
        self::IE_REJECTED_BUSINESS_MODEL_MISMATCH                       => 'sms.dashboard.ie_rejected_business_model_mismatch',
        self::IE_REJECTED_INVALID_DOCUMENTS                             => 'sms.dashboard.ie_rejected_invalid_documents_v4',
        self::IE_REJECTED_RISK_REJECTION                                => 'sms.dashboard.ie_rejected_risk_rejection_v4',
        self::IE_REJECTED_MERCHANT_HIGH_CHARGEBACKS_FRAUD               => 'sms.dashboard.ie_rejected_merchant_high_chargebacks_fraud_v4',
        self::IE_REJECTED_DORMANT_MERCHANT                              => 'sms.dashboard.ie_rejected_dormant_merchant_v4',
        self::IE_REJECTED_RESTRICTED_BUSINESS                           => 'sms.dashboard.ie_rejected_restricted_business_v4',
        self::IE_NEEDS_CLARIFICATION                                    => 'sms.dashboard.ie_needs_clarification_v4',
    ];
    ...
    const SMS_TEMPLATE_KEYS = [
        ...
        self::MERCHANT_BUSINESS_WEBSITE_UPDATE                          => [Constants::UPDATED_BUSINESS_WEBSITE],
        self::BANK_ACCOUNT_CHANGE_REQUEST                               => [Constants::NAME, Constants::ACCOUNT_NUMBER],
        self::BANK_ACCOUNT_CHANGE_PENNY_TESTING_FAILURE                 => [],
        self::BANK_ACCOUNT_CHANGE_SUCCESSFUL                            => [],
        self::INCREASE_TRANSACTION_LIMIT_REQUEST_APPROVE                => [Constants::CURRENCY_SYMBOL, Constants::UPDATED_TRANSACTION_LIMIT],
        ...
        self::GSTIN_UPDATED_ON_BVS_VALIDATION_SUCCESS                   => [Constants::GSTIN, Constants::BUSINESS_REGISTERED_ADDRESS, Constants::BUSINESS_REGISTERED_PIN],
        self::GSTIN_UPDATED_ON_WORKFLOW_APPROVE                         => [Constants::GSTIN],
        self::BULK_REGENERATE_API_KEYS                                  => [],
        self::GSTIN_ADDED_ON_BVS_VALIDATION_SUCCESS                     => [Constants::GSTIN, Constants::BUSINESS_REGISTERED_ADDRESS, Constants::BUSINESS_REGISTERED_PIN],
        ...
        self::IE_SUCCESSFUL                                             => [Constants::DASHBOARD_URL],
        self::IE_UNDER_REVIEW                                           => [Constants::DASHBOARD_URL],
        self::IE_SUCCESSFUL_PPLI                                        => [Constants::DASHBOARD_URL],
        self::IE_SUCCESSFUL_PG                                          => [Constants::DASHBOARD_URL],
        self::IE_REJECTED_CLARIFICATION_NOT_PROVIDED                    => [Constants::DASHBOARD_URL, Constants::PAYPAL_URL],
        self::IE_REJECTED_WEBSITE_DETAILS_INCOMPLETE                    => [Constants::DASHBOARD_URL, Constants::PAYPAL_URL],
        self::IE_REJECTED_BUSINESS_MODEL_MISMATCH                       => [Constants::DASHBOARD_URL, Constants::PAYPAL_URL],
        self::IE_REJECTED_INVALID_DOCUMENTS                             => [Constants::DASHBOARD_URL, Constants::PAYPAL_URL],
        self::IE_REJECTED_RISK_REJECTION                                => [Constants::DASHBOARD_URL, Constants::UPDATE_DATE, Constants::PAYPAL_URL],
        self::IE_REJECTED_MERCHANT_HIGH_CHARGEBACKS_FRAUD               => [Constants::DASHBOARD_URL, Constants::UPDATE_DATE, Constants::PAYPAL_URL],
        self::IE_REJECTED_DORMANT_MERCHANT                              => [Constants::DASHBOARD_URL, Constants::UPDATE_DATE, Constants::PAYPAL_URL],
        self::IE_REJECTED_RESTRICTED_BUSINESS                           => [Constants::DASHBOARD_URL, Constants::UPDATE_DATE, Constants::PAYPAL_URL],
        self::IE_NEEDS_CLARIFICATION                                    => [Constants::DASHBOARD_URL],
    ];
    ...
    const WHATSAPP_TEMPLATE_KEYS = [
        ...
        self::IE_SUCCESSFUL                                             => [Constants::MERCHANT_NAME, Constants::DASHBOARD_URL],
        self::IE_UNDER_REVIEW                                           => [Constants::MERCHANT_NAME, Constants::UPDATE_DATE, Constants::DASHBOARD_URL],
        self::IE_SUCCESSFUL_PPLI                                        => [Constants::MERCHANT_NAME, Constants::DASHBOARD_URL],
        self::IE_SUCCESSFUL_PG                                          => [Constants::MERCHANT_NAME, Constants::DASHBOARD_URL],
        self::IE_REJECTED_CLARIFICATION_NOT_PROVIDED                    => [Constants::MERCHANT_NAME, Constants::DASHBOARD_URL, Constants::PAYPAL_URL],
        self::IE_REJECTED_WEBSITE_DETAILS_INCOMPLETE                    => [Constants::MERCHANT_NAME, Constants::DASHBOARD_URL, Constants::PAYPAL_URL],
        self::IE_REJECTED_BUSINESS_MODEL_MISMATCH                       => [Constants::MERCHANT_NAME, Constants::DASHBOARD_URL, Constants::PAYPAL_URL],
        self::IE_REJECTED_INVALID_DOCUMENTS                             => [Constants::MERCHANT_NAME, Constants::DASHBOARD_URL, Constants::PAYPAL_URL],
        self::IE_REJECTED_RISK_REJECTION                                => [Constants::MERCHANT_NAME, Constants::UPDATE_DATE, Constants::DASHBOARD_URL, Constants::PAYPAL_URL],
        self::IE_REJECTED_MERCHANT_HIGH_CHARGEBACKS_FRAUD               => [Constants::MERCHANT_NAME, Constants::UPDATE_DATE, Constants::DASHBOARD_URL, Constants::PAYPAL_URL],
    ...
    const EMAIL_SUBJECTS = [
        ...
        self::IE_SUCCESSFUL                                             => 'International payments request is successful',
        self::IE_UNDER_REVIEW                                           => 'Enablement of international payments',
        self::IE_SUCCESSFUL_PPLI                                        => 'International payments request is successful',
        self::IE_SUCCESSFUL_PG                                          => 'International payments request is successful',
        self::IE_REJECTED_CLARIFICATION_NOT_PROVIDED                    => 'International payments request is rejected',
        self::IE_REJECTED_WEBSITE_DETAILS_INCOMPLETE                    => 'International payments request is rejected',
        self::IE_REJECTED_BUSINESS_MODEL_MISMATCH                       => 'International payments request is rejected',
        self::IE_REJECTED_INVALID_DOCUMENTS                             => 'International payments request is rejected',
        self::IE_REJECTED_RISK_REJECTION                                => 'International payments request is rejected',
        self::IE_REJECTED_MERCHANT_HIGH_CHARGEBACKS_FRAUD               => 'International payments request is rejected',
