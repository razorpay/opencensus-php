...
class Events
{
    ...
    const SMS_TEMPLATES = [
        ...
        self::NEED_CLARIFICATION_FOR_WEBSITE_UPDATE_WORKFLOW           => 'sms.dashboard.merchant_business_website_update_needs_clarification',
        self::NEED_CLARIFICATION_FOR_WEBSITE_ADD_WORKFLOW              => 'sms.dashboard.merchant_business_website_add_needs_clarification',
    ];
    ...
    const SUPPORTED_CHANNELS_FOR_EVENTS = [
        ...
        self::NEED_CLARIFICATION_FOR_BANK_ACCOUNT_UPDATE_WORKFLOW      => [Channel::EMAIL],
        self::NEED_CLARIFICATION_FOR_TRANSACTION_LIMIT_UPDATE_WORKFLOW => [Channel::EMAIL],
        self::NEED_CLARIFICATION_FOR_WEBSITE_UPDATE_WORKFLOW           => [Channel::EMAIL],
        self::NEED_CLARIFICATION_FOR_WEBSITE_ADD_WORKFLOW              => [Channel::EMAIL],
    ];
}
