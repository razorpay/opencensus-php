...
class Status
{
    ...
    const GATEWAY_DUPLICATE_TRANSACTION_REQUEST        = 1038;
	const GATEWAY_TRANSACTION_DUPLICATE_REQUEST        = 1001;
	...
	const GATEWAY_TRANSACTION_DENIED_NEGATIVE_BIN      = 1013;
    ...
    const GATEWAY_CARD_INVALID_NAME        = 1018;
