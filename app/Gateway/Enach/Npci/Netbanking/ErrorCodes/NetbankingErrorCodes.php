...
class NetbankingErrorCodes
{
    ...
    protected static $emandateregisterErrorCodeDescMappings = [
        ...
        self::AP15 => 'Mandate Not Registered_ not maintaining req balanc',
        self::AP14 => 'Invalied User Credentials',
    ...
    protected static $emandateRegisterErrorCodeMappings = [
        ...
        self::R473 => ErrorCode::BAD_REQUEST_INVALID_BANK_FOR_EMANDATE,
        ...
        self::R480 => ErrorCode::BAD_REQUEST_INVALID_BANK_FOR_EMANDATE,
