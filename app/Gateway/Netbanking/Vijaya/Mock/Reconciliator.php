...
class Reconciliator extends Mock\PaymentReconciliator
{
    ...
    {
        $this->gateway = Gateway::NETBANKING_VIJAYA;

        $this->fileExtension = 'txt';

        $this->fileToWriteName = 'RazorPay' . Carbon::now(Timezone::IST)->format('dmY');
    ...
    protected function getReconciliationData(array $input)
    {
        ...
        $data[] = [
            ...
            Carbon::createFromTimestamp($payment['created_at'], Timezone::IST)->format('Y/m/d'),
