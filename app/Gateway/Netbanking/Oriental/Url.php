...
final class Url
{
    const TEST_DOMAIN = 'http://220.226.198.27/';
    ...
    const VERIFY      = 'PreProdcorp/VService?Action.ShoppingMall.Login.Init=Y&BankId=022&UserType=1&USER_LANG_ID=001&AppType=corporate&MD=V&CG=Y&STATFLG=H&CRN=INR';
}
