...
class Validator extends Base\Validator
{
    protected static $authRules = [
        ...
        RequestFields::ACTION_LOAD      => 'required|string|in:Y',
        RequestFields::BANK_ID          => 'required|string',
        RequestFields::LOGIN_FLAG       => 'required|integer|in:1',
        RequestFields::USER_TYPE        => 'required|integer|in:1',
        RequestFields::MENU_ID          => 'required|string|in:CIMSHP',
        RequestFields::CALL_MODE        => 'required|integer|in:2',
