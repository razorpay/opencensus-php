...
class ErrorCodes
{
    protected static $reasonCodes = array(
        ...
        'N:-5002'  => "Recurring payments not supported"
        ...
        'N:-5005'  => "FRAUD - Duplicate lockout"
        ...
        'N:-30031' => "No terminal setup"
        'N:-5005'  => "FRAUD - Card temporarily blocked (Autolockout)"
        ...
        'N:2013'   => "Transaction was rejected from Net Banking Due to Cancelled_BY_User"
        'N:2013'   => "Transaction was rejected from Net Banking Due to VERIFICATION FAILED"
        'N:13'     => "Invalid amount"
        'N:-30050' => "Communication Error"
        'N:-5005'  => "FRAUD - Card's country blocked"
        ...
        'N:800'    => "General Error"
        'N:3'      => "System error. Could not process transaction"
        'N:'       => " "
        ...
        'N:-10501' => "invalid postauth attempt"
        'N:2013'   => "Transaction was rejected from Net Banking Due to null"
        ...
        'N:5'      => "Do not honor"
        'N:43'     => "Stolen card"
        'N:2013'   => "Transaction was rejected from Net Banking Due to Transaction Cancelled at Bank end"
        'N:2'      => "Failed"
        ...
        'N:408'    => "Missing Mandatory Field(s)The field terminal_state_code has exceeded the maximum length of 2"
    ...
    protected static $errorCodeMap = array(
        'N:-7778'  => ErrorCode::GATEWAY_ERROR_TIMED_OUT,
        ...
        'N:5'      => ErrorCode::GATEWAY_ERROR_PROCESSING_DECLINED,
        ...
        'N:-5111'  => ErrorCode::GATEWAY_ERROR_UNKNOWN_ERROR,
        'N:410'    => ErrorCode::GATEWAY_ERROR_PAYMENT_BIN_CHECK_FAILED,
        'N:CI'     => ErrorCode::BAD_REQUEST_PAYMENT_CARD_ISSUING_BANK_NOT_PERMITTING_PAYMENT,
        'N:-5110'  => ErrorCode::GATEWAY_ERROR_CARD_HOLDER_DIDNT_RETURN_FROM_RUPAY,
        ...
        'N:-30031' => ErrorCode::BAD_REQUEST_MERCHANT_NO_TERMINAL_ASSIGNED,
        'N:-30053' => ErrorCode::GATEWAY_ERROR_COMMUNICATION_ERROR,
        ...
        'N:-5102'  => ErrorCode::GATEWAY_ERROR_UNKNOWN_ERROR,
        ...
        'N:-10501' => ErrorCode::BAD_REQUEST_PAYMENT_INVALID_CAPTURE,
        'N:2013'   => ErrorCode::BAD_REQUEST_PAYMENT_TXN_REJECTED_FROM_NET_BANKING,
        'N:-5002'  => ErrorCode::GATEWAY_ERROR_CARD_INVALID_BRAND,
        'N:12'     => ErrorCode::BAD_REQUEST_NO_RECORDS_FOUND,
        'N:-5003'  => ErrorCode::BAD_REQUEST_ORDER_EXISTS,
        'N:-5005'  => ErrorCode::BAD_REQUEST_PAYMENT_POSSIBLE_FRAUD,
        ...
        'N:2013'   => ErrorCode::BAD_REQUEST_PAYMENT_NETBANKING_CANCELLED_BY_BANK,
        'N:2'      => ErrorCode::BAD_REQUEST_PAYMENT_FAILED
        ...
        'N:-70103' => ErrorCode::BAD_REQUEST_PAYMENT_CURRENCY_NOT_SUPPORTED,
        'N:408'    => ErrorCode::BAD_REQUEST_PAYMENT_TERMINAL_STATE_CODE_EXCEEDED_LENGTH,
        'N:-30057' => ErrorCode::GATEWAY_ERROR_COMMUNICATION_ERROR,
        'N:-7777'  => ErrorCode::GATEWAY_ERROR_SYSTEM_BUSY,
        'N:-30053' => ErrorCode::GATEWAY_ERROR_TIMED_OUT,
        ...
        'N:59'     => ErrorCode::BAD_REQUEST_PAYMENT_POSSIBLE_FRAUD,
    );
