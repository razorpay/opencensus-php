...
class VpcMessageCode
{
    const H = 'H';
    public static $acqResponseCodes = [
        ...
        "5103" => "Could not create the specified javax.crypto.Cipher object. You may not have a 
    ...
    public static $map = [
        ...
        "5045" => ErrorCode::GATEWAY_ERROR_TRANSACTION_NOT_PRESENT,
