...
class ResponseCode
{
    ...
    public static $errorCodeMap = array(
        ...
        200 => ErrorCode::GATEWAY_ERROR_CARD_AVS_FAILED,
        ...
        205 => ErrorCode::GATEWAY_ERROR_CARD_STOLEN_LOST,
        207 => ErrorCode::GATEWAY_ERROR_CARD_ISSUING_BANK_UNAVAILABLE,
        208 => ErrorCode::GATEWAY_ERROR_CARD_INACTIVE,
        209 => ErrorCode::GATEWAY_ERROR_CARD_INVALID_NUMBER,
        210 => ErrorCode::GATEWAY_ERROR_CARD_CREDIT_LIMIT_REACHED,
        ...
        222 => ErrorCode::GATEWAY_ERROR_CARD_FROZEN,
        ...
        239 => ErrorCode::GATEWAY_ERROR_PAYMENT_AMOUNT_MISMATCH,
        ...
        251 => ErrorCode::GATEWAY_ERROR_CARD_DAILY_LIMIT_REACHED,
