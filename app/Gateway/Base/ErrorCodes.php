...
//        '16' => 'Approved, Update Track 3',
    ...
    public static function getRelevantGatewayErrorCode($gatewayCode)
    {
        return $gatewayCode;
    }
    ...
    public static function getErrorDescriptionMapped($code)
    {
        if (isset(static::$errorDescriptionMap[$code]))
        {
            return static::$errorDescriptionMap[$code];
        }
