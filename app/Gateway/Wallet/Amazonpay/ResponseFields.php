...
final class ResponseFields
{
     ...
     */
    const REFUND_PAYMENT_RESULT  = 'RefundPaymentResult';
     ...
     * TODO: Confirm if the fee refunded attribute is the right value to check for assertAmount after testing on UAT
     */
