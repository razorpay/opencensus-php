...
trait RequestTrait
{
    ...
    {
        return (new Crypto($this->getGatewayPassword()))->encryptString($content);
    }

    protected function decryptString($content)
    {
        return (new Crypto($this->getGatewayPassword()))->decryptString($content);
    }
