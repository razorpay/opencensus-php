...
class Gateway extends Base\Gateway
{
    ...
    public function getQrRefId($input): string
    {
        ...
        {
            $input[Fields::VALIDITY_END_DATE_TIME] = Carbon::createFromTimestamp($qrCode[QrEntity::CLOSE_BY], Timezone::IST)->format(self::QR_CODE_TIME_FORMAT);
        }
        ...
        if ($qrCode[QrCode\Entity::STATUS] === QrCode\NonVirtualAccountQrCode\Status::CLOSED)
        {
            ...
            $input[Fields::VALIDITY_END_DATE_TIME]   = Carbon::createFromTimestamp($qrCode[QrEntity::CLOSED_AT], Timezone::IST)->format(self::QR_CODE_TIME_FORMAT);
            $input[Fields::UPDATE]                   = self::QR_UPDATE;
            $input[Fields::VALIDITY_START_DATE_TIME] = Carbon::createFromTimestamp($qrCode[QrEntity::CREATED_AT], Timezone::IST)->format(self::QR_CODE_TIME_FORMAT);

            $qrMetaData = (new QrCode\NonVirtualAccountQrCode\Entity($qrCode))->fetchQrStringMetaData();
            $input[Fields::REF_ID] = $qrMetaData['tr'];
        }
