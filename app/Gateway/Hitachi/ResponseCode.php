...
class ResponseCode
{
    ...
    protected static $responseCodeToErrorCodeMap = [
        ...
        '03' => ErrorCode::GATEWAY_ERROR_UNKNOWN_ERROR,
        ...
        '15' => ErrorCode::BAD_REQUEST_PAYMENT_CARD_DETAILS_INVALID,
        ...
        '25' => ErrorCode::GATEWAY_ERROR_UNKNOWN_ERROR,
        '28' => ErrorCode::GATEWAY_ERROR_UNKNOWN_ERROR,
        ...
        '52' => ErrorCode::BAD_REQUEST_PAYMENT_FAILED,
        '53' => ErrorCode::BAD_REQUEST_PAYMENT_FAILED,
