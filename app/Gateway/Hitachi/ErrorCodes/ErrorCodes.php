...
class ErrorCodes extends Cards\ErrorCodes
{
    public static $authRespCodeMap = [
        ...
        '85' => ErrorCode::GATEWAY_ERROR_UNKNOWN_ERROR,
        '95' => ErrorCode::GATEWAY_ERROR_RECONCILE_ERROR,
        'B1' => ErrorCode::GATEWAY_ERROR_UNKNOWN_ERROR,
        'N0' => ErrorCode::GATEWAY_ERROR_UNKNOWN_ERROR,
        'N3' => ErrorCode::BAD_REQUEST_CARD_ISSUING_BANK_UNAVAILABLE,
        'N4' => ErrorCode::GATEWAY_ERROR_UNKNOWN_ERROR,
