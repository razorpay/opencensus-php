...
class Service extends Base\Service
{
    ...
    /**
     * Note :- Adding condition that if the request is from X dashboard (if product
     *  is banking), an additional user authorization token also has to be given in input.
    ...
    public function editContactMobile(array $input)
    {
        ...
        {
            (new Validator())->validateInput('edit_contact_mobile_for_banking', $input);
