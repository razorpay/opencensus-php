...
class Core extends Base\Core
{
     ...
     *
     *  Note :- Adding condition that if the request is for x (if product
     *  is banking), a token authorizing he user has to be passed.
     *  This token is generated by using "users/email/verify-user".
     *
     * @param array  $input
     * @param Entity $user
     *
