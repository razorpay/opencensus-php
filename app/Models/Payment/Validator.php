...
class Validator extends Base\Validator
{
    ...
    protected static $createRules = [
        ...
        'vpa_token'                     => 'sometimes_if:method,upi|string|filled|max:100|custom',
        ...
        'upi.vpa_token'                 => 'sometimes_if:method,upi|filled|string',
    ...
    protected static $createUpiUnexpectedPaymentRules = [
        ...
        'upi.gateway_merchant_id'       => 'sometimes',
        'upi.vpa'                       => 'required',
        'upi.status_code'               => 'sometimes',
        'upi.account_number'            => 'sometimes',
        'upi.ifsc'                      => 'sometimes',
        'terminal'                      => 'required|array',
        'terminal.gateway_merchant_id'  => 'sometimes',
        'terminal.gateway_merchant_id2' => 'sometimes',
        'terminal.gateway'              => 'required|string|in:upi_sbi,upi_icici,upi_axis,upi_yesbank,upi_kotak,upi_axisolive,upi_juspay,upi_mindgate,upi_airtel,upi_rzpapb',
        'meta'                          => 'required|array',
    ...
    protected static $authorizeFailedNetbankingPaymentRules = [
        ...
        'netbanking.gateway'                   => 'required|string',
        'meta'                                 => 'required|array',
        'meta.force_auth_payment'              => 'required|boolean',
        'meta.art_request_id'                  => 'required',
        'meta.version'                         => 'required',
...
//        'paylater.gateway'                     => 'required|string',
    ...
    public function validateCardAndCvv(array $input)
    {
        ...
        */
        ...
        if (($this->entity->card->isAmex() ||  $this->entity->card->isVisa() || $this->entity->card->isMasterCard() || $this->entity->card->isDiners())
    ...
    protected function validateFee($input)
    {
        if (isset($input['fee']))
        {
            ...
            if ($merchant->IsCardlessEmiConvenienceFeeEnabled() === false && $merchant->isFeeBearerCustomerOrDynamic() === false)
            {
                throw new Exception\BadRequestValidationFailureException(
