...
class Validator extends Base\Validator
{
    ...
    protected static $createUpiUnexpectedPaymentRules = [
        ...
        'terminal.gateway'              => 'required|string|in:upi_sbi,upi_icici,upi_axis,upi_yesbank,upi_kotak',
        'meta'                          => 'required|array',
    ...
    protected static $authorizeFailedUpiPaymentRules = [
        ...
        'upi.vpa'                       => 'required',
        'upi.gateway'                   => 'required|string|in:upi_sbi,upi_icici,upi_axis,upi_yesbank,upi_kotak',
        'meta'                          => 'required|array',
