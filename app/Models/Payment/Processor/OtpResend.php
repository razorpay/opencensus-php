        ...
        if (($payment->isMethodCardOrEmi() === true) and
            (($payment->getAuthType() === Payment\AuthType::HEADLESS_OTP) or
             ($payment->getAuthType() === Payment\AuthType::IVR)  or
                ((($payment->getGateway() === Payment\Gateway::PAYSECURE) or ($payment->getGateway() === Payment\Gateway::AXIS_MIGS) or ($payment->getGateway() === Payment\Gateway::HITACHI) or ($payment->getGateway() === Payment\Gateway::KOTAK_DEBIT_EMI) or ($payment->getGateway() === Payment\Gateway::INDUSIND_DEBIT_EMI)) and
