...
class DetailedError
{
    ...
    public static $reasonFieldMap = [
        ...
        "R073"                                                          =>              "incorrect_credentials",
        "R074"                                                          =>              "kyc_pending",
        "R075"                                                          =>              "debit_account_blocked",
        "R076"                                                          =>              "payment_pending_approval",
        "R077"                                                          =>              "website_mismatch",
        "R078"                                                          =>              "aadhaar_not_mapped",
        "R079"                                                          =>              "mandate_inactive",
        "R080"                                                          =>              "payment_authorization",
        "R081"                                                          =>              "mandate_expired",
        "R082"                                                          =>              "invalid_frequency",
        "R083"                                                          =>              "customer_action_needed",
        "R084"                                                          =>              "invalid_ifsc",
        "R085"                                                          =>              "user_mismatch",
        "R086"                                                          =>              "debit_after_mandate_ended",
        "R087"                                                          =>              "debit_before_mandate_start",
        "R088"                                                          =>              "issuer_down",
        ];
}
