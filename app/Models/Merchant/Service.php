...
class Service extends Base\Service
{
    ...
    public function editConfig(array $input): array
    {
        ...
        if ((isset($requestData['isRectangularLogo']) === true) and (empty($requestData['isRectangularLogo']) === false) and ($this->merchant->isCustomMerchantUpiQrEnabled() === true))
        {
        ...
        if($isRectangularLogo === true)
        {
            ...
            $key = Merchant\Entity::RECT_LOGO_URL;
    ...
    public function deleteMerchantLogo(): array
    {
        ...
        if ((isset($requestData['isRectangularLogo']) === true) and (empty($requestData['isRectangularLogo']) === false) and ($this->merchant->isCustomMerchantUpiQrEnabled() === true))
        {
            ...
            (new BankingConfig\Core())->upsertBankingConfigs($bankingConfigInput, '', true, true);
        }
        else
        {
...
//        $dataLakeQuery1 = sprintf(TokenConstants::DATA_LAKE_TOKEN_HQ_ONBOARD_MERCHANT,$currentDate);
    ...
    */
    ...
    public function rizePaymentsCallback($input, string $traceCode, string $pgosRoute): void
    {
        ...
        $this->pgosProxyController->handlePGOSProxyRequests($pgosRoute, $callBackObj, $merchant, true);
    }
