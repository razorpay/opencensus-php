...
class Validator extends Base\Validator
{
    ...
    public static $createForSubmitRules = [
        ...
        Entity::MONTHLY_SALES_INTL_CARDS_MAX        => 'required_with:monthly_sales_intl_cards_min|integer',
        ...
        Entity::LOGISTIC_PARTNERS                   => 'nullable|required_if:goods_type,physical_goods,both|string|min:1|max:500',

        Entity::ABOUT_US_LINK                       => 'required|active_url',
        Entity::CONTACT_US_LINK                     => 'required|active_url',
        Entity::TERMS_AND_CONDITIONS_LINK           => 'required|active_url',
        Entity::PRIVACY_POLICY_LINK                 => 'required|active_url',
        Entity::REFUND_AND_CANCELLATION_POLICY_LINK => 'required|active_url',
        Entity::SHIPPING_POLICY_LINK                => 'nullable|required_if:goods_type,physical_goods,both|active_url',
        Entity::SOCIAL_MEDIA_PAGE_LINK              => 'nullable|sometimes|active_url',

        Entity::EXISTING_RISK_CHECKS                => 'required|array|between:1,10',
        Entity::EXISTING_RISK_CHECKS . '.*'         => 'required|string|min:1|max:500',
        Entity::CUSTOMER_INFO_COLLECTED             => 'required|array|between:1,10',
        Entity::CUSTOMER_INFO_COLLECTED . '.*'      => 'required|string|min:1|max:300',
        Entity::PARTNER_DETAILS_PLUGINS             => 'required|array|between:1,15',
        Entity::PARTNER_DETAILS_PLUGINS . '.*'      => 'required|string|min:1|max:300',
