...
//        Entity::EMAIL                       => 'sometimes|email|unique:merchants',
    ...
    protected static $appScalabilityChangeFtuxRules = [
        constants::PRODUCT       => 'required|string|in:payment_link,payment_gateway,payment_pages,assisted_financing,qr_code,subscriptions,payment_button',
    ...
    protected static $listSubmerchantsRules = [
        ...
        Entity::PRODUCT                   => 'required_with:is_used|in:primary,banking,capital,pos',
