...
class Constants
{
    ...
    const  CREATE_UDD_FOR_NON_PGOS_MERCHANTS = "CREATE_UDD_FOR_NON_PGOS_MERCHANTS";
    ...
    const VERIFICATION_RESPONSE_ERROR_CODES = [
        ...
        BVSConstants::AADHAAR . BvsValidationConstants::PROOF . 'code - 400 error - Bad Request errorType - REQUEST_TIMED_OUT'                    => 'AADHAAR_BAD_REQUEST_TIMEOUT',
        BVSConstants::AADHAAR . BvsValidationConstants::PROOF . 'Ufh request failed with http code - 500'                                         => 'AADHAAR_UFH_INTERNAL_ERROR',
        BVSConstants::AADHAAR . BvsValidationConstants::PROOF . 'Ufh request failed with http code - 502'                                         => 'AADHAAR_UFH_BAD_GATEWAY',
        BVSConstants::AADHAAR . BvsValidationConstants::PROOF . 'Ufh request failed with http code - 503'                                         => 'AADHAAR_UFH_SERVICE_UNAVAILABLE',
        ...
        BVSConstants::AADHAAR . BvsValidationConstants::PROOF . 'invalid document type'                                                           => 'AADHAAR_DOC_TYPE_INVALID',
        BVSConstants::AADHAAR . BvsValidationConstants::PROOF . 'code - 400 error - Bad Request errorType - MAX_SIZE_ALLOWED_EXCEEDED'            => 'AADHAAR_MAX_SIZE_ALLOWED_EXCEEDED',
        BVSConstants::AADHAAR . BvsValidationConstants::PROOF . 'code - 400 error - Bad Request errorType - INVALID_FILE_FORMAT'                  => 'AADHAAR_INVALID_FILE_FORMAT',
        BVSConstants::AADHAAR . BvsValidationConstants::PROOF . 'code - 400 error - Bad Request errorType - MAX_PAGES_ALLOWED_EXCEEDED'           => 'AADHAAR_MAX_PAGES_ALLOWED_EXCEEDED',
        BVSConstants::AADHAAR . BvsValidationConstants::PROOF . 'code - 400 error - Bad Request errorType - INCORRECT_PDF_PASSWORD'               => 'AADHAAR_INCORRECT_PDF_PASSWORD',
        ...
        BVSConstants::AADHAAR . BvsValidationConstants::PROOF . 'invalid image submitted'                                                         => 'AADHAAR_INVALID_IMAGE_SUBMITTED',
