...
class BusinessCategory
{
    ...
    // The below map is used for all the category subcategory validations, business logics in the backend.
    ...
    // The below map is used by the UI to display v1 categories-subcategories map to the merchant/admin (Old merchant dashboard
    // and admin dashboard )

    const SUBCATEGORY_MAP_OLD = [
        self::ECOMMERCE => [
            Sub::ECOMMERCE_MARKETPLACE,
            Sub::AGRICULTURE,
            Sub::BOOKS,
