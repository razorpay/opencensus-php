...
class Validator extends Base\Validator
{
    ...
    protected static $createRules = [
        ...
        Entity::COMPANY_PAN                     => 'sometimes|alpha_num|max:10|regex:"[A-Za-z]{5}\d{4}[A-Za-z]{1}"',
        ...
        Entity::PROMOTER_PAN                    => 'sometimes|alpha_num|max:10|regex:"[A-Za-z]{5}\d{4}[A-Za-z]{1}"',
    ...
    protected static $instantActivationRules = [
        ...
        Entity::BUSINESS_SUBCATEGORY => 'sometimes|max:255|custom',
        Entity::PROMOTER_PAN         => 'required|alpha_num|max:10|regex:"[A-Za-z]{5}\d{4}[A-Za-z]{1}"',
