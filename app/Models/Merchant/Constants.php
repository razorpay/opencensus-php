...
final class Constants
{
    ...
    const SOURCE_APP_ID                           = 'source_app_id';
    ...
    const SUBMERCHANT_MAIL_ATTRIBUTES = [
        Entity::ID,
        Entity::COUNTRY_CODE,
        Entity::EMAIL,
        Entity::NAME,
    ...
    const SUBM_EASY_SIGNUP                       = 'SUBM_EASY_SIGNUP';
    ...
    const MERCHANT_RISK_SCORE_DATA_PINOT_QUERY  = 'SELECT * FROM risk_scoring_fact WHERE merchants_id = \'%s\'';
