...
class Decomp extends Base\Service
{
    ...
    {
        $useMCS = $this->useMCSForShopifyCompleteCheckoutForFeatureFlags();
        if (!$useMCS)
        {
            return false;
        }
    ...
    public function placeShopifyOrderFromMCSQueue(array $publishData, int $waitTime): void
    {
    ...
    public function useMCSForAsyncCompleteCheckout(): bool
    {
        $useMCS = $this->useMCSForShopifyCompleteCheckoutForFeatureFlags();
        if (!$useMCS)
        {
        ...
        return (new SplitzExperimentEvaluator())->useMCSForAsyncShopifyCompleteCheckout();
    }
    ...
    protected function useMCSForShopifyCompleteCheckoutForFeatureFlags(): bool
    {
