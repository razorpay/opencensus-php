...
class Entity extends Base\PublicEntity
{
    ...
    {
        // If the merchant is created through the dashboard, the id is provided by the dashboard
        // If the merchant is created through the accounts API, the id is generated by the API
        $id = $this->getId();
