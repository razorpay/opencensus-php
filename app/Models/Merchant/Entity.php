...
class Entity extends Base\PublicEntity
{
    ...
    const AUTO_REFUND_DELAY_FOR_EMANDATE = 604800; // 7 days
    ...
    public function isLRSEducationFlowEnabled(): bool
    {
    ...
    public function getShippingSourceConfig()
    {
        return (new Merchant1ccConfig\Repository())
            ->findByMerchantAndConfigType(
                $this->getId(),
                Merchant1ccConfig\Type::SHIPPING_SOURCE
            );
    }
     ...
     */
    public function getRectangularLogoUrl()
    {
        ...
        $logoUrl = $this->getFullUrlFromRelativeUrl($relativeLogoUrl);
    ...
    public function getFullLogoUrlWithSize($size = self::ORIGINAL_SIZE)
    {
        ...
        $logoUrl = $this->getFullUrlFromRelativeUrl($relativeLogoUrl, $size);
