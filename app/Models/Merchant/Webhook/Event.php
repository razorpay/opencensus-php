...
class Event
{
    ...
    public static $eventsToFeatureMap = [
        ...
        self::TRANSFER_PROCESSED                => [Feature\Constants::MARKETPLACE, Feature\Constants::OPENWALLET],
        self::TRANSFER_SETTLED                  => Feature\Constants::TRANSFER_SETTLED_WEBHOOK,
        self::TRANSFER_FAILED                   => [Feature\Constants::MARKETPLACE, Feature\Constants::OPENWALLET],
