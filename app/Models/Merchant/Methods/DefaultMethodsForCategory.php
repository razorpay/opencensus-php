...
class DefaultMethodsForCategory
{
        ...
        const CATEGORY_DEFAULT_PROHIBITED_METHODS_MAP = [
            ...
            '6211'    => [
                Category::MUTUAL_FUNDS => [
                    self::BLACKLISTED_METHODS   => [Entity::CREDIT_CARD, Entity::AMEX, Entity::EMI, Entity::PREPAID_CARD, Entity::PAYLATER, Entity::PHONEPE, Entity::HDFC_DEBIT_EMI],
            ...
            '8931'  =>  [
                Category::OTHERS    =>  [
                    self::BLACKLISTED_METHODS => [Entity::AMEX, Entity::EMI, Entity::PHONEPE, Entity::HDFC_DEBIT_EMI],
                    self::GREYLISTED_METHODS =>[],
                    self::IGNORE_BLACKLIST_FOR_INSTRUMENT_REQUEST_METHODS => [Entity::AMEX],
                ],
            ],
            ...
            '5816'  =>  [
                Category::OTHERS    =>  [
                    self::BLACKLISTED_METHODS => [ENTITY::AMEX, Entity::EMI, Entity::FREECHARGE, Entity::HDFC_DEBIT_EMI],
                    self::GREYLISTED_METHODS =>[],
                    self::IGNORE_BLACKLIST_FOR_INSTRUMENT_REQUEST_METHODS => [Entity::AMEX],
                ]
            ],
            ...
            '5094'  =>  [
                Category::ECOMMERCE    =>  [
                    self::BLACKLISTED_METHODS => [ENTITY::EMI, Entity::HDFC_DEBIT_EMI],
                    self::GREYLISTED_METHODS =>[],
                    self::IGNORE_BLACKLIST_FOR_INSTRUMENT_REQUEST_METHODS => [],
                ]
            ],
    ...
    public static function getDefaultDisabledMethodsForInstrumentRequestFromMerchantCategories($category, $category2)
    {
        ...
        $greyedMethods = self::CATEGORY_DEFAULT_PROHIBITED_METHODS_MAP[$category][$category2][self::GREYLISTED_METHODS] ?? (self::CATEGORY_DEFAULT_PROHIBITED_METHODS_MAP[$category][Category::OTHERS][self::GREYLISTED_METHODS] ?? self::CATEGORY_DEFAULT_PROHIBITED_METHODS_MAP[Category::OTHERS][Category::OTHERS][self::GREYLISTED_METHODS]) ?? [];
