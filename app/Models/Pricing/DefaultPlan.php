...
class DefaultPlan
{
    ...
    */
    ...
    const SUB_MERCHANT_DEFAULT_PRICING_PLAN_MAP_CAT2 = [
        FeeBearer::PLATFORM => [
            Category::ECOMMERCE => 'Mar24EcomPLATnewINTMAIN',
            Category::FOREX => 'Mar24EcomPLATnewINTMAIN',
            Category::LENDING => 'Mar24FinancialServicesPlat',
            Category::LOGISTICS => 'Mar24EcomPLATnewINTMAIN',
            Category::PHARMA => 'Mar24EcomPLATnewINTMAIN',
            Category::SECURITIES => 'Mar24MutualFundPLAT',
            Category::FINANCIAL_SERVICES => 'Mar24FinancialServicesPlat',
            Category::FOOD_AND_BEVERAGE => 'Mar24EcomPLATnewINTMAIN',
            Category::HEALTHCARE => 'Mar24EcomPLATnewINTMAIN',
            Category::IT_AND_SOFTWARE => 'Mar24EcomPLATnewINTMAIN',
            Category::MEDIA_AND_ENTERTAINMENT => 'Mar24EcomPLATnewINTMAIN',
            Category::MONEY_TRANSFER => 'Mar24EcomPLATnewINTMAIN',
            Category::NOT_FOR_PROFIT => 'Mar24EcomPLATnewINTMAIN',
            Category::SERVICES => 'Mar24EcomPLATnewINTMAIN',
            Category::SOCIAL => 'Mar24EcomPLATnewINTMAIN',
            Category::CRYPTOCURRENCY => 'Mar24EcomPLATnewINTMAIN',
            Category::COMMODITIES => 'Mar24EcomPLATnewINTMAIN',
            Category::UTILITIES => 'Mar24UtilityPlatNewINTone',
            Category::RECHARGES => 'Mar24EcomPLATnewINTMAIN',
            Category::INSURANCE => 'Mar24InsurPLAT',
            Category::MUTUAL_FUNDS => 'Mar24MutualFundPLAT',
            Category::EDUCATION => 'Mar24NewICICEduPLATINTOne',
            Category::GOVT_EDUCATION => 'Mar24NewICICEduPLATINTOne',
            Category::PVT_EDUCATION => 'Mar24NewICICEduPLATINTOne',
            Category::GOVERNMENT => 'Mar24GovPlatNewINTONE',
            Category::HOUSING => 'Mar24ICICIHousplatNewINT',
            Category::REAL_ESTATE => 'Mar24ICICIHousplatNewINT',
            Category::TRAVEL_AGENCY => 'Mar24ICICtoursPLTintNEW',
            Category::TRANSPORT => 'Mar24ICICtoursPLTintNEW',
            Category::HOSPITALITY => 'Mar24ICICtoursPLTintNEW',
            Category::CORPORATE => 'Mar24B2BplatNewINT',
        ],
        FeeBearer::CUSTOMER => [
            Category::ECOMMERCE => 'Mar24EcomCustNew',
            Category::FOREX => 'Mar24EcomCustNew',
            Category::LENDING => 'Mar24FinancialServicesCust',
            Category::LOGISTICS => 'Mar24EcomCustNew',
            Category::PHARMA => 'Mar24EcomCustNew',
            Category::SECURITIES => 'Mar24MutualFundCUST',
            Category::FINANCIAL_SERVICES => 'Mar24FinancialServicesCust',
            Category::FOOD_AND_BEVERAGE => 'Mar24EcomCustNew',
            Category::HEALTHCARE => 'Mar24EcomCustNew',
            Category::IT_AND_SOFTWARE => 'Mar24EcomCustNew',
            Category::MEDIA_AND_ENTERTAINMENT => 'Mar24EcomCustNew',
            Category::MONEY_TRANSFER => 'Mar24EcomCustNew',
            Category::NOT_FOR_PROFIT => 'Mar24EcomCustNew',
            Category::SERVICES => 'Mar24EcomCustNew',
            Category::SOCIAL => 'Mar24EcomCustNew',
            Category::CRYPTOCURRENCY => 'Mar24EcomCustNew',
            Category::COMMODITIES => 'Mar24EcomCustNew',
            Category::UTILITIES => 'Mar24UtilityCustNewINTone',
            Category::RECHARGES => 'Mar24EcomCustNew',
            Category::INSURANCE => 'Mar24InsurCUST',
            Category::MUTUAL_FUNDS => 'Mar24MutualFundCUST',
            Category::EDUCATION => 'Mar24NewICICEDUcustNew',
            Category::GOVT_EDUCATION => 'Mar24NewICICEDUcustNew',
            Category::PVT_EDUCATION => 'Mar24NewICICEDUcustNew',
            Category::GOVERNMENT => 'Mar24GovCUSTNewINTONe',
            Category::HOUSING => 'Mar24ICICIHousCustNewINT',
            Category::REAL_ESTATE => 'Mar24ICICIHousCustNewINT',
            Category::TRAVEL_AGENCY => 'Mar24ICICtoursCUSintNEW',
            Category::HOSPITALITY => 'Mar24ICICtoursCUSintNEW',
            Category::TRANSPORT => 'Mar24ICICtoursCUSintNEW',
            Category::CORPORATE => 'Mar24B2BcustNewINT',
        ],
    ];
    ...
    public static function getBankingPlanData(): array
    {
        return [
            ...
            */
            ...
            // Pricing Plans for Fee Recovery Payout
            [
                'id' => '0feeRecovery01',
                'plan_id' => 'BTo98voDY05ueB',
                'plan_name' => 'Banking default plan',
