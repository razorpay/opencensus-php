...
class Validator extends Base\Validator
{
    ...
    protected static $addPlanRuleRules = [
        ...
        Entity::PAYMENT_METHOD          => 'required_unless:feature,refund,optimizer,nocodeapps,payment,affordability_widget,offer_prefunding_fee,sms,buyer_protection,buyer_protection_customer|nullable|string',
        ...
        Entity::EMI_DURATION            => 'sometimes_if:payment_method,emi,instalment|nullable|integer|in:2,3,4,6,9,12,18,24,30,36,48',
        Entity::AUTH_TYPE               => 'sometimes|nullable',
        Entity::INTERNATIONAL           => 'sometimes|in:0,1',
        Entity::RECEIVER_TYPE           => 'sometimes_if:payment_method,card,upi|nullable|in:qr_code,vpa,pos,offline,credit,wallet,credit_line',
