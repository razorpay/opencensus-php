...
class Type
{
    ...
    const CANCEL_BULK_GIFT_CARDS            = 'cancel_bulk_gift_cards';
    ...
    const EMANDATE_DEBIT_NACH_ICICI   = 'emandate_debit_nach_icici';
    ...
    public static $batchToAdminPermissionMapping = [
        ...
        self::ALT_ID_TERMINAL_ONBOARD            => Name::ADMIN_BATCH_CREATE,
