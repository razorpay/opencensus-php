...
class Flexmoney extends BaseProcessor
{
    /**
    ...
    protected function processEntry(array &$entry)
    {
        ...
        $networkCategory         = trim($entry[Batch\Header::FLEXMONEY_CATEGORY]);
        ...
        $createTerminalParams = [
            ...
            Terminal\Entity::GATEWAY_ACQUIRER           => CardlessEmi::FLEXMONEY,
        ...
        try
        {
            ...
            $entry[Batch\Header::FLEXMONEY_TERMINAL_ID]    = $terminal[Terminal\Entity::ID];
        }
