...
class EnachNbIcici extends Base
{
    ...
    protected function getDataFromRow(array & $row): array
    {
        ...
        $paymentId       = $row[Headings::TRANSACTION_REFERENCE];
    ...
    protected function getPayment(array $content)
    {
        ...
        if (($payment->getGateway() !== Gateway::ENACH_NPCI_NETBANKING) or
    ...
    {
        return $this->repo->enach->findAuthorizedPaymentByPaymentId($paymentId);
    }
