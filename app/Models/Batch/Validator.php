...
class Validator extends Base\Validator
{
    ...
    protected static $altIdTerminalOnboardCreateRules = [
        Entity::TYPE                 => 'required|in:alt_id_terminal_onboard',
        Entity::NAME                 => 'filled|string|max:255',
    ...
    protected static $vendorOnboardingCreateRules = [
        Entity::TYPE                    => 'required|in:vendor_onboarding',
        Entity::NAME                    => 'filled|string|max:255',
        Entity::FILE                    => 'required_without:file_id|file|max:60720' . self::DEFAULT_MIME_RULE,  // 60MB
        Entity::FILE_ID                 => 'required_without:file|public_id',
    ];
    ...
    protected static $updateGiftCardsExpiryCreateRules = [
        Entity::TYPE                 => 'required|custom',
        Entity::NAME                 => 'filled|string|max:255',
        Entity::FILE                 => 'required_without:file_id|file|max:51200' . self::DEFAULT_MIME_RULE,
        Entity::FILE_ID              => 'required_without:file|public_id'
    ...
    protected static $createBulkGiftCardsCreateRules = [
        Entity::TYPE                 => 'required|custom',
        Entity::NAME                 => 'filled|string|max:255',
        Entity::FILE                 => 'required_without:file_id|file|max:51200' . self::DEFAULT_MIME_RULE,
        Entity::FILE_ID              => 'required_without:file|public_id'
    ...
    protected static $editTerminalBatchRowRules = [
        ...
        Header::UPI_ONBOARDED_TERMINAL_EDIT_ALLOW_CC          =>
            'sometimes|boolean|required_if:' . Header::UPI_ONBOARDED_TERMINAL_EDIT_GATEWAY . ',' .
            Gateway::UPI_YESBANK,
