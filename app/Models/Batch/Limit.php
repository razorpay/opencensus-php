...
class Limit
{
    ...
    const HEADER_MAP = [
        ...
        Type::CANCEL_DORMANT_MANDATES               => 10000,
        Type::RECURRING_TOKEN_DELETE                => 10000,
        ...
        Type::STORE_CREATION                        => 10000,
        Type::STORE_HIERARCHY_CREATION              => 10000,
        Type::USER_GROUP_MAPPING                    => 10000,
        Type::DEVICE_STORE_MAPPING                  => 10000,
        Type::HDFC_ONBOARDING                       => 10000,
        Type::INDIAN_BANK_ONBOARDING                => 10000,
