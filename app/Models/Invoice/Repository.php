...
class Repository extends Base\Repository
{
    ...
    protected function addQueryParamPaymentId($query, $params)
    {
        ...
        $paymentIdAttribute = $this->repo->payment->getAttributeWithTableName(Payment\Entity::ID);
    ...
    protected function addQueryParamOrderId($query, $params)
    {
        ...
        $orderIdAttribute = $this->repo->invoice->getAttributeWithTableName(Entity::ORDER_ID);
