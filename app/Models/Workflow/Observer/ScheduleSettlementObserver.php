...
class ScheduleSettlementObserver implements WorkflowObserverInterface
{
    ...
    public function onApprove(array $observerData)
    {
        ...
        if (key_exists(FDConstants::TICKET_ID, $observerData) === true && key_exists(FDConstants::FD_INSTANCE, $observerData) === true)
        {
            ...
            $this->fdService->resolveTicket($observerData[FDConstants::FD_INSTANCE], $observerData[FDConstants::TICKET_ID] );
        }
    }
    ...
    public function getTicketReplyContent(string $approve_reject, string $merchantId) : array
    {
