...
class Validator extends Base\Validator
{
    ...
    protected static $createRules = [
        ...
        Entity::AMOUNT              => 'required_without:unit_amount|integer|min:100|max:2147483647',
        Entity::UNIT_AMOUNT         => 'required_without:amount|integer|min:100|max:2147483647',
    ...
    protected static $editRules  = [
        ...
        Entity::DESCRIPTION         => 'sometimes|nullable|string|max:2048',
        Entity::AMOUNT              => 'filled|integer|min:100|max:2147483647',
        Entity::UNIT_AMOUNT         => 'filled|integer|min:100|max:2147483647',
        Entity::CURRENCY            => 'filled|size:3|in:INR',
