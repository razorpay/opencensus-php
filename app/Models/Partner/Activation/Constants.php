...
class Constants
{
    ...
    const PARTNER_ACTIVATION_ACTIVATED_SMS_TEMPLATE_NAME = 'Sms.Partner_activation.Activated';
    const PARTNER_ACTIVATION_NEEDS_CLARIFICATION_SMS_TEMPLATE_NAME = 'Sms.Partner_activation.Needs_clarification';
    const PARTNER_ACTIVATION_NEEDS_CLARIFICATION_WHATSAPP_TEMPLATE_NAME = 'partner_activation_needs_clarification';
