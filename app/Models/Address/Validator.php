...
class Validator extends Base\Validator
{
    ...
    protected static $createForPaymentRules = [
        ...
        Entity::CITY    => 'required_unless:type,sender_address|string|between:2,32',
    ...
    protected static $createForCustomerRules = [
        ...
        Entity::SOURCE_TYPE => 'sometimes|in:bulk_upload,payment_pages,thirdwatch,shopify,woocommerce,sopc,unicommerce,shiprocket,unicommerce_turbo',
    ];
