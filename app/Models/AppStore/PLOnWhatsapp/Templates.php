...
class Templates
{
    const WELCOME_MESSAGE_TEMPLATE = "WELCOME_MESSAGE_TEMPLATE";

    const WRONG_MESSAGE_TEMPLATE = "WRONG_MESSAGE_TEMPLATE";
    ...
    const WHATSAPP_TEMPLATES = [
        self::WELCOME_MESSAGE_TEMPLATE => 'Congratulations! You have successfully installed Razorpay Whatsapp Bot for Payment Links. Now, you can create payments links from Whatsapp directly.
...
eg: _*Create 100*_ will create a Payment Link for INR 100',
        ...
        self::WRONG_MESSAGE_TEMPLATE => 'Sorry! We could not understand the message.
