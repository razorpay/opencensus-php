...
class Validator extends Base\Validator
{
    protected static $createRules = [
        ...
        Entity::VAULT              => 'sometimes|string|in:tokenex,rzpvault,rzpencryption,mastercard,visa,rupay,amex,hdfc',
    ...
    protected static $tokenizedCardRules = [
        ...
        Entity::VAULT_TOKEN        => 'sometimes|string',
        Entity::GLOBAL_FINGERPRINT => 'sometimes|string',
        Entity::VAULT              => 'required_with:vault_token|in:tokenex,rzpvault,rzpencryption,mastercard,visa,rupay,amex,hdfc',
        Entity::IIN                => 'required|numeric|digits:6',
