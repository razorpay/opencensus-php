...
class StatusCode
{
    ...
    const DUPLICATE_CHALLAN                  = 'Duplicate Challan';
    const CHALLAN_EXPIRED                    = 'Challan Expired';
    const INVALID_UTR                        = 'Invalid UTR';
    const CHALLAN_NOT_FOUND                  = 'Challan Not Found';
    const CHALLAN_NOT_VALIDATED              = 'Challan is not validated';
    ...
    const statusToCodeMapping = [
        ...
        StatusCode::DUPLICATE_CHALLAN                  => 1,
        StatusCode::CHALLAN_EXPIRED                    => 1,
        StatusCode::INVALID_UTR                        => 1,
        StatusCode::CHALLAN_NOT_FOUND                  => 1,
    ...
    public static function getStatusCodeForEcollect($status): int
    {
