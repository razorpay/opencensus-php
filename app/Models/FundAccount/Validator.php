...
class Validator extends Base\Validator
{
    ...
    protected static $createRules = [
        ...
        Entity::MOBILE                                   => 'sometimes|regex:/^\d+$/|between:8,10',
    ...
    protected function validateAccountAttribute($input)
    {
        ...
        $correctPresence = ((isset($input[Entity::CARD]) === true) xor
                            ...
                            (isset($input[Entity::MOBILE]) === true && is_array($input[Entity::MOBILE]) === true)); // Mobile number can be array or string

        if ($correctPresence === false)
        {
            throw new Exception\BadRequestValidationFailureException(
                'Only one of card, vpa, bank_account, mobile or wallet can be present',
                null,
                [
                    'input' => $input,
                ]);
    ...
    protected static $rxDualWriteInputRules = [
        ...
        Entity::SOURCE_ID                             => 'required|string|size:14',
        Entity::SOURCE_TYPE                           => 'required|string|in:contact',
        Entity::ACCOUNT_ID                            => 'required|string|size:14',
        Entity::ACCOUNT_TYPE                          => 'required|string|in:bank_account,vpa,card,wallet_account',
        Entity::VPA                                   => 'filled|associative_array',
        Entity::BANK_ACCOUNT                          => 'filled|associative_array',
        Entity::BANK_ACCOUNT . '.id'                  => 'sometimes:bank_account|string|size:14',
        Entity::BANK_ACCOUNT . '.merchant_id'         => 'string|size:14',
        Entity::BANK_ACCOUNT . '.entity_id'           => 'string|size:14',
        Entity::BANK_ACCOUNT . '.type'                => 'string',
        Entity::BANK_ACCOUNT . '.beneficiary_name'    => 'string',
        Entity::BANK_ACCOUNT . '.ifsc_code'           => 'string',
        Entity::BANK_ACCOUNT . '.account_number'      => 'string',
        Entity::BANK_ACCOUNT . '.bank_identifier'     => 'string',
        Entity::BANK_ACCOUNT . '.identifier_type'     => 'string|in:ifsc',
        Entity::BANK_ACCOUNT . '.beneficiary_country' => 'string',
        Entity::BANK_ACCOUNT . '.created_at'          => 'epoch',
        Entity::BANK_ACCOUNT . '.updated_at'          => 'epoch',
        Entity::VPA . '.id'                           => 'sometimes:vpa|required|string|size:14',
        Entity::VPA . '.merchant_id'                  => 'string|size:14',
        Entity::VPA . '.entity_id'                    => 'string|size:14',
        Entity::VPA . '.entity_type'                  => 'string',
        Entity::VPA . '.username'                     => 'string',
        Entity::VPA . '.handle'                       => 'string',
        Entity::VPA . '.created_at'                   => 'epoch',
        Entity::VPA . '.updated_at'                   => 'epoch',
        Entity::CARD                                  => 'filled|associative_array',
        Entity::WALLET_ACCOUNT                        => 'filled|associative_array',
        Entity::LINKED_NUMBER                         => 'sometimes|regex:/^\d+$/|between:8,10',
        Entity::MOBILE                                => 'sometimes|regex:/^\d+$/|between:8,10',
        Entity::IDEMPOTENCY_KEY                       => 'sometimes|string',
        Entity::WALLET_ACCOUNT . '.id'                => 'sometimes:vpa|required|string|size:14',
        Entity::WALLET_ACCOUNT . '.merchant_id'       => 'string|size:14',
        Entity::WALLET_ACCOUNT . '.entity_id'         => 'string|size:14',
        Entity::WALLET_ACCOUNT . '.entity_type'       => 'string',
        Entity::WALLET_ACCOUNT . '.email'             => 'string',
        Entity::WALLET_ACCOUNT . '.name'              => 'string',
        Entity::WALLET_ACCOUNT . '.phone'             => 'string',
        Entity::WALLET_ACCOUNT . '.provider'          => 'string',
        Entity::WALLET_ACCOUNT . '.created_at'        => 'epoch',
        Entity::WALLET_ACCOUNT . '.updated_at'        => 'epoch',
        Entity::CARD . '.id'                          => 'string|size:14',
        Entity::CARD . '.merchant_id'                 => 'string|size:14',
        Entity::CARD . '.' . Card\Entity::LAST4       => 'string',
        Entity::CARD . '.' . Card\Entity::LENGTH      => 'sometimes:card|string',
        Entity::CARD . '.' . Card\Entity::NETWORK     => 'sometimes:card|string',
        Entity::CARD . '.' . Card\Entity::TYPE        => 'sometimes:card|string',
        Entity::CARD . '.' . Card\Entity::SUBTYPE     => 'sometimes:card|string',
        Entity::CARD . '.' . Card\Entity::ISSUER      => 'sometimes:card|string',
        Entity::CARD . '.' . Card\Entity::VAULT       => 'sometimes:card|string',
        Entity::CARD . '.' . Card\Entity::VAULT_TOKEN => 'sometimes:card|string',
        Entity::CARD . '.' . Card\Entity::COUNTRY     => 'sometimes:card|string',
        Entity::CARD . '.' . Card\Entity::CREATED_AT  => 'sometimes:card|epoch',
        Entity::CARD . '.' . Card\Entity::UPDATED_AT  => 'sometimes:card|epoch',
        Entity::BATCH_ID                              => 'sometimes|string',
        Entity::CONTACT_ENTITY                        => 'sometimes',
        Entity::CUSTOMER_NAME                         => 'sometimes|string',
        Entity::BANK_IFSC                             => 'sometimes|string',
        Entity::ACTIVE                                => 'required|filled|boolean',
        Entity::CREATED_AT                            => 'required|epoch',
        Entity::UPDATED_AT                            => 'required|epoch',
        Entity::MERCHANT_ID                           => 'required|string|size:14',
        Entity::UNIQUE_HASH                           => 'required|string',
    ];
