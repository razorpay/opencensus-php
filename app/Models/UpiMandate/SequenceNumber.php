...
class SequenceNumber
{
    ...
    protected function findDifference(): int
    {
        switch ($this->frequency) {
            ...
            /* Sequence Number is implemented for frequencies Daily and Monthly.
            For others : Current Implementation always returns diff as 0 and sequence number as 1.
            */
    ...
    {
        return ($this->toDate)->diffInWeeks($this->fromDate);
    }
    ...
    */
    ...
    {
        return ($this->toDate->year) - ($this->fromDate->year);
    }

    protected function fortnightly(): int
    {
        $diffInWeeks = $this->weekly();

        return floor($diffInWeeks / 2);
    }
