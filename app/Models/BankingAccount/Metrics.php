...
class Metrics extends Core
{
    ...
    const BANKING_ACCOUNT_GATEWAY_BALANCE_INIT              = 'banking_account_gateway_balance_init';
    ...
    const BANKING_ACCOUNT_GATEWAY_BALANCE_FAILURE           = 'banking_account_gateway_balance_failure';
