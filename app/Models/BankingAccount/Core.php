...
class Core extends Base\Core
{
    ...
    protected function getSegmentEventPropertiesForBankingAccountStatusChange(Entity $bankingAccount, $bankingAccountStatus, $bankingAccountSubStatus)
    {
        $properties = [];

        if ($bankingAccountStatus === Status::CREATED)
        {
        ...
        if ($bankingAccountStatus == Status::INITIATED)
        {
        ...
        if($bankingAccountStatus == Status::PROCESSING)
        {
        ...
        if($bankingAccountStatus == Status::PROCESSED)
        {
        ...
        if($bankingAccountStatus == Status::ACTIVATED)
        {
