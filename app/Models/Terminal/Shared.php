...
class Shared
{
    ...
    const UPI_AXIS_RECURRING_TERMINAL    = '100AXISRcrTml';
    const UPI_AXIS_RECURRING_TERMINAL_DEDICATED = '101AXISRcrTml';
    const UPI_AXIS_RECURRING_INTENT_TERMINAL_DEDICATED = '103AXISRcrTml';
