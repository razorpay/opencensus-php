...
class Shared
{
    ...
    const UPI_MINDGATE_RECURRING_INTENT_TERMINAL_DEDICATED = '103MgateRcrTml';
    const UPI_AXIS_RECURRING_TERMINAL    = '100UAXISRcrTml';
    const UPI_AXIS_RECURRING_TERMINAL_DEDICATED = '101UAXISRcrTml';
    const UPI_AXIS_RECURRING_INTENT_TERMINAL_DEDICATED = '103UAXISRcrTml';
    ...
    const CARDLESS_EMI_LIQUILOANS_TERMINAL   = '60CrdlesEmiTml';
    const CARDLESS_EMI_INSTANT_EMI_TERMINAL  = '80CrdlesEmiTml';
    ...
    const UPI_AIRTEL_DEDICATED_OFFLINE_TERMINAL = '100ApbOffTrmnl';
    const UPI_MINDGATE_TERMINAL_DEDICATED    = '100MinDedTrmnl';
    const UPI_MINDGATE_TEST_TERMINAL_DEDICATED = '1000MinDedTrmn';
