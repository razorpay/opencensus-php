...
class Core extends Base\Core
{
    ...
    const MAX_INTL_BANK_TRANSFER_AMOUNT_BY_CURRENCIES = [
        ...
        Currency\Currency::AUD => 39000,
        Currency\Currency::CAD => 35000,
        Currency\Currency::HRK => 200000,
        Currency\Currency::DKK => 160000,
        Currency\Currency::CZK => 530000,
        Currency\Currency::EUR => 22000,
        Currency\Currency::HKD => 200000,
        Currency\Currency::HUF => 106000,
        Currency\Currency::ILS => 86000,
        Currency\Currency::KES => 3300000,
        Currency\Currency::MXN => 480000,
        Currency\Currency::NZD => 42000,
        Currency\Currency::NOK => 259000,
        Currency\Currency::QAR => 93000,
        Currency\Currency::RUB => 2018000,
        Currency\Currency::SAR => 96000,
        Currency\Currency::SGD => 32000,
        Currency\Currency::ZAR => 452000,
        Currency\Currency::SEK => 245000,
        Currency\Currency::CHF => 20000,
        Currency\Currency::THB => 833000,
        Currency\Currency::GBP => 19000,
        Currency\Currency::AED => 94000,
