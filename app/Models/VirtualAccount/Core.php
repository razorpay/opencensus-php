...
class Core extends Base\Core
{
    ...
    public function createOrFetchBankingVirtualAccount(Merchant $merchant): Entity
    {
        $virtualAccount = $this->repo->getActiveVirtualAccountFromBankAccountId($merchant->bankingBalance->getId());
