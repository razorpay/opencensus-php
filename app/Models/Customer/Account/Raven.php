...
class Raven extends Base\Core
{
    ...
    private function getTemplateByOtpReason(string $otpReason): string
    {
        switch ($otpReason)
        {
            ...
            CASE 'access_address_v8':
                return 'sms.checkout.access_address_otp_v8';

            CASE 'access_card_v8':
                return 'sms.checkout.access_card_otp_v8';

            CASE 'access_address_v9':
                return 'sms.checkout.access_address_otp_v9';

            CASE 'save_address_v9':
                return 'sms.checkout.save_address_otp_v9';
