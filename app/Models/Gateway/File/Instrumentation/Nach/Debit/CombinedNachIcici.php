...
namespace RZP\Models\Gateway\File\Instrumentation\Nach\Debit;


use RZP\Trace\TraceCode;
use RZP\Base\RuntimeManager;
use RZP\Models\Gateway\File\Instrumentation\Constants;
use RZP\Models\Gateway\File\Instrumentation\Nach\Debit;
...
class CombinedNachIcici extends Debit\Base
{
    ...
    public function processInput($data, $entries)
    {
        ...
        foreach ($entries as $entry) {
            try {
                $paymentId = trim($entry[Headings::TRANSACTION_REFERENCE]);
