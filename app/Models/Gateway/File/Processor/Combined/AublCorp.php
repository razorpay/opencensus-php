...
{
    const BANK_NAME = 'Aubl_corp';
    const FILE_TYPE               = FileStore\Type::AUBL_CORP_NETBANKING_COMBINED;
    const EXTENSION               = FileStore\Format::XLSX;
    const FILE_NAME               = 'ALL_TXN_REPORT_AUBL_CORP';
    ...
    protected function formatDataForMail(array $data)
    {
        ...
        if (isset($data['claims']) === true)
        {
            ...
            $claimsFile = $this->getFileData(FileStore\Type::AUBL_CORP_NETBANKING_CLAIM);
        }
        ...
        $summaryFile = $this->getFileData(FileStore\Type::AUBL_CORP_NETBANKING_COMBINED);
