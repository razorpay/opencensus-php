...
use RZP\Gateway\Netbanking\Hdfc\EMandateRegistrationFileHeadings as Headings;
...
class NetbankingHdfc extends Base
{
    ...
    public function fetchEntities(): PublicCollection
    {
        ...
        $payments = $this->repo->payment->fetchPendingEMandateRegistration($gateway, $begin, $end);
