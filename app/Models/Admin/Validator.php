...
class Validator extends Base\Validator
{
    ...
    protected static $setConfigKeysRules = [
        ...
        ConfigKey::RX_PAYOUT_TEST_MERCHANTS_TO_EXCLUDE_FOR_METRICS                     => 'filled|array',
        ...
        ConfigKey::ACCOUNT_STATEMENT_SKIP_VALIDATE_BALANCE                                  => 'array',
        ...
        ConfigKey::RETRY_TRANSFER_FAILURE_TOTAL_ATTEMPTS                               => 'filled|integer',
        ...
        ConfigKey::FUND_MANAGEMENT_PAYOUTS_GATEWAY_BALANCE_THRESHOLD                   => 'filled|integer',
        ...
        ConfigKey::MINIMUM_BALANCE_QUEUING_THRESHOLD                                   => 'filled|array',
        ...
        ConfigKey::DEFAULT_PRICING_FOR_FPS                                            => 'filled|array',
        ...
        ConfigKey::UPI_TURBO_PRE_FETCH_BANK_ACCOUNT_TEST                               => 'filled|array',
    ...
    protected static $mozartGatewayPvtRules = [
        'gateway'            => 'required|string|in:citi,icici,yesbank_upi,yesbank,icici_imps,rbl,m2p,axis,amazonpay,mc_send,idfc,hdfc',
