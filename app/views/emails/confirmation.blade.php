...
<html lang="en-US">
	...
	<body>
		...
		<div>
			<p>To activate your account, please click <a href = "{{ URL::to('/#/access/confirm/'.$user['confirm_token']) }}" >here</a>.</p>

			<p>Alternatively, open the following link in your browser:<br/>
			<a href = "{{ URL::to('/#/access/confirm/'.$user['confirm_token']) }}" >{{ URL::to('/#/access/confirm/'.$user['confirm_token']) }}</a>
		</div>
