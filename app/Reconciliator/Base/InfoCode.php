...
class InfoCode
{
    ...
    const RECON_NB_PLUS_QUEUE_DISPATCH                  = 'RECON_NB_PLUS_QUEUE_DISPATCH';

    const NB_PLUS_DATA_MISMATCH                         = 'NB_PLUS_DATA_MISMATCH';

    const NB_PLUS_DATA_ABSENT                           = 'NB_PLUS_DATA_ABSENT';

    const NB_PLUS_RESPONSE_DATA                         = 'NB_PLUS_RESPONSE_DATA';

    const PAYMENT_RECON_NB_PLUS_JOB_FAILURE_EXCEPTION   = 'PAYMENT_RECON_NB_PLUS_JOB_FAILURE_EXCEPTION';
}
