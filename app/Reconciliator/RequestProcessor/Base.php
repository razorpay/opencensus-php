...
class Base extends Core
{
    ...
    const GATEWAY_SENDER_MAPPING = [
        ...
        self::NETBANKING_SCB           => ['no-reply@northakross.in'],
        self::NETBANKING_CBI           => ['smcbipso@centralbankofindia.org.in', 'bmvb4982@centralbank.co.in', 'inbsite@centralbank.co.in'],
        self::NETBANKING_YESB          => [''],
        self::NETBANKING_CUB           => [''],
        self::NETBANKING_IDBI          => [''],
        self::NETBANKING_IBK           => [''],
        self::NETBANKING_RBL           => ['internetbanking@rblbank.com','settlements@razorpay.com'],
        self::NETBANKING_EQUITAS       => ['faverraj@equitasbank.com','deepakp5@equitasbank.com','arunkumar.h@equitasbank.com','ravipudichaitanyan@equitasbank.com'],
        self::NETBANKING_CANARA        => ['canarabank@canarabank.com','settlements@razorpay.com'],
        self::AIRTEL                   => ['no-reply@airtelbank.com','noreply@airtelbank.com'],
        self::NETBANKING_INDUSIND      => [],
        self::NETBANKING_OBC           => [],
        self::NETBANKING_JKB           => ['netbanking@jkbmail.com','ebanking@jkbmail.com','Settlement.crcard@jkbmail.com','ebank@jkbmail.com','support.fss1@jkbmail.com','finances.recon@razorpay.com'],
        self::NETBANKING_PNB           => ['dbdaggregator@pnb.co.in','tieup.isg@pnb.co.in'],
        ...
        self::NETBANKING_SVC           => ['netbanking@svcbank.com', 'kavishwarrk@svcbank.com', 'nirmalvb@svcbank.com', 'chaudharyam@svcbank.com'],
        self::NETBANKING_JSB           => ['channel_payments@janabank.com', 'mohamed.m05@janabank.com', 'kishan.holihosur@janabank.com','lavanya.j02@janabank.com'],
        self::NETBANKING_FSB           => ['prabhu.veluswamy@fincarebank.com','lijo.k@fincarebank.com','jayaprashanth.vk@fincarebank.com','febin.anto@fincarebank.com','ce035@fincarebank.com','joseph.arun@fincarebank.com','reconfile-billdesk@fincarebank.com','finances.recon@razorpay.com'],
        self::NETBANKING_IOB           => ['54667@iobnet.co.in', '63015@iobnet.co.in', 'pg@iobnet.co.in', 'eseeadmin@iobnet.co.in','finances.recon@razorpay.com','ibalerts@iob.in'],
        self::NETBANKING_DCB           => ['sandesh.kadam@dcbbank.com', 'arif.shaikh@dcbbank.com', 'dcm@dcbbank.com','finances.recon@razorpay.com'],
        self::NETBANKING_UBI           => [],
        self::NETBANKING_AUSF          => [],
        self::NETBANKING_AUSF_CORP     => [],
        self::NETBANKING_KOTAK_V2      => ['bankalerts@kotak.com','kotakpgrecon@kotak.com'],
