...
class Validator extends Base\Core
{
    ...
    const GATEWAY_SUBJECT_REGEX = [
        ...
        RequestProcessor\Base::AIRTEL             => ["/^(?i)ecom_merch_txn_report_1012257321/"],
    ...
    const UPDATE_NETBANKING_RECON_DATA_RULES = [
        ...
        'netbanking.gateway_amount'                        => 'sometimes',
        'netbanking.gateway_fee'                           => 'sometimes',
        'netbanking.gateway_service_tax'                   => 'sometimes',
