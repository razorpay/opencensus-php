...
class Base
{
    ...
    const GET_SETTLEMENT_TRANSACTION_TIMELINE   = '/twirp/rzp.settlements.transaction.v1.TransactionService/GetTransactionTimeline';
    ...
    const GEFU_FILE_GENERATION_TRIGGER = '/twirp/rzp.settlements.file_generation.v1.FileGenerationService/GenerateGefuFile';
