        ...
        foreach ($rawAddresses as $address)
        {
            try
            {
                ...
                if (strlen($address[RawAddress\Entity::BATCH_ID]) > 0)
                {
                    ...
                    if ($address[RawAddress\Entity::BATCH_ID] === Constants::ADDRESS_SOURCE_TYPE_SOPC)
                    {
                    ...
                    if ($address[RawAddress\Entity::BATCH_ID] === Constants::ADDRESS_SOURCE_TYPE_SHIPROCKET)
                    {
                        $sourceType = Constants::ADDRESS_SOURCE_TYPE_SHIPROCKET;
                    }
                }
