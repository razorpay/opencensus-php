...
{
    /**
     * @param Base\PublicCollection $commissions
     * @param PaymentEntity         $payment
     *
     * @return array
     */
    public static function getPayloadForCommissionCreate(Base\PublicCollection $commissions, PaymentEntity $payment): array
    {
        $commissionsPayload = [];
        ...
        $order = [
            ...
            'application_id' => (new EntityOriginCore())->getApplicationIdFromPublicKey($publicKey)
        ];
        ...
        return [
            ...
            'auth'             => ['application_id' => app('basicauth')->getOAuthApplicationId()]
        ];
    }
