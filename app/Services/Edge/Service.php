...
class Service
{
     ...
     * @param null $rolesService
     * @return null
     */
    private function authorizeUserAccessExceptRBAC($merchantIpFilter = null, $rolesService = null)
    {
        ...
        $rolesService = $rolesService ?? new \RZP\Models\Roles\Service();

        $authzRoles = $this->ba->getCustomAccessRoles();

        if (is_null($authzRoles))
        {
            $authzRoles =  $rolesService->getAuthzRolesUsingExperiment($this->ba->getUserRole());
        }
