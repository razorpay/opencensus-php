...
class OperatorSpacingSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        if (($tokens[$stackPtr]['code'] === T_EQUAL) or
            ($tokens[$stackPtr]['code'] === T_MINUS))
        {
            if (isset($tokens[$stackPtr]['nested_parenthesis']) === true)
            {
                ...
                if (isset($tokens[$bracket]['parenthesis_owner']) === true)
                {
                    ...
                    if (($tokens[$function]['code'] === T_FUNCTION) or
        ...
        {
            // Skip for '=&' case.
            if ((isset($tokens[($stackPtr + 1)]) === true) or
        ...
        if ((($tokens[$stackPtr]['code'] === T_INLINE_THEN) and
             ($tokens[($stackPtr + 1)]['code'] === T_INLINE_ELSE)) or
            (($tokens[($stackPtr - 1)]['code'] === T_INLINE_THEN) and
        ...
        else if (isset(PHP_CodeSniffer_Tokens::$assignmentTokens[$tokens[$stackPtr]['code']]) === false)
        {
            ...
            //HashCube Rule
            if(($found !== 1) and ($found === 'newline'))
            {
                return;
            }
            //Ending of Hashcube rule
