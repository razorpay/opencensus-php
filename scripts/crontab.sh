...
add_cron "32 3 * * *"       "gateway_file_combined_prod"          POST "$BASE_URL/gateway/files"              "type=combined&targets[]=indusind&targets[]=federal&targets[]=allahabad&targets[]=sib"                  $LIVE_AUTH
