...
export default class AutoResizeTextarea extends Component {
  ...
  componentDidMount() {
    ...
    this.borderTopWidth = Number(getUnitlessValue(computedStyle.borderTopWidth))
    this.borderBottomWidth = Number(getUnitlessValue(computedStyle.borderBottomWidth))
