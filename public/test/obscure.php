...
$key_id = $_GET['key'] ?? 'rzp_test_NcTYsQW03hJokQ';
$secret = 'm3aFDSxdKNuKyOffGlWNkJSq';
...
<!--    "uncomment below for device parameters testing"-->
    ...
    <tr>
        ...
        <td><input type="text" name="card[number]" value="4160211000261223" size="25" autocomplete="cc-number"></td>
    </tr>
    <tr>
