...
$key_id = $_GET['key'] ?? 'rzp_test_Jo7pO6sshoE5NW';
...
<form method="post" id="paymentform" action="//<?=$public_url?>/payments" onsubmit="disableEmptyInputs(this)">
    ...
    <tr>
        ...
        <td>
            <select name="bank">
                ...
                <option value="UCBA_C">United Commercial Bank - Corporate banking</option>
            </select>
        </td>
    </tr>
    <tr>
        <td>
            <input type="hidden" value="rzp_test_Jo7pO6sshoE5NW" name="key_id">
        </td>
    </tr>
    <tr>
    <tr>
    ...
    <tr>
        ...
        <td><input type="hidden" name="force_terminal_id" size="25" value="term_ISFYOowKXb0xX7"></td>
