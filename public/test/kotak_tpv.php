...
$key_id = 'rzp_test_B1MRk4SlY4yAeo';
$secret = 'X365TDS7bwKzb1mqsyHcC9WX';
...
<tr>
    ...
    <td>
    <input type = "text" id = "amount" name = "amount" placeholder = "Enter amount to create order for" value="50000"  readonly />
    </td>
</tr>
<tr>
    <td>
