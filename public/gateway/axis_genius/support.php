...
$SECURE_SECRET = "251F568815FE46A4593CCF4AEA776E48";/*Add secure secret here*/
...
<table width='100%' border='2' cellpadding='2' bgcolor='#C1C1C1'>
    <tr>
        <td bgcolor='#E1E1E1' width='90%'>
            <H2 class='co'>&nbsp;ePP Client S Example</H2>
        </td>
...
<!-- End branding table -->
    ...
    <tr class="title">
        <td colspan="2" height="25"><P><strong>&nbsp;Refund Input Fields</strong></P></td>
    </tr>
    <tr>
