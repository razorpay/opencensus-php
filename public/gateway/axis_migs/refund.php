...
<html>
    ...
    <body>
        ...
        <table width="80%" align="center" cellpadding="5" border="0">
          ...
          <tr bgcolor="#E1E1E1">
            <td align="right"><strong><i>Refund Amount: </i></strong></td>
            <td><?=$amount?></td>
          </tr>
          <tr>
            <td colspan = '2' align='center'><font color='#C1C1C1'>Fields above are the request values returned.</font><br/><hr/>
            </td>
          </tr>
...
// This method uses the Transaction Response code retrieved from the Digital
...
// This function takes a recipt value and checks for its existence
// If the key does not exist of there is no value for that key
// it returns a predefined response.

// If key does not exist or input is null, returns string "No Value Returned",
// else returns value corresponding to given key

// @param $map Array containing the receipt keys and their values
// @param $key is the receipt parameter in question

// @return String containing the receipt data or the predefined response
