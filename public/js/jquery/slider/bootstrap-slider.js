  ...
  Slider.prototype = {
    ...
    layout: function() {
      ...
      if (this.range) {
        ...
        if (this.orientation === 'vertical') {
          this.tooltip_min.css(
            'margin-top',
            -this.tooltip_min.outerHeight() / 2 + 'px'
          );
        } else {
          this.tooltip_min.css(
            'margin-left',
            -this.tooltip_min.outerWidth() / 2 + 'px'
          );
        }
        this.tooltip_max[0].style[this.stylePos] = positionPercentages[1] + '%';
        if (this.orientation === 'vertical') {
          this.tooltip_max.css(
            'margin-top',
            -this.tooltip_max.outerHeight() / 2 + 'px'
          );
        } else {
          this.tooltip_max.css(
            'margin-left',
            -this.tooltip_max.outerWidth() / 2 + 'px'
          );
        }
      } else {
