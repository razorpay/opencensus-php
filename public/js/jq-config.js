...
app.constant('JQ_CONFIG', {
  easyPieChart: [
    '//cdnjs.cloudflare.com/ajax/libs/easy-pie-chart/2.1.4/jquery.easypiechart.min.js',
  ],
  sparkline: [
  ...
  sortable: [
    '//cdnjs.cloudflare.com/ajax/libs/html5sortable/0.1.1/html.sortable.min.js',
  ],
  nestable: [
  ...
  dataTable: [
    '//cdnjs.cloudflare.com/ajax/libs/datatables/1.10.1/js/jquery.dataTables.min.js',
