        ...
        organization.fetchCurrentOrg().then(function(data) {
          ...
          request.success(function(data) {
            if (data.success) {
              ...
              if (
                (!data.data.length && $scope.pager.skip >= 100) ||
  ...
  .controller('auditLogDetailCtrl', [
    ...
    function(
      ...
      if ($scope.data.entity && $scope.data.entity.change) {
        var oldData = $scope.data.entity.change.old
          ? $scope.data.entity.change.old
          : [];
        var newData = $scope.data.entity.change.new
          ? $scope.data.entity.change.new
          : [];
