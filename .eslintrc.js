...
module.exports = {
  ...
  rules: {
    ...
    'i18n-rules/no-use-of-deprecated-functions': 'warn',
    'i18n-rules/no-hardcoded-i18n-types': 'warn',
  ...
  overrides: [
    ...
    },
    {
      ...
      rules: {
        ...
        'i18n-rules/no-use-of-deprecated-functions': 'off',
        'i18n-rules/no-hardcoding-dates': 'off',
        'i18n-rules/no-hardcoded-i18n-types': 'off',
