...
/**
 * @see KYCDocumentManagerAPI
 *
 * Generated from protobuf service <code>platform.bvs.kycdocumentmanager.v1.KYCDocumentManagerAPI</code>
 */
final class KYCDocumentManagerAPIServer implements RequestHandlerInterface
{
    /**
     ...
     *
     * Use KYCDocumentManagerAPIServer::getPathPrefix instead.
     */
    public const PATH_PREFIX = '/twirp/platform.bvs.kycdocumentmanager.v1.KYCDocumentManagerAPI/';
    ...
    {
        return $this->prefix.'/platform.bvs.kycdocumentmanager.v1.KYCDocumentManagerAPI/';
    }
    ...
    public function handle(ServerRequestInterface $req): ResponseInterface
    {
        ...
        if ($service != 'platform.bvs.kycdocumentmanager.v1.KYCDocumentManagerAPI') {
        ...
        switch ($method) {
            case 'CreateDocumentRecord':
                return $this->handleCreateDocumentRecord($ctx, $req);
            case 'GetDocumentRecordById':
                return $this->handleGetDocumentRecordById($ctx, $req);
    ...
    private function handleCreateDocumentRecord(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
        ...
        switch (trim(strtolower(substr($header, 0, $i)))) {
            case 'application/json':
                $resp = $this->handleCreateDocumentRecordJson($ctx, $req);
                break;

            case 'application/protobuf':
                $resp = $this->handleCreateDocumentRecordProtobuf($ctx, $req);
                break;
    ...
    private function handleCreateDocumentRecordJson(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
        ...
        try {
            ...
            $in = new \Platform\Bvs\Kycdocumentmanager\V1\CreateDocumentRecordRequest();
            $in->mergeFromJsonString((string)$req->getBody(), true);

            $out = $this->svc->CreateDocumentRecord($ctx, $in);

            if ($out === null) {
                return $this->writeError($ctx, TwirpError::newError(ErrorCode::Internal, 'received a null response while calling CreateDocumentRecord. null responses are not supported'));
            }
    ...
    private function handleCreateDocumentRecordProtobuf(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
        $ctx = Context::withMethodName($ctx, 'CreateDocumentRecord');
    ...
    private function handleGetDocumentRecordById(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
        $header = $req->getHeaderLine('Content-Type');
        $i = strpos($header, ';');
        ...
        switch (trim(strtolower(substr($header, 0, $i)))) {
            case 'application/json':
                $resp = $this->handleGetDocumentRecordByIdJson($ctx, $req);
                break;

            case 'application/protobuf':
                $resp = $this->handleGetDocumentRecordByIdProtobuf($ctx, $req);
                break;
    ...
    private function handleGetDocumentRecordByIdJson(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
        ...
        try {
            ...
            $in = new \Platform\Bvs\Kycdocumentmanager\V1\GetDocumentRecordByIdRequest();
            $in->mergeFromJsonString((string)$req->getBody(), true);

            $out = $this->svc->GetDocumentRecordById($ctx, $in);

            if ($out === null) {
                return $this->writeError($ctx, TwirpError::newError(ErrorCode::Internal, 'received a null response while calling GetDocumentRecordById. null responses are not supported'));
            }
    ...
    private function handleGetDocumentRecordByIdProtobuf(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
        $ctx = Context::withMethodName($ctx, 'GetDocumentRecordById');
