...
/**
 * @internal KYCDocumentManagerAPIAbstractClient provides abstraction for JsonClient and Client (default).
 ...
 */
abstract class KYCDocumentManagerAPIAbstractClient
{
    /**
     * @var server
     */
     ...
     * {@inheritdoc}
     */
    public function CreateDocumentRecord(array $ctx, \Platform\Bvs\Kycdocumentmanager\V1\CreateDocumentRecordRequest $in): \Platform\Bvs\Kycdocumentmanager\V1\DocumentRecordResponse
    {
        $ctx = Context::withPackageName($ctx, 'platform.bvs.kycdocumentmanager.v1');
        $ctx = Context::withServiceName($ctx, 'KYCDocumentManagerAPI');
        $ctx = Context::withMethodName($ctx, 'CreateDocumentRecord');

        $out = new \Platform\Bvs\Kycdocumentmanager\V1\DocumentRecordResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/platform.bvs.kycdocumentmanager.v1.KYCDocumentManagerAPI/CreateDocumentRecord';
        } else {
            $url = $url.'/'.$this->prefix.'/platform.bvs.kycdocumentmanager.v1.KYCDocumentManagerAPI/CreateDocumentRecord';
        }
     ...
     * {@inheritdoc}
     */
    public function GetDocumentRecordById(array $ctx, \Platform\Bvs\Kycdocumentmanager\V1\GetDocumentRecordByIdRequest $in): \Platform\Bvs\Kycdocumentmanager\V1\DocumentRecordResponse
    {
        $ctx = Context::withPackageName($ctx, 'platform.bvs.kycdocumentmanager.v1');
        $ctx = Context::withServiceName($ctx, 'KYCDocumentManagerAPI');
        $ctx = Context::withMethodName($ctx, 'GetDocumentRecordById');

        $out = new \Platform\Bvs\Kycdocumentmanager\V1\DocumentRecordResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/platform.bvs.kycdocumentmanager.v1.KYCDocumentManagerAPI/GetDocumentRecordById';
        } else {
            $url = $url.'/'.$this->prefix.'/platform.bvs.kycdocumentmanager.v1.KYCDocumentManagerAPI/GetDocumentRecordById';
        }
