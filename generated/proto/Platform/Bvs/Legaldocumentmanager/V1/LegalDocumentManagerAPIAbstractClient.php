...
/**
 * @internal LegalDocumentManagerAPIAbstractClient provides abstraction for JsonClient and Client (default).
 ...
 */
abstract class LegalDocumentManagerAPIAbstractClient
{
    /**
     * @var server
     */
     ...
     * {@inheritdoc}
     */
    public function CreateLegalDocuments(array $ctx, \Platform\Bvs\Legaldocumentmanager\V1\CreateLegalDocumentsRequest $in): \Platform\Bvs\Legaldocumentmanager\V1\LegalDocumentsManagerResponse
    {
        ...
        $out = new \Platform\Bvs\Legaldocumentmanager\V1\LegalDocumentsManagerResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/platform.bvs.legaldocumentmanager.v1.LegalDocumentManagerAPI/CreateLegalDocuments';
        } else {
            $url = $url.'/'.$this->prefix.'/platform.bvs.legaldocumentmanager.v1.LegalDocumentManagerAPI/CreateLegalDocuments';
        }
     ...
     * {@inheritdoc}
     */
    public function GetLegalDocuments(array $ctx, \Platform\Bvs\Legaldocumentmanager\V1\GetLegalDocumentsRequest $in): \Platform\Bvs\Legaldocumentmanager\V1\LegalDocumentsManagerResponse
    {
        $ctx = Context::withPackageName($ctx, 'platform.bvs.legaldocumentmanager.v1');
        $ctx = Context::withServiceName($ctx, 'LegalDocumentManagerAPI');
        ...
        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/platform.bvs.legaldocumentmanager.v1.LegalDocumentManagerAPI/GetLegalDocuments';
        } else {
            $url = $url.'/'.$this->prefix.'/platform.bvs.legaldocumentmanager.v1.LegalDocumentManagerAPI/GetLegalDocuments';
        }
     ...
     * {@inheritdoc}
     */
    public function GetLegalDocumentsByOwnerId(array $ctx, \Platform\Bvs\Legaldocumentmanager\V1\GetLegalDocumentsByOwnerIdRequest $in): \Platform\Bvs\Legaldocumentmanager\V1\LegalDocumentsManagerResponse
    {
        $ctx = Context::withPackageName($ctx, 'platform.bvs.legaldocumentmanager.v1');
        $ctx = Context::withServiceName($ctx, 'LegalDocumentManagerAPI');
        ...
        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/platform.bvs.legaldocumentmanager.v1.LegalDocumentManagerAPI/GetLegalDocumentsByOwnerId';
        } else {
            $url = $url.'/'.$this->prefix.'/platform.bvs.legaldocumentmanager.v1.LegalDocumentManagerAPI/GetLegalDocumentsByOwnerId';
        }
