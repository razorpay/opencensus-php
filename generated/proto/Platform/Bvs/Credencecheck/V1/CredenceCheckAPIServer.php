...
/**
 * @see CredenceCheckAPI
 *
 * Generated from protobuf service <code>platform.bvs.credencecheck.v1.CredenceCheckAPI</code>
 */
final class CredenceCheckAPIServer implements RequestHandlerInterface
{
    /**
     ...
     *
     * Use CredenceCheckAPIServer::getPathPrefix instead.
     */
    public const PATH_PREFIX = '/twirp/platform.bvs.credencecheck.v1.CredenceCheckAPI/';
    ...
    {
        return $this->prefix.'/platform.bvs.credencecheck.v1.CredenceCheckAPI/';
    }
    ...
    public function handle(ServerRequestInterface $req): ResponseInterface
    {
        ...
        if ($service != 'platform.bvs.credencecheck.v1.CredenceCheckAPI') {
        ...
        switch ($method) {
            ...
            case 'GetDetailsById':
                return $this->handleGetDetailsById($ctx, $req);
            case 'GetDetailsByAccountId':
                return $this->handleGetDetailsByAccountId($ctx, $req);
    ...
    private function handleCreateJson(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
        ...
        try {
            ...
            $in = new \Platform\Bvs\Credencecheck\V1\CreateRequest();
    ...
    private function handleGetDetailsById(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
        $header = $req->getHeaderLine('Content-Type');
        $i = strpos($header, ';');
        ...
        switch (trim(strtolower(substr($header, 0, $i)))) {
            case 'application/json':
                $resp = $this->handleGetDetailsByIdJson($ctx, $req);
                break;

            case 'application/protobuf':
                $resp = $this->handleGetDetailsByIdProtobuf($ctx, $req);
                break;
    ...
    private function handleGetDetailsByIdJson(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
        ...
        try {
            ...
            $in = new \Platform\Bvs\Credencecheck\V1\GetDetailsByIdRequest();
            $in->mergeFromJsonString((string)$req->getBody(), true);

            $out = $this->svc->GetDetailsById($ctx, $in);

            if ($out === null) {
                return $this->writeError($ctx, TwirpError::newError(ErrorCode::Internal, 'received a null response while calling GetDetailsById. null responses are not supported'));
            }
    ...
    private function handleGetDetailsByIdProtobuf(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
        $ctx = Context::withMethodName($ctx, 'GetDetailsById');
    ...
    private function handleGetDetailsByAccountId(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
        $header = $req->getHeaderLine('Content-Type');
        $i = strpos($header, ';');
        ...
        switch (trim(strtolower(substr($header, 0, $i)))) {
            case 'application/json':
                $resp = $this->handleGetDetailsByAccountIdJson($ctx, $req);
                break;

            case 'application/protobuf':
                $resp = $this->handleGetDetailsByAccountIdProtobuf($ctx, $req);
                break;
    ...
    private function handleGetDetailsByAccountIdJson(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
        ...
        try {
            ...
            $in = new \Platform\Bvs\Credencecheck\V1\GetDetailsByAccountIdRequest();
            $in->mergeFromJsonString((string)$req->getBody(), true);

            $out = $this->svc->GetDetailsByAccountId($ctx, $in);

            if ($out === null) {
                return $this->writeError($ctx, TwirpError::newError(ErrorCode::Internal, 'received a null response while calling GetDetailsByAccountId. null responses are not supported'));
            }
    ...
    private function handleGetDetailsByAccountIdProtobuf(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
        $ctx = Context::withMethodName($ctx, 'GetDetailsByAccountId');
