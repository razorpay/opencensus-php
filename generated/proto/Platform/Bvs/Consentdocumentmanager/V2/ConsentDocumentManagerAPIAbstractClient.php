...
/**
 * @internal ConsentDocumentManagerAPIAbstractClient provides abstraction for JsonClient and Client (default).
 ...
 */
abstract class ConsentDocumentManagerAPIAbstractClient
{
    /**
     * @var server
     */
     ...
     * {@inheritdoc}
     */
    public function CreateConsentDocuments(array $ctx, \Platform\Bvs\Consentdocumentmanager\V2\CreateConsentDocumentsRequest $in): \Platform\Bvs\Consentdocumentmanager\V2\ConsentDocumentsManagerResponse
    {
        $ctx = Context::withPackageName($ctx, 'platform.bvs.consentdocumentmanager.v2');
        $ctx = Context::withServiceName($ctx, 'ConsentDocumentManagerAPI');
        $ctx = Context::withMethodName($ctx, 'CreateConsentDocuments');

        $out = new \Platform\Bvs\Consentdocumentmanager\V2\ConsentDocumentsManagerResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/platform.bvs.consentdocumentmanager.v2.ConsentDocumentManagerAPI/CreateConsentDocuments';
        } else {
            $url = $url.'/'.$this->prefix.'/platform.bvs.consentdocumentmanager.v2.ConsentDocumentManagerAPI/CreateConsentDocuments';
        }
     ...
     * {@inheritdoc}
     */
    public function GetConsentDocuments(array $ctx, \Platform\Bvs\Consentdocumentmanager\V2\GetConsentDocumentsRequest $in): \Platform\Bvs\Consentdocumentmanager\V2\ConsentDocumentsManagerResponse
    {
        $ctx = Context::withPackageName($ctx, 'platform.bvs.consentdocumentmanager.v2');
        $ctx = Context::withServiceName($ctx, 'ConsentDocumentManagerAPI');
        $ctx = Context::withMethodName($ctx, 'GetConsentDocuments');

        $out = new \Platform\Bvs\Consentdocumentmanager\V2\ConsentDocumentsManagerResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/platform.bvs.consentdocumentmanager.v2.ConsentDocumentManagerAPI/GetConsentDocuments';
        } else {
            $url = $url.'/'.$this->prefix.'/platform.bvs.consentdocumentmanager.v2.ConsentDocumentManagerAPI/GetConsentDocuments';
        }
     ...
     * {@inheritdoc}
     */
    public function GetConsentDocumentsByOwnerId(array $ctx, \Platform\Bvs\Consentdocumentmanager\V2\GetConsentDocumentsByOwnerIdRequest $in): \Platform\Bvs\Consentdocumentmanager\V2\ConsentDocumentsManagerResponse
    {
        $ctx = Context::withPackageName($ctx, 'platform.bvs.consentdocumentmanager.v2');
        $ctx = Context::withServiceName($ctx, 'ConsentDocumentManagerAPI');
        $ctx = Context::withMethodName($ctx, 'GetConsentDocumentsByOwnerId');

        $out = new \Platform\Bvs\Consentdocumentmanager\V2\ConsentDocumentsManagerResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/platform.bvs.consentdocumentmanager.v2.ConsentDocumentManagerAPI/GetConsentDocumentsByOwnerId';
        } else {
            $url = $url.'/'.$this->prefix.'/platform.bvs.consentdocumentmanager.v2.ConsentDocumentManagerAPI/GetConsentDocumentsByOwnerId';
        }
