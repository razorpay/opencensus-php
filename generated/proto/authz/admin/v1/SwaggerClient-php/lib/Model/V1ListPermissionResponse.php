...
/**
 * V1ListPermissionResponse Class Doc Comment
 *
 * @category Class
 * @package  AuthzAdmin\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1ListPermissionResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1ListPermissionResponse';
    ...
    protected static $swaggerTypes = [
        ...
        'count' => 'string',
        'items' => '\AuthzAdmin\Client\Model\V1ExpandedPermission[]'
    ];
     ...
     * Sets items
     *
     * @param \AuthzAdmin\Client\Model\V1ExpandedPermission[] $items items
     *
     * @return $this
     */
