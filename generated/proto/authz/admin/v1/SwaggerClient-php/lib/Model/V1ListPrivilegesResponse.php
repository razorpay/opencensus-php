...
/**
 * V1ListPrivilegesResponse Class Doc Comment
 *
 * @category Class
 * @package  AuthzAdmin\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1ListPrivilegesResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1ListPrivilegesResponse';
    ...
    protected static $swaggerTypes = [
        'count' => 'string',
        'items' => '\AuthzAdmin\Client\Model\V1Privilege[]',
     ...
     * Sets items
     *
     * @param \AuthzAdmin\Client\Model\V1Privilege[] $items items
     *
     * @return $this
     */
