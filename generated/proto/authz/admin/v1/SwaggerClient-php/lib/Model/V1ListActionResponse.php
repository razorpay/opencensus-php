...
/**
 * V1ListActionResponse Class Doc Comment
 *
 * @category Class
 * @package  AuthzAdmin\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1ListActionResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1ListActionResponse';
    ...
    protected static $swaggerTypes = [
        ...
        'count' => 'string',
        'items' => '\AuthzAdmin\Client\Model\V1Action[]'
    ];
     ...
     * Sets items
     *
     * @param \AuthzAdmin\Client\Model\V1Action[] $items items
     *
     * @return $this
     */
