...
/**
 * @internal ConsumerApiKeyAPIAbstractClient provides abstraction for JsonClient and Client (default).
 ...
 */
abstract class ConsumerApiKeyAPIAbstractClient
{
    /**
     * @var server
     */
     ...
     * {@inheritdoc}
     */
    public function GetKeys(array $ctx, \Rzp\Credcase\Apikey\V1\ConsumerApiKeyListRequest $in): \Rzp\Credcase\Apikey\V1\ApiKeyListResponse
    {
        ...
        if (empty($this->prefix)) {
            $url = $url.'/rzp.credcase.apikey.v1.ConsumerApiKeyAPI/GetKeys';
        } else {
            $url = $url.'/'.$this->prefix.'/rzp.credcase.apikey.v1.ConsumerApiKeyAPI/GetKeys';
        }
     ...
     * {@inheritdoc}
     */
    public function GetKey(array $ctx, \Rzp\Credcase\Apikey\V1\ConsumerApiKeyGetRequest $in): \Rzp\Credcase\Apikey\V1\ApiKeyResponse
    {
        $ctx = Context::withPackageName($ctx, 'rzp.credcase.apikey.v1');
        $ctx = Context::withServiceName($ctx, 'ConsumerApiKeyAPI');
        ...
        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/rzp.credcase.apikey.v1.ConsumerApiKeyAPI/GetKey';
        } else {
            $url = $url.'/'.$this->prefix.'/rzp.credcase.apikey.v1.ConsumerApiKeyAPI/GetKey';
        }
