...
/**
 * A Protobuf client that implements the {@see ConsumerAPI} interface.
 ...
 */
final class ConsumerAPIClient implements ConsumerAPI
{
    /**
     * @var server
     */
     ...
     * {@inheritdoc}
     */
    public function CreateConsumer(array $ctx, \Rzp\Credcase\Consumer\V1\Consumer $in): \Rzp\Credcase\Consumer\V1\Consumer
    {
        ...
        $out = new \Rzp\Credcase\Consumer\V1\Consumer();

        $url = $this->addr.'/twirp/rzp.credcase.consumer.v1.ConsumerAPI/CreateConsumer';
     ...
     * {@inheritdoc}
     */
    public function DeleteConsumer(array $ctx, \Rzp\Credcase\Consumer\V1\Consumer $in): \Rzp\Credcase\Consumer\V1\PBEmpty
    {
        $ctx = Context::withPackageName($ctx, 'rzp.credcase.consumer.v1');
        $ctx = Context::withServiceName($ctx, 'ConsumerAPI');
        $ctx = Context::withMethodName($ctx, 'DeleteConsumer');

        $out = new \Rzp\Credcase\Consumer\V1\PBEmpty();

        $url = $this->addr.'/twirp/rzp.credcase.consumer.v1.ConsumerAPI/DeleteConsumer';
