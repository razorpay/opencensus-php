...
/**
 * A Protobuf client that implements the {@see MigrateAPI} interface.
 ...
 */
final class MigrateAPIClient implements MigrateAPI
{
    /**
     * @var server
     */
     ...
     * {@inheritdoc}
     */
    public function MigrateApiKey(array $ctx, \Rzp\Credcase\Migrate\V1\MigrateApiKeyRequest $in): \Rzp\Credcase\Migrate\V1\MigrateApiKeyResponse
    {
        ...
        $out = new \Rzp\Credcase\Migrate\V1\MigrateApiKeyResponse();

        $url = $this->addr.'/twirp/rzp.credcase.migrate.v1.MigrateAPI/MigrateApiKey';
     ...
     * {@inheritdoc}
     */
    public function ExpireApiKey(array $ctx, \Rzp\Credcase\Migrate\V1\ExpireApiKeyRequest $in): \Rzp\Credcase\Migrate\V1\ExpireApiKeyResponse
    {
        $ctx = Context::withPackageName($ctx, 'rzp.credcase.migrate.v1');
        $ctx = Context::withServiceName($ctx, 'MigrateAPI');
        $ctx = Context::withMethodName($ctx, 'ExpireApiKey');

        $out = new \Rzp\Credcase\Migrate\V1\ExpireApiKeyResponse();

        $url = $this->addr.'/twirp/rzp.credcase.migrate.v1.MigrateAPI/ExpireApiKey';
     ...
     * {@inheritdoc}
     */
    public function RotateApiKey(array $ctx, \Rzp\Credcase\Migrate\V1\RotateApiKeyRequest $in): \Rzp\Credcase\Migrate\V1\RotateApiKeyResponse
    {
        $ctx = Context::withPackageName($ctx, 'rzp.credcase.migrate.v1');
        $ctx = Context::withServiceName($ctx, 'MigrateAPI');
        $ctx = Context::withMethodName($ctx, 'RotateApiKey');

        $out = new \Rzp\Credcase\Migrate\V1\RotateApiKeyResponse();

        $url = $this->addr.'/twirp/rzp.credcase.migrate.v1.MigrateAPI/RotateApiKey';
