...
/**
 * @internal PropagationAPIAbstractClient provides abstraction for JsonClient and Client (default).
 ...
 */
abstract class PropagationAPIAbstractClient
{
    /**
     * @var server
     */
     ...
     * {@inheritdoc}
     */
    public function Check(array $ctx, \Rzp\CustomDomainService\Propagation\V1\CheckRequest $in): \Rzp\CustomDomainService\Propagation\V1\CheckResponse
    {
        $ctx = Context::withPackageName($ctx, 'rzp.custom_domain_service.propagation.v1');
        $ctx = Context::withServiceName($ctx, 'PropagationAPI');
        $ctx = Context::withMethodName($ctx, 'Check');

        $out = new \Rzp\CustomDomainService\Propagation\V1\CheckResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/rzp.custom_domain_service.propagation.v1.PropagationAPI/Check';
        } else {
            $url = $url.'/'.$this->prefix.'/rzp.custom_domain_service.propagation.v1.PropagationAPI/Check';
        }
