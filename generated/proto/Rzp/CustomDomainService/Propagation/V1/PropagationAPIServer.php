 ...
 */
final class PropagationAPIServer implements RequestHandlerInterface
{
    /**
     ...
     *
     * Use PropagationAPIServer::getPathPrefix instead.
     */
    public const PATH_PREFIX = '/twirp/rzp.custom_domain_service.propagation.v1.PropagationAPI/';
    ...
    {
        return $this->prefix.'/rzp.custom_domain_service.propagation.v1.PropagationAPI/';
    }
    ...
    public function handle(ServerRequestInterface $req): ResponseInterface
    {
        ...
        if ($service != 'rzp.custom_domain_service.propagation.v1.PropagationAPI') {
    ...
    private function handleCheckJson(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
        ...
        try {
            ...
            $in = new \Rzp\CustomDomainService\Propagation\V1\CheckRequest();
