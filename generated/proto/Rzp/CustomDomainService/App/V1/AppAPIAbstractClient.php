...
/**
 * @internal AppAPIAbstractClient provides abstraction for JsonClient and Client (default).
 ...
 */
abstract class AppAPIAbstractClient
{
    /**
     * @var server
     */
     ...
     * {@inheritdoc}
     */
    public function Create(array $ctx, \Rzp\CustomDomainService\App\V1\AppRequest $in): \Rzp\CustomDomainService\App\V1\AppResponse
    {
        $ctx = Context::withPackageName($ctx, 'rzp.custom_domain_service.app.v1');
        $ctx = Context::withServiceName($ctx, 'AppAPI');
        $ctx = Context::withMethodName($ctx, 'Create');

        $out = new \Rzp\CustomDomainService\App\V1\AppResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/rzp.custom_domain_service.app.v1.AppAPI/Create';
        } else {
            $url = $url.'/'.$this->prefix.'/rzp.custom_domain_service.app.v1.AppAPI/Create';
        }
