 ...
 */
final class AppAPIServer implements RequestHandlerInterface
{
    /**
     ...
     *
     * Use AppAPIServer::getPathPrefix instead.
     */
    public const PATH_PREFIX = '/twirp/rzp.custom_domain_service.app.v1.AppAPI/';
    ...
    {
        return $this->prefix.'/rzp.custom_domain_service.app.v1.AppAPI/';
    }
    ...
    public function handle(ServerRequestInterface $req): ResponseInterface
    {
        ...
        if ($service != 'rzp.custom_domain_service.app.v1.AppAPI') {
    ...
    private function handleCreateJson(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
        ...
        try {
            ...
            $in = new \Rzp\CustomDomainService\App\V1\AppRequest();
