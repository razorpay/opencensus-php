...
/**
 * @internal DomainAPIAbstractClient provides abstraction for JsonClient and Client (default).
 ...
 */
abstract class DomainAPIAbstractClient
{
    /**
     * @var server
     */
     ...
     * {@inheritdoc}
     */
    public function Create(array $ctx, \Rzp\CustomDomainService\Domain\V1\DomainRequest $in): \Rzp\CustomDomainService\Domain\V1\DomainResponse
    {
        $ctx = Context::withPackageName($ctx, 'rzp.custom_domain_service.domain.v1');
        $ctx = Context::withServiceName($ctx, 'DomainAPI');
        $ctx = Context::withMethodName($ctx, 'Create');

        $out = new \Rzp\CustomDomainService\Domain\V1\DomainResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/rzp.custom_domain_service.domain.v1.DomainAPI/Create';
        } else {
            $url = $url.'/'.$this->prefix.'/rzp.custom_domain_service.domain.v1.DomainAPI/Create';
        }
     ...
     * {@inheritdoc}
     */
    public function List(array $ctx, \Rzp\CustomDomainService\Domain\V1\ListDomainRequest $in): \Rzp\CustomDomainService\Domain\V1\ListDomainResponse
    {
        $ctx = Context::withPackageName($ctx, 'rzp.custom_domain_service.domain.v1');
        $ctx = Context::withServiceName($ctx, 'DomainAPI');
        $ctx = Context::withMethodName($ctx, 'List');

        $out = new \Rzp\CustomDomainService\Domain\V1\ListDomainResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/rzp.custom_domain_service.domain.v1.DomainAPI/List';
        } else {
            $url = $url.'/'.$this->prefix.'/rzp.custom_domain_service.domain.v1.DomainAPI/List';
        }
     ...
     * {@inheritdoc}
     */
    public function Delete(array $ctx, \Rzp\CustomDomainService\Domain\V1\DomainRequest $in): \Rzp\CustomDomainService\Domain\V1\DomainResponse
    {
        $ctx = Context::withPackageName($ctx, 'rzp.custom_domain_service.domain.v1');
        $ctx = Context::withServiceName($ctx, 'DomainAPI');
        ...
        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/rzp.custom_domain_service.domain.v1.DomainAPI/Delete';
        } else {
            $url = $url.'/'.$this->prefix.'/rzp.custom_domain_service.domain.v1.DomainAPI/Delete';
        }
     ...
     * {@inheritdoc}
     */
    public function IsSubDomain(array $ctx, \Rzp\CustomDomainService\Domain\V1\DomainRequest $in): \Rzp\CustomDomainService\Domain\V1\IsSubDomainResponse
    {
        $ctx = Context::withPackageName($ctx, 'rzp.custom_domain_service.domain.v1');
        $ctx = Context::withServiceName($ctx, 'DomainAPI');
        $ctx = Context::withMethodName($ctx, 'IsSubDomain');

        $out = new \Rzp\CustomDomainService\Domain\V1\IsSubDomainResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/rzp.custom_domain_service.domain.v1.DomainAPI/IsSubDomain';
        } else {
            $url = $url.'/'.$this->prefix.'/rzp.custom_domain_service.domain.v1.DomainAPI/IsSubDomain';
        }
