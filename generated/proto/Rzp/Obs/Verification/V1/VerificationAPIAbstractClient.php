...
/**
 * @internal VerificationAPIAbstractClient provides abstraction for JsonClient and Client (default).
 ...
 */
abstract class VerificationAPIAbstractClient
{
    /**
     * @var server
     */
     ...
     * {@inheritdoc}
     */
    public function CreateAutoVerificationRule(array $ctx, \Rzp\Obs\Verification\V1\CreateAutoVerificationRuleRequest $in): \Rzp\Obs\Verification\V1\CreateAutoVerificationRuleResponse
    {
        $ctx = Context::withPackageName($ctx, 'platform.obs.verification.v1');
        $ctx = Context::withServiceName($ctx, 'VerificationAPI');
        $ctx = Context::withMethodName($ctx, 'CreateAutoVerificationRule');

        $out = new \Rzp\Obs\Verification\V1\CreateAutoVerificationRuleResponse();

        $url = $this->addr.'/twirp/platform.obs.verification.v1.VerificationAPI/CreateAutoVerificationRule';
     ...
     * {@inheritdoc}
     */
    public function GetVerificationRequests(array $ctx, \Rzp\Obs\Verification\V1\GetVerificationRequest $in): \Rzp\Obs\Verification\V1\GetVerificationResponse
    {
        $ctx = Context::withPackageName($ctx, 'platform.obs.verification.v1');
        $ctx = Context::withServiceName($ctx, 'VerificationAPI');
        $ctx = Context::withMethodName($ctx, 'GetVerificationRequests');

        $out = new \Rzp\Obs\Verification\V1\GetVerificationResponse();

        $url = $this->addr.'/twirp/platform.obs.verification.v1.VerificationAPI/GetVerificationRequests';
     ...
     * {@inheritdoc}
     */
    public function UpdateVerification(array $ctx, \Rzp\Obs\Verification\V1\UpdateVerificationRequest $in): \Rzp\Obs\Verification\V1\UpdateVerificationResponse
    {
        $ctx = Context::withPackageName($ctx, 'platform.obs.verification.v1');
        $ctx = Context::withServiceName($ctx, 'VerificationAPI');
        $ctx = Context::withMethodName($ctx, 'UpdateVerification');

        $out = new \Rzp\Obs\Verification\V1\UpdateVerificationResponse();

        $url = $this->addr.'/twirp/platform.obs.verification.v1.VerificationAPI/UpdateVerification';
