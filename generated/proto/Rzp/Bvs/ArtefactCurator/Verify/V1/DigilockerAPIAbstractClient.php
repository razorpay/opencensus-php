...
/**
 * @internal DigilockerAPIAbstractClient provides abstraction for JsonClient and Client (default).
 ...
 */
abstract class DigilockerAPIAbstractClient
{
    /**
     * @var server
     */
     ...
     * {@inheritdoc}
     */
    public function GetDigilockerUrl(array $ctx, \Rzp\Bvs\ArtefactCurator\Verify\V1\GetDigilockerUrlRequest $in): \Rzp\Bvs\ArtefactCurator\Verify\V1\GetDigilockerUrlResponse
    {
        ...
        $out = new \Rzp\Bvs\ArtefactCurator\Verify\V1\GetDigilockerUrlResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/platform.bvs.artefactcurator.verify.v1.DigilockerAPI/GetDigilockerUrl';
        } else {
            $url = $url.'/'.$this->prefix.'/platform.bvs.artefactcurator.verify.v1.DigilockerAPI/GetDigilockerUrl';
        }
     ...
     * {@inheritdoc}
     */
    public function FetchAadhaarDetails(array $ctx, \Rzp\Bvs\ArtefactCurator\Verify\V1\FetchAadhaarDetailsRequest $in): \Rzp\Bvs\ArtefactCurator\Verify\V1\FetchAadhaarDetailsResponse
    {
        $ctx = Context::withPackageName($ctx, 'platform.bvs.artefactcurator.verify.v1');
        $ctx = Context::withServiceName($ctx, 'DigilockerAPI');
        $ctx = Context::withMethodName($ctx, 'FetchAadhaarDetails');

        $out = new \Rzp\Bvs\ArtefactCurator\Verify\V1\FetchAadhaarDetailsResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/platform.bvs.artefactcurator.verify.v1.DigilockerAPI/FetchAadhaarDetails';
        } else {
            $url = $url.'/'.$this->prefix.'/platform.bvs.artefactcurator.verify.v1.DigilockerAPI/FetchAadhaarDetails';
        }
     ...
     * {@inheritdoc}
     */
    public function SendOtp(array $ctx, \Rzp\Bvs\ArtefactCurator\Verify\V1\SendOtpRequest $in): \Rzp\Bvs\ArtefactCurator\Verify\V1\SendOtpResponse
    {
        $ctx = Context::withPackageName($ctx, 'platform.bvs.artefactcurator.verify.v1');
        $ctx = Context::withServiceName($ctx, 'DigilockerAPI');
        $ctx = Context::withMethodName($ctx, 'SendOtp');

        $out = new \Rzp\Bvs\ArtefactCurator\Verify\V1\SendOtpResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/platform.bvs.artefactcurator.verify.v1.DigilockerAPI/SendOtp';
        } else {
            $url = $url.'/'.$this->prefix.'/platform.bvs.artefactcurator.verify.v1.DigilockerAPI/SendOtp';
        }
     ...
     * {@inheritdoc}
     */
    public function VerifyOtp(array $ctx, \Rzp\Bvs\ArtefactCurator\Verify\V1\VerifyOtpRequest $in): \Rzp\Bvs\ArtefactCurator\Verify\V1\VerifyOtpResponse
    {
        $ctx = Context::withPackageName($ctx, 'platform.bvs.artefactcurator.verify.v1');
        $ctx = Context::withServiceName($ctx, 'DigilockerAPI');
        $ctx = Context::withMethodName($ctx, 'VerifyOtp');

        $out = new \Rzp\Bvs\ArtefactCurator\Verify\V1\VerifyOtpResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/platform.bvs.artefactcurator.verify.v1.DigilockerAPI/VerifyOtp';
        } else {
            $url = $url.'/'.$this->prefix.'/platform.bvs.artefactcurator.verify.v1.DigilockerAPI/VerifyOtp';
        }
     ...
     * {@inheritdoc}
     */
    public function FetchAadhaarXmlDetails(array $ctx, \Rzp\Bvs\ArtefactCurator\Verify\V1\FetchAadhaarXmlDetailsRequest $in): \Rzp\Bvs\ArtefactCurator\Verify\V1\FetchAadhaarXmlDetailsResponse
    {
        $ctx = Context::withPackageName($ctx, 'platform.bvs.artefactcurator.verify.v1');
        $ctx = Context::withServiceName($ctx, 'DigilockerAPI');
        $ctx = Context::withMethodName($ctx, 'FetchAadhaarXmlDetails');

        $out = new \Rzp\Bvs\ArtefactCurator\Verify\V1\FetchAadhaarXmlDetailsResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/platform.bvs.artefactcurator.verify.v1.DigilockerAPI/FetchAadhaarXmlDetails';
        } else {
            $url = $url.'/'.$this->prefix.'/platform.bvs.artefactcurator.verify.v1.DigilockerAPI/FetchAadhaarXmlDetails';
        }
