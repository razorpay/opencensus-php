...
final class ProbeAPIServer implements RequestHandlerInterface
{
     ...
     *
     * Use ProbeAPIServer::getPathPrefix instead.
     */
    public const PATH_PREFIX = '/twirp/platform.bvs.artefactcurator.probe.v1.ProbeAPI/';
    ...
    {
        return $this->prefix.'/platform.bvs.artefactcurator.probe.v1.ProbeAPI/';
    }
    ...
    public function handle(ServerRequestInterface $req): ResponseInterface
    {
        ...
        if ($service != 'platform.bvs.artefactcurator.probe.v1.ProbeAPI') {
    ...
    private function handleGetCompanySearchJson(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
        ...
        try {
            ...
            $in = new \Rzp\Bvs\ArtefactCurator\Probe\V1\CompanySearchRequest();
    ...
    private function handleGetGstDetailsJson(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
        ...
        try {
            ...
            $in = new \Rzp\Bvs\ArtefactCurator\Probe\V1\GetGstDetailsRequest();
            $in->mergeFromJsonString((string)$req->getBody(), true);
