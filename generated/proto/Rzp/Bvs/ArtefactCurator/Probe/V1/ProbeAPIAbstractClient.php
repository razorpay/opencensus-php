...
abstract class ProbeAPIAbstractClient
{
     ...
     * {@inheritdoc}
     */
    public function GetCompanySearch(array $ctx, \Rzp\Bvs\ArtefactCurator\Probe\V1\CompanySearchRequest $in): \Rzp\Bvs\ArtefactCurator\Probe\V1\CompanySearchResponse
    {
        $ctx = Context::withPackageName($ctx, 'platform.bvs.artefactcurator.probe.v1');
        $ctx = Context::withServiceName($ctx, 'ProbeAPI');
        $ctx = Context::withMethodName($ctx, 'GetCompanySearch');

        $out = new \Rzp\Bvs\ArtefactCurator\Probe\V1\CompanySearchResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/platform.bvs.artefactcurator.probe.v1.ProbeAPI/GetCompanySearch';
        } else {
            $url = $url.'/'.$this->prefix.'/platform.bvs.artefactcurator.probe.v1.ProbeAPI/GetCompanySearch';
        }
     ...
     * {@inheritdoc}
     */
    public function GetGstDetails(array $ctx, \Rzp\Bvs\ArtefactCurator\Probe\V1\GetGstDetailsRequest $in): \Rzp\Bvs\ArtefactCurator\Probe\V1\GetGstDetailsResponse
    {
        $ctx = Context::withPackageName($ctx, 'platform.bvs.artefactcurator.probe.v1');
        $ctx = Context::withServiceName($ctx, 'ProbeAPI');
        $ctx = Context::withMethodName($ctx, 'GetGstDetails');

        $out = new \Rzp\Bvs\ArtefactCurator\Probe\V1\GetGstDetailsResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/platform.bvs.artefactcurator.probe.v1.ProbeAPI/GetGstDetails';
        } else {
            $url = $url.'/'.$this->prefix.'/platform.bvs.artefactcurator.probe.v1.ProbeAPI/GetGstDetails';
        }
