...
{
    const PATH_PREFIX = '/twirp/platform.bvs.validation.v2.ValidationAPI/';
    ...
    public function handle(ServerRequestInterface $req): ResponseInterface
    {
        ...
        switch ($req->getUri()->getPath()) {
            case '/twirp/platform.bvs.validation.v2.ValidationAPI/CreateValidation':
                return $this->handleCreateValidation($ctx, $req);
            case '/twirp/platform.bvs.validation.v2.ValidationAPI/GetValidation':
