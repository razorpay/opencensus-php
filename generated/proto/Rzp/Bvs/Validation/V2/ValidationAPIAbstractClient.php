...
abstract class ValidationAPIAbstractClient
{
    ...
    public function CreateValidation(array $ctx, \Rzp\Bvs\Validation\V2\CreateValidationRequest $in): \Rzp\Bvs\Validation\V2\ValidationResponse
    {
        ...
        $url = $this->addr.'/twirp/platform.bvs.validation.v2.ValidationAPI/CreateValidation';
    ...
    public function GetValidation(array $ctx, \Rzp\Bvs\Validation\V2\GetValidationRequest $in): \Rzp\Bvs\Validation\V2\ValidationResponse
    {
        ...
        $url = $this->addr.'/twirp/platform.bvs.validation.v2.ValidationAPI/GetValidation';
