...
/**
 * @internal ValidationAPIAbstractClient provides abstraction for JsonClient and Client (default).
 ...
 */
abstract class ValidationAPIAbstractClient
{
    /**
     * @var server
     */
     ...
     * {@inheritdoc}
     */
    public function CreateValidation(array $ctx, \Rzp\Bvs\Validation\V2\CreateValidationRequest $in): \Rzp\Bvs\Validation\V2\ValidationResponse
    {
        ...
        $out = new \Rzp\Bvs\Validation\V2\ValidationResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/platform.bvs.validation.v2.ValidationAPI/CreateValidation';
        } else {
            $url = $url.'/'.$this->prefix.'/platform.bvs.validation.v2.ValidationAPI/CreateValidation';
        }
     ...
     * {@inheritdoc}
     */
    public function GetValidation(array $ctx, \Rzp\Bvs\Validation\V2\GetValidationRequest $in): \Rzp\Bvs\Validation\V2\ValidationResponse
    {
        $ctx = Context::withPackageName($ctx, 'platform.bvs.validation.v2');
        $ctx = Context::withServiceName($ctx, 'ValidationAPI');
        ...
        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/platform.bvs.validation.v2.ValidationAPI/GetValidation';
        } else {
            $url = $url.'/'.$this->prefix.'/platform.bvs.validation.v2.ValidationAPI/GetValidation';
        }
