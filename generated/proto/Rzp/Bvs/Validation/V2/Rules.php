...
/**
 * Generated from protobuf message <code>platform.bvs.validation.v2.Rules</code>
 */
class Rules extends \Google\Protobuf\Internal\Message
{
    ...
    protected $version = '';
    /**
     * Generated from protobuf field <code>map<int32, .platform.bvs.validation.v2.Rule> rules_list = 2;</code>
     */
    private $rules_list;
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::INT32, \Google\Protobuf\Internal\GPBType::MESSAGE, \Rzp\Bvs\Validation\V2\Rule::class);
        $this->rules_list = $arr;
