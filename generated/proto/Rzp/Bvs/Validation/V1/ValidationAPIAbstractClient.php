...
abstract class ValidationAPIAbstractClient
{
     ...
     * {@inheritdoc}
     */
    public function CreateValidation(array $ctx, \Rzp\Bvs\Validation\V1\CreateValidationRequest $in): \Rzp\Bvs\Validation\V1\ValidationResponse
    {
        $ctx = Context::withPackageName($ctx, 'platform.bvs.validation.v1');
        $ctx = Context::withServiceName($ctx, 'ValidationAPI');
        $ctx = Context::withMethodName($ctx, 'CreateValidation');

        $out = new \Rzp\Bvs\Validation\V1\ValidationResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/platform.bvs.validation.v1.ValidationAPI/CreateValidation';
        } else {
            $url = $url.'/'.$this->prefix.'/platform.bvs.validation.v1.ValidationAPI/CreateValidation';
        }
     ...
     * {@inheritdoc}
     */
    public function GetValidation(array $ctx, \Rzp\Bvs\Validation\V1\GetValidationRequest $in): \Rzp\Bvs\Validation\V1\ValidationResponse
    {
        $ctx = Context::withPackageName($ctx, 'platform.bvs.validation.v1');
        $ctx = Context::withServiceName($ctx, 'ValidationAPI');
        ...
        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/platform.bvs.validation.v1.ValidationAPI/GetValidation';
        } else {
            $url = $url.'/'.$this->prefix.'/platform.bvs.validation.v1.ValidationAPI/GetValidation';
        }
