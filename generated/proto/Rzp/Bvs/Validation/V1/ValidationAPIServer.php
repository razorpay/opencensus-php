...
{
    const PATH_PREFIX = '/twirp/platform.bvs.validation.v1.ValidationAPI/';
    ...
    public function handle(ServerRequestInterface $req): ResponseInterface
    {
        ...
        switch ($req->getUri()->getPath()) {
            case '/twirp/platform.bvs.validation.v1.ValidationAPI/CreateValidation':
                return $this->handleCreateValidation($ctx, $req);
            case '/twirp/platform.bvs.validation.v1.ValidationAPI/GetValidation':
    ...
    private function handleCreateValidationJson(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
        ...
        try {
            ...
            $in = new \Rzp\Bvs\Validation\V1\CreateValidationRequest();
    ...
    private function handleGetValidationJson(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
        ...
        try {
            ...
            $in = new \Rzp\Bvs\Validation\V1\GetValidationRequest();
            $in->mergeFromJsonString((string)$req->getBody());
