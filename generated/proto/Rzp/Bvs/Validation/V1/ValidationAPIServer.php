...
final class ValidationAPIServer implements RequestHandlerInterface
{
     ...
     */
    public const PATH_PREFIX = '/twirp/platform.bvs.validation.v1.ValidationAPI/';
    ...
    {
        return $this->prefix.'/platform.bvs.validation.v1.ValidationAPI/';
    }
    ...
    public function handle(ServerRequestInterface $req): ResponseInterface
    {
        ...
        if ($service != 'platform.bvs.validation.v1.ValidationAPI') {
