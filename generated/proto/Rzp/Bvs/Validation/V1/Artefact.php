...
/**
 * Generated from protobuf message <code>platform.bvs.validation.v1.Artefact</code>
 */
class Artefact extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>map<int32, .platform.bvs.validation.v1.ProofDetails> proofs = 7;</code>
     */
    private $proofs;
    /**
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::INT32, \Google\Protobuf\Internal\GPBType::MESSAGE, \Rzp\Bvs\Validation\V1\ProofDetails::class);
        $this->proofs = $arr;
