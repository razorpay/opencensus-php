...
/**
 * @internal AccountAPIAbstractClient provides abstraction for JsonClient and Client (default).
 ...
 */
abstract class AccountAPIAbstractClient
{
    /**
     * @var server
     */
     ...
     * {@inheritdoc}
     */
    public function Create(array $ctx, \Rzp\Accounts\Account\V1\CreateAccountRequest $in): \Rzp\Accounts\Account\V1\Account
    {
        ...
        $out = new \Rzp\Accounts\Account\V1\Account();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/rzp.accounts.account.v1.AccountAPI/Create';
        } else {
            $url = $url.'/'.$this->prefix.'/rzp.accounts.account.v1.AccountAPI/Create';
        }
     ...
     * {@inheritdoc}
     */
    public function Update(array $ctx, \Rzp\Accounts\Account\V1\UpdateAccountRequest $in): \Rzp\Accounts\Account\V1\Account
    {
        $ctx = Context::withPackageName($ctx, 'rzp.accounts.account.v1');
        $ctx = Context::withServiceName($ctx, 'AccountAPI');
        ...
        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/rzp.accounts.account.v1.AccountAPI/Update';
        } else {
            $url = $url.'/'.$this->prefix.'/rzp.accounts.account.v1.AccountAPI/Update';
        }
     ...
     * {@inheritdoc}
     */
    public function Fetch(array $ctx, \Rzp\Accounts\Account\V1\FetchAccountRequest $in): \Rzp\Accounts\Account\V1\Account
    {
        $ctx = Context::withPackageName($ctx, 'rzp.accounts.account.v1');
        $ctx = Context::withServiceName($ctx, 'AccountAPI');
        ...
        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/rzp.accounts.account.v1.AccountAPI/Fetch';
        } else {
            $url = $url.'/'.$this->prefix.'/rzp.accounts.account.v1.AccountAPI/Fetch';
        }
     ...
     * {@inheritdoc}
     */
    public function DeleteAccountContact(array $ctx, \Rzp\Accounts\Account\V1\DeleteAccountContactRequest $in): \Rzp\Accounts\Account\V1\DeleteAccountContactResponse
    {
        $ctx = Context::withPackageName($ctx, 'rzp.accounts.account.v1');
        $ctx = Context::withServiceName($ctx, 'AccountAPI');
        $ctx = Context::withMethodName($ctx, 'DeleteAccountContact');

        $out = new \Rzp\Accounts\Account\V1\DeleteAccountContactResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/rzp.accounts.account.v1.AccountAPI/DeleteAccountContact';
        } else {
            $url = $url.'/'.$this->prefix.'/rzp.accounts.account.v1.AccountAPI/DeleteAccountContact';
        }
