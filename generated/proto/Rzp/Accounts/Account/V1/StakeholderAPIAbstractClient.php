...
/**
 * @internal StakeholderAPIAbstractClient provides abstraction for JsonClient and Client (default).
 ...
 */
abstract class StakeholderAPIAbstractClient
{
    /**
     * @var server
     */
     ...
     * {@inheritdoc}
     */
    public function Create(array $ctx, \Rzp\Accounts\Account\V1\CreateStakeholderRequest $in): \Rzp\Accounts\Account\V1\Stakeholder
    {
        ...
        $out = new \Rzp\Accounts\Account\V1\Stakeholder();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/rzp.accounts.account.v1.StakeholderAPI/Create';
        } else {
            $url = $url.'/'.$this->prefix.'/rzp.accounts.account.v1.StakeholderAPI/Create';
        }
     ...
     * {@inheritdoc}
     */
    public function Update(array $ctx, \Rzp\Accounts\Account\V1\UpdateStakeholderRequest $in): \Rzp\Accounts\Account\V1\Stakeholder
    {
        $ctx = Context::withPackageName($ctx, 'rzp.accounts.account.v1');
        $ctx = Context::withServiceName($ctx, 'StakeholderAPI');
        ...
        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/rzp.accounts.account.v1.StakeholderAPI/Update';
        } else {
            $url = $url.'/'.$this->prefix.'/rzp.accounts.account.v1.StakeholderAPI/Update';
        }
     ...
     * {@inheritdoc}
     */
    public function Fetch(array $ctx, \Rzp\Accounts\Account\V1\FetchStakeholderRequest $in): \Rzp\Accounts\Account\V1\Stakeholder
    {
        $ctx = Context::withPackageName($ctx, 'rzp.accounts.account.v1');
        $ctx = Context::withServiceName($ctx, 'StakeholderAPI');
        ...
        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/rzp.accounts.account.v1.StakeholderAPI/Fetch';
        } else {
            $url = $url.'/'.$this->prefix.'/rzp.accounts.account.v1.StakeholderAPI/Fetch';
        }
     ...
     * {@inheritdoc}
     */
    public function FetchAll(array $ctx, \Rzp\Accounts\Account\V1\FetchStakeholdersRequest $in): \Rzp\Accounts\Account\V1\FetchStakeholdersResponse
    {
        $ctx = Context::withPackageName($ctx, 'rzp.accounts.account.v1');
        $ctx = Context::withServiceName($ctx, 'StakeholderAPI');
        $ctx = Context::withMethodName($ctx, 'FetchAll');

        $out = new \Rzp\Accounts\Account\V1\FetchStakeholdersResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/rzp.accounts.account.v1.StakeholderAPI/FetchAll';
        } else {
            $url = $url.'/'.$this->prefix.'/rzp.accounts.account.v1.StakeholderAPI/FetchAll';
        }
     ...
     * {@inheritdoc}
     */
    public function FetchMerchantStakeholders(array $ctx, \Rzp\Accounts\Account\V1\FetchMerchantStakeholdersRequest $in): \Rzp\Accounts\Account\V1\FetchMerchantStakeholdersResponse
    {
        $ctx = Context::withPackageName($ctx, 'rzp.accounts.account.v1');
        $ctx = Context::withServiceName($ctx, 'StakeholderAPI');
        $ctx = Context::withMethodName($ctx, 'FetchMerchantStakeholders');

        $out = new \Rzp\Accounts\Account\V1\FetchMerchantStakeholdersResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/rzp.accounts.account.v1.StakeholderAPI/FetchMerchantStakeholders';
        } else {
            $url = $url.'/'.$this->prefix.'/rzp.accounts.account.v1.StakeholderAPI/FetchMerchantStakeholders';
        }
