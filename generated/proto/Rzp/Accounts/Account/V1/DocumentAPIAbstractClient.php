...
/**
 * @internal DocumentAPIAbstractClient provides abstraction for JsonClient and Client (default).
 ...
 */
abstract class DocumentAPIAbstractClient
{
    /**
     * @var server
     */
     ...
     * {@inheritdoc}
     */
    public function Create(array $ctx, \Rzp\Accounts\Account\V1\CreateDocumentsRequest $in): \Rzp\Accounts\Account\V1\DocumentFetchResponse
    {
        ...
        $out = new \Rzp\Accounts\Account\V1\DocumentFetchResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/rzp.accounts.account.v1.DocumentAPI/Create';
        } else {
            $url = $url.'/'.$this->prefix.'/rzp.accounts.account.v1.DocumentAPI/Create';
        }
     ...
     * {@inheritdoc}
     */
    public function Fetch(array $ctx, \Rzp\Accounts\Account\V1\FetchDocumentsRequest $in): \Rzp\Accounts\Account\V1\DocumentFetchResponse
    {
        $ctx = Context::withPackageName($ctx, 'rzp.accounts.account.v1');
        $ctx = Context::withServiceName($ctx, 'DocumentAPI');
        ...
        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/rzp.accounts.account.v1.DocumentAPI/Fetch';
        } else {
            $url = $url.'/'.$this->prefix.'/rzp.accounts.account.v1.DocumentAPI/Fetch';
        }
     ...
     * {@inheritdoc}
     */
    public function Delete(array $ctx, \Rzp\Accounts\Account\V1\DeleteDocumentRequest $in): \Rzp\Accounts\Account\V1\DeleteDocumentResponse
    {
        $ctx = Context::withPackageName($ctx, 'rzp.accounts.account.v1');
        $ctx = Context::withServiceName($ctx, 'DocumentAPI');
        $ctx = Context::withMethodName($ctx, 'Delete');

        $out = new \Rzp\Accounts\Account\V1\DeleteDocumentResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/rzp.accounts.account.v1.DocumentAPI/Delete';
        } else {
            $url = $url.'/'.$this->prefix.'/rzp.accounts.account.v1.DocumentAPI/Delete';
        }
     ...
     * {@inheritdoc}
     */
    public function FetchMerchantDocuments(array $ctx, \Rzp\Accounts\Account\V1\FetchMerchantDocumentsRequest $in): \Rzp\Accounts\Account\V1\FetchMerchantDocumentsResponse
    {
        $ctx = Context::withPackageName($ctx, 'rzp.accounts.account.v1');
        $ctx = Context::withServiceName($ctx, 'DocumentAPI');
        $ctx = Context::withMethodName($ctx, 'FetchMerchantDocuments');

        $out = new \Rzp\Accounts\Account\V1\FetchMerchantDocumentsResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/rzp.accounts.account.v1.DocumentAPI/FetchMerchantDocuments';
        } else {
            $url = $url.'/'.$this->prefix.'/rzp.accounts.account.v1.DocumentAPI/FetchMerchantDocuments';
        }
