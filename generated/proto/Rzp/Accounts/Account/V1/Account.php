...
/**
 * Generated from protobuf message <code>rzp.accounts.account.v1.Account</code>
 */
class Account extends \Google\Protobuf\Internal\Message
{
    ...
    protected $email = '';
    /**
     * Generated from protobuf field <code>string reference_id = 5;</code>
     */
    ...
    /**
     * Generated from protobuf field <code>string pricing_plan_id = 8;</code>
     */
    protected $pricing_plan_id = '';
    /**
     * Generated from protobuf field <code>.rzp.accounts.account.v1.Account.Profile profile = 9;</code>
     */
    protected $profile = null;
    /**
     * Generated from protobuf field <code>.google.protobuf.Timestamp suspended_at = 10;</code>
     */
    protected $suspended_at = null;
    /**
     * Generated from protobuf field <code>.google.protobuf.Timestamp archived_at = 11;</code>
     */
    ...
    /**
     * Generated from protobuf field <code>repeated string transaction_report_emails = 14;</code>
     */
    private $transaction_report_emails;
    /**
     * Generated from protobuf field <code>.rzp.accounts.account.v1.Account.ChargeInfo charge_info = 15;</code>
     */
    protected $charge_info = null;
    /**
     * Generated from protobuf field <code>map<string, string> legal_info = 16;</code>
     */
    private $legal_info;
    /**
     * Generated from protobuf field <code>.rzp.accounts.account.v1.Account.Apps apps = 17;</code>
     */
    protected $apps = null;
    /**
     * Generated from protobuf field <code>.rzp.accounts.account.v1.Account.Brand brand = 18;</code>
     */
    protected $brand = null;
    /**
     * Generated from protobuf field <code>.rzp.accounts.account.v1.Account.ContactInfo contact_info = 19;</code>
     */
    protected $contact_info = null;
    /**
     * Generated from protobuf field <code>string legal_business_name = 20;</code>
     */
    protected $legal_business_name = '';
    /**
     * Generated from protobuf field <code>string customer_facing_business_name = 21;</code>
     */
    protected $customer_facing_business_name = '';
    /**
     * Generated from protobuf field <code>string business_type = 22;</code>
     */
    protected $business_type = '';
    /**
     * Generated from protobuf field <code>repeated .rzp.accounts.account.v1.BankAccount bank_accounts = 23;</code>
     */
     ...
     *     @type array<\Rzp\Accounts\Account\V1\BankAccount>|\Google\Protobuf\Internal\RepeatedField $bank_accounts
     * }
     */
     ...
     * @return $this
     */
    public function setPricingPlanId($var)
    {
        GPBUtil::checkString($var, True);
        $this->pricing_plan_id = $var;
    ...
    public function hasSuspendedAt()
    {
        return isset($this->suspended_at);
    }

    public function clearSuspendedAt()
    {
        unset($this->suspended_at);
    }
    ...
    public function hasArchivedAt()
    {
        return isset($this->archived_at);
    }

    public function clearArchivedAt()
    {
        unset($this->archived_at);
    }
    ...
    /**
     * Generated from protobuf field <code>.rzp.accounts.account.v1.Account.ChargeInfo charge_info = 15;</code>
     * @return \Rzp\Accounts\Account\V1\Account\ChargeInfo|null
     */
    ...
    public function hasChargeInfo()
    {
        return isset($this->charge_info);
    }

    public function clearChargeInfo()
    {
        unset($this->charge_info);
    }

    /**
     * Generated from protobuf field <code>.rzp.accounts.account.v1.Account.ChargeInfo charge_info = 15;</code>
     * @param \Rzp\Accounts\Account\V1\Account\ChargeInfo $var
     * @return $this
     */
    public function setChargeInfo($var)
    {
        GPBUtil::checkMessage($var, \Rzp\Accounts\Account\V1\Account\ChargeInfo::class);
        $this->charge_info = $var;
    ...
    /**
     * Generated from protobuf field <code>repeated .rzp.accounts.account.v1.BankAccount bank_accounts = 23;</code>
     * @param array<\Rzp\Accounts\Account\V1\BankAccount>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setBankAccounts($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Rzp\Accounts\Account\V1\BankAccount::class);
