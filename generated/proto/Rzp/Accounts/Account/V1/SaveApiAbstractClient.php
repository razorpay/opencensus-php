...
/**
 * @internal SaveApiAbstractClient provides abstraction for JsonClient and Client (default).
 ...
 */
abstract class SaveApiAbstractClient
{
    /**
     * @var server
     */
     ...
     * {@inheritdoc}
     */
    public function Save(array $ctx, \Rzp\Accounts\Account\V1\SaveAccountEntityRequest $in): \Rzp\Accounts\Account\V1\SaveAccountEntityResponse
    {
        ...
        $out = new \Rzp\Accounts\Account\V1\SaveAccountEntityResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/rzp.accounts.account.v1.SaveApi/Save';
        } else {
            $url = $url.'/'.$this->prefix.'/rzp.accounts.account.v1.SaveApi/Save';
        }
