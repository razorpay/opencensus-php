...
namespace Rzp\Accounts\Account\V1\UpdateStakeholderRequest;
...
/**
 * Generated from protobuf message <code>rzp.accounts.account.v1.UpdateStakeholderRequest.UpdateStakeholderRequestBody</code>
 */
class UpdateStakeholderRequestBody extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>.rzp.accounts.account.v1.Stakeholder.Relationship relationship = 1;</code>
     */
    ...
    protected $name = '';
    /**
     * Generated from protobuf field <code>int32 percentage_ownership = 5;</code>
     */
    protected $percentage_ownership = 0;
    /**
     * Generated from protobuf field <code>map<string, .rzp.accounts.account.v1.Address> addresses = 6;</code>
     */
    private $addresses;
    /**
    ...
    protected $email = '';
    /**
     * Generated from protobuf field <code>string phone_primary = 8;</code>
     */
    protected $phone_primary = '';
    /**
     * Generated from protobuf field <code>string phone_secondary = 9;</code>
     */
...
class_alias(UpdateStakeholderRequestBody::class, \Rzp\Accounts\Account\V1\UpdateStakeholderRequest_UpdateStakeholderRequestBody::class);
