...
/**
 * @internal SyncDeviationAPIAbstractClient provides abstraction for JsonClient and Client (default).
 ...
 */
abstract class SyncDeviationAPIAbstractClient
{
    /**
     * @var server
     */
     ...
     * {@inheritdoc}
     */
    public function SyncAccountDeviation(array $ctx, \Rzp\Accounts\SyncDeviation\V1\SyncAccountDeviationRequest $in): \Rzp\Accounts\SyncDeviation\V1\SyncAccountDeviationResponse
    {
        ...
        $out = new \Rzp\Accounts\SyncDeviation\V1\SyncAccountDeviationResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/rzp.accounts.sync_deviation.v1.SyncDeviationAPI/SyncAccountDeviation';
        } else {
            $url = $url.'/'.$this->prefix.'/rzp.accounts.sync_deviation.v1.SyncDeviationAPI/SyncAccountDeviation';
        }
