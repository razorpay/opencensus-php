...
export type DashboardGraphQLPayoutsQueuedSummaryWithoutReasonResolvers<
  ContextType = any,
  ParentType extends DashboardGraphQLResolversParentTypes['DashboardGraphQLPayoutsQueuedSummaryWithoutReason'] = DashboardGraphQLResolversParentTypes['DashboardGraphQLPayoutsQueuedSummaryWithoutReason'],
> = {
