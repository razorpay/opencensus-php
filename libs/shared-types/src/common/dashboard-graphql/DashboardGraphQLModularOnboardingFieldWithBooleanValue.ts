...
export type DashboardGraphQLModularOnboardingFieldWithBooleanValue = DashboardGraphQLModularOnboardingField & {
  __typename?: 'DashboardGraphQLModularOnboardingFieldWithBooleanValue';
  ...
  value: DashboardGraphQLScalars['Boolean'];
};