...
export type DashboardGraphQLPayoutsScheduledSummaryTodayResolvers<
  ContextType = any,
  ParentType extends DashboardGraphQLResolversParentTypes['DashboardGraphQLPayoutsScheduledSummaryToday'] = DashboardGraphQLResolversParentTypes['DashboardGraphQLPayoutsScheduledSummaryToday'],
> = {
