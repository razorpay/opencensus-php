<div class='content-container'>
    ...
    @if ($data['website_detail']['shipping_period'] !== 'Not applicable')
        <p class='content-text'>
            ...
            {{$data['website_detail']['shipping_period']}} or as per the delivery date agreed
            at the time of order confirmation and delivering of the shipment subject to Courier Company / post office norms.
            {{$data['merchant_legal_entity_name']}} is not liable for any delay in delivery by the courier company / postal
            authorities and only guarantees to hand over the consignment to the courier company or
            postal authorities within {{$data['website_detail']['shipping_period']}} rom the date of the order
