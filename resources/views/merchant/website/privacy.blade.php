<div class='content-container'>
    ...
    <p class='content-text'>
        ...
        {{{$data['merchant_legal_entity_name']}}} when you use this website.
    </p>
    <p class='content-text'>
        {{{$data['merchant_legal_entity_name']}}} is committed to ensuring that your
    ...
    <p class='content-text'>
        {{{$data['merchant_legal_entity_name']}}} may change this policy from time
