<div class='content-container'>
    ...
    @if ($data['website_detail']['refund_process_period'] !== 'Not applicable')
        <p class='content-text'>
            {{$data['merchant_legal_entity_name']}} believes in helping its customers as far as possible,
        ...
        <ul class='unorder-list'>
            <li class='list-item'>
                <p class='content-text list-text'>
                    ...
                    {{$data['website_detail']['refund_request_period']}} of placing the order. However, the cancellation request
            ...
            <li class='list-item'>
                <p class='content-text list-text'>
                    ...
                    customer service within {{$data['website_detail']['refund_request_period']}} of
