<div class='content-container'>
    ...
    <p class='content-text'>
        ...
        {{{$data['merchant_legal_entity_name']}}}''s relationship with you in
        relation to this website.
    </p>
    <p class='content-text'>
        The term '{{{$data['merchant_legal_entity_name']}}}' or 'us' or 'we' refers
    ...
    <ul class='unorder-list'>
        ...
        <li class='list-item'>
            <p class='content-text list-text'>
                ...
                document without {{{$data['merchant_legal_entity_name']}}}’s prior
                written consent.
            </p>
        </li>
        <li class='list-item'>
