<div class='content-container'>
    ...
    <p class= 'content-text'>
        ...
        {{{RZP\Constants\IndianStates::getStateNameByCode($data['merchant_details']['business_registered_state'])}}}
        ...
        {{{RZP\Constants\IndianStates::getStateNameByCode($data['merchant_details']['business_operation_state'])}}}
