    ...
    @endif
        <div class='compalinace-content'>
            @if ($data['sectionName'] === 'contact_us')
                @include('merchant.website.contact_us_v2',$data) @endif
            @if ($data['sectionName'] === 'privacy')
                @include('merchant.website.privacy_v2',$data) @endif
            @if ($data['sectionName']=== 'refund')
                @include('merchant.website.refund_v2',$data) @endif
            @if ($data['sectionName'] === 'shipping')
                @include('merchant.website.shipping_v2',$data) @endif
            @if ($data['sectionName']=== 'terms')
                @include('merchant.website.terms_v2',$data) @endif
        </div>
</div>
</html>
