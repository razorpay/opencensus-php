                                            ...
                                            <td align="left" style="font-size:0px;padding:0px;word-break:break-word;">
                                                <div style="font-family:Trebuchet MS;font-size:13px;line-height:1;text-align:left;color:#000000;">
                                                    <div class="card title" style="width: 85%; width: calc(46000% - 211600px); max-width: 460px; min-width: 308px; margin-left: auto; margin-right: auto; box-sizing: border-box; padding-left: 16px; padding-right: 16px; background-color: #FFFFFF; padding-bottom: 16px;">
                                                        <div class="center-align" style="text-align: center;"></div>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                ...
                                <td style="vertical-align:top;padding:0px;">
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                                        <tr>
                                            <td align="left" style="font-size:0px;padding:0px;word-break:break-word;">
                                                <div style="font-family:Trebuchet MS;font-size:13px;line-height:1;text-align:left;color:#000000;">
                                                    <div class="card informative no-horizontal-padding" style="width: 85%; width: calc(46000% - 211600px); max-width: 460px; min-width: 308px; margin-left: auto; margin-right: auto; box-sizing: border-box; background-color: #FFFFFF; padding-left: 0px; padding-right: 0px; padding-top: 20px; padding-bottom: 20px; margin-top: 8px;">
                                                        <div class="information-row" style="font-size: 14px; line-height: 1.5; width: 100%; box-sizing: border-box; padding-left: 9.3%; margin-bottom: 20px;">
                                                            <div class="label" style="color: #515978; display: inline-block; width: 40%; vertical-align: middle;">Paid out to</div>
                                                            <div class="value left-align font-color-black-o-30" style="display: inline-block; width: 50%; text-align: left; color: #333333;">{{ $contact_name }}</div>
                                                            @isset($contact_phone)<div class="label" style="color: #515978; display: inline-block; width: 40%; vertical-align: middle;"></div>@endisset
                                                            @isset($contact_phone)<div class="value left-align sub-title" style="display: inline-block; width: 50%; text-align: left; color: #666666; font-size: 12px;">{{ $contact_phone }}</div>@endisset
                                                            @isset($contact_email)<div class="label" style="color: #515978; display: inline-block; width: 40%; vertical-align: middle;"></div>@endisset
                                                            @isset($contact_email)<div class="value left-align sub-title" style="display: inline-block; width: 50%; text-align: left; color: #666666; font-size: 12px;">{{ $contact_email }}</div>@endisset
                                                        </div>
                                                        <div class="information-row" style="font-size: 14px; line-height: 1.5; width: 100%; box-sizing: border-box; padding-left: 9.3%; margin-bottom: 20px;">
                                                            <div class="label" style="color: #515978; display: inline-block; width: 40%; vertical-align: middle;">Paid on</div>
                                                            <div class="value left-align font-color-black-o-30" style="display: inline-block; width: 50%; text-align: left; color: #333333;">{{ $payout_link_success_date }}</div>
                                                        </div>
                                                        @isset($fund_account_vpa)<div class="information-row" style="font-size: 14px; line-height: 1.5; width: 100%; box-sizing: border-box; padding-left: 9.3%; margin-bottom: 20px;">
                                                            <div class="label" style="color: #515978; display: inline-block; width: 40%; vertical-align: middle;">Account details</div>
                                                            <div class="value left-align font-color-black-o-30" style="display: inline-block; width: 50%; text-align: left; color: #333333;">{{ $fund_account_vpa }}</div>
                                                        </div>@endisset
                                                        @isset($fund_account_number)<div class="information-row" style="font-size: 14px; line-height: 1.5; width: 100%; box-sizing: border-box; padding-left: 9.3%; margin-bottom: 20px;">
                                                            <div class="label" style="color: #515978; display: inline-block; width: 40%; vertical-align: middle;">Account details</div>
                                                        ...
                                                        @isset($utr)<div class="information-row" style="font-size: 14px; line-height: 1.5; width: 100%; box-sizing: border-box; padding-left: 9.3%;">
                                                            <div class="label" style="color: #515978; display: inline-block; width: 40%; vertical-align: middle;">UTR</div>
                                                            <div class="value left-align font-color-black-o-30" style="display: inline-block; width: 50%; text-align: left; color: #333333;">{{ $utr }}</div>
                                                        </div>@endisset
                                                    </div>
                                                </div>
                                            </td>
