...
<table style="width:550px">
    <div style="background-color: #FFFFFF;margin-bottom:20px;padding:20px;width: 550px">
...
@endif
<table style="width:550px">
    <div style="background-color: #FFFFFF;border-top: 2px solid #528FF0; margin-bottom:20px;padding:20px;width: 550px">
...
<table style="width:550px">
    <div style="background-color: #FFFFFF;border-top: 2px solid #528FF0; margin-bottom:20px;padding:20px;width: 550px">
        ...
        <a href = "https://dashboard.razorpay.com/#/app/settlements"><div style = "width:130px; background-color:#528ff0; border-radius: 3px; margin:auto; padding: 13px; padding-left: 60px; white-space: nowrap;" ><p style = "margin:auto; color:#fff; display: inline-block;Trebuchet MS;font-style: normal;font-weight: bold">Settle Now</p></div></a>
    </div>
</table>
@endif