@if(isset($type) and ($type) === 'customer')
  Read our customer dispute resolution policy.
  For further assistance, you can reach out to us
  <a href="https://razorpay.com/contact/">here</a>.
@elseif(isset($type) and ($type) === 'merchant_transaction')
  For chargeback queries you can read our <a href="https://razorpay.com/chargeback/">chargeback</a> guide.
  You can reach out to us <a href="https://razorpay.com/contact/">here</a>
