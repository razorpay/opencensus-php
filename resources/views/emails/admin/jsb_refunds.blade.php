...
<p>Claim details & Account details for initiating online FT</p>
            <table style="border: 1px solid grey;">
                <tr style="border: 1px solid grey">
                    <th style="border: 1px solid grey">Date of Transactions</th>
                ...
                <tr style="border: 1px solid grey">
                    <td style="border: 1px solid grey">Total Transactions</td>
                    <td style="border: 1px solid grey">{{{$count['claims']}}}</td>
                    <td style="border: 1px solid grey">{{{$amount['claims']}}}</td>
                </tr>
                <tr style="border: 1px solid grey">
                    <th style="border: 1px solid grey">Date of Refund</th>
                    <th style="border: 1px solid grey">Count</th>
                    <th style="border: 1px solid grey">Amount</th>
                </tr>
                <tr style="border: 1px solid grey">
                ...
                <tr style="border: 1px solid grey">
                    <td style="border: 1px solid grey">Total Refunds</td>
                    <td style="border: 1px solid grey">{{{$count['refunds']}}}</td>
                    <td style="border: 1px solid grey">{{{$amount['refunds']}}}</td>
                </tr>
                <tr style="border: 1px solid grey">
                    <td style="border: 1px solid grey">Net Amount</td>
                    <td style="border: 1px solid grey">{{{$amount['total']}}}</td>
                </tr>
                <tr style="border: 1px solid grey">
                    <td style="border: 1px solid grey">Net Amount Payable</td>
                    <td style="border: 1px solid grey">{{{$amount['total']}}}</td>
                </tr>
            </table>
          </td>
