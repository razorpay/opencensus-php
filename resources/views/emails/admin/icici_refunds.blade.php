...
<p>Please find attached transactions to be refunded for {{{$date}}}.</p>
<br>
<table style="border: 1px solid grey;">
    <tbody>
        <tr style="border: 1px solid grey">
            <td style="border: 1px solid grey">Total transactions to be refunded: {{{$count}}}</td>
        </tr>
        <tr style="border: 1px solid grey">
            <td style="border: 1px solid grey">Total Refund Amount: {{{$amount}}}/-</td>
        </tr>
    </tbody>
</table>
