...
<html lang="en-US">
    ...
    <body>
        ...
        <div>
            ...
            <p>Please verify the details <a href="{{ URL::to('https://dashboard.razorpay.com/admin#/app/merchants/'.$id.'/detail') }}" target="_blank">here</a> and communicate with the merchant as necessary.</p>
