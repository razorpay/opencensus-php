...
transaction date, total transaction amount, refund date, total refund amount and Net payable.
                        ...
                        <td style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6em; margin: 0; padding: 0;">
                            <table style="border: 1px solid grey;">
                                ...
                                <tr style="border: 1px solid grey">
                                    ...
                                    <th style="border: 1px solid grey">total transaction amount</th>
                                    <th style="border: 1px solid grey">refund date</th>
                                    <th style="border: 1px solid grey">total refund amount</th>
                                    <th style="border: 1px solid grey">Net payable</th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr style="border: 1px solid grey">
                                    <td style="border: 1px solid grey">{{{$date['payment']}}}</td>
                                    <td style="border: 1px solid grey">{{{$amount['claims']}}}</td>
                                    <td style="border: 1px solid grey">{{{$date['refund']}}}</td>
