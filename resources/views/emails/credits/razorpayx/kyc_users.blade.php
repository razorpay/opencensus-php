                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                                        ...
                                        <tr>
                                            <td align="left" style="font-size:0px;padding:0px;word-break:break-word;">
                                                ...
                                                <div style="font-family:Trebuchet MS;font-size:13px;line-height:1;text-align:left;color:#000000;">
                                                    <div class="card secondary title informative" style="width: 85%; width: calc(46000% - 211600px); max-width: 460px; min-width: 308px; margin-left: auto; margin-right: auto; box-sizing: border-box; background-color: #242b4d; padding-bottom: 16px; padding-left: 24px; padding-right: 24px;"><div class="center-align font-size-18 padding-35 font-color-primary padding-bottom-16 line-height-26 border-bottom-silver margin-bottom-16" style="text-align: center; font-size: 18px; color: #FFF; line-height: 26px; padding: 0 35px; padding-bottom: 16px; margin-bottom: 16px; border-bottom: 1px solid #E5E5E5;">Complete your KYC to avail your Credits today</div><div class="para-dark center" style="color: #9195A6; font-size: 14px; line-height: 1.5; text-align: center;">You can redeem these Credits again the Payout Fees. You can view the Credit Balance in the account section of your RazorpayX Dashboard.</div><div class="para-dark center" style="color: #9195A6; font-size: 14px; line-height: 1.5; text-align: center;"><a class="link btn primary font-bold" href="https://x.razorpay.com" target="_blank" style="text-decoration: none; font-weight: 700; font-size: 14px; line-height: 1.5; border: 1px solid; padding: 8px 12px; letter-spacing: 1px; border-radius: 2px; overflow: hidden; min-width: 145px; display: inline-block; font-family: Trebuchet MS; margin: 24px auto 0 auto; text-align: center; color: #FFF; background-color: #3281FF; border-color: #3281FF;">FILL KYC</a></div></div>
                                                </div>
