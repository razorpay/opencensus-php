                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                                        ...
                                        <tr>
                                            <td align="left" style="font-size:0px;padding:0px;word-break:break-word;">
                                                ...
                                                <div style="font-family:Trebuchet MS;font-size:13px;line-height:1;text-align:left;color:#000000;">
                                                    <div class="card secondary title informative" style="width: 85%; width: calc(46000% - 211600px); max-width: 460px; min-width: 308px; margin-left: auto; margin-right: auto; box-sizing: border-box; background-color: #242b4d; padding-bottom: 16px; padding-left: 24px; padding-right: 24px;"><div class="rewards-section padding-8" style="padding: 8px;"><div class="center-align font-size-18 font-color-primary line-height-26" style="text-align: center; font-size: 18px; color: #FFF; line-height: 26px;">We’re sorry to see you go!</div><div class="border-div" style="padding-top: 16px; padding-bottom: 21px;"><div class="border-bottom" style="opacity: 0.1; border-bottom: 1px solid #E5E5E5;"></div></div><div class="para-dark center" style="color: #9195A6; font-size: 14px; line-height: 1.5; text-align: center;"><div class="line-height-24" style="line-height: 24px; font-weight: 400; color: rgb(255, 255, 255, 0.5);">We have added <b>&#x20B9;{{$credits}} </b>worth free Credits to you. Your Payout fees upto ₹{{$credits}} will be redeemed against the Credits in your account.</div></div><div class="para-dark center margin-top-32" style="color: #9195A6; font-size: 14px; line-height: 1.5; margin-top: 32px; text-align: center;"><div class="line-height-24" style="line-height: 24px; font-weight: 400; color: rgb(255, 255, 255, 0.5);">You can view the Credit Balance in the account section of your RazorpayX Dashboard.</div></div><div class="center-align" style="text-align: center;"><a class="link btn primary font-bold" href="https://x.razorpay.com" target="_blank" style="text-decoration: none; font-weight: 700; font-size: 14px; line-height: 1.5; border: 1px solid; padding: 8px 12px; letter-spacing: 1px; border-radius: 2px; overflow: hidden; min-width: 145px; display: inline-block; font-family: Trebuchet MS; margin: 24px auto 0 auto; text-align: center; color: #FFF; background-color: #3281FF; border-color: #3281FF;">CLAIM YOUR CREDITS</a></div></div></div>
                                                </div>
