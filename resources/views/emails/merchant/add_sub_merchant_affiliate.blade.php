...
<p style="font-family: -apple-system,'.SFNSDisplay','Oxygen','Ubuntu','Roboto','Segoe UI','Helvetica Neue','Lucida Grande',sans-serif; font-weight: normal; padding: 0; margin-bottom: 10px; font-size: 16px; color: #2d2d2d; text-align: justify; line-height: 24px; background: white; margin: 10px 0px 10px 0px;">
  ...
  <br>
  @if($token)
  You can set up your login credentials <a href="{{ $org['hostname'] . '/#/access/resetpwd/'.$token.'?expiry_time='.$expiryTime.'&amp;email='.$subMerchant['email'] }}" target="_blank" style="color: #24bbea; text-decoration: none !important;">here</a> and submit the activation form with KYC details to start transacting.
  @else
...
<p style="font-family: -apple-system,'.SFNSDisplay','Oxygen','Ubuntu','Roboto','Segoe UI','Helvetica Neue','Lucida Grande',sans-serif; font-weight: normal; padding: 0; margin-bottom: 10px; font-size: 16px; color: #2d2d2d; text-align: justify; line-height: 24px; background: white; margin: 10px 0px 10px 0px;">This process is crucial as we share the same KYC with our partner banks who do their own due diligence. Also, signing up allows you to generate test keys from our dashboard which can be used for integrating payments in your product. You can just swap your test keys with your live keys once your account is activated.
