...
@section('content')
	...
	<br/><br/>
	As a part of this exercise, we have come across a suspicious account activity and have highlighted the same in our previous email. We observed that the website domains shared with Razorpay are no longer live. 
	<br/><br/>
