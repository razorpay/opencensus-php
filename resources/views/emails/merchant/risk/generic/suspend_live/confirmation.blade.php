...
@section('content')
    ...
    <br/><br/>
    We are writing to let you know we have suspended your account. This means that you will no longer be able to accept new transactions and there will be a temporary hold on any settlements that are due.
    <br/><br/>
