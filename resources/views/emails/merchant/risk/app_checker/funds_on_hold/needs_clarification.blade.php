...
@section('content')
	Dear {{$merchant_name}},
	<br/><br/>
	Hope you are doing fine. We wanted to write to you as we noticed an issue with your mobile application.
	<br/><br/>
	We have noticed that your registered mobile application(s) is(are) not operating at the moment. Please clarify your current business mobile application URL. Also please confirm to us how payments are being collected currently.
	<br/><br/>
