...
<div>
    ...
    <dd>We have also enabled <b>payouts</b> on <a href = "{{'https://' . parse_url(config('applications.banking_service_url'), PHP_URL_HOST)}}" >your RazorpayX account </a></dd><br>

    <dd>You can now create bank transfers using your RazorpayX account using NEFT, RTGS, IMPS transfer methods to
        other bank accounts.</dd><br>

    <dd><a href="https://razorpay.com/docs/razorpayx/" target="_blank">Click to learn how to make payouts using RazorpayX</a></dd><br>

    <dd>Alternately, you can route your payment gateway settlements to <a href = "{{'https://' . parse_url(config('applications.banking_service_url'), PHP_URL_HOST)}}" >your RazorpayX account.</a></dd><br>
