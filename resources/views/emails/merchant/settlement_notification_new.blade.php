            ...
            <table style="background-color: white; width: 100%">
              <tbody>
                ...
                <tr>
                  ...
                  <td style="text-align: end; padding: 0px 10px 20px 0px">
                    &#x20B9; {{number_format(floatval($settlement['amount']/100), 2, '.','')}}
                  </td>
                </tr>
                <tr>
                  <td
            ...
            >
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="text-align: center; padding: 10px 10px 20px 0px">
                    &#x20B9; {{number_format(floatval($settlement['breakup']['items'][$i]['amount']/100), 2, '.','')}}
                  </td>
                  <td style="text-align: center; padding: 10px 10px 20px 0px">
                    &#x20B9; {{number_format(floatval($settlement['breakup']['items'][$i]['fee']/100),2, '.', '')}}
                  </td>
                  <td style="text-align: center; padding: 10px 10px 20px 0px">
                    &#x20B9; {{number_format(floatval($settlement['breakup']['items'][$i]['tax']/100),2, '.', '')}}
                  </td>
                  <td style="text-align: center; padding: 10px 10px 20px 0px">
                    @if ($settlement['breakup']['items'][$i]['type'] === 'debit')
                      &#x20B9; {{number_format(floatval((-1*$settlement['breakup']['items'][$i]['amount'] - $settlement['breakup']['items'][$i]['fee'] - $settlement['breakup']['items'][$i]['tax'])/100),2, '.', '')}}
                    @else
                      &#x20B9; {{number_format(floatval(($settlement['breakup']['items'][$i]['amount'] - $settlement['breakup']['items'][$i]['fee'] - $settlement['breakup']['items'][$i]['tax'])/100),2, '.', '')}}
                    @endif
                  </td>
                </tr>
                @endfor
