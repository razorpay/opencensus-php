                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                                        ...
                                        <tr>
                                            <td align="left" style="font-size:0px;padding:0px;word-break:break-word;">
                                                ...
                                                <div style="font-family:Trebuchet MS;font-size:13px;line-height:1;text-align:left;color:#515978;">
                                                    <div class="card highlight" style="width: 85%; width: calc(46000% - 211600px); max-width: 460px; min-width: 308px; margin-left: auto; margin-right: auto; box-sizing: border-box; padding-left: 16px; padding-right: 16px; border-radius: 2px; background-color: #FFFFFF; padding-top: 20px; padding-bottom: 20px; margin-top: 8px;"><p class="para-normal font-size-medium" style="text-align: left; font-size: 14px; line-height: 1.5; color: #515978;">Hi, <br/><br/>Your otp for login to support page is :  {{{$otp}}} . <br/>
                                                            <br/>Please dont share it with others. <br/>
                                                        <p> Regards, </p>
                                                        <p> Team Razorpay </p>
                                                        <br/>Note: This is an auto generated message. Please dont respond to this email<br/>
                                                        </p>
