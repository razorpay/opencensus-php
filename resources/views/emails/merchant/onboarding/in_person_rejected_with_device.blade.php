...
<div class="email-wrapper">
    ...
    <div class="email-info-card"
        ...
        <div class="email-content" style="color: #7B8199; line-height: 26px">
            ...
            <br/><br/>
            We regret to inform you that your POS KYC application has not been approved. As a result, your payment will
            be refunded, and rental collection will be canceled.

            <br/><br/>
            If you have any questions or require clarification regarding this decision, please do not hesitate to
    ...
    <div class="email-footer"
        ...
        Thank you for considering Razorpay POS.
        <br/><br/>
        Best Regards,<br/>
