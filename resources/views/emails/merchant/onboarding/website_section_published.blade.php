                        ...
                        <table style="border-collapse: collapse;">
                            <tr>
                                <td style="margin-bottom: 8px;">
                                    ...
                                    >
                                        Published link for your website/app
                            ...
                            <tr>
                                ...
                                >
                                    <p>
                                        ...
                                        <br />
                                        <br />
                                        Here’s the link to your ‘{{{$section_name}}}’ page
                                        published using Razorpay:
                                        <a
                                            href="{{{$published_url}}}"
                                            target="_blank"
                                            style="color: #528FF0;"
                                        ...
                                        <br />
                                        <br />
                                        As the next step, make sure to add the link on your
                                        website/app on priority before {{{$date}}}. Settlements
                                        for your business will be put on-hold if the link is not
                                        updated before the given date. For more help, view our
                                        documentation.
                                        <br />
                                    </p>
