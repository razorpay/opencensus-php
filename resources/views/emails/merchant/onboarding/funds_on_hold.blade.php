...
<div class="email-wrapper">
    ...
    <div class="email-info-card"
        ...
        <div class="email-content" style="color: #7B8199; line-height: 26px; margin-bottom: 20px">
            ...
            <br/><br/>
            As part of our routine compliance checks, a few clarifications are pending from your end due to which we had
            to pause settlements for your account for the time being.
            <br/><br/>
            However, we are eager to complete your onboarding process with Razorpay and remove any limitations on your
            account. Please help us witht he clarifications asked on your Razorpay dashboard so our compliance team can
            complete the review process, activate your account, and settle any pending funds as quickly as possible.
        </div>
        <div class="cta"
