...
<head>
    ...
    <title>Activated MCC Pending Hard Limit breach</title>
</head>
...
<div class="email-wrapper">
    ...
    <div class="email-info-card"
        ...
        <div class="email-content" style="color: #7B8199; line-height: 26px; margin-bottom: 20px">
            ...
            <br/><br/>
            In order to complete your onboarding process, our compliance team needs certain documents and/or
            clarifications
            from
            your end. Please click on the button below to visit your dashboard and share the same.
        </div>
        <div class="cta"
             style="padding:10px 18px;text-align: center;background: #528FF0;display: inline-block; border-radius:2px">
            <a href="https://dashboard.razorpay.com/" style="color: #FFF; text-decoration:none">Share business
                details/clarifications</a>
        </div>
    </div>
    @isset($merchant['business_website'])
        <div class="note-content"
             style="width: 500px; background: #FFFFFF; margin: 10px auto; padding:20px; color: #7B8199; line-height: 26px;">
            <div style="font-weight: bold; color:#5B6583; margin-bottom: 10px;">
                Meanwhile, please ensure that you have the following pages ready on your website for our team’s review:
            </div>
        ...
        <div class="content"
            ...
            We have also shared templates that you can use to create certain pages, in case you don’t have them readily
            available.
            <br/><br/>
            <span style="color: #5B6583; font-weight:bold;">
        This information is crucial to complete your Razorpay onboarding. Please submit it on priority within 48 hours,
        post
        which we might have to suspend settlements for your account until the pages are up and running for our review.
      </span>
        </div>
    @endisset
    ...
    @empty($merchant['business_website'])
        <div class="content"
            ...
            This information is crucial to complete your Razorpay onboarding. Please submit the clarifications asked, on
            priority
            <span style="color: #5B6583;"><b>within 48 hours</b></span>, post which we might have to suspend settlements
            for
            your account until we get the required
            responses
            for our review.
        </div>
    ...
    <div class="note-content"
         style="width: 500px; background: #FFFFFF; margin: 10px auto; padding:20px 20px 125px; border-top: 2px solid #528FF0; color: #7B8199; line-height: 26px;">
        With that, you're already halfway through your onboarding journey!
        <div class="steps" style="display: flex; justify-content:center;padding-top: 26px">
            <div class="step" style="display: inline-block">
                ...
                <div class="check-point-desc" style="width: 84px; text-align: center;font-size: 9px; line-height: 15px">
                    You
                    can
                    start accepting
                    payments!
            ...
            <div class="step" style="display: inline-block; position:relative;">
                ...
                <div class="process-path"
                     style="width: 102px; height:5px; border-top: 1px dashed #F9BB21; position: relative; top: -7px;left: 36px;">
                </div>
                <div class="check-point-desc" style="width: 90px; text-align: center;font-size: 9px; line-height: 15px">
            ...
            <div class="step" style="display: inline-block; position:relative;">
                ...
                <div class="check-point"
                     style="width: 11px; height: 11px; background: #FFF; border: 1px solid #F9BB21; border-radius: 50%; z-index: 999;position: relative;left: 36px;">
                </div>
                <div class="process-path"
                     style="width: 102px; height:5px; border-top: 1px dashed #528FF0; position: relative; top: -7px;left: 36px;">
                </div>
                <div class="check-point-desc"
                     style="width: 84px; text-align: center;font-size: 9px; line-height: 15px; font-weight:bold">Your
                    business details are getting reviewed
                </div>
                <div class="tooltip"
                     style="font-size: 9px; line-height: 14px; position: absolute; width: 190px; text-align: center; background: #FFF8E7; padding: 10px; border-radius: 2px; top: 83px; left: -59px;">
                    <div class="arc"
                         style="width: 0; height: 0; border-left: 10px solid transparent; border-right: 10px solid transparent; border-bottom: 10px solid #FFF8E7; position: absolute; top: -10px;left: 93px;border-radius: 4px">
                    </div>
                    <strong>Important:</strong> <br/>
                    If we don’t get the clarifications asked on dashboard <span style="color: #5B6583;"> within 48 hours
            </span>, we might have to suspend settlements
                    into your
                    bank account.
                </div>
            </div>
