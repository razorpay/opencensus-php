...
<head>
    ...
    <title>Activated MCC Pending Soft Limit breach</title>
</head>
...
<div class="email-wrapper">
    ...
    <div class="email-info-card"
        ...
        <div class="email-content" style="color: #7B8199; line-height: 26px; margin-bottom: 20px">
            ...
            <br/><br/>
            Our compliance team is currently reviewing your business model and website details and might reach out for
            clarifications over the next few days via your <a href="http://dashboard.razorpay.com"
                                                              style="text-decoration: none; color: #528FF0">Razorpay
                dashboard</a>. When we do, please respond to our
            queries as soon as
            possible, so we can continue providing a seamless payment experience to you and your customers.
        </div>
    </div>
        ...
        <div class="steps" style="display: flex; justify-content:center;padding-top: 26px">
            ...
            <div class="step" style="display: inline-block; position:relative;">
                ...
                <div class="tooltip"
                    ...
                    If we don’t get the clarifications asked on dashboard, we might have to suspend settlements into
                    your bank
                    account.
                </div>
            </div>
    ...
    <div class="note-content"
        ...
        <div style="margin-bottom: 10px;">
            As part of our compliance checks, our team would also need to review certain key pages of your website.<b
                style="color:#5B6583;">Please ensure they are ready for our team's review at the earliest.</b>
        </div>
    ...
    <div class="content"
        ...
        In case you don’t have these pages readily available, feel free to use the templates we have shared to create
        them.
        <br/><br/>
        <span style="color: #5B6583; font-weight:bold;">
        This information is crucial to complete your Razorpay onboarding. Else, we might have to suspend settlements for
        your
