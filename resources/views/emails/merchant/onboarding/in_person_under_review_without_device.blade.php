...
<div class="email-wrapper">
    ...
    <div class="email-info-card"
        ...
        <div class="email-content" style="color: #7B8199; line-height: 26px; margin-bottom: 20px">
            ...
            <br/><br/>
            Thank you for providing your KYC details for Razorpay POS. You're one step closer to accessing the most
            trusted payment solutions in the market.
            <br/>
            Our team is currently reviewing your application and KYC information. You can expect an update through your
            registered email and contact number within the next 3-4 business days. In the meantime, feel free to
            explore our wide range of POS devices on our device catalog. To place your order, simply click
            <a href="https://razorpay.com/docs/payments/account-activation-support" target="_blank"
               style="color: #1566f1; text-decoration: none;">here.</a>
            <br/><br/>
            Should we require any additional details, we will contact you via email in the coming days.
        </div>
    </div>
