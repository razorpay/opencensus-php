                ...
                <tr>
                    <td style="background-color: #ffffff; border-radius: 16px;" class="device-padding">
                      ...
                      <span style="display: block; height: 4px; width: 24px; background-color:  #5CA2F7;">
                                    ...
                                    <br/>
                                    <div>
                                        We’re reaching out to you as we need a few more details from you again.
                                        You’re just a few steps away from POS KYC completion, so we request you to go
                                        to your Razorpay dashboard and update the required details soon.

                                    </div>
                                    <br/>
                                    <div style="background-color: #f54a2a14; border-radius: 12px; padding: 16px;">
                                        Please note, you will not be able to receive your POS device if the required
                                        details are not updated before {{{$ncSubmissionDate}}}
