                            ...
                            <tr>
                                <td style="margin-bottom: 8px;">
                                    <h4 style="color: #0d2366; font-weight: 700; font-size: 18px; text-align: center; margin-bottom: 8px; margin-top: 0; line-height: 27px;">
                                        Reminder: Update your website/app details
                                    </h4>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="font-family: 'Trebuchet MS'; font-weight: 400; font-size: 14px; line-height: 20px; color: #23496d; background-color: #ffffff;">
                                    <p>
                                        Hi,
                                        <br />
                                        <br /> This is a friendly reminder
                                        requesting you to update your
                                        website/app details on priority
                                        now. The pages below are required
                                        as per RBI guidelines to accept
                                        payments online:
                                        <br />
                                    </p>
                                    ...
                                    <table>
                                        <tr>
                                            <td style="padding-left: 7.5px;">
                                                <p style="margin-top: 0; margin-bottom: 2px; text-indent: -17px; padding-left: 17px;">&bull;&nbsp;&nbsp;<b>Contact Us</b></p>
                                                <p style="margin-top: 0; margin-bottom: 2px; text-indent: -17px; padding-left: 17px;">&bull;&nbsp;&nbsp;<b>Cancellation and Refund Policy</b></p>
                                                <p style="margin-top: 0; margin-bottom: 2px; text-indent: -17px; padding-left: 17px;">&bull;&nbsp;&nbsp;<b>Privacy Policy</b></p>
                                                <p style="margin-top: 0; margin-bottom: 2px; text-indent: -17px; padding-left: 17px;">&bull;&nbsp;&nbsp;<b>Terms and Conditions</b></p>
                                                <p style="margin-top: 0; margin-bottom: 2px; text-indent: -17px; padding-left: 17px;">&bull;&nbsp;&nbsp;<b>Shipping and Delivery Policy</b></p>
                                            </td>
                                        </tr>
                                    </table>
                                    <p style="margin-bottom: 32px;">
                                        Payments for your account will be put on-hold if these details are not
                                        submitted soon.
                                        <br />
