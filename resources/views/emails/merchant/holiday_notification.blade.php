...
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"><meta name="viewport" content="width=device-width"></head>
  <body>
    ...
    <table style="width:550px">
      <div style="background-color: #FFFFFF;margin-bottom:20px;padding:20px; width:550px; text-align: center">
    ...
    <table style="width:600px;">
      <div style = "text-align:center;margin-bottom:10px"><p style ="padding-left:50px;padding-right:50px;font-family: Trebuchet MS;font-style: normal;font-weight: normal;font-size: 14px;line-height: 16px;text-align: unset; color: #7B8199;margin-bottom:10px;margin-top:0px">
