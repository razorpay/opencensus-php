                                                ...
                                                <div style="font-family:Trebuchet MS;font-size:13px;line-height:1;text-align:left;color:#000000;">
                                                    <div class="card secondary title informative descriptive" style="width: 85%; width: calc(46000% - 211600px); max-width: 460px; min-width: 308px; margin-left: auto; margin-right: auto; box-sizing: border-box; background-color: #242b4d; padding-bottom: 16px; padding-left: 24px; padding-right: 24px;">
                                                        ...
                                                        <div class="center-align font-size-18 font-color-primary line-height-26" style="text-align: center; font-size: 18px; color: #FFF; line-height: 26px;">
                                                            Congratulations! Referral Account Added!
                                                        </div>
                                                        ...
                                                        <div class="font-size-medium para-dark" style="color: #9195A6; font-size: 14px; line-height: 1.5;">
                                                            <div class="para margin-bottom-8" style="margin: 0; margin-bottom: 20px;">
                                                                Hi, {{$merchant['name']}}!<br>
                                                                <br> {{$subMerchant['name']}} has been successfully added as your affiliate account for RazorpayX Line of Credit.
                                                                <br> We have sent an invite mail to {{$subMerchant['email']}} for setting up their RazorpayX account.
                                                            </div>
                                                            ...
                                                            <div class="para margin-bottom-24" style="margin: 0; margin-bottom: 20px;">
                                                                <ul style="list-style-type:disc;">
                                                                    <li>Step 1: Set up the password.
                                                                    </li>
                                                                    <li>Step 2: Login and initiate the Line of Credit (LOC) Application via the dashboard.
                                                                    </li>
                                                                    <li>Step 3: Submit the KYC documents.
                                                                    </li>
                                                                    <li>Step 4: Once approved, they can withdraw funds as per their needs.
                                                                    </li>
                                                                </ul>
                                                            </div>
