                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                                        ...
                                        <tr>
                                            <td align="left" style="font-size:0px;padding:0px;word-break:break-word;">
                                                ...
                                                <div style="font-family:Trebuchet MS;font-size:13px;line-height:1;text-align:left;color:#000000;">
                                                    <div class="card secondary title informative descriptive" style="width: 85%; width: calc(46000% - 211600px); max-width: 460px; min-width: 308px; margin-left: auto; margin-right: auto; box-sizing: border-box; background-color: #242b4d; padding-bottom: 16px; padding-left: 24px; padding-right: 24px;"><div class="center-align font-size-18 font-color-primary margin-bottom-8 line-height-26" style="text-align: center; font-size: 18px; color: #FFF; line-height: 26px; margin-bottom: 8px;">Hurray!</div><div class="center-align font-size-medium font-color-secondary" style="text-align: center; font-size: 14px; line-height: 1.5; color: #bdbfC9;">Your KYC form has been successfully submitted.</div><div class="center-align" style="text-align: center;"><div class="puck para" style="margin: 0; padding: 12px 0;"><div class="bar" style="margin: 0px auto; width: 24px; height: 4px; background-color: #08CA73;"></div></div></div><div class="description margin-bottom-24" style="margin-bottom: 24px; text-align: center; color: #bdbfC9; font-size: 14px; line-height: 1.5;">Once KYC is reviewed, your account would be fully active, and you will be able to create payouts.</div><div class="description margin-top-16" style="margin-top: 16px; text-align: center; color: #bdbfC9; font-size: 14px; line-height: 1.5;">
                                                            If we need any clarification on your documents our team will get in touch with you.</div></div>
                                                </div>
