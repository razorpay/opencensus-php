<!doctype html>
    ...
    .mj-column-per-100 { width:100% !important; max-width: 100%; }
      ...
      <div style="font-family:Trebuchet MS;font-size:13px;line-height:1;text-align:left;color:#000000;">
        <div class="card secondary title informative descriptive" style="width: 85%; width: calc(46000% - 211600px); max-width: 460px; min-width: 308px; margin-left: auto; margin-right: auto; box-sizing: border-box; background-color: #242b4d; padding-bottom: 16px; padding-left: 24px; padding-right: 24px;"><div class="center-align font-size-18 font-color-primary line-height-26" style="text-align: center; font-size: 18px; color: #FFF; line-height: 26px;">A few more details required</div><div class="center-align" style="text-align: center;"><div class="puck para" style="margin: 0; padding: 12px 0;"><div class="bar" style="margin: 0px auto; width: 24px; height: 4px; background-color: #08CA73;"></div></div></div><div class="center-align font-size-medium font-color-secondary margin-bottom-24" style="text-align: center; font-size: 14px; line-height: 1.5; color: #bdbfC9; margin-bottom: 24px;">We need additional information while we ready your RazorpayX account. To complete KYC click the button below. Once KYC is reviewed, your account would be fully active.<button class="btn primary font-bold" style="font-weight: 700; font-size: 14px; line-height: 1.5; border: 1px solid; padding: 8px 12px; letter-spacing: 1px; border-radius: 2px; overflow: hidden; min-width: 185px; font-family: Trebuchet MS; color: #FFF; background-color: #3281FF; border-color: #3281FF; margin: 24px auto 0 auto; display: block;"><a class="link" href="{{ $dashboard_url }}" target="_blank" style="text-decoration: none; color: #FFF;">FILL KYC</a></button></div></div>
</div>
