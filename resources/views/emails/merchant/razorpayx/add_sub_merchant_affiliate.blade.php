                                            ...
                                            <td align="left" style="font-size:0px;padding:0px;word-break:break-word;">
                                                ...
                                                <div style="font-family:Trebuchet MS;font-size:13px;line-height:1;text-align:left;color:#000000;">
                                                    <div class="card secondary title informative descriptive" style="width: 85%; width: calc(46000% - 211600px); max-width: 460px; min-width: 308px; margin-left: auto; margin-right: auto; box-sizing: border-box; background-color: #242b4d; padding-bottom: 16px; padding-left: 24px; padding-right: 24px;">
                                                        ...
                                                        <div class="center-align font-size-18 font-color-primary line-height-26" style="text-align: center; font-size: 18px; color: #FFF; line-height: 26px;">Welcome to RazorpayX</div>
                                                        ...
                                                        <div class="font-size-medium para-dark" style="color: #9195A6; font-size: 14px;line-height: 1.5;"><div class="para margin-bottom-8" style="margin: 0; margin-bottom: 20px;"> <a>{{$merchant['name']}}</a> has invited you to open a Current Account with RazorpayX.</div>
                                                            ...
                                                            <div class="para-dark center" style="margin: 0 0 20px; color: #9195A6; font-size: 14px; line-height: 1.5; text-align: center;">
                                                                @if($token)
                                                                    ...
                                                                    .'/forgot-password?intent=current_account#token='. $token . '&email=' . $subMerchant['email']}}" target="_blank" style="text-decoration: none; font-weight: 700; font-size: 14px; line-height: 1.5; border: 1px solid; padding: 8px 1px; letter-spacing: 1px; border-radius: 2px; overflow: hidden; min-width: 145px; display: inline-block; font-family: Trebuchet MS; margin: 24px auto 0 auto; color: #FFF; background-color: #3281FF; border-color: #3281FF;">GET STARTED</a>
                                                                @else
                                                                    <a class="link btn primary font-bold" href="{{'https://' . parse_url(config('applications.banking_service_url'), PHP_URL_HOST) . '?intent=current_account'}}" target="_blank" style="text-decoration: none; font-weight: 700; font-size: 14px; line-height: 1.5; border: 1px solid; padding: 8px 1px; letter-spacing: 1px; border-radius: 2px; overflow: hidden; min-width: 145px; display: inline-block; font-family: Trebuchet MS; margin: 24px auto 0 auto; color: #FFF; background-color: #3281FF; border-color: #3281FF;">GET STARTED</a>
                                                                @endif
                                                            </div>
