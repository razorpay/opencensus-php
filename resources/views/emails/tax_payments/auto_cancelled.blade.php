                                                               ...
                                                               <td align="left" style="font-size:0px;padding:0px;word-break:break-word;">
                                                                  <div style="font-family:Trebuchet MS;font-size:13px;line-height:1;text-align:left;color:#000000;">
                                                                     <div class="card secondary title informative" style="width: 85%; width: calc(46000% - 211600px); max-width: 460px; min-width: 308px; margin-left: auto; margin-right: auto; box-sizing: border-box; background-color: #242b4d; padding-bottom: 16px; padding-left: 24px; padding-right: 24px;">
                                                                        <div class="center-align font-size-18 font-color-primary margin-bottom-8 line-height-26" style="text-align: center; font-size: 18px; color: #FFF; line-height: 26px; margin-bottom: 8px;">Tax payment(s) for {{ $tax_payment['deduction_date']}} were cancelled!</div>
                                                                        ...
                                                                        <div class="para-dark center" style="color: #9195A6; font-size: 14px; line-height: 1.5; text-align: center;">Payment(s) of  <b>₹{{ $tax_payment['tds_amount'] }}</b> for {{$tax_payment['deduction_date']}} were auto-cancelled due to unavailability of funds.
                                                                           You may receive another email if these payments are subject to late fees.<br> Details are attached below.<br><br>You can reinitiate these payments from the dashboard.
                                                                           If you are making the payment outside of RazorpayX, you can mark these payments as paid from the dashboard.
                                                                        </div>
                                                               ...
                                                               <td align="left" style="font-size:0px;padding:0px;word-break:break-word;">
                                                                  <div style="font-family:Trebuchet MS;font-size:13px;line-height:1;text-align:left;color:#000000;">
                                                                     <div class="card secondary informative top-align-label" style="width: 85%; width: calc(46000% - 211600px); max-width: 460px; min-width: 308px; margin-left: auto; margin-right: auto; box-sizing: border-box; background-color: #242b4d; padding-left: 24px; padding-right: 24px; padding-top: 20px; padding-bottom: 20px; margin-top: 8px;">
                                                                        ...
                                                                        @isset($tax_payment['challan_number'])<div class="information-row" style="font-size: 14px; line-height: 1.5; width: 100%; box-sizing: border-box; margin-bottom: 20px; padding-left: 5%;">
                                                                        ...
                                                                        @isset($payout['cancelled_by']['name'])<div class="information-row" style="font-size: 14px; line-height: 1.5; width: 100%; box-sizing: border-box; margin-bottom: 20px; padding-left: 5%;">
                                                                           <div class="label half-width" style="color: #bdbfC9; display: inline-block; width: 45%; vertical-align: top;">Cancelled by</div>
                                                                           <div class="value left-align" style="color: #bdbfC9; display: inline-block; width: 50%; text-align: left;">{{ $payout['cancelled_by']['name'] }}</div>
                                                                        </div>@endisset
                                                                        @isset($payout['cancelled_comment'])<div class="information-row" style="font-size: 14px; line-height: 1.5; width: 100%; box-sizing: border-box; padding-left: 5%;">
                                                                           <div class="label half-width" style="color: #bdbfC9; display: inline-block; width: 45%; vertical-align: top;">Comments</div>
                                                                           <div class="value left-align" style="color: #bdbfC9; display: inline-block; width: 50%; text-align: left;">{{ $payout['cancelled_comment'] }}</div>
                                                                        </div>@endisset
                                                                     </div>
                                                                  </div>
                                                               </td>
