                                                            ...
                                                            <td align="left" style="font-size:0px;padding:0px;word-break:break-word;">
                                                                ...
                                                                <div style="font-family:Trebuchet MS;font-size:13px;line-height:1;text-align:left;color:#000000;">
                                                                    <div class="card secondary  title informative descriptive" style="width: 85%; width: calc(46000% - 211600px); max-width: 460px; min-width: 308px; margin-left: auto; margin-right: auto; box-sizing: border-box; background-color: #242b4d; padding-bottom: 16px; padding-left: 24px; padding-right: 24px;">
                                                                        <div class="left-align font-size-18 font-color-primary line-height-26" style="font-size: 16px; color: #FFF; line-height: 26px;">

                                                                        Dear {{ $name }},<br><br>

                                                                        We hope this message finds you well. Our records indicate a low balance in your RazorpayX account, putting it at risk of disruption. <br><br>

                                                                        To prevent any issues, please add funds to your account number: {{ $account_number }} linked to your RazorpayX account (Merchant ID: {{ $merchant_id }}),
                                                                        at your earliest convenience. This will ensure the recovery of pending transaction fees to be paid and maintain uninterrupted service. Kindly let us
                                                                        know if you have any queries. <br><br>

                                                                        Act now to safeguard your account. Thank you for your prompt attention. <br><br>

                                                                        Best,<br>Team RazorpayX
