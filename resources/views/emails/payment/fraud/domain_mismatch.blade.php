                                                ...
                                                <div style="font-family:Trebuchet MS;font-size:13px;line-height:1;text-align:left;color:#000000;">
                                                    ...
                                                    <div class="card highlight" style="width: 85%; width: calc(46000% - 211600px); max-width: 460px; min-width: 308px; margin-left: auto; margin-right: auto; box-sizing: border-box; padding-left: 16px; padding-right: 16px; border-radius: 2px; background-color: #FFFFFF; padding-top: 5px; padding-bottom: 20px;">
                                                        <p class="para-normal font-size-medium" style="font-size: 14px; line-height: 1.5; color: #515978; margin-bottom: 17px;">
                                                            This mail is with respect to the Merchant ID - <b>{{$merchant['id']}}</b> in the name of M/s. <b>{{$merchant['name']}}</b> held with Razorpay.
                                                        </p>
                                                        <p class="para-normal font-size-medium" style="font-size: 14px; line-height: 1.5; color: #515978; margin-bottom: 21px;">
                                                            We have observed that attempt(s) have been made to accept payment from the website domain: {{$payment['referer_domain']}} which is not registered with Razorpay. Here are the details of one such payment:
                                                        </p>
                                                        <p class="para-normal font-size-medium" style="font-size: 14px; line-height: 2.0; color: #515978;">
                                                            Payment ID - <b>pay_{{$payment['id']}}</b><br>
                                                            Originating URL - <b>{{$payment['referer_url']}}</b><br>
                                                            Originating Domain - <b>{{$payment['referer_domain']}}</b>
                                                        </p>
