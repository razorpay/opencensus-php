...
<div>
    <p>
        INR {{ $txn['amount_formatted'] }} has been credited to your RazorpayX account {{ $balance['account_number_masked'] }} from Bank Account {{ $source['payer_account'] }} on {{ epoch_format ($source['created_at']) }}.
    </p>
    <p>
