...
Congratulations! Your loan application number has been approved. For ease of your loan repayment, we request you to register an auto debit mandate for your RBL loan application no. {{$invoice['subscription_registration']['notes']['loan_number'] ?? ''}} by clicking on the <b>AUTHORIZE</b> tab at the bottom of this mail.
                        </div>
                    </div>
                </td>
