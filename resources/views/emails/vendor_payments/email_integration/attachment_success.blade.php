                                    ...
                                    <div class="title-content" style="
                                      ...
                                      <div class="center-align" style="text-align: center">
                                        <img class="image small"
                                          src="https://cdn.razorpay.com/static/assets/email/payment-success-icon.png"
                                          style="
                                              margin: 8px;
                                  ...
                                  <div class="content title" style="
                                    ...
                                    <div class="title-content" style="
                                      ...
                                      <div class="font-color-otp font-size-large" style="
                                        ...
                                        $total_attachments }} Invoice(s) to {{
                                        $merchant['billing_label'] }} on
                                        RazorpayX
                                      </div>
                                      <div class="center-align" style="text-align: center">
                                    ...
                                    <div class="left" style="
                                          ...
                                          color: #7b8199;
                                        ">
                                      {{ $merchant['billing_label'] }} will
                                      review them and pay them on the due
                                      date. Once the payment is approved, the
                                      vendor will be notified via email.
                                      <br />
                                      <br />
                                      Keep sending your invoices to:
                                    </div>
                                    <div class="para-dark center" style="
                                      ...
                                      <div class="information-row" style="
                                        ...
                                        <div class="label half-width" style="
                                              ...
                                              vertical-align: middle;
                                            ">
                                          <img class="image small" src="https://cdn.razorpay.com/x/email-icon-dark.png"
                                            style="
                                                background: transparent;
                                                height: 10px;
                                                width: 12px;
                                        ...
                                        <div class="value left-align merchant-invoice-forwarding-email" style="
                                              font-size: 14px;
                                              line-height: 20px;
                                              color: #5a99e8;
                                              display: inline-block;
                                      ...
                                      <div class="information-row" style="
                                        ...
                                        <div class="btn-container" style="
                                              ...
                                              display: inline-block;
                                            ">
                                          <a class="link btn primary font-bold" href="mailto:{{$email_address}}"
                                            target="_blank" style="
                                                text-decoration: none;
                                                font-size: 12px;
                                                line-height: 18px;
                                ...
                                <div class="card footer-card" style="
                                  ...
                                  <div class="information-row" style="
                                    ...
                                    <div style="font-weight: bold">
                                      ⚡️Track this invoice on Vendor Portal
                                    </div>
                                    <div style="
                                          margin-top: 10px;
                                          margin-bottom: 14px;
                                        ">
                                      If you have been invited to the vendor
                                      portal, you can also view the status of
                                      this payment on the dashboard by
