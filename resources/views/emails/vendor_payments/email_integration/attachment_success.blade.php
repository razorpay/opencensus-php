                                    ...
                                    >
                                      ...
                                      >
                                        <div
                                          ...
                                          "
                                        >
                                          Thank you for submitting {{ $total_attachments }} Invoice(s)
                                          to {{ $merchant['billing_label'] }} on RazorpayX
                                        </div>
                                        <div
                                          class="center-align"
                                          style="text-align: center"
                                      ...
                                      <div
                                        ...
                                        "
                                      >
                                        {{ $merchant['billing_label'] }} will review them and pay
                                        them on the due date. Once the payment
                                        is approved, the vendor will be notified
                                        via email.
                                        <br />
                                        <br />
