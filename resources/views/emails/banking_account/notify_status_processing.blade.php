                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                                        ...
                                        <tr>
                                            <td align="left" style="font-size:0px;padding:0px;word-break:break-word;">
                                                ...
                                                <div style="font-family:Trebuchet MS;font-size:13px;line-height:1;text-align:left;color:#000000;">
                                                    <div class="card secondary  title informative descriptive" style="width: 85%; width: calc(46000% - 211600px); max-width: 460px; min-width: 308px; margin-left: auto; margin-right: auto; box-sizing: border-box; background-color: #242b4d; padding-bottom: 16px; padding-left: 24px; padding-right: 24px;"><div class="center-align" style="text-align: center;"><img class="image medium" src="https://cdn.razorpay.com/static/assets/email/processed.png" style="margin: 8px; background: transparent; height: 80px;" height="80"></div><div class="center-align font-size-18 font-color-primary line-height-26" style="text-align: center; font-size: 18px; color: #FFF; line-height: 26px;">Your application has moved one step forward!</div><div class="center-align" style="text-align: center;"><div class="puck para" style="padding: 12px 0; margin: 0;"><div class="bar" style="margin: 0px auto; width: 24px; height: 4px; background-color: #E9BE17;"></div></div></div><div class="description" style="text-align: center; color: #bdbfC9; font-size: 14px; line-height: 1.5;">Great to hear the KYC process went smoothly. The request is currently being processed by the bank and we will be getting the current account details soon.</div><div class="description margin-top-12" style="margin-top: 12px; text-align: center; color: #bdbfC9; font-size: 14px; line-height: 1.5;">With that, you are just one step away from having a RazorpayX Current Account!</div></div>
                                                </div>
