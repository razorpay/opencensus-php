...
<center>
    <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" style="max-width: 600px">
        ...
        <tr>
            <td colspan="3">
                <p>Your RazorpayX Current Account is being processed.</p>
            </td>
        </tr>
        <tr>
            <td colspan="3">
                <p>No further action is required from your end. Our banking partner will contact you if they need any clarification on your documents. In the meantime, you can continue to use RazorpayX for your business.</p>
            </td>
        </tr>
        <tr>
            <td colspan="3">
