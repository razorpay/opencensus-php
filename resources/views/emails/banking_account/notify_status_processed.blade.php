                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                                        ...
                                        <tr>
                                            <td align="left" style="font-size:0px;padding:0px;word-break:break-word;">
                                                ...
                                                <div style="font-family:Trebuchet MS;font-size:13px;line-height:1;text-align:left;color:#000000;">
                                                    <div class="card secondary highlight informative descriptive" style="width: 85%; width: calc(46000% - 211600px); max-width: 460px; min-width: 308px; margin-left: auto; margin-right: auto; box-sizing: border-box; background-color: #242b4d; border-top: 2px solid #3281FF; padding-top: 20px; padding-bottom: 20px; padding-left: 24px; padding-right: 24px; border-color: #528ff0; margin-top: 8px;"><div class="title-white" style="font-size: 14px; line-height: 1.5; color: #FFF; margin-bottom: 8px;">Your RBL current account are as follows:</div><div class="information-row margin-top-16" style="margin-top: 16px; font-size: 14px; line-height: 1.5; width: 100%; box-sizing: border-box; margin-bottom: 20px; padding-left: 5%;"><div class="label" style="color: #bdbfC9; display: inline-block; width: 40%; vertical-align: middle;">Beneficiary Name</div><div class="value" style="color: #bdbfC9; display: inline-block; width: 50%; text-align: right;">{{$name}}</div></div><div class="information-row" style="font-size: 14px; line-height: 1.5; width: 100%; box-sizing: border-box; margin-bottom: 20px; padding-left: 5%;"><div class="label" style="color: #bdbfC9; display: inline-block; width: 40%; vertical-align: middle;">Account No.</div><div class="value" style="color: #bdbfC9; display: inline-block; width: 50%; text-align: right;">{{$account_num}}</div></div><div class="information-row" style="font-size: 14px; line-height: 1.5; width: 100%; box-sizing: border-box; margin-bottom: 20px; padding-left: 5%;"><div class="label" style="color: #bdbfC9; display: inline-block; width: 40%; vertical-align: middle;">IFSC Code</div><div class="value" style="color: #bdbfC9; display: inline-block; width: 50%; text-align: right;">{{$account_ifsc}}</div></div><div class="description dark" style="font-size: 14px; line-height: 1.5; text-align: left; color: #9195A6;">We are integrating your newly created current account onto our systems, which is the final step in the process. Watch out for an another mail from our end, intimating activation. <div class="center-align" style="text-align: center;"><a class="link btn primary font-bold" href="{{ $dashboard_url }}" target="_blank" style="text-decoration: none; font-weight: 700; font-size: 14px; line-height: 1.5; border: 1px solid; padding: 8px 12px; letter-spacing: 1px; border-radius: 2px; overflow: hidden; min-width: 145px; display: inline-block; font-family: Trebuchet MS; margin: 24px auto 0 auto; color: #FFF; background-color: #3281FF; border-color: #3281FF;">VIEW DASHBAORD</a></div></div></div>
                                                </div>
