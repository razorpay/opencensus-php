                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                                        ...
                                        <tr>
                                            <td align="left" style="font-size:0px;padding:0px;word-break:break-word;">
                                                ...
                                                <div style="font-family:Trebuchet MS;font-size:13px;line-height:1;text-align:left;color:#000000;">
                                                    <div class="card secondary descriptive" style="width: 85%; width: calc(46000% - 211600px); max-width: 460px; min-width: 308px; margin-left: auto; margin-right: auto; box-sizing: border-box; background-color: #242b4d; padding-top: 20px; padding-bottom: 20px; padding-left: 24px; padding-right: 24px; margin-top: 8px;"><div class="title-white" style="font-size: 14px; line-height: 1.5; color: #FFF; margin-bottom: 8px;">Help us improve!</div><div class="description dark margin-bottom-24" style="margin-bottom: 24px; font-size: 14px; line-height: 1.5; text-align: left; color: #9195A6;">If there’s anything you think we can improve in the onboarding process or RazorpayX in general, please let us know by replying to this email. Your feedback goes a long way in helping us to improve the experience for our users.<button class="btn primary font-bold" style="font-weight: 700; font-size: 14px; line-height: 1.5; border: 1px solid; padding: 8px 12px; letter-spacing: 1px; border-radius: 2px; overflow: hidden; min-width: 185px; font-family: Trebuchet MS; color: #FFF; background-color: #3A405F; border-color: #3A405F; margin: 24px auto 0 auto; display: block;"><a class="link" href="{{ $give_feedback_url }}" target="_blank" style="text-decoration: none; color: #FFF;">GIVE FEEDBACK</a></button></div>
                                                    </div>
