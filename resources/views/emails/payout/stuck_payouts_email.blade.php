...
<head>
    <title>
        Beneficiary Bank Downtime Alert
    </title>
    <!--[if !mso]><!-- -->
                                                        ...
                                                        <div class="content title highlight" style="width: 85%; width: calc(46000% - 211600px); max-width: 460px; min-width: 308px; margin-left: auto; margin-right: auto; box-sizing: border-box; padding-left: 16px; padding-right: 16px; background-color: #242b4d; padding-top: 16px; padding-bottom: 12px">
                                                            <div class="title-content" style="text-align: center; width: fit-content; margin: 0 auto;">
                                                                <div class="center-align" style="text-align: center;">
                                                                    <img src="https://cdn.razorpay.com/static/assets/email/glowing_red_bell.png" width="100px" style="height: 25%; width: 25%;">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <td align="left" style="font-size:0px;padding:0px;word-break:break-word;">
                                                ...
                                                <div style="font-family:Trebuchet MS;font-size:13px;line-height:1;text-align:left;color:#000000;">
                                                    <div class="card secondary title informative descriptive" style="width: 85%; width: calc(46000% - 211600px); max-width: 460px; min-width: 308px; margin-left: auto; margin-right: auto; box-sizing: border-box; background-color: #242b4d; padding-left: 24px; padding-right: 24px; margin-bottom: 8px;">
                                                        ...
                                                        <div class="left-align font-size-medium font-color-secondary" style="text-align: left; font-size: 14px; font-weight: normal; color: #9A9EAD; line-height: 20px; padding-bottom: 16px;">
                                                            @if(!empty($stuck_payouts_count))
                                                                <strong>{{ $stuck_payouts_count }}</strong> of your
                                                                @if(!empty($payout_mode) and $payout_mode !== 'ALL')
                                                                    {{ $payout_mode }}
                                                                @endif
                                                                 payouts are stuck in the initiated state due to issues from the bank side.
                                                            @else
                                                                The number of payouts stuck in the initiated state
                                                                @if(!empty($payout_mode) and $payout_mode !== 'ALL')
                                                                    for {{ $payout_mode }} mode
                                                                @endif
                                                                has crossed your configured upper threshold.
                                                            @endif
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card secondary title informative descriptive" style="width: 85%; width: calc(46000% - 211600px); max-width: 460px; min-width: 308px; margin-left: auto; margin-right: auto; box-sizing: border-box; background-color: #242b4d; padding-left: 24px; padding-right: 24px;">
                                                        <div class="description margin-bottom-24" style="text-align: left; color: #9A9EAD; font-size: 14px; font-weight: normal; line-height: 20px;">
                                                            ...
                                                            <div style="padding-top: 8px; padding-bottom: 24px;">
                                                                Stay updated! We will notify you once payouts start getting processed and the number of stuck payouts falls below your configured limit.
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
