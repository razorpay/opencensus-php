...
<div style="background-color:#1E2442;">
                                                    ...
                                                    <div class="header" style="box-sizing: border-box; padding-top: 16px; max-width: 100%;">
                                                        ...
                                                        <div class="content title" style="width: 85%; width: calc(46000% - 211600px); max-width: 460px; min-width: 308px; margin-left: auto; margin-right: auto; box-sizing: border-box; padding-left: 16px; padding-right: 16px; background-color: #242b4d; padding-top: 24px;">
                                                            <div class="title-content" style="text-align: center; width: fit-content; margin: 0 auto;">
                                                                <div class="center-align" style="text-align: center;"><img class="image small" src="https://cdn.razorpay.com/static/assets/email/payout-approval-pending.png" style="margin: 8px; background: transparent; height: 44px;" height="44"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <td align="left" style="font-size:0px;padding:0px;word-break:break-word;">
                                                <div style="font-family:Trebuchet MS;font-size:13px;line-height:1;text-align:left;color:#000000;">
                                                    <div class="card secondary title informative" style="width: 85%; width: calc(46000% - 211600px); max-width: 460px; min-width: 308px; margin-left: auto; margin-right: auto; box-sizing: border-box; background-color: #242b4d; padding-bottom: 16px; padding-left: 24px; padding-right: 24px;">
                                                        <div class="center-align font-size-18 font-color-primary margin-bottom-8 line-height-26 padding-left-36 padding-right-36" style="text-align: center; font-size: 18px; color: #FFF; line-height: 26px; padding-left: 36px; padding-right: 36px; margin-bottom: 8px;">Approve {{ $this->input['total_count'] }} payouts to process ₹{{ $this->input['amount_total'] }}.</div>
                                                        ...
                                                        <div class="para-dark left" style="color: #9195A6; font-size: 14px; line-height: 1.5;">Hi {{ $this->input['name'] }}!!<br>Your teammates have initiated payouts awaiting your review. Now it’s up to you to move them into the next state. Go ahead and approve them to avoid delays</div>
                                                        <div class="center-align" style="text-align: center;"><a class="link btn primary font-bold" href="https://x.razorpay.com/payouts" target="_blank" style="text-decoration: none; font-weight: 700; font-size: 14px; line-height: 1.5; border: 1px solid; padding: 8px 12px; letter-spacing: 1px; border-radius: 2px; overflow: hidden; min-width: 145px; display: inline-block; font-family: Trebuchet MS; margin: 24px auto 0 auto; text-align: center; color: #FFF; background-color: #3281FF; border-color: #3281FF;">Approve Payouts</a></div>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
    ...
    >
        <tr>
            <td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;">
    <![endif]-->
    @foreach($this->input['data'] as $payoutData)
        <div class="max-width-override" style="Margin: 0px auto; max-width: unset;">
            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
                <tbody>
                <tr>
                                                ...
                                                <td align="left" style="font-size:0px;padding:0px;word-break:break-word;">
                                                    <div style="font-family:Trebuchet MS;font-size:13px;line-height:1;text-align:left;color:#000000;">
                                                        <div class="card secondary  informative top-align-label" style="width: 85%; width: calc(46000% - 211600px); max-width: 460px; min-width: 308px; margin-left: auto; margin-right: auto; box-sizing: border-box; background-color: #242b4d; padding-left: 24px; padding-right: 24px; padding-top: 20px; padding-bottom: 20px; margin-top: 8px;">
                                                            <div class="title" style="font-size: 16px; line-height: 1.5; color: #bdbfC9; margin-bottom: 24px;">Quick summary: {{ $payoutData['account_number'] }}</div>
                                                            <div class="information-row" style="font-size: 14px; line-height: 1.5; width: 100%; box-sizing: border-box; margin-bottom: 20px; padding-left: 5%;">
                                                                <div class="label half-width" style="color: #bdbfC9; display: inline-block; width: 45%; vertical-align: top;">Payouts pending</div>
                                                                <div class="value left-align" style="color: #bdbfC9; display: inline-block; width: 50%; text-align: left;">{{ $payoutData['payout_count'] }}</div>
                                                            </div>
                                                            <div class="information-row" style="font-size: 14px; line-height: 1.5; width: 100%; box-sizing: border-box; margin-bottom: 20px; padding-left: 5%;">
                                                                <div class="label half-width" style="color: #bdbfC9; display: inline-block; width: 45%; vertical-align: top;">Amount pending</div>
                                                                <div class="value left-align" style="color: #bdbfC9; display: inline-block; width: 50%; text-align: left;">{{ $payoutData['payout_total'] }}</div>
                                                            </div>
                                                            <div class="information-row" style="font-size: 14px; line-height: 1.5; width: 100%; box-sizing: border-box; padding-left: 5%;">
                                                                <div class="label half-width" style="color: #bdbfC9; display: inline-block; width: 45%; vertical-align: top;">Pending since</div>
                                                                <div class="value left-align" style="color: #bdbfC9; display: inline-block; width: 50%; text-align: left;">{{ $payoutData['first_payout_pending_since'] }}</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
