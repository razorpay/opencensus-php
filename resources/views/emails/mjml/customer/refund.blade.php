    ...
    <style type="text/css">
      ...
      <div style="font-family:Trebuchet MS;font-size:13px;line-height:1;text-align:left;color:#000000;">
        <div class="card title" style="width: 85%; width: calc(46000% - 211600px); max-width: 460px; min-width: 308px; margin-left: auto; margin-right: auto; box-sizing: border-box; padding-left: 16px; padding-right: 16px; border-radius: 2px; background-color: #FFFFFF; padding-bottom: 16px; border-top-left-radius: 0; border-top-right-radius: 0;"><div class="center-align" style="text-align: center;"><div class="para para-banner para-light" style="margin: 0; font-size: 16px; line-height: 1.5; color: #7B8199;"><div class="icon" style="width: 14px; display: inline-block; vertical-align: middle;"><img src="https://cdn.razorpay.com/static/assets/email/payment_refund.png" style="height: 100%; width: 100%;"></div><div class="inline-block" style="display: inline-block;">&nbsp;Refund has been initiated</div></div><div class="divider" style="padding: 12px 0;"><div class="divider-line" style="height: 1px; background: #EBEDF2;"></div></div><p class="para font-size-medium font-color-secondary" style="font-size: 14px; line-height: 1.5; color: #515978; margin: 0;">Your bank may take upto 5-7 business days to credit the refund to your account. You can track the&nbsp;<a class="link" href="https://razorpay.com/support/#refund?utm_source=customer_mailer&amp;utm_medium=email&amp;utm_campaign=payment_refund" target="_blank" style="text-decoration: none; color: #528FF0;">refund status here.</a></p></div></div>
      </div>
      ...
      <div style="font-family:Trebuchet MS;font-size:13px;line-height:1;text-align:left;color:#000000;">
        <div class="card merchant-highlight informative" style="width: 85%; width: calc(46000% - 211600px); max-width: 460px; min-width: 308px; margin-left: auto; margin-right: auto; box-sizing: border-box; padding-left: 16px; padding-right: 16px; border-radius: 2px; background-color: #FFFFFF; border-top-width: 2px; border-top-style: solid; padding-top: 20px; padding-bottom: 20px; border-top-color: {{ $merchant['brand_color'] }}; margin-top: 8px;"><div class="information-row" style="font-size: 14px; line-height: 1.5; width: 100%; box-sizing: border-box; padding-left: 9.3%; margin-bottom: 20px;"><div class="label" style="color: #7B8199; display: inline-block; vertical-align: top; width: 50%; width: calc((388.203px - 100%) * 388.203); max-width: 100%; min-width: 50%;">Refund Id</div><div class="value" style="color: #515978; display: inline-block;">{{ $refund['public_id'] }}</div></div><div class="information-row" style="font-size: 14px; line-height: 1.5; width: 100%; box-sizing: border-box; padding-left: 9.3%; margin-bottom: 20px;"><div class="label" style="color: #7B8199; display: inline-block; vertical-align: top; width: 50%; width: calc((388.203px - 100%) * 388.203); max-width: 100%; min-width: 50%;">Initiated On</div><div class="value" style="color: #515978; display: inline-block;">{{ $refund['created_at_formatted'] }}</div></div><div class="information-row" style="font-size: 14px; line-height: 1.5; width: 100%; box-sizing: border-box; padding-left: 9.3%; margin-bottom: 20px;"><div class="label" style="color: #7B8199; display: inline-block; vertical-align: top; width: 50%; width: calc((388.203px - 100%) * 388.203); max-width: 100%; min-width: 50%;">Total Paid</div><div class="value" style="color: #515978; display: inline-block;"><div class="amount value" style="font-size: 14px; line-height: 1.5; color: #515978; display: inline-block;"><span class="symbol" style="font-size: 14px; line-height: 1.5; color: inherit;">{{$payment['amount_spread'][0]}}</span><span class="rupees" style="font-size: 14px; line-height: 1.5; color: inherit;">{{$payment['amount_spread'][1]}}</span><span class="paise" style="font-size: 12px; line-height: 1.5; color: inherit;">.{{$payment['amount_spread'][2]}}</span></div></div></div><div class="information-row" style="font-size: 14px; line-height: 1.5; width: 100%; box-sizing: border-box; padding-left: 9.3%; margin-bottom: 20px;"><div class="label" style="color: #7B8199; display: inline-block; vertical-align: top; width: 50%; width: calc((388.203px - 100%) * 388.203); max-width: 100%; min-width: 50%;">Payment Via</div><div class="value" style="color: #515978; display: inline-block;"><div>{{ $payment['method'][1] }}</div><div class="font-color-tertiary" style="color: #7B8199;">{{ $payment['method'][0] }}</div></div></div><div class="information-row" style="font-size: 14px; line-height: 1.5; width: 100%; box-sizing: border-box; padding-left: 9.3%;"><div class="label" style="color: #7B8199; display: inline-block; vertical-align: top; width: 50%; width: calc((388.203px - 100%) * 388.203); max-width: 100%; min-width: 50%;">Mobile Number</div><div class="value" style="color: #515978; display: inline-block;">{{ $customer['phone'] }}</div></div></div>
      </div>
