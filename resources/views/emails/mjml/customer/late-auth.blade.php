                                    ...
                                    <div class="para para-banner para-light"
                                      ...
                                      <div class="icon"
                                        style="width: 14px; display: inline-block; vertical-align: middle;"><img
                                          src="https://cdn.razorpay.com/static/assets/email/payment_late_auth.png"
                                          style="height: 100%; width: 100%;"></div>
                                      <div class="inline-block" style="display: inline-block;">&nbsp;Awaited for the bank update
                                      </div>
                                      <hr style="opacity: 0.2; margin: 16px 0;">
                                      <div style="font-size: 14px;">
                                      We haven't received any update from the bank on the payment you made. We request you to check the payment status here in next 2-3 days
                                      </div>
                                    </div>
                                  </div>
                                </div>
