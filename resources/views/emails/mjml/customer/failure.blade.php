                                    ...
                                    <div class="para para-banner para-light"
                                      ...
                                      <div class="icon"
                                        style="width: 14px; display: inline-block; vertical-align: middle;"><img
                                          src="https://cdn.razorpay.com/static/assets/email/payment_failure.png"
                                          style="height: 100%; width: 100%;"></div>
                                      <div class="inline-block" style="display: inline-block;">&nbsp;Payment Failed
                                      </div>
                                      <hr style="opacity: 0.2; margin: 16px 0;">
                                      <div style="font-size: 14px;">
                                        In case your money has already debited from your account, It will credit to your bank account within 5-7 business days.
                                      </div>
                                    </div>
                                  </div>
                                </div>
