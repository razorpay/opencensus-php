    ...
    <style type="text/css">
      ...
      <div style="font-family:Trebuchet MS;font-size:13px;line-height:1;text-align:left;color:#000000;">
        <div class="card title" style="width: 85%; width: calc(46000% - 211600px); max-width: 460px; min-width: 308px; margin-left: auto; margin-right: auto; box-sizing: border-box; padding-left: 16px; padding-right: 16px; border-radius: 2px; background-color: #FFFFFF; padding-bottom: 16px; border-top-left-radius: 0; border-top-right-radius: 0;"><div class="center-align font-size-normal font-color-primary" style="text-align: center; font-size: 16px; line-height: 1.5; color: #0D2366;">Commission Payout Invoice Created for {{ $merchant["id"] }}: {{ $merchant["name"] }}: {{ $created_at }}</div><p class="para-normal font-size-medium" style="font-size: 14px; line-height: 1.5; color: #515978;">Dear Team,</p><p class="para-normal font-size-medium" style="font-size: 14px; line-height: 1.5; color: #515978;">{{ $merchant["id"] }}: {{ $merchant["name"] }} has generated an invoice with invoice id: {{ $invoice['id'] }}.</p><p class="para-normal font-size-medium" style="font-size: 14px; line-height: 1.5; color: #515978;">The merchant is not under "automated_commission_payout" feature. Hence, kindly process the invoice.</p><p class="para para-normal font-size-medium" style="font-size: 14px; line-height: 1.5; margin: 0; color: #515978;">Thanks &amp; Regards,</p><p class="para para-normal font-size-medium" style="font-size: 14px; line-height: 1.5; margin: 0; color: #515978;">Razorpay Team</p></div>
      </div>
