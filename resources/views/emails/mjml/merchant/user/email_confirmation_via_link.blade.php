    ...
    <style type="text/css">
      ...
      <div style="font-family:Trebuchet MS;font-size:13px;line-height:1;text-align:left;color:#000000;">
        <div class="card highlight" style="width: 85%; width: calc(46000% - 211600px); max-width: 460px; min-width: 308px; margin-left: auto; margin-right: auto; box-sizing: border-box; padding-left: 16px; padding-right: 16px; border-radius: 2px; background-color: #FFFFFF; border-top: 2px solid #528FF0; padding-top: 20px; padding-bottom: 20px; margin-top: 8px;"><p class="para-normal font-size-medium" style="font-size: 14px; line-height: 1.5; color: #515978;">You have successfully created a Razorpay account. Please click on the button below to verify your email address.</p><div class="center-align padding-top-8 padding-bottom-8" style="text-align: center; padding-top: 8px; padding-bottom: 8px;"><button class="btn primary-link" style="font-size: 14px; line-height: 1.5; border: 1px solid; padding: 8px 12px; letter-spacing: 1px; border-radius: 2px; overflow: hidden; min-width: 185px; color: #0D2366; background-color: #528FF0; border-color: #528FF0;"><a class="link" href="{{ $confirmation_link }}" target="_blank" style="text-decoration: none; color: #FFFFFF;">Verify Email</a></button></div><p class="para-normal font-size-medium" style="font-size: 14px; line-height: 1.5; color: #515978;">Or open the following link in your browser:</p><p class="para-normal font-size-medium" style="font-size: 14px; line-height: 1.5; color: #515978;"><a class="link" href="{{$confirmation_link}}" target="_blank" style="text-decoration: none; color: #528FF0;">{{$confirmation_link}}</a></p></div>
      </div>
