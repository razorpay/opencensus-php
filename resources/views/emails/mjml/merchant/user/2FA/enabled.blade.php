    ...
    <style type="text/css">
          ...
          <div class="content branding rzp" style="width: 85%; width: calc(46000% - 211600px); max-width: 460px; min-width: 308px; margin-left: auto; margin-right: auto; box-sizing: border-box; padding-left: 16px; padding-right: 16px; border-radius: 2px; padding-top: 12px; padding-bottom: 12px;">
            <div class="branding-content" style="text-align: center; width: fit-content; margin: 0 auto; font-size: 12px; line-height: 1.5; color: #8D92A4;">
              <div class="content-element logo" style="display: inline-block; vertical-align: middle; height: 18px; width: 85px; margin-left: 5px;">
                @if ((isset($custom_branding) === true) && ($custom_branding === false))
      ...
      <div style="font-family:Trebuchet MS;font-size:13px;line-height:1;text-align:left;color:#000000;">
        <div class="card highlight" style="width: 85%; width: calc(46000% - 211600px); max-width: 460px; min-width: 308px; margin-left: auto; margin-right: auto; box-sizing: border-box; padding-left: 16px; padding-right: 16px; border-radius: 2px; background-color: #FFFFFF; border-top: 2px solid #528FF0; padding-top: 20px; padding-bottom: 20px; margin-top: 8px;"><p class="para-normal font-size-medium" style="font-size: 14px; line-height: 1.5; color: #515978;">Two step authentication is now enabled for your account - {{ $merchant['name'] }} with account ID {{ $merchant['id'] }} using mobile number {{ $user['contact_mobile'] }}</p><p class="para-normal font-size-medium" style="font-size: 14px; line-height: 1.5; color: #515978;">This will ensure that all the users accessing this account validates their identity by providing the OTP sent to their registered mobile number.</p><p class="para-normal font-size-medium" style="font-size: 14px; line-height: 1.5; color: #515978;">You can disable this anytime by navigating to the ‘My Account’ -> ‘Manage team’ section within the Razorpay dashboard.</p><p class="para-normal font-size-medium" style="font-size: 14px; line-height: 1.5; color: #515978;">You can find more details about two step authentication&nbsp;<a class="link" href="https://razorpay.com/docs/payment-gateway/dashboard-guide/my-account/#troubleshooting" target="_blank" style="text-decoration: none; color: #528FF0;">here</a></p></div>
      </div>
      ...
      @if ((isset($custom_branding) === true) && ($custom_branding === true))
        <div class="max-width-override" style="Margin: 0px auto; max-width: unset;">
            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
                <tbody>
                    <tr>
