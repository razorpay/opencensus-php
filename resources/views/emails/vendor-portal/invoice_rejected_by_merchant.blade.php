                                    ...
                                    >
                                      ...
                                      >
                                        <img
                                          width="44px"
                                          height="44px"
                                          src="https://cdn.razorpay.com/static/assets/email/vendor-portal/invoice_rejected.png"
                                        />
                                      </div>
                                      <div
                                        class="title-content"
                                      ...
                                      >
                                        <div
                                          ...
                                          "
                                        >
                                          {{ $business_name }} has rejected your
                                          payment request
                                        </div>
                                        <div
                                          class="center-align"
                                      ...
                                      <div
                                        ...
                                        "
                                      >
                                        Payment request of ₹{{ $payout_amount
                                        }}/- was rejected.
                                        <div>
                                          Details are attached below. In case of
                                          any confusion, contact the merchant
                                          directly.
                                        </div>
                                      </div>
                                      <div
                          ...
                          >
                            <tr>
                              ...
                              >
                                ...
                                >
                                  <div
                                    class="card secondary informative"
                                    style="
                                      width: 85%;
                                      width: calc(46000% - 211600px);
                                      max-width: 460px;
                                  ...
                                  >
                                    ...
                                    @endif @if(!empty($invoice['gst_amount']))
                                    <div
                                      class="information-row"
                                      style="
                                        font-size: 14px;
