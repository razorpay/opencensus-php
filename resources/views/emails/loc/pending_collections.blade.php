...
<div style="background-color:#FAFAFA;">
    ...
    <!--[if mso | IE]>
    <table
        align="center" border="0" cellpadding="0" cellspacing="0" class="max-width-override-outlook"
    ...
    <div class="max-width-override"
         style="background: #03299C; background-color: #03299C; Margin: 0px auto; max-width: unset;">

        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
               style="background:#03299C;background-color:#03299C;width:100%;">
            <tbody>
            <tr>
                                                        ...
                                                        <div class="content branding rzp"
                                                            ...
                                                            <div class="branding-content"
                                                                ...
                                                                <div class="content-element logo"
                                                                    ...
                                                                    <img src="https://cdn.razorpay.com/logo_invert.png"
                                                            ...
                                                            <div class="title-content"
                                                                ...
                                                                <div class="center-align" style="text-align: center;">
                                                                    <img class="image small"
                                                                         src="https://cdn.razorpay.com/static/assets/email/flash.png"
                                            ...
                                            <td align="left" style="font-size:0px;padding:0px;word-break:break-word;">
                                                ...
                                                <div
                                                    ...
                                                    <div class="card title"
                                                        ...
                                                        <div class="center-align font-size-large font-color-primary"
                                                             style="text-align: center; font-size: 24px; line-height: 1.5; color: #0D2366;">
                                                            Hello
                                                        </div>
                                                        <div class="center-align font-size-normal font-color-secondary"
                                                             style="text-align: center; font-size: 16px; line-height: 1.5; color: #515978;">
                                                            Greetings from Razorpay!
                                                        </div>
                                                        <div class="center-align" style="text-align: center;">
                                                            <div class="puck para" style="padding: 12px 0; margin: 0;">
                                                                <div class="bar"
                                                                     style="margin: 0px auto; width: 24px; height: 4px; background-color: #3BD541;"></div>
                                                            </div>
                                                        </div>
                                                        <div class="center-align font-size-medium font-color-tertiary"
                                                             style="text-align: center; font-size: 14px; line-height: 1.5; color: #7B8199;">
                                                            Check the list of pending collections for the day
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style=""
                                        ...
                                        <tr>
                                            <td align="left" style="font-size:0px;padding:0px;word-break:break-word;">
                                                ...
                                                <div
                                                    style="font-family:Trebuchet MS;font-size:13px;line-height:1;text-align:left;color:#000000;">
                                                    <div class="card highlight informative"
                                                         style="width: 85%; width: calc(46000% - 211600px); max-width: 460px; min-width: 308px; margin-left: auto; margin-right: auto; box-sizing: border-box; padding-left: 16px; padding-right: 16px; border-radius: 2px; background-color: #FFFFFF; border-top: 2px solid #528FF0; padding-top: 20px; padding-bottom: 20px; margin-top: 8px;">
                                                        <div class="information-row"
                                                            ...
                                                            <div class="label"
                                                                ...
                                                                <div class="font-size-normal font-color-tertiary"
                                                                     style="font-size: 16px; line-height: 1.5; color: #7B8199;">
                                                                    Withdrawal ID {{$i}}
                                                                </div>
                                                            </div>
                                                            <div class="value"
                                                                 style="color: #515978; display: inline-block; max-width: 50%;">
                                                                <div class="font-size-normal font-color-secondary"
                                                                     style="font-size: 16px; line-height: 1.5; color: #515978;">{{ $data['pending_collections'][$i]['withdrawal_id'] }}</div>
                                                            </div>
                                                        </div>
                                                        <br>
                                                        <div class="information-row"
                                                            ...
                                                            <div class="value"
                                                                 style="color: #515978; display: inline-block; max-width: 50%;">
                                                                <div class="font-size-normal font-color-secondary"
                                                                     style="font-size: 16px; line-height: 1.5; color: #515978;">{{ $data['pending_collections'][$i]['merchant_id'] }}</div>
                                                            </div>
                                                        </div>
                                                        <br>
                                                        <div class="information-row"
                                        ...
                                        <tr>
                                            <td align="left" style="font-size:0px;padding:0px;word-break:break-word;">
                                                ...
                                                <div
                                                    style="font-family:Trebuchet MS;font-size:13px;line-height:1;text-align:left;color:#000000;">
                                                    <div class="card"
                                                         style="width: 85%; width: calc(46000% - 211600px); max-width: 460px; min-width: 308px; margin-left: auto; margin-right: auto; box-sizing: border-box; padding-left: 16px; padding-right: 16px; border-radius: 2px; background-color: #FFFFFF; padding-top: 20px; padding-bottom: 20px; margin-top: 8px;">
                                                        <div class="center-align font-size-medium font-color-tertiary"
                                                             style="text-align: center; font-size: 14px; line-height: 1.5; color: #7B8199;">
                                                            Thanks & Regards,
                                                        </div>
                                                        <div class="center-align font-size-medium font-color-secondary"
                                                             style="text-align: center; font-size: 14px; line-height: 1.5; color: #515978;">
                                                            Razorpay Team
                                                        </div>
                                                    </div>
                                                </div>
