...
$payment_page_status    = $payment_page_data['status'] ?? null;
                    ...
                    <div class="table-box" id="chkout-par">
                        ...
                        <div id="chkout-box" class={{$payment_page_status === 'inactive' ? 'short' : ''}}>
                            <div id="udf_parent">
                                ...
                                <div id="submit">
                                    <input type="button" class="btn btn-primary btn-lg btn-block" id="udf_submit_btn" value="Submit">
                                </div>
                            </div>
                            <div id="scs-box">
