...
<head>
    ...
    <style>
        ...
        * {
        ...
        html, body {
            height: 100%;
            font-family: ubuntu, "Helvetica Neue", helvetica, arial, sans-serif, sans;
        }
