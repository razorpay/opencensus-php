<script type="text/javascript">
    ...
    window.cdnDashboardAssetsUrl = "{{ config('app.cdn_dashboard_assets_url') }}";
    ...
    window.INSIGHT_X_SUPERSET_URL="{{ env('INSIGHT_X_SUPERSET_URL') }}";         
    window.INSIGHT_X_SUPERSET_OVERVIEW_ID="{{ env('INSIGHT_X_SUPERSET_OVERVIEW_ID') }}";
    window.INSIGHT_X_SUPERSET_UPI_ID="{{ env('INSIGHT_X_SUPERSET_UPI_ID') }}";
    window.INSIGHT_X_SUPERSET_CARDS_ID="{{ env('INSIGHT_X_SUPERSET_CARDS_ID') }}";
    window.INSIGHT_X_SUPERSET_NETBANKING_ID="{{ env('INSIGHT_X_SUPERSET_NETBANKING_ID') }}";
    window.INSIGHT_X_SUPERSET_WALLETS_ID="{{ env('INSIGHT_X_SUPERSET_WALLETS_ID') }}";
    ...
    window.RAZORPAY_ACCOUNTS_URL = "{{ config('app.razorpay_accounts_url') }}";
