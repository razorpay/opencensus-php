...
<head>
    <meta charset="utf-8">
    <title>RzpCheckoutBuilder</title>
    <base href="/">
    ...
    <link rel="stylesheet" href="{{$cdn}}/checkout-builder/styles.css">
</head>

<body>
    <app-root></app-root>
    <script src="{{$cdn}}/checkout-builder/runtime-es2015.js" type="module"></script>
    <script src="{{$cdn}}/checkout-builder/polyfills-es2015.js" type="module"></script>
    <script src="{{$cdn}}/checkout-builder/main-es2015.js" type="module"></script>
</body>
