...
use RZP\Models\Merchant\AutoKyc\Bvs\requestDispatcher\TrustSocietyNgoBusinessCertificateOcr;
...
class TrustSocietyNgoBusinessCertificateDocTest extends TestCase
{
    use DbEntityFetchTrait;

    protected $dispatcherClass = TrustSocietyNgoBusinessCertificateOcr::class;
    ...
    public function testCanTriggerValidationForTrustExperimentOn()
    {
    ...
    public function testRequestPayload()
    {
        ...
        $this->assertEquals(Constant::TRUST_SOCIETY_NGO_BUSINESS_CERTIFICATE, $requestPayload[Constant::ARTEFACT_TYPE]);
        $this->assertEquals(Constant::TRUST_SOCIETY_NGO_BUSINESS_CERTIFICATE_OCR, $requestPayload[Constant::CONFIG_NAME]);
    ...
    public function testPostProcessOperation()
    {
        ...
        $this->assertEquals(Constant::TRUST_SOCIETY_NGO_BUSINESS_CERTIFICATE, $verificationDetail->getAttribute(Entity::ARTEFACT_TYPE));
