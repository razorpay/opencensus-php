...
use RZP\Models\Merchant\AutoKyc\Bvs\requestDispatcher\CancelledChequeOcr;
use RZP\Tests\Functional\TestCase;


class CancelledChequeOcrTest extends TestCase
{

    protected $dispatcherClass = CancelledChequeOcr::class;
    ...
    public function testRequestPayloadForUnregistered()
    {
        ...
        $this->verifyRequestPayload(
            ...
            Constant::CANCELLED_CHEQUE_OCR_PERSONAL_PAN
        );
    }
    ...
    public function testRequestPayloadForProprietorship()
    {
        ...
        $this->verifyRequestPayload(
            ...
            Constant::CANCELLED_CHEQUE_OCR_BUSINESS_OR_PROMOTER_PAN
        );
    }
