...
use RZP\Models\Merchant\AutoKyc\Bvs\ManualVerificationRequestDispatcher\ActivatedMccPending;
use RZP\Tests\Functional\TestCase;

class ActivatedMccPendingTest extends TestCase
{
    protected $dispatcherClass  = ActivatedMccPending::class;
    ...
    public function testRequestPayload()
    {
        ...
        $dispatcher = new $this->dispatcherClass($merchant);
    ...
    protected function verifyRequestPayload($requestPayload, $expectedconfigName)
    {
        ...
        // assert that the state of merchant details is set to Activated MCC pending
        $this->assertEquals(Constant::ACTIVATED_MCC_PENDING, $requestPayload[Constant::DETAILS][Constant::DATA][Constant::STATUS]);
