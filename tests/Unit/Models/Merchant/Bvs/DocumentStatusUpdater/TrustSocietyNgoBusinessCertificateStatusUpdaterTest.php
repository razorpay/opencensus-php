...
class TrustSocietyNgoBusinessCertificateStatusUpdaterTest extends TestCase
{
    ...
    public function testNgoCertificateDocVerificationStatusForSuccessEvent()
    {
        $this->processKafkaEvent('success', 'verified');
    }

    public function testNgoCertificateDocVerificationStatusForFailureEvent()
    {
