...
class GstCertificateStatusUpdaterTest extends TestCase
{
    ...
    public function testGSTCertificateDocVerificationStatusForSuccessEvent()
    {
        $this->processKafkaEvent('success', 'verified');
    }

    public function testGSTCertificateDocVerificationStatusForFailureEvent()
    {
