...
class CoreTest extends TestCase
{
    ...
    public function testUpdatePosActivationStatusForRejectedToUnderReviewMerchants()
    {
        ...
        $this->assertNull((new DetailCore())->updatePosActivationStatus($merchantDetails->merchant, $activationStatusData, $merchantDetails->merchant));
    }
    public function testActivatedWorkflowCreationInUpdatePosActivationStatus()
    {
        ...
        $this->assertNotEmpty((new DetailCore())->updatePosActivationStatus($merchantDetails->merchant, $activationStatusData, $merchantDetails->merchant));
    }
    ...
    public function testAMerchantActivateWithBusinessTypeWithoutPersonalPan()
    {
        ...
        $detailCoreMock = $this->getMockBuilder(DetailCore::class)
                               ->setMethods(['isAutoKycDone'])
                               ->setMethods(['isEligibleForAutomationActivation'])
                               ->setMethods(['performComplianceChecksBasedOnBusinessType'])
                               ->getMock();
        ...
        $detailCoreMock->expects($this->any())
                       ...
                       ->willReturn(true);
        $detailCoreMock->expects($this->any())
                       ->method('performComplianceChecksBasedOnBusinessType')
                       ->willReturnCallback(function() {
                           throw new BadRequestValidationFailureException('Personal PAN should not be blank.');
                       });
