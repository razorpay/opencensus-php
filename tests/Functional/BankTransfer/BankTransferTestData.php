...
return [
    ...
    'testRblBankTransferWithShortPayeeAccountRazorXTreatmentEnabled' => [
        'request' => [
            'url'     => '/ecollect/validate/rbl/test',
            'method'  => 'post',
            'server'  => [
            ...
            'content' => [
                ...
                'Data' =>  [
                    [
                        'messageType'               => 'IMPS',
                        'beneficiaryAccountNumber'  => '22233300433',
                        'beneficiaryAccountType'    => 'Current Account',
                        'senderName'                => 'BharatPe',
                        'senderAccountNumber'       => '123412341234',
                        'senderIFSC'                => 'SBIN0000002',
    ...
    'testBankTransferIciciIMPSForRazorpayXWithPayerBankAccountCreationFailure' => [
        'request'  => [
            ...
            'content' => [
                ...
                'payee_ifsc'     => null,
                'payer_name'     => 'Name of account holder',
                'payer_account'  => '9876543200000010126789987654320000001012',
    ...
    'testNotifyCollectxTransferYesbank' => [
        'request' => [
            'url'     => '/ecollect/pay',
            'method'  => 'post',
            'server'  => [
