...
class CareServiceTest extends TestCase
{
    ...
    public function testCareProxy()
    {
        $testCases = [
            ...
            [
                self::AUTH                                => 'cron',
                self::API_ROUTE                           => '/care_service/cron/twirp/rzp.care.notification.v1.NotificationService/SendPaymentSummaryPushNotification',
                self::EXPECTED_CARE_SERVICE_ROUTE         => 'https://care-int.razorpay.com/twirp/rzp.care.notification.v1.NotificationService/SendPaymentSummaryPushNotification',
                self::EXPECTED_CARE_SERVICE_REQUEST       => [],
                self::ACTUAL_CARE_SERVICE_RESPONSE_BODY   => [
                    'key' => 'value',
                ],
            ...
            [
                self::AUTH                                => 'proxy',
                self::API_ROUTE                           => '/care_service/merchant/twirp/rzp.care.dashboard.home.v1.HomeService/GetMerchantKeyUpdate',
                self::EXPECTED_CARE_SERVICE_ROUTE         => 'https://care-int.razorpay.com/twirp/rzp.care.dashboard.home.v1.HomeService/GetMerchantKeyUpdate',
                self::EXPECTED_CARE_SERVICE_REQUEST       => [
                    'merchant' => [
                        'id' => '10000000000000',
                        'user_id' => User::MERCHANT_USER_ID,
            ...
            [
                self::AUTH                                => 'proxy',
                self::API_ROUTE                           => '/care_service/merchant/twirp/rzp.care.dashboard.home.v1.HomeService/GetMerchantSettlementOverview',
                self::EXPECTED_CARE_SERVICE_ROUTE         => 'https://care-int.razorpay.com/twirp/rzp.care.dashboard.home.v1.HomeService/GetMerchantSettlementOverview',
                self::EXPECTED_CARE_SERVICE_REQUEST       => [
                    'merchant' => [
                        'id' => '10000000000000',
                        'user_id' => User::MERCHANT_USER_ID,
            ...
            [
                self::AUTH                                => 'proxy',
                self::API_ROUTE                           => '/care_service/merchant/twirp/rzp.care.dashboard.home.v1.HomeService/GetMerchantPaymentYearlyRecap',
                self::EXPECTED_CARE_SERVICE_ROUTE         => 'https://care-int.razorpay.com/twirp/rzp.care.dashboard.home.v1.HomeService/GetMerchantPaymentYearlyRecap',
                self::EXPECTED_CARE_SERVICE_REQUEST       => [
                    'merchant' => [
                        'id' => '10000000000000',
                        'user_id' => User::MERCHANT_USER_ID,
