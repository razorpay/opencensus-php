...
class HdfcNetbankingBulkTerminalTest extends TestCase
{
    use BatchTestTrait;
    ...
    public function testBulkTerminalCreationValidateFileInvalidTpv()
    {
        $this->ba->proxyAuth();

        $entries = $this->getDefaultFileEntries();

        $entries[0][Batch\Header::HDFC_NB_TPV ] = 4;
    ...
    public function testBulkTerminalCreation()
    {
        ...
        $this->assertEquals($terminals['items'][0][Terminal\Entity::NETWORK_CATEGORY], $entries[1][Batch\Header::HDFC_NB_CATEGORY]);
    ...
    protected function getDefaultFileEntries()
    {
        return [
            [
                ...
                Batch\Header::HDFC_NB_GATEWAY_MERCHANT_ID   => '1233231',
                Batch\Header::HDFC_NB_TPV                   => 0
            ],
            [
                Batch\Header::HDFC_NB_MERCHANT_ID          => '100000Razorpay',
                Batch\Header::HDFC_NB_CATEGORY             => 'ecommerce',
                Batch\Header::HDFC_NB_GATEWAY_MERCHANT_ID  => '1233291',
                Batch\Header::HDFC_NB_TPV                  => 1
            ],
            // Should Fail
            [
                Batch\Header::HDFC_NB_MERCHANT_ID          => '10NodalAccount',
