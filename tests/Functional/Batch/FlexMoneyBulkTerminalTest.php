...
class FlexMoneyBulkTerminalTest extends TestCase
{
    ...
    public function testBulkTerminalCreation()
    {
        ...
        $this->assertEquals($terminals['items'][0][Terminal\Entity::NETWORK_CATEGORY], $entries[1][Batch\Header::FLEXMONEY_CATEGORY]);
        ...
        $this->assertEquals($terminals['items'][1][Terminal\Entity::NETWORK_CATEGORY], $entries[0][Batch\Header::FLEXMONEY_CATEGORY]);
    ...
    protected function getDefaultFileEntries()
    {
        return [
            [
                ...
                Batch\Header::FLEXMONEY_CATEGORY             => 'ecommerce',
            ],
            [
