...
class Pricing extends Base
{
    ...
    public function createPricingPlanForFeeSplit($pricingPlanId)
    {
        $rows = [
            [
                'id'                    => '1nvp2PaymentNB',
                'plan_id'               => $pricingPlanId,
                'plan_name'             => 'paymentFee',
                'product'               => 'primary',
                'feature'               => 'payment',
                'payment_method'        => 'netbanking',
                'payment_method_type'   => '',
            ...
            [
                'id'                    => '1nvpMagicCheck',
                'plan_id'               => $pricingPlanId,
                'plan_name'             => 'magicCheckoutFee',
                'product'               => 'primary',
                'feature'               => 'magic_checkout',
                'payment_method'        => 'netbanking',
                'payment_method_type'   => '',
                'payment_network'       => null,
                'payment_issuer'        => null,
