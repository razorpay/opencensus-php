...
class Terminal extends Base
{
    ...
    public function createAllSharedTerminals()
    {
        ...
        $this->createSharedNetbankingJsbTpvTerminal();
    ...
    public function createPayuUpiRecurringTerminal(array $override)
    {
        $attributes = [
            'merchant_id'           => '10000000000000',
            'gateway'               => 'payu',
    ...
    public function createDedicatedUpiMindgateTerminal($attributes)
    {
        ...
        $defaultValues = [
            ...
            'gateway'                   => 'upi_mindgate',
            'gateway_merchant_id'       => 'razorpay upi',
            'gateway_terminal_id'       => 'nodal account upi mindgate',
            'gateway_merchant_id2'      => 'razorpay@hdfcbank',
            'gateway_terminal_password' => 'razorpay_password',
            'upi'                       => true,
            'tpv'                       => 2,
    ...
    public function createDedicatedUpiMindgateIntentRecurringTerminal(array $attributes = [])
    {
        $termId = Shared::UPI_MINDGATE_RECURRING_INTENT_TERMINAL_DEDICATED;
    ...
    public function createDedicatedUpiYesbankOfflineTerminal($attributes)
    {
        $termId = '101YesDedTrmnl';
    ...
    public function createDedicatedUpiYesbankTerminal60($attributes)
    {
        $termId = Shared::UPI_YESBANK_DEDICATED_TERMINAL_60;
...
//                'collect'       => '1',
    ...
    public function createUpiRzpapbTerminal(array $attributes)
        {
            $defaultValues = [
                'id'                        => Shared::UPI_RZPAPB_TERMINAL,
                'merchant_id'               => '100000Razorpay',
                'gateway'                   => 'upi_rzpapb',
                'gateway_merchant_id'       => 'RazorpayVpaId1',
                'gateway_merchant_id2'      => 'RzpDeviceId123',
    ...
    public function createSharedNetbankingJsbTpvTerminal(array $attributes = []){

        $merchantId = \RZP\Models\Merchant\Account::SHARED_ACCOUNT;

        $defaultValues = [
            'id'                    => Shared::NETBANKING_JSB_TPV_TERMINAL,
            'merchant_id'           => $merchantId,
            'gateway'               => Gateway::NETBANKING_JSB,
            'gateway_merchant_id'   => 'netbanking_jsb',
            'netbanking'            => 1,
