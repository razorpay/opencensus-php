...
class Merchant extends Base
{
    ...
    public function createMarketplaceAccount($data = null)
    {
        ...
        $merchantData = [
            ...
            MerchantEntity::LIVE_DISABLE_REASON => $data[MerchantEntity::LIVE_DISABLE_REASON] ?? null,
        ];
    ...
    public function deactivate($id = '10000000000000')
    {
        return $this->edit($id, ['activated' => 0, 'live' => 0]);
    }
