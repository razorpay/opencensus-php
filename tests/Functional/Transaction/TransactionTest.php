...
class TransactionTest extends TestCase
{
    ...
    public function testTransactionAfterCapturingPaymentMerchantIndiaDfbPrePaidFlat()
    {
        $this->fixtures->merchant->edit('10000000000000', ['country_code' => 'IN']);

        $this->fixtures->base->editEntity('merchant', '10000000000000', ['fee_model' => 'prepaid','fee_bearer' => 'dynamic']);
        ...
        $this->fixtures->merchant->editFeeCredits('10000');
        ...
        // go through comment on 'setCustomerFeeAndTaxForDfb' method in 'app/Models/Transaction/Processor/Base.php' for better understanding
        $this->assertEquals($oldBalance['fee_credits'] - ($payment['fee'] -$txn['reference7']-$txn['reference8']), $balance['fee_credits']);
    ...
    public function testTransactionAfterCapturingPaymentMerchantIndiaDfbPrePaidFlatNotEnoughFeeCredits()
    {
        $this->fixtures->merchant->edit('10000000000000', ['country_code' => 'IN']);
        ...
        $this->fixtures->merchant->editFeeCredits('10');
        ...
        $testData = $this->testData['txnDataAfterCapturingPaymentDfbPrePaidInsufficientFeeCredits'];
        $testData['entity_id'] = $payment['id'];

        $balance = $this->getEntityById('balance', '10000000000000', true);

        // go through comment on 'setCustomerFeeAndTaxForDfb' method in 'app/Models/Transaction/Processor/Base.php' for better understanding
        $this->assertEquals($oldBalance['fee_credits'], $balance['fee_credits']);
        $this->assertArraySelectiveEquals($testData, $txn);

        return $payment;
    }

    public function testTransactionAfterCapturingPaymentMerchantIndiaDfbPrePaidPercentFeeCredits()
    {
        $this->fixtures->merchant->edit('10000000000000', ['country_code' => 'IN']);
        ...
        // payment amount of 10120 ( 120 is customer fee), and payment fee is remaining i.e. 180 ,, therefore comparing the credits before and after.
        // go through comment on 'setCustomerFeeAndTaxForDfb' method in 'app/Models/Transaction/Processor/Base.php' for better understanding
        $this->assertEquals($oldBalance['fee_credits'] - ($payment['fee'] -$txn['reference7']-$txn['reference8']), $balance['fee_credits']);
