...
//        $this->assertNull($response['error_message']);
    ...
    public function testCreateQrPaymentViaRefactorFlowForJKBankStaticQrWithTamperedMerchantReference()
    {
        // These are used during assertions at the end of the test
        $count = 0;
        ...
        $qrCode = $this->createMerchantQrCode(
            [
                ...
                'vpa'                => 'rzp.qrTest@jkb',
                'device_id'          => '12345Test',
                'qrString'         => 'upi://pay?ver=01&pa=rzp.qrTest@jkb&tr=&pn=TestJk2&cu=INR&mc=5817&qrMedium=04&tn=PaymenttoTest',
            ]);
        ...
        $this->mockMozartResponse(
            ...
            res  : [
                       ...
                       'data'    => [
                           ...
                           'upi'      => [
                               'vpa'                => 'payervpa@upi',
                               'merchant_reference' => 'RandomTrGenerated',
                               'npci_reference_id'  => 'RndmNpciRefId',
                               'gateway_timestamp'  => 1722114963,
                               'gateway_amount'     => 100,
                           ],
    ...
    public function testCheckJkBankSettledByFlag()
    {
        // These are used during assertions at the end of the test
        $count = 0;
        ...
        // check the settled_by flag
        $this->assertEquals('jkbank', $payment->getSettledBy());
    }
    ...
    public function testCreateQrPaymentViaRefactorFlowForStaticQrWithStoreId()
    {
        $this->fixtures->merchant->addFeatures(['omni_enabled'], 'LiveAccountMer');
