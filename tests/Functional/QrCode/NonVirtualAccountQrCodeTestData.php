...
return [
    ...
    'testProcessIciciQrPaymentWithPPIPayerAccountType' => [
        'url'     => '/payment/callback/bharatqr/upi_icici',
        'method'  => 'post',
        'content' => [
            Fields::MERCHANT_ID         => 'abcd_bharat_qr',
            ...
            Fields::TXN_COMPLETION_DATE => '20200601085715',
            Fields::RESPONSE_CODE       => '',
            Fields::PAYER_ACCOUNT_TYPE  => 'PPIWALLET',
        ],
    ],

    'testProcessIciciQrPaymentWithWalletPayerAccountType' => [
        'url'     => '/payment/callback/bharatqr/upi_icici',
        'method'  => 'post',
        'content' => [
            Fields::MERCHANT_ID         => 'abcd_bharat_qr',
            ...
            Fields::TXN_COMPLETION_DATE => '20200601085715',
            Fields::RESPONSE_CODE       => '',
            Fields::PAYER_ACCOUNT_TYPE  => 'WALLET',
        ],
    ],
    ...
    'testStatusCheckApiVerifyFailedResponse60Yesbank' => [
        'request' => [
            'method'  => 'POST',
            'url'     => '/reminders/send/test/qr_code/qr_code_payment_status/',
        ],
    ...
    'testStatusCheckApiVerifySuccessResponse60Yesbank' => [
        'request' => [
            'method'  => 'POST',
            'url'     => '/reminders/send/test/qr_code/qr_code_payment_status/',
        ],
    ...
    'testStatusCheckApiYesbank60ErrorResponse' => [
        'request' => [
            'method'  => 'POST',
            'url'     => '/reminders/send/test/qr_code/qr_code_payment_status/',
        ],
    ...
    'testProcessIciciQrPaymentOnSharedTerminalForSingleUseQrViaVPACallbackRoute' => [
        ...
        'content' => [
            ...
            Fields::TERMINAL_ID         => '5411',
            Fields::BANK_RRN            => '015306767323',
            Fields::MERCHANT_TRAN_ID    => 'RZPHavdshc12Dacftqrv2',
            Fields::PAYER_NAME          => 'Kushagra Gupta',
            Fields::PAYER_VA            => 'random@icici',
            Fields::PAYER_AMOUNT        => '40.00',
            Fields::TXN_STATUS          => 'SUCCESS',
            Fields::TXN_INIT_DATE       => '20200601085714',
    ...
    'testProcessYesbankQrPaymentInternalWithPayerAccountType' => [
        'url'     => '/payment/callback/bharatqr/upi_yesbank/internal',
        'method'  => 'post',
        'content' => [
            'data'=>[
    ...
    'testProcessYesbankQrPaymentInternalWithInvalidPayerAccountType' => [
        'url'     => '/payment/callback/bharatqr/upi_yesbank/internal',
        'method'  => 'post',
        'content' => [
            'data'=>[
    ...
    'testProcessYesbankQrPaymentInternalWithNullPayerAccountType' => [
        'url'     => '/payment/callback/bharatqr/upi_yesbank/internal',
        'method'  => 'post',
        'content' => [
            'data'=>[
    ...
    'testProcessYesbankQrPaymentInternalWithEmptyPayerAccountType' => [
        'url'     => '/payment/callback/bharatqr/upi_yesbank/internal',
        'method'  => 'post',
        'content' => [
            'data'=>[
