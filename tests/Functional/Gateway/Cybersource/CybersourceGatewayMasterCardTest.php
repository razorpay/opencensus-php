...
class CybersourceGatewayMasterCardTest extends TestCase
{
    use PaymentTrait;

    public function setUp()
    {
        $this->testDataFilePath = __DIR__.'/helpers/CybersourceGatewayMasterCardTestData.php';
    ...
    public function testEnrolledSuccessfulAuthentication()
    {
        $payment = $this->getDefaultPaymentArray();
        $payment['card']['number'] = '5200000000000007';
    ...
    {
        $payment = $this->getDefaultPaymentArray();
        $payment['card']['number'] = '5200000000000015';
    ...
    {
        $payment = $this->getDefaultPaymentArray();
        $payment['card']['number'] = '5200000000000106';
    ...
    {
        $payment = $this->getDefaultPaymentArray();
        $payment['card']['number'] = '5200000000000023';
    ...
    public function testUnavailableAuthentication()
    {
        $payment = $this->getDefaultPaymentArray();
        $payment['card']['number'] = '5200000000000064';
    ...
    {
        $payment = $this->getDefaultPaymentArray();
        $payment['card']['number'] = '5200000000000098';
        ...
        $this->assertEquals('authorize_failed', $cybersource['status']);
        $this->assertEquals(476, $cybersource['reason_code']);
        $this->assertEquals('1', $cybersource['eci']);
    }

    public function testCardNotEnrolled()
    {
        // TODO: Fix this test case
        $this->markTestSkipped('Invalid response returned from ACS');
        $payment = $this->getDefaultPaymentArray();
        $payment['card']['number'] = '5200000000000056';
    ...
    public function testEnrollmentErrorCheck()
    {
        $payment = $this->getDefaultPaymentArray();
        $payment['card']['number'] = '5200000000000080';
