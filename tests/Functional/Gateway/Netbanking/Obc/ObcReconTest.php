 ...
 * Class ObcReconTest
 * @package RZP\Tests\Functional\Gateway\Obc
 */
class ObcReconTest extends TestCase
{
    use ReconTrait;
    use PaymentTrait;
    ...
    public function setUp()
    {
        ...
        $this->sharedTerminal = $this->fixtures->create('terminal:shared_netbanking_obc_terminal');
    }
    ...
    public function testPaymentRecon()
    {
        ...
        $response = $this->reconcile($uploadedFile, Recon::NETBANKING_OBC);
