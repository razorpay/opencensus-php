...
class UpiMindgateGatewayTest extends TestCase
{
    ...
    public function testUnexpectedPaymentWithCreditLinePayerAccountTypeSuccess()
    {
        $this->disableUnexpectedPaymentRefundImmediately();
        ...
        $assertEqualsMap = [
            ...
            $paymentTransactionEntity['amount']    => $paymentEntity['amount'],
            '826115528405'                         => $paymentEntity['reference16'],
            'credit_line'                          => $paymentEntity['reference2'],
        ];
    ...
    public function testUpiQrPaymentProcessWithCreditLinePayerAccountType()
    {
        $this->fixtures->merchant->addFeatures(['virtual_accounts', 'bharat_qr']);
        ...
        $request = $this->mockServer()->getAsyncCallbackContentForBharatQr($qrCodeId, 100, ['rrn' => '025403043688', 'payer_account_type' => 'CREDITLINE!NA!NA!NA!NA']);
        ...
        $this->assertEquals(100, $payment['amount']);
        $this->assertEquals('025403043688', $payment['reference16']);
        $this->assertEquals('credit_line', $payment['reference2']);
