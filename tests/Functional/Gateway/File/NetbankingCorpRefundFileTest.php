...
class NetbankingCorpRefundFileTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->testDataFilePath = __DIR__ . '/helpers/NetbankingCorpRefundFileTestData.php';
    ...
    public function testNetbankingCorpRefundFile()
    {
        Mail::fake();
        ...
        Mail::assertQueued(RefundFileMail::class, function ($mail) use ($file)
        {
            ...
            $expectedSubject = RefundFileMailConstants::SUBJECT_MAP[Gateway::NETBANKING_CORPORATION] . $today;
