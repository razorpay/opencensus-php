...
class NbplusNetbankingJkbReconciliationTest extends NbPlusPaymentServiceNetbankingTest
{
    use ReconTrait;
    ...
    public function testJkbSuccessRecon()
    {
        ...
        $uploadedFile = $this->createUploadedFile($reconFile['local_file_path'], 'JkbReconTest.txt', "text/plain");

        $this->reconcile($uploadedFile, Base::NETBANKING_JKB);
    ...
    public function testJkbSuccessReconWithLateAuthorize()
    {
        ...
        $data = $this->testData['testJkbSuccessRecon'];
