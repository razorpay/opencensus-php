...
class WalletCcavenueGatewayTest extends TestCase
{
    ...
    {
        $this->testDataFilePath = __DIR__ . '/WalletCcavenueGatewayTestData.php';
    ...
    public function testVerifyFailed()
    {
        ...
        $payment = $this->fixtures->create('payment:failed', [
            ...
            PaymentEntity::GATEWAY      => 'ccavenue',
        ...
        $this->fixtures->create('mozart', [
            Mozart\Entity::GATEWAY      => 'ccavenue',
    ...
    protected function runPaymentCallbackFlowCcavenue($response, &$callback = null)
    {
