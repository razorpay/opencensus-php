...
class UpiRzpapbInitialRecurringTest extends TestCase
{
    use PaymentTrait;
    ...
    protected function setUp(): void
    {
        ...
        $this->terminal = $this->fixtures->create('terminal:dedicated_rzpapb_recurring_terminal');
    ...
    public function testRecurringAuthenticateFailed()
    {
        ...
        $this->assertArraySubset(
            [
                ...
                Payment\Entity::GATEWAY             => 'upi_rzpapb',
    ...
    protected function mandateCreateCallback($payment)
    {
        ...
        $this->makeS2SCallbackAndGetContent($content, 'upi_rzpapb', true);
    }

    protected function firstDebitCallback($payment)
    {
        $content = $this->mockServer()->getAsyncCallbackResponseFirstDebitForApb($payment);
    ...
    protected function mandatePauseCallback($mandate)
    {
        ...
        $this->makeS2sCallbackAndGetContentSilentlyForRecurring($content, 'upi_rzpapb', true);
    }
