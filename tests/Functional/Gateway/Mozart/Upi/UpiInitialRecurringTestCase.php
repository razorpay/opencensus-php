...
class UpiInitialRecurringTestCase extends TestCase
{
    ...
    public function provideVpasWithThrowables(): array
    {
        ...
        */
        ...
        $cases['hdfc_hdfcbank_allow']          = ['razorpay@hdfcbank', $throwables['whitelisted']];
        ...
        $cases['gokiwi_goaxb_allow']            = ['razorpay@goaxb', $throwables['whitelisted']];
        $cases['mahamobileplus_mahb_allow']     = ['razorpay@mahb', $throwables['whitelisted']];
        $cases['fincarebank_fincarebank_allow'] = ['razorpay@fincarebank', $throwables['whitelisted']];
        $cases['whatsapp_waicici_allow']        = ['razorpay@waicici', $throwables['whitelisted']];
        $cases['indianoverseasbank_iob_allow']  = ['razorpay@iob', $throwables['whitelisted']];
        $cases['bhimcentupiapp_centralbank_allow']  = ['razorpay@centralbank', $throwables['whitelisted']];
        $cases['indusindbankapp_indie_allow']  = ['razorpay@indie', $throwables['whitelisted']];
        $cases['samsungpay_pingpay_allow']     = ['razorpay@pingpay', $throwables['whitelisted']];
        $cases['yespaynext_yespay_allow']      = ['razorpay@yespay', $throwables['whitelisted']];
        $cases['kotakbankapp_kotak_allow']      = ['razorpay@kotak', $throwables['whitelisted']];
        $cases['kotakbankapp_kotak811_allow']   = ['razorpay@kotak811', $throwables['whitelisted']];
        $cases['cred_axisb_allow']              = ['razorpay@axisb', $throwables['whitelisted']];
        $cases['paytm_paytmwallet_allow']       = ['razorpay@paytmwallet', $throwables['whitelisted']];
        $cases['adityabirlacapitaldigital_abcdicici_allow']       = ['razorpay@abcdicici', $throwables['whitelisted']];
        $cases['freecharge_freecharge_allow']   = ['razorpay@freecharge', $throwables['whitelisted']];
        $cases['yonosbi_sbipa_allow']           = ['razorpay@sbipa', $throwables['whitelisted']];
        ...
        $cases['paytm_pthdfc_allow']            = ['razorpay@pthdfc', $throwables['whitelisted']];
        $cases['paytm_ptsbi_allow']             = ['razorpay@ptsbi', $throwables['whitelisted']];
        $cases['paytm_ptaxis_allow']            = ['razorpay@ptaxis', $throwables['whitelisted']];
        $cases['paytm_ptyes_allow']             = ['razorpay@ptyes', $throwables['whitelisted']];
        $cases['freo_freoicici_allow']          = ['razorpay@freoicici', $throwables['whitelisted']];
        $cases['bhimcrgbpay_crgb_allow']        = ['razorpay@crgb', $throwables['whitelisted']];
        $cases['pop_yespop_allow']              = ['razorpay@yespop', $throwables['whitelisted']];
