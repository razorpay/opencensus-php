...
class UpiYesbankInitialRecurringTest extends TestCase
{
    use PaymentTrait;
    ...
    protected function setUp(): void
    {
        ...
        $this->fixtures->create('terminal', [
            'id' => '1000SharpTrmnl',
            'gateway' => 'upi_yesbank',
            'gateway_merchant_id' => 'YBL000000097501',
            'vpa' => '7262093972.stage@rzp',
        ]);

        $this->terminalId = '1000SharpTrmnl';
    ...
    public function testRecurringAuthenticateFailed()
    {
        ...
        $this->assertArraySubset(
            [
                ...
                Payment\Entity::GATEWAY             => 'upi_yesbank',
    ...
    {
        $content = $this->mockServer()->getAsyncCallbackResponseMandateCreateForYesBank($payment);

        $this->makeS2SCallbackAndGetContent($content, 'upi_yesbank', true);
    }

    protected function firstDebitCallback($payment)
    {
        $content = $this->mockServer()->getAsyncCallbackResponseFirstDebitForYesBank($payment);
    ...
    protected function mandatePauseCallback($mandate)
    {
        ...
        $this->makeS2sCallbackAndGetContentSilentlyForRecurring($content, 'upi_yesbank', true);
    }
