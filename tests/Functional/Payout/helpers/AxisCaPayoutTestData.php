...
return [
        ...
        'response' => [
            'content' => [
                'error' => [
                    ...
                    'description' => 'AXIS does not support UPI payouts to VPA',
                ],
            ],
            'status_code' => 400,
        ],
    ...
    'testCreateFreePayoutForUPIModeDirectAccountWithFeatureEnabled' => [
        'request'  => [
            'method'  => 'POST',
            'url'     => '/payouts',
            'content' => [
    ...
    'testCreateAxisPayoutToUpiWithFeatureEnabledAndNonFreePayout' => [
        'request'  => [
            'method'  => 'POST',
            'url'     => '/payouts',
            'content' => [
