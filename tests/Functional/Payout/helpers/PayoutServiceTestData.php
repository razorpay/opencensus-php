...
return [
    ...
    'testBulkPayout_CurrentAccountPayoutViaPayoutService_NotesAsEmptyArray' => [
        'request'   => [
            'url'     => '/payouts/bulk',
            'method'  => 'POST',
            'content' => [
    ...
    'testBulkPayout_CurrentAccountPayoutViaPayoutService_SinglePayout_SpacesInAccountNumber' => [
        'request'   => [
            'url'     => '/payouts/bulk',
            'method'  => 'POST',
            'content' => [
    ...
    'testBulkPayout_CurrentAccountPayoutViaPayoutService_MultiplePayouts_SpacesInAccountNumber' => [
        'request'   => [
            'url'     => '/payouts/bulk',
            'method'  => 'POST',
            'content' => [
    ...
    'testBulkPayout_SharedAccountPayoutViaAPIMonolith_MultiplePayouts_SpacesInAccountNumber' => [
        'request'   => [
            'url'     => '/payouts/bulk',
            'method'  => 'POST',
            'content' => [
    ...
    'testBulkPayout_DirectAccount_MultiplePayout_SkipWorkflowTrue_FeatureEnabled' => [
        'request'   => [
            'url'     => '/payouts/bulk',
            'method'  => 'POST',
            'content' => [
    ...
    'testBulkPayout_SharedAccountPayoutViaAPIMonolith_MultiplePayout_SkipWorkflowTrue_FeatureEnabled' => [
        'request'   => [
            'url'     => '/payouts/bulk',
            'method'  => 'POST',
            'content' => [
    ...
    'testBulkPayout_SharedAccount_SinglePayout_SkipWorkflowTrue_FeatureEnabled_UseMicroservice' => [
        'request'   => [
            'url'     => '/payouts/bulk',
            'method'  => 'POST',
            'content' => [
    ...
    'testBulkPayout_VAPayoutViaAPIMonolithAndCAPayoutViaPS_MultiplePayout_SpacesInAccountNumber' => [
        'request'   => [
            'url'     => '/payouts/bulk',
            'method'  => 'POST',
            'content' => [
    ...
    'testBulkPayout_CurrentAccountPayoutViaPayoutService_InvalidAccountNumber' => [
        'request'  => [
            'url'     => '/payouts/bulk',
            'method'  => 'POST',
            'content' => [
    ...
    'testBulkPayoutForLiteBlocked_CAViaAPI_LiteViaPS' => [
        'request'   => [
            'url'     => '/payouts/bulk',
            'method'  => 'POST',
            'content' => [
    ...
    'testBulkPayoutForLiteBlocked_CAViaPS_LiteViaAPI' => [
        'request'   => [
            'url'     => '/payouts/bulk',
            'method'  => 'POST',
            'content' => [
    ...
    'testBulkPayout_SharedPayoutViaApiMonolith_DirectAccountsViaPayoutService' => [
        'request'   => [
            'url'     => '/payouts/bulk',
            'method'  => 'POST',
            'content' => [
    ...
    'testBulkPayout_VAPayoutViaAPIMonolithAndCAPayoutViaPS_ExceptionFromCurrentAccount' => [
        'request'   => [
            'url'     => '/payouts/bulk',
            'method'  => 'POST',
            'content' => [
    ...
    'testBulkPayout_VAPayoutViaAPIMonolithAndCAPayoutViaPS_ExceptionFromSharedAccount' => [
        'request'   => [
            'url'     => '/payouts/bulk',
            'method'  => 'POST',
            'content' => [
    ...
    'testBulkPayout_SharedAndDirectAccountsPayoutViaPS' => [
        'request'   => [
            'url'     => '/payouts/bulk',
            'method'  => 'POST',
            'content' => [
