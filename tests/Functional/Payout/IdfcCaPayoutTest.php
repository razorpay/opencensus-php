...
class IdfcCaPayoutTest extends TestCase
{
    ...
    public function testCreatePayout()
    {
        ...
        $this->assertEquals('idfc', $payout['channel']);
        ...
        $this->assertEquals(Channel::IDFC, $attempt['channel']);
    }
    public function testCreatePayoutWithZeroPricing()
    {
        $this->fixtures->edit('pricing', 'Bbg7e4oKCgidfc', ['fixed_rate' => 0]);
    ...
    public function testCreatePayoutWithMissingPricingRule()
    {
        ...
        $this->fixtures->edit('pricing', 'Bbg7e4oKCgidfc', ['plan_id' => 'idfcplan12345']);
    ...
    public function testIdfcPayoutUsingCredits()
    {
    ...
    public function testIdfcPayoutUsingCreditsFailed()
    {
        $this->fixtures->create('credits', ['merchant_id' => '10000000000000', 'value' => 500 , 'campaign' => 'test rewards', 'type' => 'reward_fee', 'product' => 'banking']);
    ...
    public function testIdfcPayoutUsingCreditsReversed()
    {
        $this->fixtures->create('credits', ['merchant_id' => '10000000000000', 'value' => 500 , 'campaign' => 'test rewards', 'type' => 'reward_fee', 'product' => 'banking']);
    ...
    protected function createPendingPayoutAndApprovePayoutUptoSecondLevel(int $gatewayBalance, $queueFlag = 1)
    {
        ...
        $this->mockMozartResponseForFetchingBalanceFromIdfcGateway($gatewayBalance);
    ...
    public function testCreateFreePayoutForNEFTModeDirectAccountProxyAuth()
    {
        ...
        $this->setUpCounterAndFreePayoutsCount('direct', $balanceId, 'idfc');
    ...
    protected function createFundAccountForContact($contact, $ifsc = 'IDFC0000047', $accountNumber = '111000111000')
    {
    ...
    protected function createRzpFeesContactAndFundAccountForIdfc()
    {
    ...
    public function testCreateFeeRecoveryAtPayoutCreationForIdfcPayouts()
    {
        $this->mockMozartResponseForFetchingBalanceFromIdfcGateway(500);
    ...
    public function testFeeRecoveryPayoutCronForIdfc()
    {
        ...
        // Create first payout
        $this->testCreateFeeRecoveryAtPayoutCreationForIdfcPayouts();
        ...
        $this->createRzpFeesContactAndFundAccountForIdfc();
    ...
    public function testCreateFreePayoutForUPIModeDirectAccountWithUpiEnabled()
    {
        ...
        $dcsResponse = [
            Payout\Configurations\DirectAccounts\PayoutModeConfig\Constants::ALLOWED_UPI_CHANNELS => ["idfc","axis"],
        ];
        ...
        $this->assertEquals('idfc', $payout->getChannel());
    ...
    public function testScheduledPayoutProcessingAutoRejectForIdfc()
    {
        Mail::fake();
        ...
        Mail::assertQueued(AutoRejectedPayout::class, function($mail) use ($id, $payout) {
            ...
            $accountType = 'IDFC Current Account';
    ...
    public function testCreateIdfcPayoutToUpiWithFeatureEnabledAndNonFreePayout()
    {
        $fundAccountRequest = [
            'method'  => 'POST',
            'url'     => '/fund_accounts',
        ...
        $dcsResponse = [
            Payout\Configurations\DirectAccounts\PayoutModeConfig\Constants::ALLOWED_UPI_CHANNELS => ["idfc"],
        ];
