...
class BankingSettlementTest extends TestCase
{
    ...
    public function testCustomGefuFileWithExcludingthePOSTransactionsPositiveScenario()
    {
        $this->app['config']->set('applications.ufh.mock', true);
        ...
        foreach ($merchants as $index => $merchant) {
            ...
            $settlementId = random_alphanum_string(14);
            $this->fixtures->create(
                'settlement',
                [
                    'id' => $settlementId,
            ...
            $transactionId = random_alphanum_string(14);
            $transactionId2 = random_alphanum_string(14);

            $paymentId = random_alphanum_string(14);
            $paymentId2 = random_alphanum_string(14);
    ...
    public function testCustomGefuFileWithExcludingthePOSTransactionsNegativeScenario()
    {
        $this->app['config']->set('applications.ufh.mock', true);
