...
return [
    'testTransferToInvalidOrUnlinkedId' => [
        ...
        'response'  => [
            'content'     => [
                'error' => [
                    ...
                    'description' => PublicErrorDescription::BAD_REQUEST_TRANSFER_UNSUPPORTED_ACCOUNT_ID
                ],
            ],
            'status_code' => 400,
        ],
        'exception' => [
            ...
            'internal_error_code' => ErrorCode::BAD_REQUEST_TRANSFER_UNSUPPORTED_ACCOUNT_ID
        ],
    ],
