...
class NbplusPaymentAmazonPaylaterTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->fixtures->merchant->enablePaylaterProviders(['amazonpay' => 1]);

        // s2s flow
        $this->terminal = $this->fixtures->create('terminal:paylater_amazonpay_terminal');
