...
class PaymentRetrieveTest extends TestCase
{
    ...
    */
    ...
    public function testSearchEsForNotesKeys()
    {
        $this->ba->proxyAuth();
        ...
        $expectedSearchParams = $this->testData["testSearchEsForNotesKeysParams"];
    ...
    public function testSearchEsForNotesKeysNegative()
    {
        $this->ba->proxyAuth();
