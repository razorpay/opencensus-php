...
return [
    ...
    'testInactiveIdamSamlLoginDueToDormancy' => [
        'request' => [
            'url' => '/admins/saml/login',
            'method' => 'post',
            'content' => [
    ...
    'testActiveIdamSamlLoginDueToDormancy' => [
        'request' => [
            'url' => '/admins/saml/login',
            'method' => 'post',
            'content' => [
    ...
    'testActiveAdminsWithNoLoginSinceCreation' => [
        'request' => [
            'url' => '/admins/saml/login',
            'method' => 'post',
            'content' => [
    ...
    'testDisablesDormantAdminsWithNoLoginSinceCreation' => [
        'request' => [
            'url' => '/admins/saml/login',
            'method' => 'post',
            'content' => [
