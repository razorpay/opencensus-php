...
class MerchantWebsiteWrapperTest extends TestCase
{
    ...
    function testSaveOrFail()
    {
        ...
        $emailEntity = new MerchantWebsiteEntity(['id' => '10000000000111', 'merchant_id' => '10000000000000']);
        ...
        $merchantWebsiteWrapperMock->saveApiAsvClient = $saveApiAsvClientMock;
        $merchantWebsiteWrapperMock->expects($this->exactly(1))->method('isShadowOrReverseShadowOnForOperation')->willReturn(true);

        $merchantWebsiteWrapperMock->SaveOrFail($emailEntity);
        #T1 Ends
