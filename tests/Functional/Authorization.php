...
class Authorization
{
    ...
    public function paymentsCrossBorderAppAuth($hostname = null, $mode = 'test'): void
    {
        $this->appAuth('rzp_test_10000000000000', \Config::get('applications.payments_cross_border_service')['secret']);
