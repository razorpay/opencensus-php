...
//    }
    ...
    public function testCreateBankingAccountWithActivationDetailWithBusinessTypeAsSection8Company()
    {
        $this->fixtures->terminal->createBankAccountTerminalForBusinessBanking();
        ...
        $this->assertEquals('section_8_company', $activationDetailEntity['business_category']);
