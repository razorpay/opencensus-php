...
class PartnerTest extends OAuthTestCase
{
    ...
    public function testFetchPartnerSubmerchantsFilterByActivationStatusForActivated()
    {
        $partnerUser = $this->createPartnerAndUser();
        ...
        $this->fixtures->merchant_detail->edit(self::DEFAULT_SUBMERCHANT_ID, ['activation_status' => 'activated_mcc_pending']);
        ...
        $submerchantId = '10000000000011';
        $this->allowAdminToAccessMerchant($submerchantId);
        $this->fixtures->merchant->edit($submerchantId, [
            'name' => 'random_name_1',
            'email' => 'subm2@xyz.com',
        ]);
