...
class MerchantDetailTest extends OAuthTestCase
{
    ...
    public function testNCRevampEligibilityForSignupCampaignNilAndPosStatusNotNeedsClarification()
    {
        $this->enableRazorXTreatmentForRazorX();
    ...
    public function testNCRevampEligibilityForSignupCampaignNilAndPosStatusNeedsClarification()
    {
        $this->enableRazorXTreatmentForRazorX();
    ...
    public function testPosActivationRequestStatusWithException()
    {
        Mail::fake();
        ...
        $testData = $this->testData['changePosActivationStatusToUnderReview'];
    ...
    public function testPosActivationRequestForNCStatusWithException()
    {
        Mail::fake();
        ...
        $testData = $this->testData['changePosActivationStatusToNeedsClarification'];
    ...
    public function testMerchantActivationStatusWithCustomOnboarding()
    {
        Mail::fake();
        ...
        $this->fixtures->org->addFeatures([FeatureConstants::CUSTOM_ONBOARDING_EMAILS],"100000razorpay");
        ...
        Mail::assertQueued(Rejection::class, function ($mail)
        {
            $data = $mail->getData();
            $this->assertArrayHasKey('isCustomOnboardingEmail', $data);
            $this->assertEquals($data['isCustomOnboardingEmail'], true);
            $this->assertEquals('emails.merchant.rejection_notification', $mail->view);
...
Team Razorpay', '+911234567890');
    ...
    public function testL2SubmissionChangesForAssistedOnboardingOfRazorPaySalesRole()
    {
        ...
        $this->ba->proxyAuth('rzp_test_' . $merchantDetail['merchant_id'], $razorpaySalesUser['user_id']);

        $this->startTest();
    }

    public function testShopDetailsSubmissionChangesForAssistedOnboardingOfRazorPaySalesRole()
    {
        $this->app['config']['pgos.proxy.request.mock'] = true;
    ...
    public function testL2SubmissionChangesForAssistedOnboardingOfOwnerRole()
    {
        $this->app['config']['pgos.proxy.request.mock'] = true;
...
//    }
    ...
    public function testGetMerchantWebsiteSectionDataRegularMerchant()
    {
        ...
        $testData['request']['url'] = '/merchant/' . 'website/' . 'section';

        $response = $this->runRequestResponseFlow($testData);

        $this->assertEquals(true, $response['isWebsiteSectionsApplicable']);

        $this->assertEquals(true, $response['isGracePeriodApplicable']);
    ...
    public function testGetSubMerchantWebsiteHtmlData()
    {
        $this->ba->proxyAuth();
