...
class TestCase extends Service\TestCase
{
    protected $deviceSetMap = [
        Fixtures::DEVICE_1 => [
            ...
            'bank_account'  => Fixtures::CUSTOMER_1_BANK_ACCOUNT_1,
            'vpa'           => Fixtures::CUSTOMER_1_VPA_1,
        ],
        Fixtures::DEVICE_2 => [
            'merchant'      => Fixtures::TEST_MERCHANT,
            ...
            'handle'        => Fixtures::RAZOR_SHARP,
            'bank_account'  => Fixtures::CUSTOMER_2_BANK_ACCOUNT_1,
            'vpa'           => Fixtures::CUSTOMER_2_VPA_1,
        ],
    ];
}
