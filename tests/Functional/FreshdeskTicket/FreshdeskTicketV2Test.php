...
class FreshdeskTicketV2Test extends TestCase
{
    ...
    public function testCreateTicketForUserRzpXValidation()
    {
        $frDueBy = time() + self::DAY * 2;
        ...
        $this->assertEquals('RazorpayX | Activation | 10000000000000', $ticket['ticket_details']['ticket_subject']);

    }

    public function testCreateTicketForUserRzpXWithoutCCEmail()
    {
        $frDueBy = time() + self::DAY * 2;
    ...
    public function testCreateTicketForUserRzpXWithSpecialCharsInSubject()
    {
        $response = $this->startTest();
        ...
        $this->assertEquals('ticket | subject | [] /\\', $ticket['ticket_details']['ticket_subject']);
