...
return [
    ...
    'testStoreReserveBalanceTicketDetails' => [
        ...
        'response' => [
            'content' => [
                'ticket_details' => '{"email":"sujata@razorpay.com","subject":"Reserve Balance test ticket","description":"This is a testing ticket for the new ticket API, please ignore.","priority":1,"status":2,"custom_fields":{"cf_requester_category":"Prospect","cf_requestor_subcategory":"I want to refer a merchant \/partner programme"}}',
                'ticket_id'       => '1',
                'merchant_id'     => '10000000000000',
                'type'            => 'reserve_balance_activate',
            ],
