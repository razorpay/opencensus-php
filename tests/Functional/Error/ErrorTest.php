...
class ErrorTest extends TestCase
{
    ...
    public function testErrorMappingAvalaibleForInternalErrorCode()
    {
        ...
        $shouldNotBeInRepoError = ["SUCCESS", "INVALID_ARGUMENT_INVALID_FILE_HANDLER_SOURCE","UNHANDLED_KYC_PROCESSOR_TYPE",
            ...
            "SERVER_ERROR_LEDGER_JOURNAL_FETCH_TRANSACTION",
            ...
            "BAD_REQUEST_INVALID_ACTION_CLEAR_TAG_VALUE","BAD_REQUEST_UNSUPPORTED_COMMUNICATION_TYPE", "BAD_REQUEST_CORPORATE_CARD_INVALID_TOKEN",
        ];
