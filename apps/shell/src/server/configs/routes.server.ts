...
export const SHELL_EXTERNAL_API_ROUTES = {
  USER: '/user',
  USER_OPTIMIZED: '/user?tags=0&merchant_details=0&features=0&experiments=0&splitz_experiments=0&payouts=0',
  ...
  MERCHANT_CONFIG_STORE_LIVE_ONBOARDING: "/merchant/api/live/merchants/config/store?namespace=onboarding",
  MERCHANT_CONFIG_STORE_TEST_ONBOARDING: "/merchant/api/test/merchants/config/store?namespace=onboarding",
}
