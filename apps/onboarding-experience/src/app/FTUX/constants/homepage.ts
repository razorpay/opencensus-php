...
export const PG_PAGE_LAYOUT_TEST: HOMEPAGE_ELEMENTS[] = [
  HOMEPAGE_ELEMENTS.ACCORDION,
  HOMEPAGE_ELEMENTS.WAYS_FOR_PAYMENT,
  HOMEPAGE_ELEMENTS.NOCODE_NUDGE,
  HOMEPAGE_ELEMENTS.BROWSE_ALL,
...
export const NO_CODE_PAGE_LAYOUT_TEST: HOMEPAGE_ELEMENTS[] = [
  HOMEPAGE_ELEMENTS.NOCODE_NUDGE,
  HOMEPAGE_ELEMENTS.BROWSE_ALL,
  HOMEPAGE_ELEMENTS.WAYS_FOR_PAYMENT,
  HOMEPAGE_ELEMENTS.WEBSITE_NUDGE,
...
export const PG_PLUS_NO_CODE_PAGE_LAYOUT_TEST: HOMEPAGE_ELEMENTS[] = [
  HOMEPAGE_ELEMENTS.ACCORDION,
  HOMEPAGE_ELEMENTS.NOCODE_NUDGE,
  HOMEPAGE_ELEMENTS.BROWSE_ALL,
];
