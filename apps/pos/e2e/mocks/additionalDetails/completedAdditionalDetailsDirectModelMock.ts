export const completedAdditionalDetailsDirectModelMock = {
  ...
  onboardingState: {
    ...
    modularComponents: ['device_catalogue_component', 'vas_rates_component', 'agreement_component'],
