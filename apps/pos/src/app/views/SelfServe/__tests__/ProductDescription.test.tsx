...
import ProductDescription from 'apps/pos/src/app/views/SelfServe/ProductDescription';
import { MOCK_USER, MOCK_GTM } from 'apps/pos/src/app/views/SelfServe/__tests__/mocks/fixtures';
import {
