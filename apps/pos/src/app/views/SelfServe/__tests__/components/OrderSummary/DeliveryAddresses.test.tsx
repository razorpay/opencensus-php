...
import DeliveryAddresses from 'apps/pos/src/app/views/SelfServe/OrderSummary/DeliveryAddresses';
import {
  MOCK_ADDRESSES,
  MOCK_USER,
  MOCK_PRICING_PLAN,
...
jest.mock('apps/pos/src/app/views/SelfServe/helpers', () => ({
  ...(jest.requireActual('apps/pos/src/app/views/SelfServe/helpers') as Record<string, string>),
