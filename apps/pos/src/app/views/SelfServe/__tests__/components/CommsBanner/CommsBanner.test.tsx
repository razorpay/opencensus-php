...
import CommsBanner from 'apps/pos/src/app/views/SelfServe/CommsBanner';
import { MOCK_USER } from 'apps/pos/src/app/views/SelfServe/__tests__/mocks/fixtures';
import { commsOrderFetchHandler } from 'apps/pos/src/app/views/SelfServe/__tests__/mocks/handlers';
...
jest.mock('apps/pos/src/app/views/SelfServe/CommsBanner/getMerchantComms', () => ({
