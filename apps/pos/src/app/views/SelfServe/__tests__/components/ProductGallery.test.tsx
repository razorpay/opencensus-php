...
import Thumbnails from 'apps/pos/src/app/views/SelfServe/ProductDescription/ProductGallery/Thumbnails';
import { MOCK_PRODUCT } from 'apps/pos/src/app/views/SelfServe/__tests__/mocks/fixtures';
