import { getMerchantComms } from 'apps/pos/src/app/views/SelfServe/CommsBanner/getMerchantComms';
import {
  MOCK_USER,
  MOCK_ORDER_RESPONSE,
  MOCK_DELIVERED_ORDER_ITEM,
} from 'apps/pos/src/app/views/SelfServe/__tests__/mocks/fixtures';
import { OrderDetailsItem, RefundStatusTypes } from 'apps/pos/src/app/views/SelfServe/types';
