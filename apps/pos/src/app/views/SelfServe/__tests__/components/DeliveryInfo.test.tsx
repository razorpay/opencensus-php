...
import DeliveryInfo from 'apps/pos/src/app/views/SelfServe/ProductDescription/DeliveryInfo';
import { MOCK_GTM } from 'apps/pos/src/app/views/SelfServe/__tests__/mocks/fixtures';
import { getPincodeInfoHandler } from 'apps/pos/src/app/views/SelfServe/__tests__/mocks/handlers';
