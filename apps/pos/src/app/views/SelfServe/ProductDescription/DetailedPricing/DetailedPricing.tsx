...
import { OFFER_DETAILED_PRICING, SOUNDBOX } from 'apps/pos/src/app/views/SelfServe/constants';
...
import { DetailedPricingModel, ProductDescription } from 'apps/pos/src/app/views/SelfServe/types';
