...
import EmptyOrderImg from 'apps/pos/src/assets/EmptyCart.svg';
import { useLocation, useNavigate } from 'react-router-dom';

import { ORDER_LIST_STATUS_TYPES } from 'apps/pos/src/app/views/SelfServe/constants';
import { PosDeviceStoreContext } from 'apps/pos/src/app/views/SelfServe/context';
import { getOrderList, getSubmerchantOrderList } from 'apps/pos/src/app/views/SelfServe/services';
...
const OrderList = ({ pageSize = 6 }: OrderList): JSX.Element => {
  const {
  ...
  const {
    ...
    onError: () => {
      toast.show({ color: 'negative', content: 'Something went wrong while fetching orders' });
    },
  });
