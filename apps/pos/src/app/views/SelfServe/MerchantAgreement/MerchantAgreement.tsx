...
import { DASHBOARD_PRIORITY_RANKS as Ranks } from '@libs/shared-types';
import { ErrorBoundary } from '@libs/shared-ui';
import POSAgreementConfirmation from 'apps/pos/src/app/views/SelfServe/MerchantAgreement/AgreementConfirmation';
import {
  StyledAgreementContainer,
  StyledBanner,
  StyledHandshake,
} from 'apps/pos/src/app/views/SelfServe/MerchantAgreement/styles';
import {
...
import {
  agreeToPosMerchantAgreement,
  getModularOnboardingData,
} from 'apps/pos/src/app/views/SelfServe/services';
import { PosAgreementSignIds } from 'apps/pos/src/app/views/SelfServe/types';
import { ErrorBoundaryFallBackComponent } from 'apps/pos/src/app/components/ErrorBoundaryFallBackComponent';
