  ...
  withRefundPendingFeatureDisabled: {
    paymentsData: {
      ...
      paymentByMethod: [
        {
          label: 'cod',
          value: paiseToRupees(6794974),
        },
        {
          label: 'netbanking',
          value: paiseToRupees(386774),
        },
        {
          label: 'upi',
          value: paiseToRupees(354387),
        },
        {
          label: 'Others',
          value: paiseToRupees(149500),
        },
      ],
    },
  },
  ...
  top_4_methods: {
    paymentsData: {
      ...
      paymentByMethod: [
        ...
        {
          label: 'card',
          value: paiseToRupees(136500),
        },
        {
          label: 'wallet',
          value: paiseToRupees(13000),
        },
      ],
    },
  },
