// Skipping this suite as this is out of scope for phase 1

import React from 'react';
import '@testing-library/jest-dom/extend-expect';
import { useBreakpoint } from '@razorpay/blade/utils';

import { render, screen, waitFor, userEvent } from 'apps/self-serve/src/services/test/test-utils';
...
import {
  ...
  paymentCaptureFlow,
} from 'apps/self-serve/src/App/Transactions/v2/Payments/components/Timeline/__tests__/mocks/fixtures/Timeline';
import { mockPaymentCapture } from 'apps/self-serve/src/App/Transactions/v2/Payments/components/Timeline/__tests__/mocks/handlers';
