...
const ExtraFiltersModal = lazy(
  () =>
    import(
      /* webpackChunkName: 'ExtraFiltersModal' */ 'apps/self-serve/src/App/Transactions/v2/Payments/components/PaymentsListFilter/ExtraFiltersModal'
    ),
);
...
const PaymentsListFilter = ({
  ...
  const { user, openModal } = useStore((state) => ({
