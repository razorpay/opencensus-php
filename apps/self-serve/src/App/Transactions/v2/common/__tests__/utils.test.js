...
} from 'apps/self-serve/src/App/Transactions/v2/common/__tests__/mocks/fixtures/utils';
...
import {
  ...
  searchByOptionsMap,
} from 'apps/self-serve/src/App/Transactions/v2/Payments/components/PaymentsListFilter/constants';
import { searchByOptionsMap as refundsSearchByOptionsMap } from 'apps/self-serve/src/App/Transactions/v2/Refunds/components/RefundsListFilter/constants';
...
describe('utils', () => {
  ...
  describe('getDefaultDateAndOption', () => {
    ...
    test('should return default date and duration with the correct option when from and to match a section option', () => {
      ...
      const expected = {
        defaultDate: {
          from: getFromTime(LAST_30_DAYS).unix(),
          to: endOfDay.unix(),
        },
        defaultDuration: {
          title: 'Last 30 days',
