...
import { stringDeepTrim, getURLQueryParams, stringifyQueryParams } from '@libs/shared-utils';
...
class ListContainer extends Component {
  ...
  search = (params) => {
    this.searchFilters = stringDeepTrim(params);
  ...
  analizeFailure = (params) => {
    const failureAnalysisFilter = stringDeepTrim(params);
    return this.fetchAll(
      {
